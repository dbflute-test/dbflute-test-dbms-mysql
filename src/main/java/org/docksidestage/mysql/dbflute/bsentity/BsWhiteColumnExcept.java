 ...
 */
public abstract class BsWhiteColumnExcept implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsWhiteColumnExcept)) { return false; }
        BsWhiteColumnExcept other = (BsWhiteColumnExcept)obj;
        if (!xSV(getExceptColumnId(), other.getExceptColumnId())) { return false; }
        return true;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getExceptColumnId());
        sb.append(dm).append(getColumnExceptTest());
