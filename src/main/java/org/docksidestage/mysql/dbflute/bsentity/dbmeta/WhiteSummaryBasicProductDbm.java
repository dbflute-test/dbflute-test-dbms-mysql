...
public class WhiteSummaryBasicProductDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((WhiteSummaryBasicProduct)et).getProductStatusCode(), (et, vl) -> {
            ccls(et, columnProductStatusCode(), vl);
            CDef.ProductStatus cls = (CDef.ProductStatus)gcls(et, columnProductStatusCode(), vl);
            if (cls != null) {
                ((WhiteSummaryBasicProduct)et).setProductStatusCodeAsProductStatus(cls);
            } else {
                ((WhiteSummaryBasicProduct)et).mynativeMappingProductStatusCode((String)vl);
            }
        }, "productStatusCode");
    }
    ...
    protected final ColumnInfo _columnProductStatusCode = cci("PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", null, null, String.class, "productStatusCode", null, false, false, true, "CHAR", 3, 0, null, null, false, null, null, null, null, CDef.DefMeta.ProductStatus, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.mysql.dbflute.exentity.WhiteSummaryBasicProduct"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.mysql.dbflute.cbean.WhiteSummaryBasicProductCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.mysql.dbflute.exbhv.WhiteSummaryBasicProductBhv"; }
