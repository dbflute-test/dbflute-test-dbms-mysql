...
public class WhiteUqClassificationDbm extends AbstractDBMeta {
    ...
    protected final String _tableDispName = "WHITE_UQ_CLASSIFICATION";
    ...
    protected final ColumnInfo _columnUqClsCode = cci("UQ_CLS_CODE", "UQ_CLS_CODE", null, null, String.class, "uqClsCode", null, false, false, true, "CHAR", 3, 0, null, null, false, null, null, null, null, CDef.DefMeta.UQClassificationType, false);
    ...
    //                                        Unique Element
    //                                        --------------
    public UniqueInfo uniqueOf() { return hpcui(columnUqClsCode()); }
