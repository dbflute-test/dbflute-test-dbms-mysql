 ...
 */
public abstract class BsWhiteQuotedRef implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getWhere());
        sb.append(dm).append(getOrder());
    ...
    protected String buildRelationString() {
        StringBuilder sb = new StringBuilder();
        String cm = ",";
        if (_whiteQuoted != null) { sb.append(cm).append("whiteQuoted"); }
