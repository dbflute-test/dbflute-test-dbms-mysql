...
public class WhiteAdditionalDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnFooDate = cci("foo_date", "foo_date", null, null, java.time.LocalDate.class, "fooDate", null, false, false, false, "UnknownType", null, null, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnRegisterDatetime = cci("register_datetime", "register_datetime", null, null, java.time.LocalDateTime.class, "registerDatetime", null, false, false, false, "DATETIME", null, null, "CURRENT_TIMESTAMP", false, null, null, null, null, null);
