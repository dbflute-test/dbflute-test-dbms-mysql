...
public abstract class BsOptionMember implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public DBMeta getDBMeta() {
        return org.docksidestage.mysql.dbflute.bsentity.customize.dbmeta.OptionMemberDbm.getInstance();
    }
    ...
    public void setDummyFlgAsFlg(CDef.Flg cdef) {
        setDummyFlg(cdef != null ? FunCustodial.toNumber(cdef.code(), Long.class) : null);
    }
