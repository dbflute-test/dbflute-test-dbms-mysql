...
/**
 * The entity of WHITE_UQ_CLASSIFICATION_FLG_PART as TABLE. <br>
 * <pre>
 * [primary-key]
 *     UQ_CLS_ID
 *
 ...
 * Integer uqClsFlg = entity.getUqClsFlg();
 * entity.setUqClsId(uqClsId);
 * entity.setUqClsName(uqClsName);
 * entity.setUqClsFlg(uqClsFlg);
 * = = = = = = = = = =/
 * </pre>
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsWhiteUqClassificationFlgPart extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWhiteUqClassificationFlgPart) {
            BsWhiteUqClassificationFlgPart other = (BsWhiteUqClassificationFlgPart)obj;
    ...
    @Override
    public WhiteUqClassificationFlgPart clone() {
        return (WhiteUqClassificationFlgPart)super.clone();
    }
