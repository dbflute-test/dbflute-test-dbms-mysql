 ...
 */
public abstract class BsWhiteSuppressDefCheck implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsWhiteSuppressDefCheck)) { return false; }
        BsWhiteSuppressDefCheck other = (BsWhiteSuppressDefCheck)obj;
        if (!xSV(getDefCheckId(), other.getDefCheckId())) { return false; }
        return true;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getDefCheckId());
        sb.append(dm).append(getDefCheckName());
