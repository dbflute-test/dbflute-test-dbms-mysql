...
public class SpReturnResultSetNotParamResult1Dbm extends AbstractDBMeta {
    ...
    protected final Map<String, PropertyGateway> _epgMap = newHashMap();
    {
        ...
        setupEpg(_epgMap, et -> ((SpReturnResultSetNotParamResult1)et).getFormalizedDatetime(), (et, vl) -> ((SpReturnResultSetNotParamResult1)et).setFormalizedDatetime((java.sql.Timestamp)vl), "formalizedDatetime");
