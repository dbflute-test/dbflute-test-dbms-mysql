...
public abstract class BsMemberLogin extends AbstractEntity implements DomainEntity {
    ...
    /**
     * Get the value of loginMemberStatusCode as the classification of SubItemTable. <br>
     ...
     * @return The instance of classification definition (as ENUM type). (NullAllowed: when the column value is null)
     */
    public CDef.SubItemTable getLoginMemberStatusCodeAsSubItemTable() {
        return CDef.SubItemTable.of(getLoginMemberStatusCode()).orElse(null);
    }

    /**
     * Set the value of loginMemberStatusCode as the classification of SubItemTable. <br>
     * (ログイン会員ステータスコード)LOGIN_MEMBER_STATUS_CODE: {IX, NotNull, CHAR(3), FK to member_status, classification=SubItemTable} <br>
     * the test of sub-item map for table classification
     * @param cdef The instance of classification definition (as ENUM type). (NullAllowed: if null, null value is set to the column)
     */
    public void setLoginMemberStatusCodeAsSubItemTable(CDef.SubItemTable cdef) {
    ...
    public void setLoginMemberStatusCode_正式会員() {
        setLoginMemberStatusCodeAsSubItemTable(CDef.SubItemTable.正式会員);
    }
    ...
    public void setLoginMemberStatusCode_退会会員() {
        setLoginMemberStatusCodeAsSubItemTable(CDef.SubItemTable.退会会員);
    }
    ...
    public void setLoginMemberStatusCode_仮会員() {
        setLoginMemberStatusCodeAsSubItemTable(CDef.SubItemTable.仮会員);
    }
    ...
    public boolean isLoginMemberStatusCode正式会員() {
        CDef.SubItemTable cdef = getLoginMemberStatusCodeAsSubItemTable();
        return cdef != null ? cdef.equals(CDef.SubItemTable.正式会員) : false;
    }
    ...
    public boolean isLoginMemberStatusCode退会会員() {
        CDef.SubItemTable cdef = getLoginMemberStatusCodeAsSubItemTable();
        return cdef != null ? cdef.equals(CDef.SubItemTable.退会会員) : false;
    }
    ...
    public boolean isLoginMemberStatusCode仮会員() {
        CDef.SubItemTable cdef = getLoginMemberStatusCodeAsSubItemTable();
        return cdef != null ? cdef.equals(CDef.SubItemTable.仮会員) : false;
    }
    ...
    public boolean isLoginMemberStatusCode_LastestStatus() {
        CDef.SubItemTable cdef = getLoginMemberStatusCodeAsSubItemTable();
        return cdef != null && cdef.isLastestStatus();
    }
    ...
    public OptionalEntity<MemberStatus> getMemberStatus() {
        ...
        if (_memberStatus.orElse(null) == null) { _memberStatus = CachedMemberStatus.get(this, "memberStatus", getLoginMemberStatusCode()); }
    ...
    /**
     * [get] (ログイン会員ステータスコード)LOGIN_MEMBER_STATUS_CODE: {IX, NotNull, CHAR(3), FK to member_status, classification=SubItemTable} <br>
     * ログイン時の会員ステータス
    ...
    /**
     * [set] (ログイン会員ステータスコード)LOGIN_MEMBER_STATUS_CODE: {IX, NotNull, CHAR(3), FK to member_status, classification=SubItemTable} <br>
     * ログイン時の会員ステータス
    ...
    protected void setLoginMemberStatusCode(String loginMemberStatusCode) {
        checkClassificationCode("LOGIN_MEMBER_STATUS_CODE", CDef.DefMeta.SubItemTable, loginMemberStatusCode);
