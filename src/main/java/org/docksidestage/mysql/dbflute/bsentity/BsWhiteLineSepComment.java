 ...
 */
public abstract class BsWhiteLineSepComment implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsWhiteLineSepComment)) { return false; }
        BsWhiteLineSepComment other = (BsWhiteLineSepComment)obj;
        if (!xSV(getLineSepCommentCode(), other.getLineSepCommentCode())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hs = xCH(hs, getLineSepCommentCode());
        return hs;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getLineSepCommentCode());
        sb.append(dm).append(getLineSepCommentName());
