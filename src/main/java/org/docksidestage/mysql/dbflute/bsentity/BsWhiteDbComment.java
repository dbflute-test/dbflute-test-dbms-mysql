 ...
 */
public abstract class BsWhiteDbComment implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsWhiteDbComment)) { return false; }
        BsWhiteDbComment other = (BsWhiteDbComment)obj;
        if (!xSV(getDbCommentCode(), other.getDbCommentCode())) { return false; }
        return true;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getDbCommentCode());
        sb.append(dm).append(getDbCommentName());
