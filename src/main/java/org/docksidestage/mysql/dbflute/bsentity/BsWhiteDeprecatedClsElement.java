 ...
 */
public abstract class BsWhiteDeprecatedClsElement implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsWhiteDeprecatedClsElement)) { return false; }
        BsWhiteDeprecatedClsElement other = (BsWhiteDeprecatedClsElement)obj;
        if (!xSV(getDeprecatedClsElementCode(), other.getDeprecatedClsElementCode())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hs = xCH(hs, getDeprecatedClsElementCode());
        return hs;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getDeprecatedClsElementCode());
        sb.append(dm).append(getDeprecatedClsElementName());
