 ...
 */
public abstract class BsVendorCheckIntegerSum implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public int hashCode() {
        ...
        hs = xCH(hs, getIntegerNonDigitSum());
        return hs;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getIntegerNonDigitSum());
