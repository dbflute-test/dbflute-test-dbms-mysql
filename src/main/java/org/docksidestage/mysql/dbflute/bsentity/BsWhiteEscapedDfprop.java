 ...
 */
public abstract class BsWhiteEscapedDfprop implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public int hashCode() {
        ...
        hs = xCH(hs, getEscapedDfpropCode());
        return hs;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getEscapedDfpropCode());
        sb.append(dm).append(getEscapedDfpropName());
