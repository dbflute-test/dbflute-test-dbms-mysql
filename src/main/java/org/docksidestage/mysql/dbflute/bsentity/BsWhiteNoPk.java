 ...
 */
public abstract class BsWhiteNoPk implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsWhiteNoPk)) { return false; }
        BsWhiteNoPk other = (BsWhiteNoPk)obj;
        if (!xSV(getNoPkId(), other.getNoPkId())) { return false; }
        if (!xSV(getNoPkName(), other.getNoPkName())) { return false; }
        if (!xSV(getNoPkInteger(), other.getNoPkInteger())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hs = xCH(hs, getNoPkId());
        hs = xCH(hs, getNoPkName());
        hs = xCH(hs, getNoPkInteger());
        return hs;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getNoPkId());
        sb.append(dm).append(getNoPkName());
        sb.append(dm).append(getNoPkInteger());
