...
/**
 * The entity of SpPointTypeMappingNotParamResult1.
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsSpPointTypeMappingNotParamResult1 extends AbstractEntity implements CustomizeEntity {
    ...
    protected java.time.LocalDate _memberName;
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.mysql.dbflute.bsentity.customize.dbmeta.SpPointTypeMappingNotParamResult1Dbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SpPointTypeMappingNotParamResult1";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSpPointTypeMappingNotParamResult1) {
            BsSpPointTypeMappingNotParamResult1 other = (BsSpPointTypeMappingNotParamResult1)obj;
    ...
    @Override
    public SpPointTypeMappingNotParamResult1 clone() {
        return (SpPointTypeMappingNotParamResult1)super.clone();
    }
     ...
     */
    public java.time.LocalDate getMemberName() {
     ...
     */
    public void setMemberName(java.time.LocalDate memberName) {
