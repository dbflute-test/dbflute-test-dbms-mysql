...
public abstract class BsLargeAutoPaging extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.mysql.dbflute.bsentity.customize.dbmeta.LargeAutoPagingDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "LargeAutoPaging";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsLargeAutoPaging) {
            BsLargeAutoPaging other = (BsLargeAutoPaging)obj;
    ...
    @Override
    public LargeAutoPaging clone() {
        return (LargeAutoPaging)super.clone();
    }
