 ...
 */
public abstract class BsWhiteLoadData implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsWhiteLoadData)) { return false; }
        BsWhiteLoadData other = (BsWhiteLoadData)obj;
        if (!xSV(getLoadDataId(), other.getLoadDataId())) { return false; }
        return true;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getLoadDataId());
        sb.append(dm).append(getLoadDataName());
