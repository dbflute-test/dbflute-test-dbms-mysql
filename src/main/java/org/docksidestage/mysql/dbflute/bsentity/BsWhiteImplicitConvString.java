 ...
 */
public abstract class BsWhiteImplicitConvString implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsWhiteImplicitConvString)) { return false; }
        BsWhiteImplicitConvString other = (BsWhiteImplicitConvString)obj;
        if (!xSV(getImplicitConvStringId(), other.getImplicitConvStringId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hs = xCH(hs, getImplicitConvStringId());
        return hs;
    }
