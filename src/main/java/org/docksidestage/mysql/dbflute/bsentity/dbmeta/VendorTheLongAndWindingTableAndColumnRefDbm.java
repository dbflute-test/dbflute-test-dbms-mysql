...
public class VendorTheLongAndWindingTableAndColumnRefDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnTheLongAndWindingTableAndColumnRefDate = cci("THE_LONG_AND_WINDING_TABLE_AND_COLUMN_REF_DATE", "THE_LONG_AND_WINDING_TABLE_AND_COLUMN_REF_DATE", null, null, java.time.LocalDate.class, "theLongAndWindingTableAndColumnRefDate", null, false, false, true, "DATE", 10, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnShortDate = cci("SHORT_DATE", "SHORT_DATE", null, null, java.time.LocalDate.class, "shortDate", null, false, false, true, "DATE", 10, 0, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignVendorTheLongAndWindingTableAndColumn() {
        ...
        return cfi("FK_VENDOR_THE_LONG_AND_WINDING_TABLE_AND_COLUMN_REF", "vendorTheLongAndWindingTableAndColumn", this, VendorTheLongAndWindingTableAndColumnDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "vendorTheLongAndWindingTableAndColumnRefList", false);
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.mysql.dbflute.exentity.VendorTheLongAndWindingTableAndColumnRef"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.mysql.dbflute.cbean.VendorTheLongAndWindingTableAndColumnRefCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.mysql.dbflute.exbhv.VendorTheLongAndWindingTableAndColumnRefBhv"; }
