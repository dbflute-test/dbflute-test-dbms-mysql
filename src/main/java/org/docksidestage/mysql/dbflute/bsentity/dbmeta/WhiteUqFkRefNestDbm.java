...
public class WhiteUqFkRefNestDbm extends AbstractDBMeta {
    ...
    protected final String _tableDispName = "WHITE_UQ_FK_REF_NEST";
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnUqFkRefNestId = cci("UQ_FK_REF_NEST_ID", "UQ_FK_REF_NEST_ID", null, null, Long.class, "uqFkRefNestId", null, true, false, true, "DECIMAL", 16, 0, null, null, false, null, null, null, null, null, false);
