...
public class WhiteEscapedDfpropDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((WhiteEscapedDfprop)et).getEscapedDfpropCode(), (et, vl) -> {
            ccls(et, columnEscapedDfpropCode(), vl);
            CDef.EscapedDfpropCls cls = (CDef.EscapedDfpropCls)gcls(et, columnEscapedDfpropCode(), vl);
            if (cls != null) {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnEscapedDfpropCode = cci("ESCAPED_DFPROP_CODE", "ESCAPED_DFPROP_CODE", null, null, String.class, "escapedDfpropCode", null, true, false, true, "CHAR", 3, 0, null, null, false, null, null, null, null, CDef.DefMeta.EscapedDfpropCls, false);
    protected final ColumnInfo _columnEscapedDfpropName = cci("ESCAPED_DFPROP_NAME", "ESCAPED_DFPROP_NAME", null, null, String.class, "escapedDfpropName", null, false, false, false, "VARCHAR", 20, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.mysql.dbflute.exentity.WhiteEscapedDfprop"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.mysql.dbflute.cbean.WhiteEscapedDfpropCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.mysql.dbflute.exbhv.WhiteEscapedDfpropBhv"; }
