...
/**
 * The entity of (VIEW)WHITE_SUMMARY_COMPLEX_PRODUCT as VIEW.
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsWhiteSummaryComplexProduct extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWhiteSummaryComplexProduct) {
            BsWhiteSummaryComplexProduct other = (BsWhiteSummaryComplexProduct)obj;
    ...
    @Override
    public WhiteSummaryComplexProduct clone() {
        return (WhiteSummaryComplexProduct)super.clone();
    }
