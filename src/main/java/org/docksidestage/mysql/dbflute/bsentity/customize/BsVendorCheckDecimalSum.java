 ...
 */
public abstract class BsVendorCheckDecimalSum implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public DBMeta getDBMeta() {
        return org.docksidestage.mysql.dbflute.bsentity.customize.dbmeta.VendorCheckDecimalSumDbm.getInstance();
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsVendorCheckDecimalSum)) { return false; }
        BsVendorCheckDecimalSum other = (BsVendorCheckDecimalSum)obj;
        if (!xSV(getDecimalDigitSum(), other.getDecimalDigitSum())) { return false; }
        return true;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getDecimalDigitSum());
