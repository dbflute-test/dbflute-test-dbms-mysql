...
public class OptionMemberDbm extends AbstractDBMeta {
    ...
    public static class EpgDummyNoflg implements PropertyGateway {
        ...
        public void write(Entity et, Object vl) { ((OptionMember)et).setDummyNoflg(ctl(vl)); }
    }
    ...
    protected final ColumnInfo _columnStatusDisplayOrder = cci("STATUS_DISPLAY_ORDER", "STATUS_DISPLAY_ORDER", null, "表示順", Integer.class, "statusDisplayOrder", null, false, false, false, "INT", 11, 0, null, false, null, "UI上のステータスの表示順を示すNO。\n並べるときは、このカラムに対して昇順のソート条件にする。", null, null, null);
    ...
    protected final ColumnInfo _columnDummyFlg = cci("DUMMY_FLG", "DUMMY_FLG", null, null, Long.class, "dummyFlg", null, false, false, false, "BIGINT", 1, 0, null, false, null, null, null, null, CDef.DefMeta.Flg);
    protected final ColumnInfo _columnDummyNoflg = cci("DUMMY_NOFLG", "DUMMY_NOFLG", null, null, Long.class, "dummyNoflg", null, false, false, false, "BIGINT", 1, 0, null, false, null, null, null, null, null);
