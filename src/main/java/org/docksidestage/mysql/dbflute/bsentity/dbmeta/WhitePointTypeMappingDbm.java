...
public class WhitePointTypeMappingDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnPointTypeMappingMemberName = cci("POINT_TYPE_MAPPING_MEMBER_NAME", "POINT_TYPE_MAPPING_MEMBER_NAME", null, null, org.docksidestage.mysql.mytype.MyMemberName.class, "pointTypeMappingMemberName", null, false, false, false, "VARCHAR", 32, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnPointTypeMappingPriceCount = cci("POINT_TYPE_MAPPING_PRICE_COUNT", "POINT_TYPE_MAPPING_PRICE_COUNT", null, null, org.docksidestage.mysql.mytype.MyPriceCount.class, "pointTypeMappingPriceCount", null, false, false, false, "INT", 10, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnPointTypeMappingSaleDate = cci("POINT_TYPE_MAPPING_SALE_DATE", "POINT_TYPE_MAPPING_SALE_DATE", null, null, org.docksidestage.mysql.mytype.MySaleDate.class, "pointTypeMappingSaleDate", null, false, false, false, "BIGINT", 19, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnPointTypeMappingWantedDatetime = cci("POINT_TYPE_MAPPING_WANTED_DATETIME", "POINT_TYPE_MAPPING_WANTED_DATETIME", null, null, java.time.LocalDate.class, "pointTypeMappingWantedDatetime", null, false, false, false, "DATETIME", 19, 0, null, false, null, null, null, null, null);
