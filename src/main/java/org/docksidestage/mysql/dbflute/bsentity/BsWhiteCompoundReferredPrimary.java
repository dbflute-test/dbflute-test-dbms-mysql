...
/**
 * The entity of WHITE_COMPOUND_REFERRED_PRIMARY as TABLE. <br />
 * <pre>
 * [primary-key]
 *     REFERRED_ID
 * 
 ...
 */
public abstract class BsWhiteCompoundReferredPrimary implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public String getTablePropertyName() { // according to Java Beans rule
        return "whiteCompoundReferredPrimary";
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsWhiteCompoundReferredPrimary)) { return false; }
