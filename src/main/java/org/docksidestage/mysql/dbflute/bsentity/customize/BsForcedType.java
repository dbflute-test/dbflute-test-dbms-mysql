 ...
 */
public abstract class BsForcedType implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public DBMeta getDBMeta() {
        return org.docksidestage.mysql.dbflute.bsentity.customize.dbmeta.ForcedTypeDbm.getInstance();
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsForcedType)) { return false; }
        BsForcedType other = (BsForcedType)obj;
        if (!xSV(getMaxMemberId(), other.getMaxMemberId())) { return false; }
        return true;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String dm = ", ";
        sb.append(dm).append(getMaxMemberId());
