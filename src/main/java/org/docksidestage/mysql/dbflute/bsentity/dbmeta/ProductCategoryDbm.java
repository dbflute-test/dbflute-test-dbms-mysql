...
public class ProductCategoryDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnParentCategoryCode = cci("PARENT_CATEGORY_CODE", "PARENT_CATEGORY_CODE", null, "親カテゴリコード", String.class, "parentCategoryCode", null, false, false, false, "CHAR", 3, 0, null, false, null, "最上位の場合はデータなし。", "productCategorySelf", null, null, false);
