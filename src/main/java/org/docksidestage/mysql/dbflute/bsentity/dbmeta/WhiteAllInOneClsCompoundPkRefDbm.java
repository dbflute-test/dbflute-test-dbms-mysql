...
public class WhiteAllInOneClsCompoundPkRefDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((WhiteAllInOneClsCompoundPkRef)et).getFooCode(), (et, vl) -> ((WhiteAllInOneClsCompoundPkRef)et).setFooCode((String)vl), "fooCode");
        setupEpg(_epgMap, et -> ((WhiteAllInOneClsCompoundPkRef)et).getBarCode(), (et, vl) -> ((WhiteAllInOneClsCompoundPkRef)et).setBarCode((String)vl), "barCode");
        setupEpg(_epgMap, et -> ((WhiteAllInOneClsCompoundPkRef)et).getQuxCode(), (et, vl) -> ((WhiteAllInOneClsCompoundPkRef)et).setQuxCode((String)vl), "quxCode");
    }
    ...
    protected void xsetupEfpg() {
        setupEfpg(_efpgMap, et -> ((WhiteAllInOneClsCompoundPkRef)et).getWhiteAllInOneClsElementAsFoo(), (et, vl) -> ((WhiteAllInOneClsCompoundPkRef)et).setWhiteAllInOneClsElementAsFoo((OptionalEntity<WhiteAllInOneClsElement>)vl), "whiteAllInOneClsElementAsFoo");
        setupEfpg(_efpgMap, et -> ((WhiteAllInOneClsCompoundPkRef)et).getWhiteAllInOneClsElementAsBar(), (et, vl) -> ((WhiteAllInOneClsCompoundPkRef)et).setWhiteAllInOneClsElementAsBar((OptionalEntity<WhiteAllInOneClsElement>)vl), "whiteAllInOneClsElementAsBar");
    }
    ...
    protected final String _tableDispName = "WHITE_ALL_IN_ONE_CLS_COMPOUND_PK_REF";
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.mysql.dbflute.exentity.WhiteAllInOneClsCompoundPkRef"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.mysql.dbflute.cbean.WhiteAllInOneClsCompoundPkRefCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.mysql.dbflute.exbhv.WhiteAllInOneClsCompoundPkRefBhv"; }
