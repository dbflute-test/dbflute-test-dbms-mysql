...
public class SpReturnResultSetMoreNotParamResult1Dbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((SpReturnResultSetMoreNotParamResult1)et).getBirthdate(), (et, vl) -> ((SpReturnResultSetMoreNotParamResult1)et).setBirthdate(ctld(vl)), "birthdate");
        setupEpg(_epgMap, et -> ((SpReturnResultSetMoreNotParamResult1)et).getFormalizedDatetime(), (et, vl) -> ((SpReturnResultSetMoreNotParamResult1)et).setFormalizedDatetime(ctldt(vl)), "formalizedDatetime");
