...
public class WhiteImplicitConvIntegerDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnImplicitConvIntegerId = cci("IMPLICIT_CONV_INTEGER_ID", "IMPLICIT_CONV_INTEGER_ID", null, null, Integer.class, "implicitConvIntegerId", null, true, false, true, "INT", 10, 0, null, null, false, null, null, null, "whiteImplicitConvNumericList,whiteImplicitConvStringList", null, false);
    protected final ColumnInfo _columnImplicitConvNumericId = cci("IMPLICIT_CONV_NUMERIC_ID", "IMPLICIT_CONV_NUMERIC_ID", null, null, Integer.class, "implicitConvNumericId", null, false, false, true, "INT", 10, 0, null, null, false, null, null, "whiteImplicitConvNumeric", null, null, false);
    protected final ColumnInfo _columnImplicitConvStringId = cci("IMPLICIT_CONV_STRING_ID", "IMPLICIT_CONV_STRING_ID", null, null, Integer.class, "implicitConvStringId", null, false, false, true, "INT", 10, 0, null, null, false, null, null, "whiteImplicitConvString", null, null, false);
