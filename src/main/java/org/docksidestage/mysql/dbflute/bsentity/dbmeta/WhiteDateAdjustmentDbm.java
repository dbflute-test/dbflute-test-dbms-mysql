...
public class WhiteDateAdjustmentDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnAdjustedDate = cci("ADJUSTED_DATE", "ADJUSTED_DATE", null, "adjusted", java.time.LocalDate.class, "adjustedDate", null, false, false, false, "DATE", 10, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnAdjustedDatetime = cci("ADJUSTED_DATETIME", "ADJUSTED_DATETIME", null, null, java.time.LocalDateTime.class, "adjustedDatetime", null, false, false, false, "DATETIME", 19, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnAdjustedTime = cci("ADJUSTED_TIME", "ADJUSTED_TIME", null, null, java.time.LocalTime.class, "adjustedTime", null, false, false, false, "TIME", 8, 0, null, false, null, null, null, null, null);
