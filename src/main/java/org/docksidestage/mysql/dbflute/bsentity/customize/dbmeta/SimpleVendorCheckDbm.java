...
public class SimpleVendorCheckDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((SimpleVendorCheck)et).getTypeOfBoolean(), (et, vl) -> {
            ...
            ((SimpleVendorCheck)et).setTypeOfBoolean((Boolean)vl);
        }, "typeOfBoolean");
    ...
    protected final ColumnInfo _columnTypeOfText = cci("TYPE_OF_TEXT", "TYPE_OF_TEXT", null, null, String.class, "typeOfText", null, false, false, false, "VARCHAR", 16383, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnTypeOfBoolean = cci("TYPE_OF_BOOLEAN", "TYPE_OF_BOOLEAN", null, null, Boolean.class, "typeOfBoolean", null, false, false, false, "TINYINT", 1, 0, null, null, false, null, null, null, null, CDef.DefMeta.BooleanFlg, false);
