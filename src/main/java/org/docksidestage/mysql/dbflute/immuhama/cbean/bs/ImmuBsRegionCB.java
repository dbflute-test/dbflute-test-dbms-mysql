 ...
 */
public class ImmuBsRegionCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuRegionCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsRegionCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuRegionCB acceptPK(ImmuCDef.Region regionId) {
        assertObjectNotNull("regionId", regionId);
        ImmuBsRegionCB cb = this;
        cb.query().setRegionId_Equal_AsRegion(regionId);
        return (ImmuRegionCB)this;
    }
     ...
     */
    public ImmuRegionCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuRegionCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuRegionCQ doGetConditionQuery() {
    ...
    protected ImmuRegionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuRegionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuRegionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuRegionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuRegionCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuRegionCB> unionCBLambda) {
        final ImmuRegionCB cb = new ImmuRegionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuRegionCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuRegionCB> unionCBLambda) {
        final ImmuRegionCB cb = new ImmuRegionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuRegionCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuRegionCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuRegionCQ> qyCall
         ...
         */
        public HpSDRFunction<ImmuMemberAddressCB, ImmuRegionCQ> derivedMemberAddress() {
            assertDerived("memberAddressList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberAddressCB> sq, ImmuRegionCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<ImmuRegionCB, ImmuRegionCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuRegionCB> sq, ImmuRegionCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuRegionCB dreamCruiseCB() {
        ImmuRegionCB cb = new ImmuRegionCB();
        cb.xsetupForDreamCruise((ImmuRegionCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuRegionCB> columnQuery(final SpecifyQuery<ImmuRegionCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuRegionCB xcreateColumnQueryCB() {
        ImmuRegionCB cb = new ImmuRegionCB();
        cb.xsetupForColumnQuery((ImmuRegionCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuRegionCB> orCBLambda) {
        xorSQ((ImmuRegionCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuRegionCB> andCBLambda) {
        xorSQAP((ImmuRegionCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuRegionCB cb;
        if (mainCB != null) {
            cb = (ImmuRegionCB)mainCB;
        } else {
            cb = new ImmuRegionCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuRegionCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuRegionCQ.class.getName(); }
