 ...
 */
public class ImmuBsProductCategoryCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuProductCategoryCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsProductCategoryCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuProductCategoryCB acceptPK(String productCategoryCode) {
        assertObjectNotNull("productCategoryCode", productCategoryCode);
        ImmuBsProductCategoryCB cb = this;
        cb.query().setProductCategoryCode_Equal(productCategoryCode);
        return (ImmuProductCategoryCB)this;
    }
     ...
     */
    public ImmuProductCategoryCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuProductCategoryCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuProductCategoryCQ doGetConditionQuery() {
    ...
    protected ImmuProductCategoryCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuProductCategoryCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuProductCategoryCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuProductCategoryCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuProductCategoryCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuProductCategoryCB> unionCBLambda) {
        final ImmuProductCategoryCB cb = new ImmuProductCategoryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuProductCategoryCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuProductCategoryCB> unionCBLambda) {
        final ImmuProductCategoryCB cb = new ImmuProductCategoryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuProductCategoryCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }

    // ===================================================================================
    //                                                                         SetupSelect
    //                                                                         ===========
    protected ImmuProductCategoryNss _nssProductCategorySelf;
    public ImmuProductCategoryNss xdfgetNssProductCategorySelf() {
        if (_nssProductCategorySelf == null) { _nssProductCategorySelf = new ImmuProductCategoryNss(null); }
     ...
     */
    public ImmuProductCategoryNss setupSelect_ProductCategorySelf() {
        ...
        { _nssProductCategorySelf = new ImmuProductCategoryNss(query().queryProductCategorySelf()); }
        return _nssProductCategorySelf;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuProductCategoryCQ> {
        protected ImmuProductCategoryCB.HpSpecification _productCategorySelf;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuProductCategoryCQ> qyCall
         ...
         */
        public ImmuProductCategoryCB.HpSpecification specifyProductCategorySelf() {
            assertRelation("productCategorySelf");
            if (_productCategorySelf == null) {
                _productCategorySelf = new ImmuProductCategoryCB.HpSpecification(_baseCB
         ...
         * }, ImmuProduct.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<ImmuProductCB, ImmuProductCategoryCQ> derivedProduct() {
            assertDerived("productList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuProductCB> sq, ImmuProductCategoryCQ cq, String al, DerivedReferrerOption op)
         ...
         * }, ImmuProductCategory.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<ImmuProductCategoryCB, ImmuProductCategoryCQ> derivedProductCategorySelf() {
            assertDerived("productCategorySelfList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuProductCategoryCB> sq, ImmuProductCategoryCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<ImmuProductCategoryCB, ImmuProductCategoryCQ> myselfDerived() {
     ...
     */
    public ImmuProductCategoryCB dreamCruiseCB() {
        ImmuProductCategoryCB cb = new ImmuProductCategoryCB();
        cb.xsetupForDreamCruise((ImmuProductCategoryCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuProductCategoryCB> columnQuery(final SpecifyQuery<ImmuProductCategoryCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuProductCategoryCB xcreateColumnQueryCB() {
        ImmuProductCategoryCB cb = new ImmuProductCategoryCB();
        cb.xsetupForColumnQuery((ImmuProductCategoryCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuProductCategoryCB> orCBLambda) {
        xorSQ((ImmuProductCategoryCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuProductCategoryCB> andCBLambda) {
        xorSQAP((ImmuProductCategoryCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuProductCategoryCB cb;
        if (mainCB != null) {
            cb = (ImmuProductCategoryCB)mainCB;
        } else {
            cb = new ImmuProductCategoryCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuProductCategoryCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuProductCategoryCQ.class.getName(); }
