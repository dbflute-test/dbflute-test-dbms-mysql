 ...
 */
public class ImmuProductStatusDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final ImmuProductStatusDbm _instance = new ImmuProductStatusDbm();
    private ImmuProductStatusDbm() {}
    public static ImmuProductStatusDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((ImmuProductStatus)et).getProductStatusCode(), (et, vl) -> ((ImmuProductStatus)et).setProductStatusCode((String)vl), "productStatusCode");
        setupEpg(_epgMap, et -> ((ImmuProductStatus)et).getProductStatusName(), (et, vl) -> ((ImmuProductStatus)et).setProductStatusName((String)vl), "productStatusName");
        setupEpg(_epgMap, et -> ((ImmuProductStatus)et).getDisplayOrder(), (et, vl) -> ((ImmuProductStatus)et).setDisplayOrder(cti(vl)), "displayOrder");
    }
    ...
    public ReferrerInfo referrerProductList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnProductStatusCode(), ImmuProductDbm.getInstance().columnProductStatusCode());
        return cri("FK_PRODUCT_PRODUCT_STATUS", "productList", this, ImmuProductDbm.getInstance(), mp, false, "productStatus");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.mysql.dbflute.immuhama.exentity.ImmuProductStatus"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.mysql.dbflute.immuhama.cbean.ImmuProductStatusCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.mysql.dbflute.immuhama.exbhv.ImmuProductStatusBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<ImmuProductStatus> getEntityType() { return ImmuProductStatus.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public ImmuProductStatus newEntity() { return new ImmuProductStatus(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((ImmuProductStatus)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((ImmuProductStatus)et, mp); }
