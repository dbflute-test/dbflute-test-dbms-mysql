...
/**
 * The base condition-bean of cdef_product_status.
 * @author DBFlute(AutoGenerator)
 */
public class ImmuBsCdefProductStatusCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuCdefProductStatusCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsCdefProductStatusCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuCdefProductStatusCB acceptPK(String productStatusCode) {
        assertObjectNotNull("productStatusCode", productStatusCode);
        ImmuBsCdefProductStatusCB cb = this;
        cb.query().setProductStatusCode_Equal(productStatusCode);
        return (ImmuCdefProductStatusCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ImmuCdefProductStatusCB acceptUniqueOf(Integer displayOrder) {
     ...
     */
    public ImmuCdefProductStatusCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuCdefProductStatusCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuCdefProductStatusCQ doGetConditionQuery() {
    ...
    protected ImmuCdefProductStatusCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuCdefProductStatusCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuCdefProductStatusCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuCdefProductStatusCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuCdefProductStatusCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuCdefProductStatusCB> unionCBLambda) {
        final ImmuCdefProductStatusCB cb = new ImmuCdefProductStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuCdefProductStatusCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuCdefProductStatusCB> unionCBLambda) {
        final ImmuCdefProductStatusCB cb = new ImmuCdefProductStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuCdefProductStatusCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuCdefProductStatusCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuCdefProductStatusCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "cdef_product_status"; }
        /**
         ...
         */
        public HpSDRFunction<ImmuProductDetailCB, ImmuCdefProductStatusCQ> derivedProductDetail() {
            assertDerived("productDetailList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuProductDetailCB> sq, ImmuCdefProductStatusCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<ImmuCdefProductStatusCB, ImmuCdefProductStatusCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuCdefProductStatusCB> sq, ImmuCdefProductStatusCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuCdefProductStatusCB dreamCruiseCB() {
        ImmuCdefProductStatusCB cb = new ImmuCdefProductStatusCB();
        cb.xsetupForDreamCruise((ImmuCdefProductStatusCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuCdefProductStatusCB> columnQuery(final SpecifyQuery<ImmuCdefProductStatusCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuCdefProductStatusCB xcreateColumnQueryCB() {
        ImmuCdefProductStatusCB cb = new ImmuCdefProductStatusCB();
        cb.xsetupForColumnQuery((ImmuCdefProductStatusCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuCdefProductStatusCB> orCBLambda) {
        xorSQ((ImmuCdefProductStatusCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuCdefProductStatusCB> andCBLambda) {
        xorSQAP((ImmuCdefProductStatusCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuCdefProductStatusCB cb;
        if (mainCB != null) {
            cb = (ImmuCdefProductStatusCB)mainCB;
        } else {
            cb = new ImmuCdefProductStatusCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuCdefProductStatusCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuCdefProductStatusCQ.class.getName(); }
