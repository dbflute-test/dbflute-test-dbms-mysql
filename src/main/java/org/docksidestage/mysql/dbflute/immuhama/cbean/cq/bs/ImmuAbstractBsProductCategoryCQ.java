 ...
 */
public abstract class ImmuAbstractBsProductCategoryCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsProductCategoryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void existsProduct(SubQuery<ImmuProductCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductCB cb = new ImmuProductCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepProductCategoryCode_ExistsReferrer_ProductList(ImmuProductCQ sq);
     ...
     */
    public void existsProductCategorySelf(SubQuery<ImmuProductCategoryCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductCategoryCB cb = new ImmuProductCategoryCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepProductCategoryCode_ExistsReferrer_ProductCategorySelfList(ImmuProductCategoryCQ sq);
     ...
     */
    public void notExistsProduct(SubQuery<ImmuProductCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductCB cb = new ImmuProductCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepProductCategoryCode_NotExistsReferrer_ProductList(ImmuProductCQ sq);
     ...
     */
    public void notExistsProductCategorySelf(SubQuery<ImmuProductCategoryCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductCategoryCB cb = new ImmuProductCategoryCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepProductCategoryCode_NotExistsReferrer_ProductCategorySelfList(ImmuProductCategoryCQ sq);

    public void xsderiveProductList(String fn, SubQuery<ImmuProductCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductCB cb = new ImmuProductCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepProductCategoryCode_SpecifyDerivedReferrer_ProductList(ImmuProductCQ sq);

    public void xsderiveProductCategorySelfList(String fn, SubQuery<ImmuProductCategoryCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductCategoryCB cb = new ImmuProductCategoryCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepProductCategoryCode_SpecifyDerivedReferrer_ProductCategorySelfList(ImmuProductCategoryCQ sq);
     ...
     */
    public HpQDRFunction<ImmuProductCB> derivedProduct() {
        return xcreateQDRFunctionProductList();
    }
    protected HpQDRFunction<ImmuProductCB> xcreateQDRFunctionProductList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveProductList(fn, sq, rd, vl, op));
    }
    public void xqderiveProductList(String fn, SubQuery<ImmuProductCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductCB cb = new ImmuProductCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepProductCategoryCode_QueryDerivedReferrer_ProductList(ImmuProductCQ sq);
     ...
     * @return The object to set up a function for referrer table. (NotNull)
     */
    public HpQDRFunction<ImmuProductCategoryCB> derivedProductCategorySelf() {
        return xcreateQDRFunctionProductCategorySelfList();
    }
    protected HpQDRFunction<ImmuProductCategoryCB> xcreateQDRFunctionProductCategorySelfList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveProductCategorySelfList(fn, sq, rd, vl, op));
    }
    public void xqderiveProductCategorySelfList(String fn, SubQuery<ImmuProductCategoryCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductCategoryCB cb = new ImmuProductCategoryCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepProductCategoryCode_QueryDerivedReferrer_ProductCategorySelfList(ImmuProductCategoryCQ sq);
     ...
     */
    public HpSLCFunction<ImmuProductCategoryCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuProductCategoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCategoryCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuProductCategoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCategoryCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuProductCategoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCategoryCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuProductCategoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCategoryCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuProductCategoryCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuProductCategoryCB&gt;() {
     *     public void query(ImmuProductCategoryCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCategoryCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuProductCategoryCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductCategoryCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuProductCategoryCQ sq);

    protected ImmuProductCategoryCB xcreateScalarConditionCB() {
        ImmuProductCategoryCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuProductCategoryCB xcreateScalarConditionPartitionByCB() {
        ImmuProductCategoryCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuProductCategoryCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductCategoryCB cb = new ImmuProductCategoryCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PRODUCT_CATEGORY_CODE";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuProductCategoryCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuProductCategoryCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuProductCategoryCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductCategoryCB cb = new ImmuProductCategoryCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_CATEGORY_CODE";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuProductCategoryCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuProductCategoryCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductCategoryCB cb = new ImmuProductCategoryCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuProductCategoryCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuProductCategoryCB newMyCB() {
        return new ImmuProductCategoryCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuProductCategoryCQ.class.getName(); }
