...
/**
 * The abstract condition-query of cdef_withdrawal_reason.
 * @author DBFlute(AutoGenerator)
 */
public abstract class ImmuAbstractBsCdefWithdrawalReasonCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsCdefWithdrawalReasonCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void setWithdrawalReasonCode_Equal_AsWithdrawalReason(ImmuCDef.WithdrawalReason cdef) {
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setWithdrawalReasonCode_NotEqual_AsWithdrawalReason(ImmuCDef.WithdrawalReason cdef) {
     ...
     */
    public void setWithdrawalReasonCode_InScope_AsWithdrawalReason(Collection<ImmuCDef.WithdrawalReason> cdefList) {
     ...
     * @param cdefList The list of classification definition (as ENUM type). (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setWithdrawalReasonCode_NotInScope_AsWithdrawalReason(Collection<ImmuCDef.WithdrawalReason> cdefList) {
     ...
     */
    public void existsMemberWithdrawal(SubQuery<ImmuMemberWithdrawalCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuMemberWithdrawalCB cb = new ImmuMemberWithdrawalCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepWithdrawalReasonCode_ExistsReferrer_MemberWithdrawalList(ImmuMemberWithdrawalCQ sq);
     ...
     */
    public void notExistsMemberWithdrawal(SubQuery<ImmuMemberWithdrawalCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuMemberWithdrawalCB cb = new ImmuMemberWithdrawalCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepWithdrawalReasonCode_NotExistsReferrer_MemberWithdrawalList(ImmuMemberWithdrawalCQ sq);

    public void xsderiveMemberWithdrawalList(String fn, SubQuery<ImmuMemberWithdrawalCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberWithdrawalCB cb = new ImmuMemberWithdrawalCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepWithdrawalReasonCode_SpecifyDerivedReferrer_MemberWithdrawalList(ImmuMemberWithdrawalCQ sq);
     ...
     */
    public HpQDRFunction<ImmuMemberWithdrawalCB> derivedMemberWithdrawal() {
        return xcreateQDRFunctionMemberWithdrawalList();
    }
    protected HpQDRFunction<ImmuMemberWithdrawalCB> xcreateQDRFunctionMemberWithdrawalList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveMemberWithdrawalList(fn, sq, rd, vl, op));
    }
    public void xqderiveMemberWithdrawalList(String fn, SubQuery<ImmuMemberWithdrawalCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberWithdrawalCB cb = new ImmuMemberWithdrawalCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepWithdrawalReasonCode_QueryDerivedReferrer_MemberWithdrawalList(ImmuMemberWithdrawalCQ sq);
     ...
     * (退会理由テキスト)WITHDRAWAL_REASON_TEXT: {NotNull, TEXT(65535)}
     * @param withdrawalReasonText The value of withdrawalReasonText as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * (退会理由テキスト)WITHDRAWAL_REASON_TEXT: {NotNull, TEXT(65535)}
     * @param withdrawalReasonText The value of withdrawalReasonText as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * (退会理由テキスト)WITHDRAWAL_REASON_TEXT: {NotNull, TEXT(65535)}
     * @param withdrawalReasonText The value of withdrawalReasonText as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * (退会理由テキスト)WITHDRAWAL_REASON_TEXT: {NotNull, TEXT(65535)}
     * @param withdrawalReasonText The value of withdrawalReasonText as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     */
    public HpSLCFunction<ImmuCdefWithdrawalReasonCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuCdefWithdrawalReasonCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefWithdrawalReasonCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuCdefWithdrawalReasonCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefWithdrawalReasonCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuCdefWithdrawalReasonCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefWithdrawalReasonCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuCdefWithdrawalReasonCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefWithdrawalReasonCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuCdefWithdrawalReasonCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuCdefWithdrawalReasonCB&gt;() {
     *     public void query(ImmuCdefWithdrawalReasonCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefWithdrawalReasonCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuCdefWithdrawalReasonCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefWithdrawalReasonCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuCdefWithdrawalReasonCQ sq);

    protected ImmuCdefWithdrawalReasonCB xcreateScalarConditionCB() {
        ImmuCdefWithdrawalReasonCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuCdefWithdrawalReasonCB xcreateScalarConditionPartitionByCB() {
        ImmuCdefWithdrawalReasonCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuCdefWithdrawalReasonCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefWithdrawalReasonCB cb = new ImmuCdefWithdrawalReasonCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "WITHDRAWAL_REASON_CODE";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuCdefWithdrawalReasonCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuCdefWithdrawalReasonCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuCdefWithdrawalReasonCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefWithdrawalReasonCB cb = new ImmuCdefWithdrawalReasonCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "WITHDRAWAL_REASON_CODE";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuCdefWithdrawalReasonCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuCdefWithdrawalReasonCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuCdefWithdrawalReasonCB cb = new ImmuCdefWithdrawalReasonCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuCdefWithdrawalReasonCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuCdefWithdrawalReasonCB newMyCB() {
        return new ImmuCdefWithdrawalReasonCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuCdefWithdrawalReasonCQ.class.getName(); }
