...
/**
 * The abstract condition-query of member_login_password.
 * @author DBFlute(AutoGenerator)
 */
public abstract class ImmuAbstractBsMemberLoginPasswordCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsMemberLoginPasswordCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param memberLoginPasswordId The value of memberLoginPasswordId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberLoginPasswordId_Equal(Long memberLoginPasswordId) {
        doSetMemberLoginPasswordId_Equal(memberLoginPasswordId);
    }

    protected void doSetMemberLoginPasswordId_Equal(Long memberLoginPasswordId) {
        regMemberLoginPasswordId(CK_EQ, memberLoginPasswordId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberLoginPasswordId The value of memberLoginPasswordId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberLoginPasswordId_NotEqual(Long memberLoginPasswordId) {
        doSetMemberLoginPasswordId_NotEqual(memberLoginPasswordId);
    }

    protected void doSetMemberLoginPasswordId_NotEqual(Long memberLoginPasswordId) {
        regMemberLoginPasswordId(CK_NES, memberLoginPasswordId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberLoginPasswordId The value of memberLoginPasswordId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberLoginPasswordId_GreaterThan(Long memberLoginPasswordId) {
        regMemberLoginPasswordId(CK_GT, memberLoginPasswordId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberLoginPasswordId The value of memberLoginPasswordId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberLoginPasswordId_LessThan(Long memberLoginPasswordId) {
        regMemberLoginPasswordId(CK_LT, memberLoginPasswordId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberLoginPasswordId The value of memberLoginPasswordId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberLoginPasswordId_GreaterEqual(Long memberLoginPasswordId) {
        regMemberLoginPasswordId(CK_GE, memberLoginPasswordId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberLoginPasswordId The value of memberLoginPasswordId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberLoginPasswordId_LessEqual(Long memberLoginPasswordId) {
        regMemberLoginPasswordId(CK_LE, memberLoginPasswordId);
    }
     ...
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of memberLoginPasswordId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of memberLoginPasswordId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setMemberLoginPasswordId_RangeOf(Long minNumber, Long maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setMemberLoginPasswordId_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     */
    protected void setMemberLoginPasswordId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueMemberLoginPasswordId(), "MEMBER_LOGIN_PASSWORD_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberLoginPasswordIdList The collection of memberLoginPasswordId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setMemberLoginPasswordId_InScope(Collection<Long> memberLoginPasswordIdList) {
        doSetMemberLoginPasswordId_InScope(memberLoginPasswordIdList);
    }

    protected void doSetMemberLoginPasswordId_InScope(Collection<Long> memberLoginPasswordIdList) {
        regINS(CK_INS, cTL(memberLoginPasswordIdList), xgetCValueMemberLoginPasswordId(), "MEMBER_LOGIN_PASSWORD_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberLoginPasswordIdList The collection of memberLoginPasswordId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setMemberLoginPasswordId_NotInScope(Collection<Long> memberLoginPasswordIdList) {
        doSetMemberLoginPasswordId_NotInScope(memberLoginPasswordIdList);
    }

    protected void doSetMemberLoginPasswordId_NotInScope(Collection<Long> memberLoginPasswordIdList) {
        regINS(CK_NINS, cTL(memberLoginPasswordIdList), xgetCValueMemberLoginPasswordId(), "MEMBER_LOGIN_PASSWORD_ID");
    }
     ...
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setMemberLoginPasswordId_IsNull() { regMemberLoginPasswordId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setMemberLoginPasswordId_IsNotNull() { regMemberLoginPasswordId(CK_ISNN, DOBJ); }

    protected void regMemberLoginPasswordId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueMemberLoginPasswordId(), "MEMBER_LOGIN_PASSWORD_ID"); }
    protected abstract ConditionValue xgetCValueMemberLoginPasswordId();
     ...
     */
    public HpSLCFunction<ImmuMemberLoginPasswordCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuMemberLoginPasswordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginPasswordCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuMemberLoginPasswordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginPasswordCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuMemberLoginPasswordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginPasswordCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuMemberLoginPasswordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginPasswordCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuMemberLoginPasswordCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuMemberLoginPasswordCB&gt;() {
     *     public void query(ImmuMemberLoginPasswordCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginPasswordCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuMemberLoginPasswordCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberLoginPasswordCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuMemberLoginPasswordCQ sq);

    protected ImmuMemberLoginPasswordCB xcreateScalarConditionCB() {
        ImmuMemberLoginPasswordCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuMemberLoginPasswordCB xcreateScalarConditionPartitionByCB() {
        ImmuMemberLoginPasswordCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuMemberLoginPasswordCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberLoginPasswordCB cb = new ImmuMemberLoginPasswordCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "MEMBER_LOGIN_PASSWORD_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuMemberLoginPasswordCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuMemberLoginPasswordCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuMemberLoginPasswordCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberLoginPasswordCB cb = new ImmuMemberLoginPasswordCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_LOGIN_PASSWORD_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuMemberLoginPasswordCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuMemberLoginPasswordCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuMemberLoginPasswordCB cb = new ImmuMemberLoginPasswordCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuMemberLoginPasswordCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuMemberLoginPasswordCB newMyCB() {
        return new ImmuMemberLoginPasswordCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuMemberLoginPasswordCQ.class.getName(); }
