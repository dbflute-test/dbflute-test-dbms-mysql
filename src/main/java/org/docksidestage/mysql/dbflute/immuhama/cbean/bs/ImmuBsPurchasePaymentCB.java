 ...
 */
public class ImmuBsPurchasePaymentCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuPurchasePaymentCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsPurchasePaymentCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuPurchasePaymentCB acceptPK(Long purchasePaymentId) {
        assertObjectNotNull("purchasePaymentId", purchasePaymentId);
        ImmuBsPurchasePaymentCB cb = this;
        cb.query().setPurchasePaymentId_Equal(purchasePaymentId);
        return (ImmuPurchasePaymentCB)this;
    }
     ...
     */
    public ImmuPurchasePaymentCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuPurchasePaymentCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuPurchasePaymentCQ doGetConditionQuery() {
    ...
    protected ImmuPurchasePaymentCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuPurchasePaymentCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuPurchasePaymentCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuPurchasePaymentCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuPurchasePaymentCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuPurchasePaymentCB> unionCBLambda) {
        final ImmuPurchasePaymentCB cb = new ImmuPurchasePaymentCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuPurchasePaymentCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuPurchasePaymentCB> unionCBLambda) {
        final ImmuPurchasePaymentCB cb = new ImmuPurchasePaymentCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuPurchasePaymentCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuPurchasePaymentCQ> {
        protected ImmuPurchaseCB.HpSpecification _purchase;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuPurchasePaymentCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryPurchase()
                    || qyCall().qy().xgetReferrerQuery() instanceof ImmuPurchaseCQ) {
         ...
         */
        public HpSDRFunction<ImmuPurchasePaymentCB, ImmuPurchasePaymentCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuPurchasePaymentCB> sq, ImmuPurchasePaymentCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuPurchasePaymentCB dreamCruiseCB() {
        ImmuPurchasePaymentCB cb = new ImmuPurchasePaymentCB();
        cb.xsetupForDreamCruise((ImmuPurchasePaymentCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuPurchasePaymentCB> columnQuery(final SpecifyQuery<ImmuPurchasePaymentCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuPurchasePaymentCB xcreateColumnQueryCB() {
        ImmuPurchasePaymentCB cb = new ImmuPurchasePaymentCB();
        cb.xsetupForColumnQuery((ImmuPurchasePaymentCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuPurchasePaymentCB> orCBLambda) {
        xorSQ((ImmuPurchasePaymentCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuPurchasePaymentCB> andCBLambda) {
        xorSQAP((ImmuPurchasePaymentCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuPurchasePaymentCB cb;
        if (mainCB != null) {
            cb = (ImmuPurchasePaymentCB)mainCB;
        } else {
            cb = new ImmuPurchasePaymentCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuPurchasePaymentCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuPurchasePaymentCQ.class.getName(); }
