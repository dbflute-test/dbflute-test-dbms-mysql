 ...
 */
public class ImmuBsProductStatusCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuProductStatusCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsProductStatusCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuProductStatusCB acceptPK(String productStatusCode) {
        assertObjectNotNull("productStatusCode", productStatusCode);
        ImmuBsProductStatusCB cb = this;
        cb.query().setProductStatusCode_Equal(productStatusCode);
        return (ImmuProductStatusCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ImmuProductStatusCB acceptUniqueOf(Integer displayOrder) {
     ...
     */
    public ImmuProductStatusCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuProductStatusCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuProductStatusCQ doGetConditionQuery() {
    ...
    protected ImmuProductStatusCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuProductStatusCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuProductStatusCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuProductStatusCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuProductStatusCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuProductStatusCB> unionCBLambda) {
        final ImmuProductStatusCB cb = new ImmuProductStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuProductStatusCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuProductStatusCB> unionCBLambda) {
        final ImmuProductStatusCB cb = new ImmuProductStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuProductStatusCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuProductStatusCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuProductStatusCQ> qyCall
         ...
         */
        public HpSDRFunction<ImmuProductCB, ImmuProductStatusCQ> derivedProduct() {
            assertDerived("productList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuProductCB> sq, ImmuProductStatusCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<ImmuProductStatusCB, ImmuProductStatusCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuProductStatusCB> sq, ImmuProductStatusCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuProductStatusCB dreamCruiseCB() {
        ImmuProductStatusCB cb = new ImmuProductStatusCB();
        cb.xsetupForDreamCruise((ImmuProductStatusCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuProductStatusCB> columnQuery(final SpecifyQuery<ImmuProductStatusCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuProductStatusCB xcreateColumnQueryCB() {
        ImmuProductStatusCB cb = new ImmuProductStatusCB();
        cb.xsetupForColumnQuery((ImmuProductStatusCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuProductStatusCB> orCBLambda) {
        xorSQ((ImmuProductStatusCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuProductStatusCB> andCBLambda) {
        xorSQAP((ImmuProductStatusCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuProductStatusCB cb;
        if (mainCB != null) {
            cb = (ImmuProductStatusCB)mainCB;
        } else {
            cb = new ImmuProductStatusCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuProductStatusCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuProductStatusCQ.class.getName(); }
