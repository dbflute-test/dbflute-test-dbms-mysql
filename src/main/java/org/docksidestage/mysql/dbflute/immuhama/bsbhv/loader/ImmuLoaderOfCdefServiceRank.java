...
/**
 * The referrer loader of ([区分値]サービスランク)CDEF_SERVICE_RANK as TABLE. <br>
 * <pre>
 * [primary key]
 *     SERVICE_RANK_CODE
 *
 ...
 */
public class ImmuLoaderOfCdefServiceRank {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<ImmuCdefServiceRank> _selectedList;
    protected BehaviorSelector _selector;
    protected ImmuCdefServiceRankBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public ImmuLoaderOfCdefServiceRank ready(List<ImmuCdefServiceRank> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected ImmuCdefServiceRankBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(ImmuCdefServiceRankBhv.class); return _myBhv; } }
     ...
     * <pre>
     * <span style="color: #0000C0">cdefServiceRankBhv</span>.<span style="color: #994747">load</span>(<span style="color: #553000">cdefServiceRankList</span>, <span style="color: #553000">rankLoader</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * });
     * for (ImmuCdefServiceRank cdefServiceRank : <span style="color: #553000">cdefServiceRankList</span>) {
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<ImmuCdefServiceRank> getSelectedList() { return _selectedList; }
