...
/**
 * The referrer loader of ([区分値]地域)CDEF_REGION as TABLE. <br>
 * <pre>
 * [primary key]
 *     REGION_ID
 *
 ...
 */
public class ImmuLoaderOfCdefRegion {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<ImmuCdefRegion> _selectedList;
    protected BehaviorSelector _selector;
    protected ImmuCdefRegionBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public ImmuLoaderOfCdefRegion ready(List<ImmuCdefRegion> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected ImmuCdefRegionBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(ImmuCdefRegionBhv.class); return _myBhv; } }
     ...
     * <pre>
     * <span style="color: #0000C0">cdefRegionBhv</span>.<span style="color: #994747">load</span>(<span style="color: #553000">cdefRegionList</span>, <span style="color: #553000">regionLoader</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * });
     * for (ImmuCdefRegion cdefRegion : <span style="color: #553000">cdefRegionList</span>) {
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<ImmuCdefRegion> getSelectedList() { return _selectedList; }
