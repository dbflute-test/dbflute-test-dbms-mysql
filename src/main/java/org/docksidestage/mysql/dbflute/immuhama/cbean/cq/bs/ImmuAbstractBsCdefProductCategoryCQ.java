...
/**
 * The abstract condition-query of cdef_product_category.
 * @author DBFlute(AutoGenerator)
 */
public abstract class ImmuAbstractBsCdefProductCategoryCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsCdefProductCategoryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * {exists (select PARENT_CATEGORY_CODE from cdef_product_category where ...)} <br>
     * ([区分値]商品カテゴリ)cdef_product_category by PARENT_CATEGORY_CODE, named 'cdefProductCategorySelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">existsCdefProductCategorySelf</span>(categoryCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     categoryCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of CdefProductCategorySelfList for 'exists'. (NotNull)
     */
    public void existsCdefProductCategorySelf(SubQuery<ImmuCdefProductCategoryCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuCdefProductCategoryCB cb = new ImmuCdefProductCategoryCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductCategoryCode_ExistsReferrer_CdefProductCategorySelfList(cb.query());
        registerExistsReferrer(cb.query(), "PRODUCT_CATEGORY_CODE", "PARENT_CATEGORY_CODE", pp, "cdefProductCategorySelfList");
    }
    public abstract String keepProductCategoryCode_ExistsReferrer_CdefProductCategorySelfList(ImmuCdefProductCategoryCQ sq);

    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select PRODUCT_CATEGORY_CODE from product_detail where ...)} <br>
     * (商品詳細)product_detail by PRODUCT_CATEGORY_CODE, named 'productDetailAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">existsProductDetail</span>(detailCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     detailCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of ProductDetailList for 'exists'. (NotNull)
     */
    public void existsProductDetail(SubQuery<ImmuProductDetailCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductDetailCB cb = new ImmuProductDetailCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductCategoryCode_ExistsReferrer_ProductDetailList(cb.query());
        registerExistsReferrer(cb.query(), "PRODUCT_CATEGORY_CODE", "PRODUCT_CATEGORY_CODE", pp, "productDetailList");
    }
    public abstract String keepProductCategoryCode_ExistsReferrer_ProductDetailList(ImmuProductDetailCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select PARENT_CATEGORY_CODE from cdef_product_category where ...)} <br>
     * ([区分値]商品カテゴリ)cdef_product_category by PARENT_CATEGORY_CODE, named 'cdefProductCategorySelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsCdefProductCategorySelf</span>(categoryCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     categoryCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of ProductCategoryCode_NotExistsReferrer_CdefProductCategorySelfList for 'not exists'. (NotNull)
     */
    public void notExistsCdefProductCategorySelf(SubQuery<ImmuCdefProductCategoryCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuCdefProductCategoryCB cb = new ImmuCdefProductCategoryCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductCategoryCode_NotExistsReferrer_CdefProductCategorySelfList(cb.query());
        registerNotExistsReferrer(cb.query(), "PRODUCT_CATEGORY_CODE", "PARENT_CATEGORY_CODE", pp, "cdefProductCategorySelfList");
    }
    public abstract String keepProductCategoryCode_NotExistsReferrer_CdefProductCategorySelfList(ImmuCdefProductCategoryCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select PRODUCT_CATEGORY_CODE from product_detail where ...)} <br>
     * (商品詳細)product_detail by PRODUCT_CATEGORY_CODE, named 'productDetailAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsProductDetail</span>(detailCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     detailCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of ProductCategoryCode_NotExistsReferrer_ProductDetailList for 'not exists'. (NotNull)
     */
    public void notExistsProductDetail(SubQuery<ImmuProductDetailCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductDetailCB cb = new ImmuProductDetailCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductCategoryCode_NotExistsReferrer_ProductDetailList(cb.query());
        registerNotExistsReferrer(cb.query(), "PRODUCT_CATEGORY_CODE", "PRODUCT_CATEGORY_CODE", pp, "productDetailList");
    }
    public abstract String keepProductCategoryCode_NotExistsReferrer_ProductDetailList(ImmuProductDetailCQ sq);

    public void xsderiveCdefProductCategorySelfList(String fn, SubQuery<ImmuCdefProductCategoryCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefProductCategoryCB cb = new ImmuCdefProductCategoryCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepProductCategoryCode_SpecifyDerivedReferrer_CdefProductCategorySelfList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PRODUCT_CATEGORY_CODE", "PARENT_CATEGORY_CODE", pp, "cdefProductCategorySelfList", al, op);
    }
    public abstract String keepProductCategoryCode_SpecifyDerivedReferrer_CdefProductCategorySelfList(ImmuCdefProductCategoryCQ sq);

    public void xsderiveProductDetailList(String fn, SubQuery<ImmuProductDetailCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductDetailCB cb = new ImmuProductDetailCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepProductCategoryCode_SpecifyDerivedReferrer_ProductDetailList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PRODUCT_CATEGORY_CODE", "PRODUCT_CATEGORY_CODE", pp, "productDetailList", al, op);
    }
    public abstract String keepProductCategoryCode_SpecifyDerivedReferrer_ProductDetailList(ImmuProductDetailCQ sq);

    /**
     * Prepare for (Query)DerivedReferrer (correlated sub-query). <br>
     * {FOO &lt;= (select max(BAR) from cdef_product_category where ...)} <br>
     * ([区分値]商品カテゴリ)cdef_product_category by PARENT_CATEGORY_CODE, named 'cdefProductCategorySelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedCdefProductCategorySelf()</span>.<span style="color: #CC4747">max</span>(categoryCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public HpQDRFunction<ImmuCdefProductCategoryCB> derivedCdefProductCategorySelf() {
        return xcreateQDRFunctionCdefProductCategorySelfList();
    }
    protected HpQDRFunction<ImmuCdefProductCategoryCB> xcreateQDRFunctionCdefProductCategorySelfList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveCdefProductCategorySelfList(fn, sq, rd, vl, op));
    }
    public void xqderiveCdefProductCategorySelfList(String fn, SubQuery<ImmuCdefProductCategoryCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefProductCategoryCB cb = new ImmuCdefProductCategoryCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepProductCategoryCode_QueryDerivedReferrer_CdefProductCategorySelfList(cb.query()); String prpp = keepProductCategoryCode_QueryDerivedReferrer_CdefProductCategorySelfListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PRODUCT_CATEGORY_CODE", "PARENT_CATEGORY_CODE", sqpp, "cdefProductCategorySelfList", rd, vl, prpp, op);
    }
    public abstract String keepProductCategoryCode_QueryDerivedReferrer_CdefProductCategorySelfList(ImmuCdefProductCategoryCQ sq);
    public abstract String keepProductCategoryCode_QueryDerivedReferrer_CdefProductCategorySelfListParameter(Object vl);

    /**
     * Prepare for (Query)DerivedReferrer (correlated sub-query). <br>
     * {FOO &lt;= (select max(BAR) from product_detail where ...)} <br>
     * (商品詳細)product_detail by PRODUCT_CATEGORY_CODE, named 'productDetailAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedProductDetail()</span>.<span style="color: #CC4747">max</span>(detailCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The object to set up a function for referrer table. (NotNull)
     */
    public HpQDRFunction<ImmuProductDetailCB> derivedProductDetail() {
        return xcreateQDRFunctionProductDetailList();
    }
    protected HpQDRFunction<ImmuProductDetailCB> xcreateQDRFunctionProductDetailList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveProductDetailList(fn, sq, rd, vl, op));
    }
    public void xqderiveProductDetailList(String fn, SubQuery<ImmuProductDetailCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductDetailCB cb = new ImmuProductDetailCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepProductCategoryCode_QueryDerivedReferrer_ProductDetailList(cb.query()); String prpp = keepProductCategoryCode_QueryDerivedReferrer_ProductDetailListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PRODUCT_CATEGORY_CODE", "PRODUCT_CATEGORY_CODE", sqpp, "productDetailList", rd, vl, prpp, op);
    }
    public abstract String keepProductCategoryCode_QueryDerivedReferrer_ProductDetailList(ImmuProductDetailCQ sq);
    public abstract String keepProductCategoryCode_QueryDerivedReferrer_ProductDetailListParameter(Object vl);
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * (親カテゴリコード)PARENT_CATEGORY_CODE: {IX, CHAR(3), FK to cdef_product_category} <br>
     ...
     */
    public HpSLCFunction<ImmuCdefProductCategoryCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuCdefProductCategoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductCategoryCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuCdefProductCategoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductCategoryCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuCdefProductCategoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductCategoryCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuCdefProductCategoryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductCategoryCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuCdefProductCategoryCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuCdefProductCategoryCB&gt;() {
     *     public void query(ImmuCdefProductCategoryCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductCategoryCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuCdefProductCategoryCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefProductCategoryCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuCdefProductCategoryCQ sq);

    protected ImmuCdefProductCategoryCB xcreateScalarConditionCB() {
        ImmuCdefProductCategoryCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuCdefProductCategoryCB xcreateScalarConditionPartitionByCB() {
        ImmuCdefProductCategoryCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuCdefProductCategoryCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefProductCategoryCB cb = new ImmuCdefProductCategoryCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PRODUCT_CATEGORY_CODE";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuCdefProductCategoryCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuCdefProductCategoryCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuCdefProductCategoryCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefProductCategoryCB cb = new ImmuCdefProductCategoryCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_CATEGORY_CODE";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuCdefProductCategoryCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuCdefProductCategoryCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuCdefProductCategoryCB cb = new ImmuCdefProductCategoryCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuCdefProductCategoryCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuCdefProductCategoryCB newMyCB() {
        return new ImmuCdefProductCategoryCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuCdefProductCategoryCQ.class.getName(); }
