 ...
 */
public class ImmuBsMemberWithdrawalCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuMemberWithdrawalCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsMemberWithdrawalCB() {
    ...
    public ImmuMemberWithdrawalCB acceptPK(Integer memberId) {
        ...
        ImmuBsMemberWithdrawalCB cb = this;
        cb.query().setMemberId_Equal(memberId);
        return (ImmuMemberWithdrawalCB)this;
    }
     ...
     */
    public ImmuMemberWithdrawalCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuMemberWithdrawalCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuMemberWithdrawalCQ doGetConditionQuery() {
    ...
    protected ImmuMemberWithdrawalCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuMemberWithdrawalCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuMemberWithdrawalCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuMemberWithdrawalCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuMemberWithdrawalCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuMemberWithdrawalCB> unionCBLambda) {
        final ImmuMemberWithdrawalCB cb = new ImmuMemberWithdrawalCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberWithdrawalCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuMemberWithdrawalCB> unionCBLambda) {
        final ImmuMemberWithdrawalCB cb = new ImmuMemberWithdrawalCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberWithdrawalCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuMemberWithdrawalCQ> {
         ...
         */
        public HpSDRFunction<ImmuMemberWithdrawalCB, ImmuMemberWithdrawalCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberWithdrawalCB> sq, ImmuMemberWithdrawalCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuMemberWithdrawalCB dreamCruiseCB() {
        ImmuMemberWithdrawalCB cb = new ImmuMemberWithdrawalCB();
        cb.xsetupForDreamCruise((ImmuMemberWithdrawalCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuMemberWithdrawalCB> columnQuery(final SpecifyQuery<ImmuMemberWithdrawalCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuMemberWithdrawalCB xcreateColumnQueryCB() {
        ImmuMemberWithdrawalCB cb = new ImmuMemberWithdrawalCB();
        cb.xsetupForColumnQuery((ImmuMemberWithdrawalCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuMemberWithdrawalCB> orCBLambda) {
        xorSQ((ImmuMemberWithdrawalCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuMemberWithdrawalCB> andCBLambda) {
        xorSQAP((ImmuMemberWithdrawalCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuMemberWithdrawalCB cb;
        if (mainCB != null) {
            cb = (ImmuMemberWithdrawalCB)mainCB;
        } else {
            cb = new ImmuMemberWithdrawalCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuMemberWithdrawalCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuMemberWithdrawalCQ.class.getName(); }
