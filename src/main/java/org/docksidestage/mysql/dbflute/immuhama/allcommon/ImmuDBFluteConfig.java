 ...
 */
public class ImmuDBFluteConfig {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(ImmuDBFluteConfig.class);

    /** Singleton instance. */
    private static final ImmuDBFluteConfig _instance = new ImmuDBFluteConfig();
    ...
    protected String _outsideSqlPackage = "org.docksidestage.mysql.dbflute.immuhama";
     ...
     * Constructor.
     */
    private ImmuDBFluteConfig() { // adjusts default settings
     ...
     */
    public static ImmuDBFluteConfig getInstance() {
        return _instance;
    }
