...
/**
 * The entity of ([区分値]地域)CDEF_REGION as TABLE. <br>
 ...
 */
public abstract class ImmuBsCdefRegion extends AbstractEntity implements DomainEntity {
    ...
    /**
     * [get] (会員住所)MEMBER_ADDRESS by REGION_ID, named 'memberAddressList'.
    ...
    /**
     * [set] (会員住所)MEMBER_ADDRESS by REGION_ID, named 'memberAddressList'.
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsCdefRegion) {
            ImmuBsCdefRegion other = (ImmuBsCdefRegion)obj;
    ...
    @Override
    public ImmuCdefRegion clone() {
        return (ImmuCdefRegion)super.clone();
    }
