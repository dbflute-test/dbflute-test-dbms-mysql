 ...
 */
public abstract class ImmuBsPurchasePaymentBhv extends AbstractBehaviorWritable<ImmuPurchasePayment, ImmuPurchasePaymentCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuPurchasePaymentDbm asDBMeta() { return ImmuPurchasePaymentDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuPurchasePaymentCB newConditionBean() { return new ImmuPurchasePaymentCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuPurchasePayment. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuPurchasePaymentCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuPurchasePayment> selectEntity(CBCall<ImmuPurchasePaymentCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuPurchasePayment> facadeSelectEntity(ImmuPurchasePaymentCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuPurchasePayment> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuPurchasePaymentCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuPurchasePayment <span style="color: #553000">purchasePayment</span> = <span style="color: #0000C0">purchasePaymentBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuPurchasePayment selectEntityWithDeletedCheck(CBCall<ImmuPurchasePaymentCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuPurchasePayment> selectByPK(Long purchasePaymentId) {
        return facadeSelectByPK(purchasePaymentId);
    }

    protected OptionalEntity<ImmuPurchasePayment> facadeSelectByPK(Long purchasePaymentId) {
        return doSelectOptionalByPK(purchasePaymentId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuPurchasePayment> ENTITY doSelectByPK(Long purchasePaymentId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(purchasePaymentId), tp);
    }

    protected <ENTITY extends ImmuPurchasePayment> OptionalEntity<ENTITY> doSelectOptionalByPK(Long purchasePaymentId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(purchasePaymentId, tp), purchasePaymentId);
    }

    protected ImmuPurchasePaymentCB xprepareCBAsPK(Long purchasePaymentId) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuPurchasePayment&gt; <span style="color: #553000">purchasePaymentList</span> = <span style="color: #0000C0">purchasePaymentBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuPurchasePayment <span style="color: #553000">purchasePayment</span> : <span style="color: #553000">purchasePaymentList</span>) {
     *     ... = <span style="color: #553000">purchasePayment</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuPurchasePayment. (NotNull)
     ...
     */
    public ListResultBean<ImmuPurchasePayment> selectList(CBCall<ImmuPurchasePaymentCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuPurchasePayment&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">purchasePaymentBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuPurchasePayment purchasePayment : <span style="color: #553000">page</span>) {
     *     ... = purchasePayment.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuPurchasePayment. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuPurchasePayment> selectPage(CBCall<ImmuPurchasePaymentCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuPurchasePayment. (NotNull)
     * @param entityLambda The handler of entity row of ImmuPurchasePayment. (NotNull)
     */
    public void selectCursor(CBCall<ImmuPurchasePaymentCB> cbLambda, EntityRowHandler<ImmuPurchasePayment> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuPurchasePaymentCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuPurchasePayment> purchasePaymentList, ReferrerLoaderHandler<ImmuLoaderOfPurchasePayment> loaderLambda) {
        xassLRArg(purchasePaymentList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfPurchasePayment().ready(purchasePaymentList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuPurchasePayment purchasePayment, ReferrerLoaderHandler<ImmuLoaderOfPurchasePayment> loaderLambda) {
        xassLRArg(purchasePayment, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfPurchasePayment().ready(xnewLRAryLs(purchasePayment), _behaviorSelector));
    }
    ...
    //                                                                   =================
    /**
     * Pull out the list of foreign table 'ImmuPurchase'.
     * @param purchasePaymentList The list of purchasePayment. (NotNull, EmptyAllowed)
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<ImmuPurchase> pulloutPurchase(List<ImmuPurchasePayment> purchasePaymentList)
     ...
     */
    public List<Long> extractPurchasePaymentIdList(List<ImmuPurchasePayment> purchasePaymentList)
     ...
     * <pre>
     * ImmuPurchasePayment purchasePayment = <span style="color: #70226C">new</span> ImmuPurchasePayment();
     ...
     */
    public void insert(ImmuPurchasePayment purchasePayment) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuPurchasePayment purchasePayment) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuPurchasePayment purchasePayment) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuPurchasePayment purchasePayment) {
     ...
     */
    public int[] batchInsert(List<ImmuPurchasePayment> purchasePaymentList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<ImmuPurchasePayment> purchasePaymentList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<ImmuPurchasePayment> purchasePaymentList) {
     ...
     * <pre>
     * <span style="color: #0000C0">purchasePaymentBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuPurchasePayment, ImmuPurchasePaymentCB&gt;() {
     *     public ConditionBean setup(ImmuPurchasePayment entity, ImmuPurchasePaymentCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuPurchasePayment, ImmuPurchasePaymentCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuPurchasePayment purchasePayment, CBCall<ImmuPurchasePaymentCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuPurchasePaymentCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuPurchasePayment purchasePayment, WritableOptionCall<ImmuPurchasePaymentCB, InsertOption<ImmuPurchasePaymentCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuPurchasePayment purchasePayment, WritableOptionCall<ImmuPurchasePaymentCB, UpdateOption<ImmuPurchasePaymentCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuPurchasePayment purchasePayment, WritableOptionCall<ImmuPurchasePaymentCB, InsertOption<ImmuPurchasePaymentCB>> insertOpLambda, WritableOptionCall<ImmuPurchasePaymentCB, UpdateOption<ImmuPurchasePaymentCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuPurchasePayment purchasePayment, WritableOptionCall<ImmuPurchasePaymentCB, DeleteOption<ImmuPurchasePaymentCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuPurchasePayment> purchasePaymentList, WritableOptionCall<ImmuPurchasePaymentCB, InsertOption<ImmuPurchasePaymentCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuPurchasePayment> purchasePaymentList, WritableOptionCall<ImmuPurchasePaymentCB, UpdateOption<ImmuPurchasePaymentCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuPurchasePayment> purchasePaymentList, WritableOptionCall<ImmuPurchasePaymentCB, DeleteOption<ImmuPurchasePaymentCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuPurchasePayment, ImmuPurchasePaymentCB> manyArgLambda, WritableOptionCall<ImmuPurchasePaymentCB, InsertOption<ImmuPurchasePaymentCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuPurchasePayment purchasePayment, CBCall<ImmuPurchasePaymentCB> cbLambda, WritableOptionCall<ImmuPurchasePaymentCB, UpdateOption<ImmuPurchasePaymentCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuPurchasePaymentCB> cbLambda, WritableOptionCall<ImmuPurchasePaymentCB, DeleteOption<ImmuPurchasePaymentCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuPurchasePaymentBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuPurchasePayment> typeOfSelectedEntity() { return ImmuPurchasePayment.class; }
    protected Class<ImmuPurchasePayment> typeOfHandlingEntity() { return ImmuPurchasePayment.class; }
    protected Class<ImmuPurchasePaymentCB> typeOfHandlingConditionBean() { return ImmuPurchasePaymentCB.class; }
}
