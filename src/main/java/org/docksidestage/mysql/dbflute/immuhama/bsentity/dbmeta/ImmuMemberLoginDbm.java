 ...
 */
public class ImmuMemberLoginDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final ImmuMemberLoginDbm _instance = new ImmuMemberLoginDbm();
    private ImmuMemberLoginDbm() {}
    public static ImmuMemberLoginDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((ImmuMemberLogin)et).getMemberLoginId(), (et, vl) -> ((ImmuMemberLogin)et).setMemberLoginId(ctl(vl)), "memberLoginId");
        setupEpg(_epgMap, et -> ((ImmuMemberLogin)et).getMemberId(), (et, vl) -> ((ImmuMemberLogin)et).setMemberId(cti(vl)), "memberId");
        setupEpg(_epgMap, et -> ((ImmuMemberLogin)et).getLoginDatetime(), (et, vl) -> ((ImmuMemberLogin)et).setLoginDatetime(ctldt(vl)), "loginDatetime");
        setupEpg(_epgMap, et -> ((ImmuMemberLogin)et).getMobileLoginFlg(), (et, vl) -> {
            ImmuCDef.Flg cls = (ImmuCDef.Flg)gcls(et, columnMobileLoginFlg(), vl);
            if (cls != null) {
                ((ImmuMemberLogin)et).setMobileLoginFlgAsFlg(cls);
            } else {
                ((ImmuMemberLogin)et).mynativeMappingMobileLoginFlg(ctn(vl, Integer.class));
            }
        }, "mobileLoginFlg");
        setupEpg(_epgMap, et -> ((ImmuMemberLogin)et).getLoginMemberStatusCode(), (et, vl) -> {
            ImmuCDef.MemberStatus cls = (ImmuCDef.MemberStatus)gcls(et, columnLoginMemberStatusCode(), vl);
            if (cls != null) {
                ((ImmuMemberLogin)et).setLoginMemberStatusCodeAsMemberStatus(cls);
            } else {
                ((ImmuMemberLogin)et).mynativeMappingLoginMemberStatusCode((String)vl);
            }
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("FK_MEMBER_LOGIN_MEMBER", "member", this, ImmuMemberDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "memberLoginList", false);
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.mysql.dbflute.immuhama.exentity.ImmuMemberLogin"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.mysql.dbflute.immuhama.cbean.ImmuMemberLoginCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.mysql.dbflute.immuhama.exbhv.ImmuMemberLoginBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<ImmuMemberLogin> getEntityType() { return ImmuMemberLogin.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public ImmuMemberLogin newEntity() { return new ImmuMemberLogin(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((ImmuMemberLogin)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((ImmuMemberLogin)et, mp); }
