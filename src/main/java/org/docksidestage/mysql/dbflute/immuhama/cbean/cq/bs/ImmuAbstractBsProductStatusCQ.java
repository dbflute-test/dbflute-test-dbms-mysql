 ...
 */
public abstract class ImmuAbstractBsProductStatusCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsProductStatusCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public abstract String keepProductStatusCode_ExistsReferrer_ProductList(ImmuProductCQ sq);
    ...
    public abstract String keepProductStatusCode_NotExistsReferrer_ProductList(ImmuProductCQ sq);
    ...
    public abstract String keepProductStatusCode_SpecifyDerivedReferrer_ProductList(ImmuProductCQ sq);
    ...
    public abstract String keepProductStatusCode_QueryDerivedReferrer_ProductList(ImmuProductCQ sq);
     ...
     */
    public HpSLCFunction<ImmuProductStatusCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductStatusCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductStatusCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductStatusCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductStatusCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuProductStatusCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuProductStatusCB&gt;() {
     *     public void query(ImmuProductStatusCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductStatusCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuProductStatusCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductStatusCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuProductStatusCQ sq);

    protected ImmuProductStatusCB xcreateScalarConditionCB() {
        ImmuProductStatusCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuProductStatusCB xcreateScalarConditionPartitionByCB() {
        ImmuProductStatusCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuProductStatusCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductStatusCB cb = new ImmuProductStatusCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PRODUCT_STATUS_CODE";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuProductStatusCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuProductStatusCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuProductStatusCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductStatusCB cb = new ImmuProductStatusCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_STATUS_CODE";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuProductStatusCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuProductStatusCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductStatusCB cb = new ImmuProductStatusCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuProductStatusCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuProductStatusCB newMyCB() {
        return new ImmuProductStatusCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuProductStatusCQ.class.getName(); }
