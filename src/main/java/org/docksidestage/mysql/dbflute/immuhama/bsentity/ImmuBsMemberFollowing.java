 ...
 */
public abstract class ImmuBsMemberFollowing extends AbstractEntity implements DomainEntity {
    ...
    protected OptionalEntity<ImmuMember> _memberByMyMemberId;
     ...
     */
    public OptionalEntity<ImmuMember> getMemberByMyMemberId() {
     ...
     */
    public void setMemberByMyMemberId(OptionalEntity<ImmuMember> memberByMyMemberId) {
        _memberByMyMemberId = memberByMyMemberId;
    }

    /** (会員)MEMBER by my YOUR_MEMBER_ID, named 'memberByYourMemberId'. */
    protected OptionalEntity<ImmuMember> _memberByYourMemberId;
     ...
     */
    public OptionalEntity<ImmuMember> getMemberByYourMemberId() {
     ...
     */
    public void setMemberByYourMemberId(OptionalEntity<ImmuMember> memberByYourMemberId) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsMemberFollowing) {
            ImmuBsMemberFollowing other = (ImmuBsMemberFollowing)obj;
    ...
    @Override
    public ImmuMemberFollowing clone() {
        return (ImmuMemberFollowing)super.clone();
    }
