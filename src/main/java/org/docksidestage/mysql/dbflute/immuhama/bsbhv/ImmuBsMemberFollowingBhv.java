 ...
 */
public abstract class ImmuBsMemberFollowingBhv extends AbstractBehaviorWritable<ImmuMemberFollowing, ImmuMemberFollowingCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuMemberFollowingDbm asDBMeta() { return ImmuMemberFollowingDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuMemberFollowingCB newConditionBean() { return new ImmuMemberFollowingCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberFollowing. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuMemberFollowingCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuMemberFollowing> selectEntity(CBCall<ImmuMemberFollowingCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuMemberFollowing> facadeSelectEntity(ImmuMemberFollowingCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberFollowing> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuMemberFollowingCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuMemberFollowing <span style="color: #553000">memberFollowing</span> = <span style="color: #0000C0">memberFollowingBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuMemberFollowing selectEntityWithDeletedCheck(CBCall<ImmuMemberFollowingCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuMemberFollowing> selectByPK(Long memberFollowingId) {
        return facadeSelectByPK(memberFollowingId);
    }

    protected OptionalEntity<ImmuMemberFollowing> facadeSelectByPK(Long memberFollowingId) {
        return doSelectOptionalByPK(memberFollowingId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberFollowing> ENTITY doSelectByPK(Long memberFollowingId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberFollowingId), tp);
    }

    protected <ENTITY extends ImmuMemberFollowing> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberFollowingId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(memberFollowingId, tp), memberFollowingId);
    }

    protected ImmuMemberFollowingCB xprepareCBAsPK(Long memberFollowingId) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuMemberFollowing> selectByUniqueOf(Integer myMemberId, Integer yourMemberId) {
        return facadeSelectByUniqueOf(myMemberId, yourMemberId);
    }

    protected OptionalEntity<ImmuMemberFollowing> facadeSelectByUniqueOf(Integer myMemberId, Integer yourMemberId) {
        return doSelectByUniqueOf(myMemberId, yourMemberId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberFollowing> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer myMemberId, Integer yourMemberId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(myMemberId, yourMemberId), tp), myMemberId, yourMemberId);
    }

    protected ImmuMemberFollowingCB xprepareCBAsUniqueOf(Integer myMemberId, Integer yourMemberId) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuMemberFollowing&gt; <span style="color: #553000">memberFollowingList</span> = <span style="color: #0000C0">memberFollowingBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuMemberFollowing <span style="color: #553000">memberFollowing</span> : <span style="color: #553000">memberFollowingList</span>) {
     *     ... = <span style="color: #553000">memberFollowing</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberFollowing. (NotNull)
     ...
     */
    public ListResultBean<ImmuMemberFollowing> selectList(CBCall<ImmuMemberFollowingCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuMemberFollowing&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">memberFollowingBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuMemberFollowing memberFollowing : <span style="color: #553000">page</span>) {
     *     ... = memberFollowing.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberFollowing. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuMemberFollowing> selectPage(CBCall<ImmuMemberFollowingCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberFollowing. (NotNull)
     * @param entityLambda The handler of entity row of ImmuMemberFollowing. (NotNull)
     */
    public void selectCursor(CBCall<ImmuMemberFollowingCB> cbLambda, EntityRowHandler<ImmuMemberFollowing> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuMemberFollowingCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuMemberFollowing> memberFollowingList, ReferrerLoaderHandler<ImmuLoaderOfMemberFollowing> loaderLambda) {
        xassLRArg(memberFollowingList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberFollowing().ready(memberFollowingList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuMemberFollowing memberFollowing, ReferrerLoaderHandler<ImmuLoaderOfMemberFollowing> loaderLambda) {
        xassLRArg(memberFollowing, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberFollowing().ready(xnewLRAryLs(memberFollowing), _behaviorSelector));
    }
     ...
     */
    public List<ImmuMember> pulloutMemberByMyMemberId(List<ImmuMemberFollowing> memberFollowingList)
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<ImmuMember> pulloutMemberByYourMemberId(List<ImmuMemberFollowing> memberFollowingList)
     ...
     */
    public List<Long> extractMemberFollowingIdList(List<ImmuMemberFollowing> memberFollowingList)
     ...
     * <pre>
     * ImmuMemberFollowing memberFollowing = <span style="color: #70226C">new</span> ImmuMemberFollowing();
     ...
     */
    public void insert(ImmuMemberFollowing memberFollowing) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuMemberFollowing memberFollowing) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuMemberFollowing memberFollowing) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuMemberFollowing memberFollowing) {
     ...
     */
    public int[] batchInsert(List<ImmuMemberFollowing> memberFollowingList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<ImmuMemberFollowing> memberFollowingList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<ImmuMemberFollowing> memberFollowingList) {
     ...
     * <pre>
     * <span style="color: #0000C0">memberFollowingBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuMemberFollowing, ImmuMemberFollowingCB&gt;() {
     *     public ConditionBean setup(ImmuMemberFollowing entity, ImmuMemberFollowingCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuMemberFollowing, ImmuMemberFollowingCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuMemberFollowing memberFollowing, CBCall<ImmuMemberFollowingCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuMemberFollowingCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuMemberFollowing memberFollowing, WritableOptionCall<ImmuMemberFollowingCB, InsertOption<ImmuMemberFollowingCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuMemberFollowing memberFollowing, WritableOptionCall<ImmuMemberFollowingCB, UpdateOption<ImmuMemberFollowingCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuMemberFollowing memberFollowing, WritableOptionCall<ImmuMemberFollowingCB, InsertOption<ImmuMemberFollowingCB>> insertOpLambda, WritableOptionCall<ImmuMemberFollowingCB, UpdateOption<ImmuMemberFollowingCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuMemberFollowing memberFollowing, WritableOptionCall<ImmuMemberFollowingCB, DeleteOption<ImmuMemberFollowingCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuMemberFollowing> memberFollowingList, WritableOptionCall<ImmuMemberFollowingCB, InsertOption<ImmuMemberFollowingCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuMemberFollowing> memberFollowingList, WritableOptionCall<ImmuMemberFollowingCB, UpdateOption<ImmuMemberFollowingCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuMemberFollowing> memberFollowingList, WritableOptionCall<ImmuMemberFollowingCB, DeleteOption<ImmuMemberFollowingCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuMemberFollowing, ImmuMemberFollowingCB> manyArgLambda, WritableOptionCall<ImmuMemberFollowingCB, InsertOption<ImmuMemberFollowingCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuMemberFollowing memberFollowing, CBCall<ImmuMemberFollowingCB> cbLambda, WritableOptionCall<ImmuMemberFollowingCB, UpdateOption<ImmuMemberFollowingCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuMemberFollowingCB> cbLambda, WritableOptionCall<ImmuMemberFollowingCB, DeleteOption<ImmuMemberFollowingCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuMemberFollowingBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuMemberFollowing> typeOfSelectedEntity() { return ImmuMemberFollowing.class; }
    protected Class<ImmuMemberFollowing> typeOfHandlingEntity() { return ImmuMemberFollowing.class; }
    protected Class<ImmuMemberFollowingCB> typeOfHandlingConditionBean() { return ImmuMemberFollowingCB.class; }
}
