 ...
 */
public class ImmuBsMemberStatusCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuMemberStatusCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsMemberStatusCB() {
     ...
     */
    public ImmuMemberStatusCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuMemberStatusCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuMemberStatusCQ doGetConditionQuery() {
    ...
    protected ImmuMemberStatusCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuMemberStatusCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuMemberStatusCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuMemberStatusCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuMemberStatusCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuMemberStatusCB> unionCBLambda) {
        final ImmuMemberStatusCB cb = new ImmuMemberStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberStatusCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuMemberStatusCB> unionCBLambda) {
        final ImmuMemberStatusCB cb = new ImmuMemberStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberStatusCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuMemberStatusCQ> {
         ...
         */
        public HpSDRFunction<ImmuMemberStatusCB, ImmuMemberStatusCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberStatusCB> sq, ImmuMemberStatusCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuMemberStatusCB dreamCruiseCB() {
        ImmuMemberStatusCB cb = new ImmuMemberStatusCB();
        cb.xsetupForDreamCruise((ImmuMemberStatusCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuMemberStatusCB> columnQuery(final SpecifyQuery<ImmuMemberStatusCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuMemberStatusCB xcreateColumnQueryCB() {
        ImmuMemberStatusCB cb = new ImmuMemberStatusCB();
        cb.xsetupForColumnQuery((ImmuMemberStatusCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuMemberStatusCB> orCBLambda) {
        xorSQ((ImmuMemberStatusCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuMemberStatusCB> andCBLambda) {
        xorSQAP((ImmuMemberStatusCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuMemberStatusCB cb;
        if (mainCB != null) {
            cb = (ImmuMemberStatusCB)mainCB;
        } else {
            cb = new ImmuMemberStatusCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuMemberStatusCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuMemberStatusCQ.class.getName(); }
