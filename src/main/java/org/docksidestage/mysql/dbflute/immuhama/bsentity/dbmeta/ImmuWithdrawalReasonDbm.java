 ...
 */
public class ImmuWithdrawalReasonDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final ImmuWithdrawalReasonDbm _instance = new ImmuWithdrawalReasonDbm();
    private ImmuWithdrawalReasonDbm() {}
    public static ImmuWithdrawalReasonDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((ImmuWithdrawalReason)et).getWithdrawalReasonCode(), (et, vl) -> {
            ImmuCDef.WithdrawalReason cls = (ImmuCDef.WithdrawalReason)gcls(et, columnWithdrawalReasonCode(), vl);
            if (cls != null) {
                ((ImmuWithdrawalReason)et).setWithdrawalReasonCodeAsWithdrawalReason(cls);
            } else {
                ((ImmuWithdrawalReason)et).mynativeMappingWithdrawalReasonCode((String)vl);
            }
        }, "withdrawalReasonCode");
        setupEpg(_epgMap, et -> ((ImmuWithdrawalReason)et).getWithdrawalReasonText(), (et, vl) -> ((ImmuWithdrawalReason)et).setWithdrawalReasonText((String)vl), "withdrawalReasonText");
        setupEpg(_epgMap, et -> ((ImmuWithdrawalReason)et).getDisplayOrder(), (et, vl) -> ((ImmuWithdrawalReason)et).setDisplayOrder(cti(vl)), "displayOrder");
    }
    ...
    protected final ColumnInfo _columnWithdrawalReasonText = cci("WITHDRAWAL_REASON_TEXT", "WITHDRAWAL_REASON_TEXT", null, "退会理由テキスト", String.class, "withdrawalReasonText", null, false, false, true, "TEXT", 65535, 0, null, null, false, null, "退会理由の内容。テキスト形式なので目いっぱい書けるが、\nそうするとUI側できれいに見せるのが大変でしょうね。", null, null, null, false);
    ...
    public ReferrerInfo referrerMemberWithdrawalList() {
        ...
        return cri("FK_MEMBER_WITHDRAWAL_WITHDRAWAL_REASON", "memberWithdrawalList", this, ImmuMemberWithdrawalDbm.getInstance(), mp, false, "withdrawalReason");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.mysql.dbflute.immuhama.exentity.ImmuWithdrawalReason"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.mysql.dbflute.immuhama.cbean.ImmuWithdrawalReasonCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.mysql.dbflute.immuhama.exbhv.ImmuWithdrawalReasonBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<ImmuWithdrawalReason> getEntityType() { return ImmuWithdrawalReason.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public ImmuWithdrawalReason newEntity() { return new ImmuWithdrawalReason(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((ImmuWithdrawalReason)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((ImmuWithdrawalReason)et, mp); }
