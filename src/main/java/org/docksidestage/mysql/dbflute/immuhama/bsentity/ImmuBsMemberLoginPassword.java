...
/**
 * The entity of (会員ログインパスワード)MEMBER_LOGIN_PASSWORD as TABLE. <br>
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long memberLoginPasswordId = entity.getMemberLoginPasswordId();
 ...
 * entity.setMemberLoginPasswordId(memberLoginPasswordId);
 ...
 */
public abstract class ImmuBsMemberLoginPassword extends AbstractEntity implements DomainEntity, ImmuEntityDefinedCommonColumn {
    ...
    protected Long _memberLoginPasswordId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_memberLoginPasswordId == null) { return false; }
        return true;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsMemberLoginPassword) {
            ImmuBsMemberLoginPassword other = (ImmuBsMemberLoginPassword)obj;
            if (!xSV(_memberLoginPasswordId, other._memberLoginPasswordId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _memberLoginPasswordId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_memberLoginPasswordId));
    ...
    @Override
    public ImmuMemberLoginPassword clone() {
        return (ImmuMemberLoginPassword)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * @return The value of the column 'MEMBER_LOGIN_PASSWORD_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getMemberLoginPasswordId() {
        checkSpecifiedProperty("memberLoginPasswordId");
        return _memberLoginPasswordId;
    }

    /**
     * [set] (会員ログインパスワードID)MEMBER_LOGIN_PASSWORD_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * @param memberLoginPasswordId The value of the column 'MEMBER_LOGIN_PASSWORD_ID'. (basically NotNull if update: for the constraint)
     */
    public void setMemberLoginPasswordId(Long memberLoginPasswordId) {
        registerModifiedProperty("memberLoginPasswordId");
        _memberLoginPasswordId = memberLoginPasswordId;
    }
