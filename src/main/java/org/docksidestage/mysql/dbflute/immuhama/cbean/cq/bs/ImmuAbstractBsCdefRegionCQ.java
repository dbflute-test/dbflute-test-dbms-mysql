...
/**
 * The abstract condition-query of cdef_region.
 * @author DBFlute(AutoGenerator)
 */
public abstract class ImmuAbstractBsCdefRegionCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsCdefRegionCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * (会員住所)member_address by REGION_ID, named 'memberAddressAsOne'.
     * <pre>
     ...
     */
    public HpSLCFunction<ImmuCdefRegionCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuCdefRegionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefRegionCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuCdefRegionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefRegionCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuCdefRegionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefRegionCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuCdefRegionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefRegionCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuCdefRegionCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuCdefRegionCB&gt;() {
     *     public void query(ImmuCdefRegionCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefRegionCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuCdefRegionCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefRegionCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuCdefRegionCQ sq);

    protected ImmuCdefRegionCB xcreateScalarConditionCB() {
        ImmuCdefRegionCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuCdefRegionCB xcreateScalarConditionPartitionByCB() {
        ImmuCdefRegionCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuCdefRegionCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefRegionCB cb = new ImmuCdefRegionCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "REGION_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuCdefRegionCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuCdefRegionCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuCdefRegionCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefRegionCB cb = new ImmuCdefRegionCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "REGION_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuCdefRegionCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuCdefRegionCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuCdefRegionCB cb = new ImmuCdefRegionCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuCdefRegionCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuCdefRegionCB newMyCB() {
        return new ImmuCdefRegionCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuCdefRegionCQ.class.getName(); }
