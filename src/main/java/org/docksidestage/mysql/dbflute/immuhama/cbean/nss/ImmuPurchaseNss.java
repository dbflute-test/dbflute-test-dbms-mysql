...
import org.docksidestage.mysql.dbflute.immuhama.cbean.cq.ImmuPurchaseCQ;

/**
 * The nest select set-upper of purchase.
 * @author DBFlute(AutoGenerator)
 */
public class ImmuPurchaseNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final ImmuPurchaseCQ _query;
    public ImmuPurchaseNss(ImmuPurchaseCQ query) { _query = query; }
