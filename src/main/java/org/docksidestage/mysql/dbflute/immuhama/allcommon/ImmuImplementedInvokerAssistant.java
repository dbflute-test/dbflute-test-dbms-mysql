 ...
 */
public class ImmuImplementedInvokerAssistant implements InvokerAssistant {
    ...
    protected ImmuDBFluteInitializer _introduction;
    ...
    public DBDef assistCurrentDBDef() {
        return ImmuDBCurrent.getInstance().currentDBDef();
    }
    ...
    public DataSource assistDataSource() { // DI component
        ...
        DataSourceHandler handler = ImmuDBFluteConfig.getInstance().getDataSourceHandler();
    ...
    protected ImmuImplementedSqlClauseCreator newImplementedSqlClauseCreator() {
        return new ImmuImplementedSqlClauseCreator();
    }
    ...
    protected StatementFactory createStatementFactory() {
        ...
        ImmuDBFluteConfig config = ImmuDBFluteConfig.getInstance();
    ...
    protected TnBeanMetaDataFactory createBeanMetaDataFactory() {
        ...
        factory.setInternalDebug(ImmuDBFluteConfig.getInstance().isInternalDebug());
        return factory;
    }
    ...
    protected OutsideSqlExecutorFactory createOutsideSqlExecutorFactory() {
        OutsideSqlExecutorFactory factory = ImmuDBFluteConfig.getInstance().getOutsideSqlExecutorFactory();
        if (factory != null) {
            return factory;
        }
    ...
    protected SQLExceptionDigger createSQLExceptionDigger() {
        return ImmuDBFluteConfig.getInstance().getSQLExceptionDigger();
    }
    ...
    protected SequenceCacheHandler createSequenceCacheHandler() {
        ...
        SequenceCacheKeyGenerator generator = ImmuDBFluteConfig.getInstance().getSequenceCacheKeyGenerator();
        if (generator != null) {
            handler.setSequenceCacheKeyGenerator(generator);
        }
        handler.setInternalDebug(ImmuDBFluteConfig.getInstance().isInternalDebug());
        return handler;
    }
    ...
    public StatementConfig assistDefaultStatementConfig() {
        return ImmuDBFluteConfig.getInstance().getDefaultStatementConfig();
    }
    ...
    public GearedCipherManager assistGearedCipherManager() {
        return ImmuDBFluteConfig.getInstance().getGearedCipherManager();
    }
    ...
    protected ResourceParameter createResourceParameter() {
        ...
        parameter.setOutsideSqlPackage(ImmuDBFluteConfig.getInstance().getOutsideSqlPackage());
        parameter.setMappingDateTimeZoneProvider(ImmuDBFluteConfig.getInstance().getMappingDateTimeZoneProvider());
        parameter.setLogDatePattern(ImmuDBFluteConfig.getInstance().getLogDatePattern());
        parameter.setLogTimestampPattern(ImmuDBFluteConfig.getInstance().getLogTimestampPattern());
        parameter.setLogTimePattern(ImmuDBFluteConfig.getInstance().getLogTimePattern());
        parameter.setLogTimeZoneProvider(ImmuDBFluteConfig.getInstance().getLogTimeZoneProvider());
        parameter.setInternalDebug(ImmuDBFluteConfig.getInstance().isInternalDebug());
        return parameter;
    }
    ...
    @Resource
    public void setIntroduction(ImmuDBFluteInitializer introduction) {
