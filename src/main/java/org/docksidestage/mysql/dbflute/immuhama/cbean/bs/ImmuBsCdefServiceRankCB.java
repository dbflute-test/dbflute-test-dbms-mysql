...
/**
 * The base condition-bean of cdef_service_rank.
 * @author DBFlute(AutoGenerator)
 */
public class ImmuBsCdefServiceRankCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuCdefServiceRankCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsCdefServiceRankCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuCdefServiceRankCB acceptPK(String serviceRankCode) {
        assertObjectNotNull("serviceRankCode", serviceRankCode);
        ImmuBsCdefServiceRankCB cb = this;
        cb.query().setServiceRankCode_Equal(serviceRankCode);
        return (ImmuCdefServiceRankCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ImmuCdefServiceRankCB acceptUniqueOf(Integer displayOrder) {
     ...
     */
    public ImmuCdefServiceRankCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuCdefServiceRankCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuCdefServiceRankCQ doGetConditionQuery() {
    ...
    protected ImmuCdefServiceRankCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuCdefServiceRankCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuCdefServiceRankCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuCdefServiceRankCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuCdefServiceRankCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuCdefServiceRankCB> unionCBLambda) {
        final ImmuCdefServiceRankCB cb = new ImmuCdefServiceRankCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuCdefServiceRankCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuCdefServiceRankCB> unionCBLambda) {
        final ImmuCdefServiceRankCB cb = new ImmuCdefServiceRankCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuCdefServiceRankCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuCdefServiceRankCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuCdefServiceRankCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "cdef_service_rank"; }
        /**
         ...
         * }, ImmuMemberService.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<ImmuMemberServiceCB, ImmuCdefServiceRankCQ> derivedMemberService() {
            assertDerived("memberServiceList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberServiceCB> sq, ImmuCdefServiceRankCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<ImmuCdefServiceRankCB, ImmuCdefServiceRankCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuCdefServiceRankCB> sq, ImmuCdefServiceRankCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuCdefServiceRankCB dreamCruiseCB() {
        ImmuCdefServiceRankCB cb = new ImmuCdefServiceRankCB();
        cb.xsetupForDreamCruise((ImmuCdefServiceRankCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuCdefServiceRankCB> columnQuery(final SpecifyQuery<ImmuCdefServiceRankCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuCdefServiceRankCB xcreateColumnQueryCB() {
        ImmuCdefServiceRankCB cb = new ImmuCdefServiceRankCB();
        cb.xsetupForColumnQuery((ImmuCdefServiceRankCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuCdefServiceRankCB> orCBLambda) {
        xorSQ((ImmuCdefServiceRankCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuCdefServiceRankCB> andCBLambda) {
        xorSQAP((ImmuCdefServiceRankCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuCdefServiceRankCB cb;
        if (mainCB != null) {
            cb = (ImmuCdefServiceRankCB)mainCB;
        } else {
            cb = new ImmuCdefServiceRankCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuCdefServiceRankCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuCdefServiceRankCQ.class.getName(); }
