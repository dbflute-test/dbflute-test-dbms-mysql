 ...
 */
public class ImmuBsRegionCQ extends ImmuAbstractBsRegionCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuRegionCIQ _inlineQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsRegionCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public ImmuRegionCIQ inline() {
        if (_inlineQuery == null) { _inlineQuery = xcreateCIQ(); }
        _inlineQuery.xsetOnClause(false); return _inlineQuery;
    }

    protected ImmuRegionCIQ xcreateCIQ() {
        ImmuRegionCIQ ciq = xnewCIQ();
        ciq.xsetBaseCB(_baseCB);
        return ciq;
    }

    protected ImmuRegionCIQ xnewCIQ() {
        return new ImmuRegionCIQ(xgetReferrerQuery(), xgetSqlClause(), xgetAliasName(), xgetNestLevel(), this);
    }
     ...
     */
    public ImmuRegionCIQ on() {
        if (isBaseQuery()) { throw new IllegalConditionBeanOperationException("OnClause for local table is unavailable!"); }
        ImmuRegionCIQ inlineQuery = inline(); inlineQuery.xsetOnClause(true); return inlineQuery;
    }
     ...
     * @return this. (NotNull)
     */
    public ImmuBsRegionCQ addOrderBy_RegionId_Asc() { regOBA("REGION_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public ImmuBsRegionCQ addOrderBy_RegionId_Desc() { regOBD("REGION_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public ImmuBsRegionCQ addOrderBy_RegionName_Asc() { regOBA("REGION_NAME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public ImmuBsRegionCQ addOrderBy_RegionName_Desc() { regOBD("REGION_NAME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public ImmuBsRegionCQ addSpecifiedDerivedOrderBy_Asc(String aliasName) { registerSpecifiedDerivedOrderBy_Asc(aliasName); return this; }
     ...
     * @return this. (NotNull)
     */
    public ImmuBsRegionCQ addSpecifiedDerivedOrderBy_Desc(String aliasName) { registerSpecifiedDerivedOrderBy_Desc(aliasName); return this; }
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, ImmuRegionCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(ImmuRegionCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, ImmuRegionCQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(ImmuRegionCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, ImmuRegionCQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    public String keepQueryMyselfDerived(ImmuRegionCQ sq) { return xkeepSQue("queryMyselfDerived", sq); }
    ...
    //                                                                        MyselfExists
    //                                                                        ============
    protected Map<String, ImmuRegionCQ> _myselfExistsMap;
    public Map<String, ImmuRegionCQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(ImmuRegionCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, ImmuRegionCQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
    public String keepMyselfInScope(ImmuRegionCQ sq) { return xkeepSQue("myselfInScope", sq); }

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xCB() { return ImmuRegionCB.class.getName(); }
    protected String xCQ() { return ImmuRegionCQ.class.getName(); }
