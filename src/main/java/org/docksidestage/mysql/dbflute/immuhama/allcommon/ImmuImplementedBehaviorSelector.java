 ...
 */
public class ImmuImplementedBehaviorSelector implements BehaviorSelector {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(ImmuImplementedBehaviorSelector.class);
    ...
    public void initializeConditionBeanMetaData() {
        final Map<String, DBMeta> dbmetaMap = ImmuDBMetaInstanceHandler.getUnmodifiableDBMetaMap();
    ...
    public BehaviorReadable byName(String tableFlexibleName) {
        ...
        final DBMeta dbmeta = ImmuDBMetaInstanceHandler.findDBMeta(tableFlexibleName);
