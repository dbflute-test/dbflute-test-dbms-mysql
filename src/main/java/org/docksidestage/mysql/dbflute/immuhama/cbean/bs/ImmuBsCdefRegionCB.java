...
/**
 * The base condition-bean of cdef_region.
 * @author DBFlute(AutoGenerator)
 */
public class ImmuBsCdefRegionCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuCdefRegionCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsCdefRegionCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuCdefRegionCB acceptPK(ImmuCDef.Region regionId) {
        assertObjectNotNull("regionId", regionId);
        ImmuBsCdefRegionCB cb = this;
        cb.query().setRegionId_Equal_AsRegion(regionId);
        return (ImmuCdefRegionCB)this;
    }
     ...
     */
    public ImmuCdefRegionCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuCdefRegionCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuCdefRegionCQ doGetConditionQuery() {
    ...
    protected ImmuCdefRegionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuCdefRegionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuCdefRegionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuCdefRegionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuCdefRegionCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuCdefRegionCB> unionCBLambda) {
        final ImmuCdefRegionCB cb = new ImmuCdefRegionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuCdefRegionCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuCdefRegionCB> unionCBLambda) {
        final ImmuCdefRegionCB cb = new ImmuCdefRegionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuCdefRegionCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuCdefRegionCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuCdefRegionCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "cdef_region"; }
        /**
         ...
         */
        public HpSDRFunction<ImmuMemberAddressCB, ImmuCdefRegionCQ> derivedMemberAddress() {
            assertDerived("memberAddressList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberAddressCB> sq, ImmuCdefRegionCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<ImmuCdefRegionCB, ImmuCdefRegionCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuCdefRegionCB> sq, ImmuCdefRegionCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuCdefRegionCB dreamCruiseCB() {
        ImmuCdefRegionCB cb = new ImmuCdefRegionCB();
        cb.xsetupForDreamCruise((ImmuCdefRegionCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuCdefRegionCB> columnQuery(final SpecifyQuery<ImmuCdefRegionCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuCdefRegionCB xcreateColumnQueryCB() {
        ImmuCdefRegionCB cb = new ImmuCdefRegionCB();
        cb.xsetupForColumnQuery((ImmuCdefRegionCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuCdefRegionCB> orCBLambda) {
        xorSQ((ImmuCdefRegionCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuCdefRegionCB> andCBLambda) {
        xorSQAP((ImmuCdefRegionCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuCdefRegionCB cb;
        if (mainCB != null) {
            cb = (ImmuCdefRegionCB)mainCB;
        } else {
            cb = new ImmuCdefRegionCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuCdefRegionCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuCdefRegionCQ.class.getName(); }
