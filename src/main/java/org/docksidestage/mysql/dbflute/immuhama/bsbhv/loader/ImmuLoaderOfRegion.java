 ...
 */
public class ImmuLoaderOfRegion {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<ImmuRegion> _selectedList;
    protected BehaviorSelector _selector;
    protected ImmuRegionBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public ImmuLoaderOfRegion ready(List<ImmuRegion> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected ImmuRegionBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(ImmuRegionBhv.class); return _myBhv; } }
     ...
     * });
     * for (ImmuRegion region : <span style="color: #553000">regionList</span>) {
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<ImmuRegion> getSelectedList() { return _selectedList; }
