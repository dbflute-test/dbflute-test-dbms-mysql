 ...
 */
public class ImmuBsMemberServiceCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuMemberServiceCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsMemberServiceCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuMemberServiceCB acceptPK(Integer memberServiceId) {
        assertObjectNotNull("memberServiceId", memberServiceId);
        ImmuBsMemberServiceCB cb = this;
        cb.query().setMemberServiceId_Equal(memberServiceId);
        return (ImmuMemberServiceCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ImmuMemberServiceCB acceptUniqueOf(Integer memberId) {
     ...
     */
    public ImmuMemberServiceCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuMemberServiceCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuMemberServiceCQ doGetConditionQuery() {
    ...
    protected ImmuMemberServiceCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuMemberServiceCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuMemberServiceCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuMemberServiceCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuMemberServiceCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuMemberServiceCB> unionCBLambda) {
        final ImmuMemberServiceCB cb = new ImmuMemberServiceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberServiceCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuMemberServiceCB> unionCBLambda) {
        final ImmuMemberServiceCB cb = new ImmuMemberServiceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberServiceCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuMemberServiceCQ> {
         ...
         */
        public HpSDRFunction<ImmuMemberServiceCB, ImmuMemberServiceCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberServiceCB> sq, ImmuMemberServiceCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuMemberServiceCB dreamCruiseCB() {
        ImmuMemberServiceCB cb = new ImmuMemberServiceCB();
        cb.xsetupForDreamCruise((ImmuMemberServiceCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuMemberServiceCB> columnQuery(final SpecifyQuery<ImmuMemberServiceCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuMemberServiceCB xcreateColumnQueryCB() {
        ImmuMemberServiceCB cb = new ImmuMemberServiceCB();
        cb.xsetupForColumnQuery((ImmuMemberServiceCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuMemberServiceCB> orCBLambda) {
        xorSQ((ImmuMemberServiceCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuMemberServiceCB> andCBLambda) {
        xorSQAP((ImmuMemberServiceCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuMemberServiceCB cb;
        if (mainCB != null) {
            cb = (ImmuMemberServiceCB)mainCB;
        } else {
            cb = new ImmuMemberServiceCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuMemberServiceCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuMemberServiceCQ.class.getName(); }
