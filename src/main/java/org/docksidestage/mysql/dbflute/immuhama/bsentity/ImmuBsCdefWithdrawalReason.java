...
/**
 * The entity of ([区分値]退会理由)CDEF_WITHDRAWAL_REASON as TABLE. <br>
 ...
 */
public abstract class ImmuBsCdefWithdrawalReason extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsCdefWithdrawalReason) {
            ImmuBsCdefWithdrawalReason other = (ImmuBsCdefWithdrawalReason)obj;
    ...
    @Override
    public ImmuCdefWithdrawalReason clone() {
        return (ImmuCdefWithdrawalReason)super.clone();
    }
