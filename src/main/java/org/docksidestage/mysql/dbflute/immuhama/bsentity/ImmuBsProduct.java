 ...
 */
public abstract class ImmuBsProduct extends AbstractEntity implements DomainEntity, ImmuEntityDefinedCommonColumn {
    ...
    protected OptionalEntity<ImmuProductCategory> _productCategory;
     ...
     */
    public OptionalEntity<ImmuProductCategory> getProductCategory() {
     ...
     */
    public void setProductCategory(OptionalEntity<ImmuProductCategory> productCategory) {
        _productCategory = productCategory;
    }

    /** (商品ステータス)PRODUCT_STATUS by my PRODUCT_STATUS_CODE, named 'productStatus'. */
    protected OptionalEntity<ImmuProductStatus> _productStatus;
     ...
     */
    public OptionalEntity<ImmuProductStatus> getProductStatus() {
     ...
     */
    public void setProductStatus(OptionalEntity<ImmuProductStatus> productStatus) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsProduct) {
            ImmuBsProduct other = (ImmuBsProduct)obj;
    ...
    @Override
    public ImmuProduct clone() {
        return (ImmuProduct)super.clone();
    }
