...
public abstract class ImmuBsProduct extends AbstractEntity implements DomainEntity, ImmuEntityDefinedCommonColumn {
    ...
    /**
     * [get] (商品詳細)PRODUCT_DETAIL by PRODUCT_ID, named 'productDetailList'.
    ...
    /**
     * [set] (商品詳細)PRODUCT_DETAIL by PRODUCT_ID, named 'productDetailList'.
    ...
    protected List<ImmuProductPrice> _productPriceList;

    /**
     * [get] (商品価格)PRODUCT_PRICE by PRODUCT_ID, named 'productPriceList'.
     * @return The entity list of referrer property 'productPriceList'. (NotNull: even if no loading, returns empty list)
     */
    public List<ImmuProductPrice> getProductPriceList() {
        if (_productPriceList == null) { _productPriceList = newReferrerList(); }
        return _productPriceList;
    }

    /**
     * [set] (商品価格)PRODUCT_PRICE by PRODUCT_ID, named 'productPriceList'.
     * @param productPriceList The entity list of referrer property 'productPriceList'. (NullAllowed)
     */
    public void setProductPriceList(List<ImmuProductPrice> productPriceList) {
        _productPriceList = productPriceList;
    }
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_productPriceList != null) { for (ImmuProductPrice et : _productPriceList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "productPriceList")); } } }
        return sb.toString();
    }
    ...
    protected String doBuildRelationString(String dm) {
        ...
        if (_productPriceList != null && !_productPriceList.isEmpty())
        { sb.append(dm).append("productPriceList"); }
        if (sb.length() > dm.length()) {
