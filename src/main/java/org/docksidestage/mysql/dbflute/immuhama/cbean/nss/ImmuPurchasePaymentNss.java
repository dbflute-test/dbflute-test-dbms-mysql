...
import org.docksidestage.mysql.dbflute.immuhama.cbean.cq.ImmuPurchasePaymentCQ;

/**
 * The nest select set-upper of purchase_payment.
 * @author DBFlute(AutoGenerator)
 */
public class ImmuPurchasePaymentNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final ImmuPurchasePaymentCQ _query;
    public ImmuPurchasePaymentNss(ImmuPurchasePaymentCQ query) { _query = query; }
