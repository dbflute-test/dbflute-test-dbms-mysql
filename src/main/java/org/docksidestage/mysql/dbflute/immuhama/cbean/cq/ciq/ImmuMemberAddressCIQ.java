 ...
 */
public class ImmuMemberAddressCIQ extends ImmuAbstractBsMemberAddressCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuBsMemberAddressCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuMemberAddressCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, ImmuBsMemberAddressCQ myCQ) {
    ...
    public String keepSpecifyMyselfDerived(ImmuMemberAddressCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ImmuMemberAddressCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ImmuMemberAddressCQ sq)
    ...
    protected String xinCB() { return ImmuMemberAddressCB.class.getName(); }
    protected String xinCQ() { return ImmuMemberAddressCQ.class.getName(); }
}
