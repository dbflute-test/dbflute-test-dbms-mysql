 ...
 */
public abstract class ImmuBsServiceRank extends AbstractEntity implements DomainEntity {
    ...
    public ImmuCDef.Flg getNewAcceptableFlgAsFlg() {
        return ImmuCDef.Flg.codeOf(getNewAcceptableFlg());
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsServiceRank) {
            ImmuBsServiceRank other = (ImmuBsServiceRank)obj;
    ...
    @Override
    public ImmuServiceRank clone() {
        return (ImmuServiceRank)super.clone();
    }
