 ...
 */
public abstract class ImmuBsRegionBhv extends AbstractBehaviorWritable<ImmuRegion, ImmuRegionCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuRegionDbm asDBMeta() { return ImmuRegionDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuRegionCB newConditionBean() { return new ImmuRegionCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuRegion. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuRegionCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuRegion> selectEntity(CBCall<ImmuRegionCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuRegion> facadeSelectEntity(ImmuRegionCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuRegion> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuRegionCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuRegion <span style="color: #553000">region</span> = <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuRegion selectEntityWithDeletedCheck(CBCall<ImmuRegionCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuRegion> selectByPK(ImmuCDef.Region regionId) {
        return facadeSelectByPK(regionId);
    }

    protected OptionalEntity<ImmuRegion> facadeSelectByPK(ImmuCDef.Region regionId) {
        return doSelectOptionalByPK(regionId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuRegion> ENTITY doSelectByPK(ImmuCDef.Region regionId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(regionId), tp);
    }

    protected <ENTITY extends ImmuRegion> OptionalEntity<ENTITY> doSelectOptionalByPK(ImmuCDef.Region regionId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(regionId, tp), regionId);
    }

    protected ImmuRegionCB xprepareCBAsPK(ImmuCDef.Region regionId) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuRegion&gt; <span style="color: #553000">regionList</span> = <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuRegion <span style="color: #553000">region</span> : <span style="color: #553000">regionList</span>) {
     *     ... = <span style="color: #553000">region</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuRegion. (NotNull)
     ...
     */
    public ListResultBean<ImmuRegion> selectList(CBCall<ImmuRegionCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuRegion&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuRegion region : <span style="color: #553000">page</span>) {
     *     ... = region.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuRegion. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuRegion> selectPage(CBCall<ImmuRegionCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuRegion. (NotNull)
     * @param entityLambda The handler of entity row of ImmuRegion. (NotNull)
     */
    public void selectCursor(CBCall<ImmuRegionCB> cbLambda, EntityRowHandler<ImmuRegion> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuRegionCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuRegion> regionList, ReferrerLoaderHandler<ImmuLoaderOfRegion> loaderLambda) {
        xassLRArg(regionList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfRegion().ready(regionList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuRegion region, ReferrerLoaderHandler<ImmuLoaderOfRegion> loaderLambda) {
        xassLRArg(region, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfRegion().ready(xnewLRAryLs(region), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (ImmuRegion region : <span style="color: #553000">regionList</span>) {
     ...
     */
    public NestedReferrerListGateway<ImmuMemberAddress> loadMemberAddress(List<ImmuRegion> regionList, ReferrerConditionSetupper<ImmuMemberAddressCB> refCBLambda) {
        xassLRArg(regionList, refCBLambda);
        return doLoadMemberAddress(regionList, new LoadReferrerOption<ImmuMemberAddressCB, ImmuMemberAddress>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ImmuMemberAddress> loadMemberAddress(ImmuRegion region, ReferrerConditionSetupper<ImmuMemberAddressCB> refCBLambda) {
        xassLRArg(region, refCBLambda);
        return doLoadMemberAddress(xnewLRLs(region), new LoadReferrerOption<ImmuMemberAddressCB, ImmuMemberAddress>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<ImmuMemberAddress> doLoadMemberAddress(List<ImmuRegion> regionList, LoadReferrerOption<ImmuMemberAddressCB, ImmuMemberAddress> option) {
     ...
     */
    public List<Integer> extractRegionIdList(List<ImmuRegion> regionList)
     ...
     * <pre>
     * ImmuRegion region = <span style="color: #70226C">new</span> ImmuRegion();
     ...
     */
    public void insert(ImmuRegion region) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuRegion region) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuRegion region) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuRegion region) {
     ...
     */
    public int[] batchInsert(List<ImmuRegion> regionList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<ImmuRegion> regionList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<ImmuRegion> regionList) {
     ...
     * <pre>
     * <span style="color: #0000C0">regionBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuRegion, ImmuRegionCB&gt;() {
     *     public ConditionBean setup(ImmuRegion entity, ImmuRegionCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuRegion, ImmuRegionCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuRegion region, CBCall<ImmuRegionCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuRegionCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuRegion region, WritableOptionCall<ImmuRegionCB, InsertOption<ImmuRegionCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuRegion region, WritableOptionCall<ImmuRegionCB, UpdateOption<ImmuRegionCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuRegion region, WritableOptionCall<ImmuRegionCB, InsertOption<ImmuRegionCB>> insertOpLambda, WritableOptionCall<ImmuRegionCB, UpdateOption<ImmuRegionCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuRegion region, WritableOptionCall<ImmuRegionCB, DeleteOption<ImmuRegionCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuRegion> regionList, WritableOptionCall<ImmuRegionCB, InsertOption<ImmuRegionCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuRegion> regionList, WritableOptionCall<ImmuRegionCB, UpdateOption<ImmuRegionCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuRegion> regionList, WritableOptionCall<ImmuRegionCB, DeleteOption<ImmuRegionCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuRegion, ImmuRegionCB> manyArgLambda, WritableOptionCall<ImmuRegionCB, InsertOption<ImmuRegionCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuRegion region, CBCall<ImmuRegionCB> cbLambda, WritableOptionCall<ImmuRegionCB, UpdateOption<ImmuRegionCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuRegionCB> cbLambda, WritableOptionCall<ImmuRegionCB, DeleteOption<ImmuRegionCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuRegionBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuRegion> typeOfSelectedEntity() { return ImmuRegion.class; }
    protected Class<ImmuRegion> typeOfHandlingEntity() { return ImmuRegion.class; }
    protected Class<ImmuRegionCB> typeOfHandlingConditionBean() { return ImmuRegionCB.class; }
}
