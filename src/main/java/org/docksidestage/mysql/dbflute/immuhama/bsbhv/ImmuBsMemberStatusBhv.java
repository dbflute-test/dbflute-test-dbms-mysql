 ...
 */
public abstract class ImmuBsMemberStatusBhv extends AbstractBehaviorWritable<ImmuMemberStatus, ImmuMemberStatusCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuMemberStatusDbm asDBMeta() { return ImmuMemberStatusDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuMemberStatusCB newConditionBean() { return new ImmuMemberStatusCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberStatus. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuMemberStatusCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuMemberStatus> selectEntity(CBCall<ImmuMemberStatusCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuMemberStatus> facadeSelectEntity(ImmuMemberStatusCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberStatus> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuMemberStatusCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuMemberStatus <span style="color: #553000">memberStatus</span> = <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuMemberStatus selectEntityWithDeletedCheck(CBCall<ImmuMemberStatusCB> cbLambda) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuMemberStatus&gt; <span style="color: #553000">memberStatusList</span> = <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuMemberStatus <span style="color: #553000">memberStatus</span> : <span style="color: #553000">memberStatusList</span>) {
     *     ... = <span style="color: #553000">memberStatus</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberStatus. (NotNull)
     ...
     */
    public ListResultBean<ImmuMemberStatus> selectList(CBCall<ImmuMemberStatusCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuMemberStatus&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuMemberStatus memberStatus : <span style="color: #553000">page</span>) {
     *     ... = memberStatus.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberStatus. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuMemberStatus> selectPage(CBCall<ImmuMemberStatusCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberStatus. (NotNull)
     * @param entityLambda The handler of entity row of ImmuMemberStatus. (NotNull)
     */
    public void selectCursor(CBCall<ImmuMemberStatusCB> cbLambda, EntityRowHandler<ImmuMemberStatus> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuMemberStatusCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuMemberStatus> memberStatusList, ReferrerLoaderHandler<ImmuLoaderOfMemberStatus> loaderLambda) {
        xassLRArg(memberStatusList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberStatus().ready(memberStatusList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuMemberStatus memberStatus, ReferrerLoaderHandler<ImmuLoaderOfMemberStatus> loaderLambda) {
     ...
     * <pre>
     * ImmuMemberStatus memberStatus = <span style="color: #70226C">new</span> ImmuMemberStatus();
     ...
     */
    public void insert(ImmuMemberStatus memberStatus) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuMemberStatus memberStatus) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuMemberStatus memberStatus) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuMemberStatus memberStatus) {
     ...
     */
    public int[] batchInsert(List<ImmuMemberStatus> memberStatusList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<ImmuMemberStatus> memberStatusList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<ImmuMemberStatus> memberStatusList) {
     ...
     * <pre>
     * <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuMemberStatus, ImmuMemberStatusCB&gt;() {
     *     public ConditionBean setup(ImmuMemberStatus entity, ImmuMemberStatusCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuMemberStatus, ImmuMemberStatusCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuMemberStatus memberStatus, CBCall<ImmuMemberStatusCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuMemberStatusCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuMemberStatus memberStatus, WritableOptionCall<ImmuMemberStatusCB, InsertOption<ImmuMemberStatusCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuMemberStatus memberStatus, WritableOptionCall<ImmuMemberStatusCB, UpdateOption<ImmuMemberStatusCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuMemberStatus memberStatus, WritableOptionCall<ImmuMemberStatusCB, InsertOption<ImmuMemberStatusCB>> insertOpLambda, WritableOptionCall<ImmuMemberStatusCB, UpdateOption<ImmuMemberStatusCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuMemberStatus memberStatus, WritableOptionCall<ImmuMemberStatusCB, DeleteOption<ImmuMemberStatusCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuMemberStatus> memberStatusList, WritableOptionCall<ImmuMemberStatusCB, InsertOption<ImmuMemberStatusCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuMemberStatus> memberStatusList, WritableOptionCall<ImmuMemberStatusCB, UpdateOption<ImmuMemberStatusCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuMemberStatus> memberStatusList, WritableOptionCall<ImmuMemberStatusCB, DeleteOption<ImmuMemberStatusCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuMemberStatus, ImmuMemberStatusCB> manyArgLambda, WritableOptionCall<ImmuMemberStatusCB, InsertOption<ImmuMemberStatusCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuMemberStatus memberStatus, CBCall<ImmuMemberStatusCB> cbLambda, WritableOptionCall<ImmuMemberStatusCB, UpdateOption<ImmuMemberStatusCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuMemberStatusCB> cbLambda, WritableOptionCall<ImmuMemberStatusCB, DeleteOption<ImmuMemberStatusCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuMemberStatusBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuMemberStatus> typeOfSelectedEntity() { return ImmuMemberStatus.class; }
    protected Class<ImmuMemberStatus> typeOfHandlingEntity() { return ImmuMemberStatus.class; }
    protected Class<ImmuMemberStatusCB> typeOfHandlingConditionBean() { return ImmuMemberStatusCB.class; }
}
