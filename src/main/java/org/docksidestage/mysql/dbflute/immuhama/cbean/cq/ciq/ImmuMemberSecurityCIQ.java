 ...
 */
public class ImmuMemberSecurityCIQ extends ImmuAbstractBsMemberSecurityCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuBsMemberSecurityCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuMemberSecurityCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, ImmuBsMemberSecurityCQ myCQ) {
    ...
    public String keepScalarCondition(ImmuMemberSecurityCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ImmuMemberSecurityCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ImmuMemberSecurityCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ImmuMemberSecurityCQ sq)
    ...
    protected String xinCB() { return ImmuMemberSecurityCB.class.getName(); }
    protected String xinCQ() { return ImmuMemberSecurityCQ.class.getName(); }
}
