...
import org.docksidestage.mysql.dbflute.immuhama.cbean.cq.ImmuMemberStatusCQ;

/**
 * The nest select set-upper of member_status.
 * @author DBFlute(AutoGenerator)
 */
public class ImmuMemberStatusNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final ImmuMemberStatusCQ _query;
    public ImmuMemberStatusNss(ImmuMemberStatusCQ query) { _query = query; }
