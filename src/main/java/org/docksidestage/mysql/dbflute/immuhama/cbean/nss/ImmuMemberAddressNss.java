...
import org.docksidestage.mysql.dbflute.immuhama.cbean.cq.ImmuMemberAddressCQ;

/**
 * The nest select set-upper of member_address.
 * @author DBFlute(AutoGenerator)
 */
public class ImmuMemberAddressNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final ImmuMemberAddressCQ _query;
    public ImmuMemberAddressNss(ImmuMemberAddressCQ query) { _query = query; }
