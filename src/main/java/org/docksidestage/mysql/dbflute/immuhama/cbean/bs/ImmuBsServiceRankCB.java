 ...
 */
public class ImmuBsServiceRankCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuServiceRankCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsServiceRankCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuServiceRankCB acceptPK(String serviceRankCode) {
        assertObjectNotNull("serviceRankCode", serviceRankCode);
        ImmuBsServiceRankCB cb = this;
        cb.query().setServiceRankCode_Equal(serviceRankCode);
        return (ImmuServiceRankCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ImmuServiceRankCB acceptUniqueOf(Integer displayOrder) {
     ...
     */
    public ImmuServiceRankCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuServiceRankCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuServiceRankCQ doGetConditionQuery() {
    ...
    protected ImmuServiceRankCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuServiceRankCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuServiceRankCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuServiceRankCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuServiceRankCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuServiceRankCB> unionCBLambda) {
        final ImmuServiceRankCB cb = new ImmuServiceRankCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuServiceRankCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuServiceRankCB> unionCBLambda) {
        final ImmuServiceRankCB cb = new ImmuServiceRankCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuServiceRankCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuServiceRankCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuServiceRankCQ> qyCall
         ...
         */
        public HpSDRFunction<ImmuMemberServiceCB, ImmuServiceRankCQ> derivedMemberService() {
            assertDerived("memberServiceList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberServiceCB> sq, ImmuServiceRankCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<ImmuServiceRankCB, ImmuServiceRankCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuServiceRankCB> sq, ImmuServiceRankCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuServiceRankCB dreamCruiseCB() {
        ImmuServiceRankCB cb = new ImmuServiceRankCB();
        cb.xsetupForDreamCruise((ImmuServiceRankCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuServiceRankCB> columnQuery(final SpecifyQuery<ImmuServiceRankCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuServiceRankCB xcreateColumnQueryCB() {
        ImmuServiceRankCB cb = new ImmuServiceRankCB();
        cb.xsetupForColumnQuery((ImmuServiceRankCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuServiceRankCB> orCBLambda) {
        xorSQ((ImmuServiceRankCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuServiceRankCB> andCBLambda) {
        xorSQAP((ImmuServiceRankCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuServiceRankCB cb;
        if (mainCB != null) {
            cb = (ImmuServiceRankCB)mainCB;
        } else {
            cb = new ImmuServiceRankCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuServiceRankCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuServiceRankCQ.class.getName(); }
