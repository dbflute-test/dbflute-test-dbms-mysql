...
/**
 * The abstract condition-query of cdef_product_status.
 * @author DBFlute(AutoGenerator)
 */
public abstract class ImmuAbstractBsCdefProductStatusCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsCdefProductStatusCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * (商品ステータスコード)PRODUCT_STATUS_CODE: {PK, NotNull, CHAR(3)}
     * @param productStatusCode The value of productStatusCode as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * (商品ステータスコード)PRODUCT_STATUS_CODE: {PK, NotNull, CHAR(3)}
     * @param productStatusCode The value of productStatusCode as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * (商品ステータスコード)PRODUCT_STATUS_CODE: {PK, NotNull, CHAR(3)}
     * @param productStatusCode The value of productStatusCode as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * (商品ステータスコード)PRODUCT_STATUS_CODE: {PK, NotNull, CHAR(3)}
     * @param productStatusCode The value of productStatusCode as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * {exists (select PRODUCT_STATUS_CODE from product_detail where ...)} <br>
     * (商品詳細)product_detail by PRODUCT_STATUS_CODE, named 'productDetailAsOne'.
     * <pre>
    ...
    public void existsProductDetail(SubQuery<ImmuProductDetailCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductStatusCode_ExistsReferrer_ProductDetailList(cb.query());
        registerExistsReferrer(cb.query(), "PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", pp, "productDetailList");
    }
    public abstract String keepProductStatusCode_ExistsReferrer_ProductDetailList(ImmuProductDetailCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select PRODUCT_STATUS_CODE from product_detail where ...)} <br>
     * (商品詳細)product_detail by PRODUCT_STATUS_CODE, named 'productDetailAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of ProductStatusCode_NotExistsReferrer_ProductDetailList for 'not exists'. (NotNull)
     */
    public void notExistsProductDetail(SubQuery<ImmuProductDetailCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductDetailCB cb = new ImmuProductDetailCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductStatusCode_NotExistsReferrer_ProductDetailList(cb.query());
        registerNotExistsReferrer(cb.query(), "PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", pp, "productDetailList");
    }
    public abstract String keepProductStatusCode_NotExistsReferrer_ProductDetailList(ImmuProductDetailCQ sq);
    ...
    public void xsderiveProductDetailList(String fn, SubQuery<ImmuProductDetailCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepProductStatusCode_SpecifyDerivedReferrer_ProductDetailList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", pp, "productDetailList", al, op);
    }
    public abstract String keepProductStatusCode_SpecifyDerivedReferrer_ProductDetailList(ImmuProductDetailCQ sq);
    ...
    public void xqderiveProductDetailList(String fn, SubQuery<ImmuProductDetailCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductDetailCB cb = new ImmuProductDetailCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepProductStatusCode_QueryDerivedReferrer_ProductDetailList(cb.query()); String prpp = keepProductStatusCode_QueryDerivedReferrer_ProductDetailListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", sqpp, "productDetailList", rd, vl, prpp, op);
    }
    public abstract String keepProductStatusCode_QueryDerivedReferrer_ProductDetailList(ImmuProductDetailCQ sq);
    public abstract String keepProductStatusCode_QueryDerivedReferrer_ProductDetailListParameter(Object vl);
     ...
     */
    public HpSLCFunction<ImmuCdefProductStatusCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuCdefProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductStatusCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuCdefProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductStatusCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuCdefProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductStatusCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuCdefProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductStatusCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuCdefProductStatusCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuCdefProductStatusCB&gt;() {
     *     public void query(ImmuCdefProductStatusCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefProductStatusCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuCdefProductStatusCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefProductStatusCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuCdefProductStatusCQ sq);

    protected ImmuCdefProductStatusCB xcreateScalarConditionCB() {
        ImmuCdefProductStatusCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuCdefProductStatusCB xcreateScalarConditionPartitionByCB() {
        ImmuCdefProductStatusCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuCdefProductStatusCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefProductStatusCB cb = new ImmuCdefProductStatusCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PRODUCT_STATUS_CODE";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuCdefProductStatusCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuCdefProductStatusCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuCdefProductStatusCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefProductStatusCB cb = new ImmuCdefProductStatusCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_STATUS_CODE";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuCdefProductStatusCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuCdefProductStatusCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuCdefProductStatusCB cb = new ImmuCdefProductStatusCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuCdefProductStatusCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuCdefProductStatusCB newMyCB() {
        return new ImmuCdefProductStatusCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuCdefProductStatusCQ.class.getName(); }
