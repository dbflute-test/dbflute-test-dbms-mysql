 ...
 */
public abstract class ImmuBsRegion extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsRegion) {
            ImmuBsRegion other = (ImmuBsRegion)obj;
    ...
    @Override
    public ImmuRegion clone() {
        return (ImmuRegion)super.clone();
    }
