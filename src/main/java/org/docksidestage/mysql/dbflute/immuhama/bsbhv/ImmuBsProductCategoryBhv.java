 ...
 */
public abstract class ImmuBsProductCategoryBhv extends AbstractBehaviorWritable<ImmuProductCategory, ImmuProductCategoryCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuProductCategoryDbm asDBMeta() { return ImmuProductCategoryDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuProductCategoryCB newConditionBean() { return new ImmuProductCategoryCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProductCategory. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuProductCategoryCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuProductCategory> selectEntity(CBCall<ImmuProductCategoryCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuProductCategory> facadeSelectEntity(ImmuProductCategoryCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuProductCategory> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuProductCategoryCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuProductCategory <span style="color: #553000">productCategory</span> = <span style="color: #0000C0">productCategoryBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuProductCategory selectEntityWithDeletedCheck(CBCall<ImmuProductCategoryCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuProductCategory> selectByPK(String productCategoryCode) {
        return facadeSelectByPK(productCategoryCode);
    }

    protected OptionalEntity<ImmuProductCategory> facadeSelectByPK(String productCategoryCode) {
        return doSelectOptionalByPK(productCategoryCode, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuProductCategory> ENTITY doSelectByPK(String productCategoryCode, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(productCategoryCode), tp);
    }

    protected <ENTITY extends ImmuProductCategory> OptionalEntity<ENTITY> doSelectOptionalByPK(String productCategoryCode, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(productCategoryCode, tp), productCategoryCode);
    }

    protected ImmuProductCategoryCB xprepareCBAsPK(String productCategoryCode) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuProductCategory&gt; <span style="color: #553000">productCategoryList</span> = <span style="color: #0000C0">productCategoryBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuProductCategory <span style="color: #553000">productCategory</span> : <span style="color: #553000">productCategoryList</span>) {
     *     ... = <span style="color: #553000">productCategory</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProductCategory. (NotNull)
     ...
     */
    public ListResultBean<ImmuProductCategory> selectList(CBCall<ImmuProductCategoryCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuProductCategory&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">productCategoryBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuProductCategory productCategory : <span style="color: #553000">page</span>) {
     *     ... = productCategory.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProductCategory. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuProductCategory> selectPage(CBCall<ImmuProductCategoryCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProductCategory. (NotNull)
     * @param entityLambda The handler of entity row of ImmuProductCategory. (NotNull)
     */
    public void selectCursor(CBCall<ImmuProductCategoryCB> cbLambda, EntityRowHandler<ImmuProductCategory> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuProductCategoryCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuProductCategory> productCategoryList, ReferrerLoaderHandler<ImmuLoaderOfProductCategory> loaderLambda) {
        xassLRArg(productCategoryList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfProductCategory().ready(productCategoryList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuProductCategory productCategory, ReferrerLoaderHandler<ImmuLoaderOfProductCategory> loaderLambda) {
        xassLRArg(productCategory, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfProductCategory().ready(xnewLRAryLs(productCategory), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (ImmuProductCategory productCategory : <span style="color: #553000">productCategoryList</span>) {
     ...
     */
    public NestedReferrerListGateway<ImmuProduct> loadProduct(List<ImmuProductCategory> productCategoryList, ReferrerConditionSetupper<ImmuProductCB> refCBLambda) {
        xassLRArg(productCategoryList, refCBLambda);
        return doLoadProduct(productCategoryList, new LoadReferrerOption<ImmuProductCB, ImmuProduct>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ImmuProduct> loadProduct(ImmuProductCategory productCategory, ReferrerConditionSetupper<ImmuProductCB> refCBLambda) {
        xassLRArg(productCategory, refCBLambda);
        return doLoadProduct(xnewLRLs(productCategory), new LoadReferrerOption<ImmuProductCB, ImmuProduct>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<ImmuProduct> doLoadProduct(List<ImmuProductCategory> productCategoryList, LoadReferrerOption<ImmuProductCB, ImmuProduct> option) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ImmuProductCategory> loadProductCategorySelf(List<ImmuProductCategory> productCategoryList, ReferrerConditionSetupper<ImmuProductCategoryCB> refCBLambda) {
        xassLRArg(productCategoryList, refCBLambda);
        return doLoadProductCategorySelf(productCategoryList, new LoadReferrerOption<ImmuProductCategoryCB, ImmuProductCategory>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ImmuProductCategory> loadProductCategorySelf(ImmuProductCategory productCategory, ReferrerConditionSetupper<ImmuProductCategoryCB> refCBLambda) {
        xassLRArg(productCategory, refCBLambda);
        return doLoadProductCategorySelf(xnewLRLs(productCategory), new LoadReferrerOption<ImmuProductCategoryCB, ImmuProductCategory>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<ImmuProductCategory> doLoadProductCategorySelf(List<ImmuProductCategory> productCategoryList, LoadReferrerOption<ImmuProductCategoryCB, ImmuProductCategory> option) {
     ...
     */
    public List<ImmuProductCategory> pulloutProductCategorySelf(List<ImmuProductCategory> productCategoryList)
     ...
     */
    public List<String> extractProductCategoryCodeList(List<ImmuProductCategory> productCategoryList)
     ...
     * <pre>
     * ImmuProductCategory productCategory = <span style="color: #70226C">new</span> ImmuProductCategory();
     ...
     */
    public void insert(ImmuProductCategory productCategory) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuProductCategory productCategory) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuProductCategory productCategory) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuProductCategory productCategory) {
     ...
     */
    public int[] batchInsert(List<ImmuProductCategory> productCategoryList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<ImmuProductCategory> productCategoryList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<ImmuProductCategory> productCategoryList) {
     ...
     * <pre>
     * <span style="color: #0000C0">productCategoryBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuProductCategory, ImmuProductCategoryCB&gt;() {
     *     public ConditionBean setup(ImmuProductCategory entity, ImmuProductCategoryCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuProductCategory, ImmuProductCategoryCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuProductCategory productCategory, CBCall<ImmuProductCategoryCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuProductCategoryCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuProductCategory productCategory, WritableOptionCall<ImmuProductCategoryCB, InsertOption<ImmuProductCategoryCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuProductCategory productCategory, WritableOptionCall<ImmuProductCategoryCB, UpdateOption<ImmuProductCategoryCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuProductCategory productCategory, WritableOptionCall<ImmuProductCategoryCB, InsertOption<ImmuProductCategoryCB>> insertOpLambda, WritableOptionCall<ImmuProductCategoryCB, UpdateOption<ImmuProductCategoryCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuProductCategory productCategory, WritableOptionCall<ImmuProductCategoryCB, DeleteOption<ImmuProductCategoryCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuProductCategory> productCategoryList, WritableOptionCall<ImmuProductCategoryCB, InsertOption<ImmuProductCategoryCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuProductCategory> productCategoryList, WritableOptionCall<ImmuProductCategoryCB, UpdateOption<ImmuProductCategoryCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuProductCategory> productCategoryList, WritableOptionCall<ImmuProductCategoryCB, DeleteOption<ImmuProductCategoryCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuProductCategory, ImmuProductCategoryCB> manyArgLambda, WritableOptionCall<ImmuProductCategoryCB, InsertOption<ImmuProductCategoryCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuProductCategory productCategory, CBCall<ImmuProductCategoryCB> cbLambda, WritableOptionCall<ImmuProductCategoryCB, UpdateOption<ImmuProductCategoryCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuProductCategoryCB> cbLambda, WritableOptionCall<ImmuProductCategoryCB, DeleteOption<ImmuProductCategoryCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuProductCategoryBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuProductCategory> typeOfSelectedEntity() { return ImmuProductCategory.class; }
    protected Class<ImmuProductCategory> typeOfHandlingEntity() { return ImmuProductCategory.class; }
    protected Class<ImmuProductCategoryCB> typeOfHandlingConditionBean() { return ImmuProductCategoryCB.class; }
}
