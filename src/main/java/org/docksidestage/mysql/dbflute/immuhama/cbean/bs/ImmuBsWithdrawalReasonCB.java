 ...
 */
public class ImmuBsWithdrawalReasonCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuWithdrawalReasonCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsWithdrawalReasonCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuWithdrawalReasonCB acceptPK(ImmuCDef.WithdrawalReason withdrawalReasonCode) {
        assertObjectNotNull("withdrawalReasonCode", withdrawalReasonCode);
        ImmuBsWithdrawalReasonCB cb = this;
        cb.query().setWithdrawalReasonCode_Equal_AsWithdrawalReason(withdrawalReasonCode);
        return (ImmuWithdrawalReasonCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ImmuWithdrawalReasonCB acceptUniqueOf(Integer displayOrder) {
     ...
     */
    public ImmuWithdrawalReasonCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuWithdrawalReasonCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuWithdrawalReasonCQ doGetConditionQuery() {
    ...
    protected ImmuWithdrawalReasonCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuWithdrawalReasonCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuWithdrawalReasonCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuWithdrawalReasonCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuWithdrawalReasonCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuWithdrawalReasonCB> unionCBLambda) {
        final ImmuWithdrawalReasonCB cb = new ImmuWithdrawalReasonCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuWithdrawalReasonCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuWithdrawalReasonCB> unionCBLambda) {
        final ImmuWithdrawalReasonCB cb = new ImmuWithdrawalReasonCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuWithdrawalReasonCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuWithdrawalReasonCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuWithdrawalReasonCQ> qyCall
         ...
         */
        public HpSDRFunction<ImmuMemberWithdrawalCB, ImmuWithdrawalReasonCQ> derivedMemberWithdrawal() {
            assertDerived("memberWithdrawalList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberWithdrawalCB> sq, ImmuWithdrawalReasonCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<ImmuWithdrawalReasonCB, ImmuWithdrawalReasonCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuWithdrawalReasonCB> sq, ImmuWithdrawalReasonCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuWithdrawalReasonCB dreamCruiseCB() {
        ImmuWithdrawalReasonCB cb = new ImmuWithdrawalReasonCB();
        cb.xsetupForDreamCruise((ImmuWithdrawalReasonCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuWithdrawalReasonCB> columnQuery(final SpecifyQuery<ImmuWithdrawalReasonCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuWithdrawalReasonCB xcreateColumnQueryCB() {
        ImmuWithdrawalReasonCB cb = new ImmuWithdrawalReasonCB();
        cb.xsetupForColumnQuery((ImmuWithdrawalReasonCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuWithdrawalReasonCB> orCBLambda) {
        xorSQ((ImmuWithdrawalReasonCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuWithdrawalReasonCB> andCBLambda) {
        xorSQAP((ImmuWithdrawalReasonCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuWithdrawalReasonCB cb;
        if (mainCB != null) {
            cb = (ImmuWithdrawalReasonCB)mainCB;
        } else {
            cb = new ImmuWithdrawalReasonCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuWithdrawalReasonCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuWithdrawalReasonCQ.class.getName(); }
