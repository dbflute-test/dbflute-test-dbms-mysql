 ...
 */
public abstract class ImmuBsMemberSecurity extends AbstractEntity implements DomainEntity, ImmuEntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsMemberSecurity) {
            ImmuBsMemberSecurity other = (ImmuBsMemberSecurity)obj;
    ...
    @Override
    public ImmuMemberSecurity clone() {
        return (ImmuMemberSecurity)super.clone();
    }
