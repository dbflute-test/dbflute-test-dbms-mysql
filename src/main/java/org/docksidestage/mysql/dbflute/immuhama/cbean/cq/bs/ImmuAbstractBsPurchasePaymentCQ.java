 ...
 */
public abstract class ImmuAbstractBsPurchasePaymentCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsPurchasePaymentCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void setPaymentMethodCode_Equal_AsPaymentMethod(ImmuCDef.PaymentMethod cdef) {
    ...
    public void setPaymentMethodCode_Equal_ByHand() {
        setPaymentMethodCode_Equal_AsPaymentMethod(ImmuCDef.PaymentMethod.ByHand);
    }
    ...
    public void setPaymentMethodCode_Equal_BankTransfer() {
        setPaymentMethodCode_Equal_AsPaymentMethod(ImmuCDef.PaymentMethod.BankTransfer);
    }
    ...
    public void setPaymentMethodCode_Equal_CreditCard() {
        setPaymentMethodCode_Equal_AsPaymentMethod(ImmuCDef.PaymentMethod.CreditCard);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setPaymentMethodCode_NotEqual_AsPaymentMethod(ImmuCDef.PaymentMethod cdef) {
    ...
    public void setPaymentMethodCode_NotEqual_ByHand() {
        setPaymentMethodCode_NotEqual_AsPaymentMethod(ImmuCDef.PaymentMethod.ByHand);
    }
    ...
    public void setPaymentMethodCode_NotEqual_BankTransfer() {
        setPaymentMethodCode_NotEqual_AsPaymentMethod(ImmuCDef.PaymentMethod.BankTransfer);
    }
    ...
    public void setPaymentMethodCode_NotEqual_CreditCard() {
        setPaymentMethodCode_NotEqual_AsPaymentMethod(ImmuCDef.PaymentMethod.CreditCard);
    }
     ...
     */
    public void setPaymentMethodCode_InScope_AsPaymentMethod(Collection<ImmuCDef.PaymentMethod> cdefList) {
    ...
    public void setPaymentMethodCode_InScope_Recommended() {
        setPaymentMethodCode_InScope_AsPaymentMethod(ImmuCDef.PaymentMethod.listOfRecommended());
    }
     ...
     * @param cdefList The list of classification definition (as ENUM type). (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPaymentMethodCode_NotInScope_AsPaymentMethod(Collection<ImmuCDef.PaymentMethod> cdefList) {
     ...
     */
    public HpSLCFunction<ImmuPurchasePaymentCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuPurchasePaymentCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuPurchasePaymentCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuPurchasePaymentCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuPurchasePaymentCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuPurchasePaymentCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuPurchasePaymentCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuPurchasePaymentCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuPurchasePaymentCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuPurchasePaymentCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuPurchasePaymentCB&gt;() {
     *     public void query(ImmuPurchasePaymentCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuPurchasePaymentCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuPurchasePaymentCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuPurchasePaymentCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuPurchasePaymentCQ sq);

    protected ImmuPurchasePaymentCB xcreateScalarConditionCB() {
        ImmuPurchasePaymentCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuPurchasePaymentCB xcreateScalarConditionPartitionByCB() {
        ImmuPurchasePaymentCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuPurchasePaymentCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(ImmuPurchasePaymentCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuPurchasePaymentCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuPurchasePaymentCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuPurchasePaymentCB cb = new ImmuPurchasePaymentCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PURCHASE_PAYMENT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuPurchasePaymentCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuPurchasePaymentCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuPurchasePaymentCB cb = new ImmuPurchasePaymentCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuPurchasePaymentCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuPurchasePaymentCB newMyCB() {
        return new ImmuPurchasePaymentCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuPurchasePaymentCQ.class.getName(); }
