 ...
 */
public abstract class ImmuBsProductBhv extends AbstractBehaviorWritable<ImmuProduct, ImmuProductCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuProductDbm asDBMeta() { return ImmuProductDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuProductCB newConditionBean() { return new ImmuProductCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProduct. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuProductCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuProduct> selectEntity(CBCall<ImmuProductCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuProduct> facadeSelectEntity(ImmuProductCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuProduct> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuProductCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuProduct <span style="color: #553000">product</span> = <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuProduct selectEntityWithDeletedCheck(CBCall<ImmuProductCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuProduct> selectByPK(Integer productId) {
        return facadeSelectByPK(productId);
    }

    protected OptionalEntity<ImmuProduct> facadeSelectByPK(Integer productId) {
        return doSelectOptionalByPK(productId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuProduct> ENTITY doSelectByPK(Integer productId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(productId), tp);
    }

    protected <ENTITY extends ImmuProduct> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer productId, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuProduct&gt; <span style="color: #553000">productList</span> = <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuProduct <span style="color: #553000">product</span> : <span style="color: #553000">productList</span>) {
     *     ... = <span style="color: #553000">product</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProduct. (NotNull)
     ...
     */
    public ListResultBean<ImmuProduct> selectList(CBCall<ImmuProductCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuProduct&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuProduct product : <span style="color: #553000">page</span>) {
     *     ... = product.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProduct. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuProduct> selectPage(CBCall<ImmuProductCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProduct. (NotNull)
     * @param entityLambda The handler of entity row of ImmuProduct. (NotNull)
     */
    public void selectCursor(CBCall<ImmuProductCB> cbLambda, EntityRowHandler<ImmuProduct> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuProductCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuProduct> productList, ReferrerLoaderHandler<ImmuLoaderOfProduct> loaderLambda) {
        xassLRArg(productList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfProduct().ready(productList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuProduct product, ReferrerLoaderHandler<ImmuLoaderOfProduct> loaderLambda) {
        xassLRArg(product, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfProduct().ready(xnewLRAryLs(product), _behaviorSelector));
    }
     ...
     */
    public void insert(ImmuProduct product) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuProduct product) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuProduct product) {
     ...
     */
    public int[] batchInsert(List<ImmuProduct> productList) {
     ...
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuProduct, ImmuProductCB&gt;() {
     *     public ConditionBean setup(ImmuProduct entity, ImmuProductCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuProduct, ImmuProductCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuProduct product, CBCall<ImmuProductCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuProductCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuProduct product, WritableOptionCall<ImmuProductCB, InsertOption<ImmuProductCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuProduct product, WritableOptionCall<ImmuProductCB, UpdateOption<ImmuProductCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuProduct product, WritableOptionCall<ImmuProductCB, InsertOption<ImmuProductCB>> insertOpLambda, WritableOptionCall<ImmuProductCB, UpdateOption<ImmuProductCB>> updateOpLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuProduct> productList, WritableOptionCall<ImmuProductCB, InsertOption<ImmuProductCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuProduct> productList, WritableOptionCall<ImmuProductCB, UpdateOption<ImmuProductCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuProduct, ImmuProductCB> manyArgLambda, WritableOptionCall<ImmuProductCB, InsertOption<ImmuProductCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuProduct product, CBCall<ImmuProductCB> cbLambda, WritableOptionCall<ImmuProductCB, UpdateOption<ImmuProductCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuProductCB> cbLambda, WritableOptionCall<ImmuProductCB, DeleteOption<ImmuProductCB>> opLambda) {
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuProduct> typeOfSelectedEntity() { return ImmuProduct.class; }
    protected Class<ImmuProduct> typeOfHandlingEntity() { return ImmuProduct.class; }
    protected Class<ImmuProductCB> typeOfHandlingConditionBean() { return ImmuProductCB.class; }
}
