 ...
 */
public abstract class ImmuBsProductStatusBhv extends AbstractBehaviorWritable<ImmuProductStatus, ImmuProductStatusCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuProductStatusDbm asDBMeta() { return ImmuProductStatusDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuProductStatusCB newConditionBean() { return new ImmuProductStatusCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProductStatus. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuProductStatusCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuProductStatus> selectEntity(CBCall<ImmuProductStatusCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuProductStatus> facadeSelectEntity(ImmuProductStatusCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuProductStatus> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuProductStatusCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuProductStatus <span style="color: #553000">productStatus</span> = <span style="color: #0000C0">productStatusBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuProductStatus selectEntityWithDeletedCheck(CBCall<ImmuProductStatusCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuProductStatus> selectByPK(String productStatusCode) {
        return facadeSelectByPK(productStatusCode);
    }

    protected OptionalEntity<ImmuProductStatus> facadeSelectByPK(String productStatusCode) {
        return doSelectOptionalByPK(productStatusCode, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuProductStatus> ENTITY doSelectByPK(String productStatusCode, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(productStatusCode), tp);
    }

    protected <ENTITY extends ImmuProductStatus> OptionalEntity<ENTITY> doSelectOptionalByPK(String productStatusCode, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(productStatusCode, tp), productStatusCode);
    }

    protected ImmuProductStatusCB xprepareCBAsPK(String productStatusCode) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuProductStatus> selectByUniqueOf(Integer displayOrder) {
        return facadeSelectByUniqueOf(displayOrder);
    }

    protected OptionalEntity<ImmuProductStatus> facadeSelectByUniqueOf(Integer displayOrder) {
        return doSelectByUniqueOf(displayOrder, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuProductStatus> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer displayOrder, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(displayOrder), tp), displayOrder);
    }

    protected ImmuProductStatusCB xprepareCBAsUniqueOf(Integer displayOrder) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuProductStatus&gt; <span style="color: #553000">productStatusList</span> = <span style="color: #0000C0">productStatusBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuProductStatus <span style="color: #553000">productStatus</span> : <span style="color: #553000">productStatusList</span>) {
     *     ... = <span style="color: #553000">productStatus</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProductStatus. (NotNull)
     ...
     */
    public ListResultBean<ImmuProductStatus> selectList(CBCall<ImmuProductStatusCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuProductStatus&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">productStatusBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuProductStatus productStatus : <span style="color: #553000">page</span>) {
     *     ... = productStatus.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProductStatus. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuProductStatus> selectPage(CBCall<ImmuProductStatusCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuProductStatus. (NotNull)
     * @param entityLambda The handler of entity row of ImmuProductStatus. (NotNull)
     */
    public void selectCursor(CBCall<ImmuProductStatusCB> cbLambda, EntityRowHandler<ImmuProductStatus> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuProductStatusCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuProductStatus> productStatusList, ReferrerLoaderHandler<ImmuLoaderOfProductStatus> loaderLambda) {
        xassLRArg(productStatusList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfProductStatus().ready(productStatusList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuProductStatus productStatus, ReferrerLoaderHandler<ImmuLoaderOfProductStatus> loaderLambda) {
        xassLRArg(productStatus, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfProductStatus().ready(xnewLRAryLs(productStatus), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (ImmuProductStatus productStatus : <span style="color: #553000">productStatusList</span>) {
     ...
     */
    public NestedReferrerListGateway<ImmuProduct> loadProduct(List<ImmuProductStatus> productStatusList, ReferrerConditionSetupper<ImmuProductCB> refCBLambda) {
        xassLRArg(productStatusList, refCBLambda);
        return doLoadProduct(productStatusList, new LoadReferrerOption<ImmuProductCB, ImmuProduct>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ImmuProduct> loadProduct(ImmuProductStatus productStatus, ReferrerConditionSetupper<ImmuProductCB> refCBLambda) {
        xassLRArg(productStatus, refCBLambda);
        return doLoadProduct(xnewLRLs(productStatus), new LoadReferrerOption<ImmuProductCB, ImmuProduct>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<ImmuProduct> doLoadProduct(List<ImmuProductStatus> productStatusList, LoadReferrerOption<ImmuProductCB, ImmuProduct> option) {
     ...
     */
    public List<String> extractProductStatusCodeList(List<ImmuProductStatus> productStatusList)
     ...
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Integer> extractDisplayOrderList(List<ImmuProductStatus> productStatusList)
     ...
     * <pre>
     * ImmuProductStatus productStatus = <span style="color: #70226C">new</span> ImmuProductStatus();
     ...
     */
    public void insert(ImmuProductStatus productStatus) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuProductStatus productStatus) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuProductStatus productStatus) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuProductStatus productStatus) {
     ...
     */
    public int[] batchInsert(List<ImmuProductStatus> productStatusList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<ImmuProductStatus> productStatusList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<ImmuProductStatus> productStatusList) {
     ...
     * <pre>
     * <span style="color: #0000C0">productStatusBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuProductStatus, ImmuProductStatusCB&gt;() {
     *     public ConditionBean setup(ImmuProductStatus entity, ImmuProductStatusCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuProductStatus, ImmuProductStatusCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuProductStatus productStatus, CBCall<ImmuProductStatusCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuProductStatusCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuProductStatus productStatus, WritableOptionCall<ImmuProductStatusCB, InsertOption<ImmuProductStatusCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuProductStatus productStatus, WritableOptionCall<ImmuProductStatusCB, UpdateOption<ImmuProductStatusCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuProductStatus productStatus, WritableOptionCall<ImmuProductStatusCB, InsertOption<ImmuProductStatusCB>> insertOpLambda, WritableOptionCall<ImmuProductStatusCB, UpdateOption<ImmuProductStatusCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuProductStatus productStatus, WritableOptionCall<ImmuProductStatusCB, DeleteOption<ImmuProductStatusCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuProductStatus> productStatusList, WritableOptionCall<ImmuProductStatusCB, InsertOption<ImmuProductStatusCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuProductStatus> productStatusList, WritableOptionCall<ImmuProductStatusCB, UpdateOption<ImmuProductStatusCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuProductStatus> productStatusList, WritableOptionCall<ImmuProductStatusCB, DeleteOption<ImmuProductStatusCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuProductStatus, ImmuProductStatusCB> manyArgLambda, WritableOptionCall<ImmuProductStatusCB, InsertOption<ImmuProductStatusCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuProductStatus productStatus, CBCall<ImmuProductStatusCB> cbLambda, WritableOptionCall<ImmuProductStatusCB, UpdateOption<ImmuProductStatusCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuProductStatusCB> cbLambda, WritableOptionCall<ImmuProductStatusCB, DeleteOption<ImmuProductStatusCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuProductStatusBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuProductStatus> typeOfSelectedEntity() { return ImmuProductStatus.class; }
    protected Class<ImmuProductStatus> typeOfHandlingEntity() { return ImmuProductStatus.class; }
    protected Class<ImmuProductStatusCB> typeOfHandlingConditionBean() { return ImmuProductStatusCB.class; }
}
