 ...
 */
public abstract class ImmuBsMemberService extends AbstractEntity implements DomainEntity, ImmuEntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsMemberService) {
            ImmuBsMemberService other = (ImmuBsMemberService)obj;
    ...
    @Override
    public ImmuMemberService clone() {
        return (ImmuMemberService)super.clone();
    }
