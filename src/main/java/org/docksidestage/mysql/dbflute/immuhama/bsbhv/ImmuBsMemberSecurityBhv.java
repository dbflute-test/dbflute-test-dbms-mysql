 ...
 */
public abstract class ImmuBsMemberSecurityBhv extends AbstractBehaviorWritable<ImmuMemberSecurity, ImmuMemberSecurityCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuMemberSecurityDbm asDBMeta() { return ImmuMemberSecurityDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuMemberSecurityCB newConditionBean() { return new ImmuMemberSecurityCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberSecurity. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuMemberSecurityCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuMemberSecurity> selectEntity(CBCall<ImmuMemberSecurityCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuMemberSecurity> facadeSelectEntity(ImmuMemberSecurityCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberSecurity> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuMemberSecurityCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuMemberSecurity <span style="color: #553000">memberSecurity</span> = <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuMemberSecurity selectEntityWithDeletedCheck(CBCall<ImmuMemberSecurityCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuMemberSecurity> selectByPK(Integer memberId) {
        return facadeSelectByPK(memberId);
    }

    protected OptionalEntity<ImmuMemberSecurity> facadeSelectByPK(Integer memberId) {
        return doSelectOptionalByPK(memberId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberSecurity> ENTITY doSelectByPK(Integer memberId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends ImmuMemberSecurity> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(memberId, tp), memberId);
    }

    protected ImmuMemberSecurityCB xprepareCBAsPK(Integer memberId) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuMemberSecurity&gt; <span style="color: #553000">memberSecurityList</span> = <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuMemberSecurity <span style="color: #553000">memberSecurity</span> : <span style="color: #553000">memberSecurityList</span>) {
     *     ... = <span style="color: #553000">memberSecurity</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberSecurity. (NotNull)
     ...
     */
    public ListResultBean<ImmuMemberSecurity> selectList(CBCall<ImmuMemberSecurityCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuMemberSecurity&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuMemberSecurity memberSecurity : <span style="color: #553000">page</span>) {
     *     ... = memberSecurity.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberSecurity. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuMemberSecurity> selectPage(CBCall<ImmuMemberSecurityCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberSecurity. (NotNull)
     * @param entityLambda The handler of entity row of ImmuMemberSecurity. (NotNull)
     */
    public void selectCursor(CBCall<ImmuMemberSecurityCB> cbLambda, EntityRowHandler<ImmuMemberSecurity> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuMemberSecurityCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuMemberSecurity> memberSecurityList, ReferrerLoaderHandler<ImmuLoaderOfMemberSecurity> loaderLambda) {
        xassLRArg(memberSecurityList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberSecurity().ready(memberSecurityList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuMemberSecurity memberSecurity, ReferrerLoaderHandler<ImmuLoaderOfMemberSecurity> loaderLambda) {
        xassLRArg(memberSecurity, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberSecurity().ready(xnewLRAryLs(memberSecurity), _behaviorSelector));
    }
     ...
     */
    public List<ImmuMember> pulloutMember(List<ImmuMemberSecurity> memberSecurityList)
     ...
     */
    public List<Integer> extractMemberIdList(List<ImmuMemberSecurity> memberSecurityList)
     ...
     * <pre>
     * ImmuMemberSecurity memberSecurity = <span style="color: #70226C">new</span> ImmuMemberSecurity();
     ...
     */
    public void insert(ImmuMemberSecurity memberSecurity) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuMemberSecurity memberSecurity) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(ImmuMemberSecurity memberSecurity) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuMemberSecurity memberSecurity) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdateNonstrict(ImmuMemberSecurity memberSecurity) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuMemberSecurity memberSecurity) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrict(ImmuMemberSecurity memberSecurity) {
     ...
     */
    public int[] batchInsert(List<ImmuMemberSecurity> memberSecurityList) {
     ...
     */
    public int[] batchUpdate(List<ImmuMemberSecurity> memberSecurityList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<ImmuMemberSecurity> memberSecurityList) {
     ...
     * @throws BatchEntityAlreadyUpdatedException When the entity has already been updated. This exception extends EntityAlreadyUpdatedException.
     */
    public int[] batchDelete(List<ImmuMemberSecurity> memberSecurityList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDeleteNonstrict(List<ImmuMemberSecurity> memberSecurityList) {
     ...
     * <pre>
     * <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuMemberSecurity, ImmuMemberSecurityCB&gt;() {
     *     public ConditionBean setup(ImmuMemberSecurity entity, ImmuMemberSecurityCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuMemberSecurity, ImmuMemberSecurityCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuMemberSecurity memberSecurity, CBCall<ImmuMemberSecurityCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuMemberSecurityCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuMemberSecurity memberSecurity, WritableOptionCall<ImmuMemberSecurityCB, InsertOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuMemberSecurity memberSecurity, WritableOptionCall<ImmuMemberSecurityCB, UpdateOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdateNonstrict(ImmuMemberSecurity memberSecurity, WritableOptionCall<ImmuMemberSecurityCB, UpdateOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuMemberSecurity memberSecurity, WritableOptionCall<ImmuMemberSecurityCB, InsertOption<ImmuMemberSecurityCB>> insertOpLambda, WritableOptionCall<ImmuMemberSecurityCB, UpdateOption<ImmuMemberSecurityCB>> updateOpLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdateNonstrict(ImmuMemberSecurity memberSecurity, WritableOptionCall<ImmuMemberSecurityCB, InsertOption<ImmuMemberSecurityCB>> insertOpLambda, WritableOptionCall<ImmuMemberSecurityCB, UpdateOption<ImmuMemberSecurityCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuMemberSecurity memberSecurity, WritableOptionCall<ImmuMemberSecurityCB, DeleteOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDeleteNonstrict(ImmuMemberSecurity memberSecurity, WritableOptionCall<ImmuMemberSecurityCB, DeleteOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuMemberSecurity> memberSecurityList, WritableOptionCall<ImmuMemberSecurityCB, InsertOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuMemberSecurity> memberSecurityList, WritableOptionCall<ImmuMemberSecurityCB, UpdateOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdateNonstrict(List<ImmuMemberSecurity> memberSecurityList, WritableOptionCall<ImmuMemberSecurityCB, UpdateOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuMemberSecurity> memberSecurityList, WritableOptionCall<ImmuMemberSecurityCB, DeleteOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDeleteNonstrict(List<ImmuMemberSecurity> memberSecurityList, WritableOptionCall<ImmuMemberSecurityCB, DeleteOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuMemberSecurity, ImmuMemberSecurityCB> manyArgLambda, WritableOptionCall<ImmuMemberSecurityCB, InsertOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuMemberSecurity memberSecurity, CBCall<ImmuMemberSecurityCB> cbLambda, WritableOptionCall<ImmuMemberSecurityCB, UpdateOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuMemberSecurityCB> cbLambda, WritableOptionCall<ImmuMemberSecurityCB, DeleteOption<ImmuMemberSecurityCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuMemberSecurityBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuMemberSecurity> typeOfSelectedEntity() { return ImmuMemberSecurity.class; }
    protected Class<ImmuMemberSecurity> typeOfHandlingEntity() { return ImmuMemberSecurity.class; }
    protected Class<ImmuMemberSecurityCB> typeOfHandlingConditionBean() { return ImmuMemberSecurityCB.class; }
}
