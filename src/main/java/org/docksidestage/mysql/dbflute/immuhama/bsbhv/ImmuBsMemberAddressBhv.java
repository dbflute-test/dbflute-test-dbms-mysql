 ...
 */
public abstract class ImmuBsMemberAddressBhv extends AbstractBehaviorWritable<ImmuMemberAddress, ImmuMemberAddressCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuMemberAddressDbm asDBMeta() { return ImmuMemberAddressDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuMemberAddressCB newConditionBean() { return new ImmuMemberAddressCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberAddress. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuMemberAddressCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuMemberAddress> selectEntity(CBCall<ImmuMemberAddressCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuMemberAddress> facadeSelectEntity(ImmuMemberAddressCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberAddress> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuMemberAddressCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuMemberAddress <span style="color: #553000">memberAddress</span> = <span style="color: #0000C0">memberAddressBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuMemberAddress selectEntityWithDeletedCheck(CBCall<ImmuMemberAddressCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuMemberAddress> selectByPK(Integer memberAddressId) {
        return facadeSelectByPK(memberAddressId);
    }

    protected OptionalEntity<ImmuMemberAddress> facadeSelectByPK(Integer memberAddressId) {
        return doSelectOptionalByPK(memberAddressId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberAddress> ENTITY doSelectByPK(Integer memberAddressId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberAddressId), tp);
    }

    protected <ENTITY extends ImmuMemberAddress> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberAddressId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(memberAddressId, tp), memberAddressId);
    }

    protected ImmuMemberAddressCB xprepareCBAsPK(Integer memberAddressId) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuMemberAddress> selectByUniqueOf(Integer memberId, java.time.LocalDate validBeginDate) {
        return facadeSelectByUniqueOf(memberId, validBeginDate);
    }

    protected OptionalEntity<ImmuMemberAddress> facadeSelectByUniqueOf(Integer memberId, java.time.LocalDate validBeginDate) {
        return doSelectByUniqueOf(memberId, validBeginDate, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberAddress> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer memberId, java.time.LocalDate validBeginDate, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(memberId, validBeginDate), tp), memberId, validBeginDate);
    }

    protected ImmuMemberAddressCB xprepareCBAsUniqueOf(Integer memberId, java.time.LocalDate validBeginDate) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuMemberAddress&gt; <span style="color: #553000">memberAddressList</span> = <span style="color: #0000C0">memberAddressBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuMemberAddress <span style="color: #553000">memberAddress</span> : <span style="color: #553000">memberAddressList</span>) {
     *     ... = <span style="color: #553000">memberAddress</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberAddress. (NotNull)
     ...
     */
    public ListResultBean<ImmuMemberAddress> selectList(CBCall<ImmuMemberAddressCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuMemberAddress&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">memberAddressBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuMemberAddress memberAddress : <span style="color: #553000">page</span>) {
     *     ... = memberAddress.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberAddress. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuMemberAddress> selectPage(CBCall<ImmuMemberAddressCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberAddress. (NotNull)
     * @param entityLambda The handler of entity row of ImmuMemberAddress. (NotNull)
     */
    public void selectCursor(CBCall<ImmuMemberAddressCB> cbLambda, EntityRowHandler<ImmuMemberAddress> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuMemberAddressCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuMemberAddress> memberAddressList, ReferrerLoaderHandler<ImmuLoaderOfMemberAddress> loaderLambda) {
        xassLRArg(memberAddressList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberAddress().ready(memberAddressList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuMemberAddress memberAddress, ReferrerLoaderHandler<ImmuLoaderOfMemberAddress> loaderLambda) {
        xassLRArg(memberAddress, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberAddress().ready(xnewLRAryLs(memberAddress), _behaviorSelector));
    }
     ...
     */
    public List<ImmuMember> pulloutMember(List<ImmuMemberAddress> memberAddressList)
    { return helpPulloutInternally(memberAddressList, "member"); }

    /**
     * Pull out the list of foreign table 'ImmuRegion'.
     * @param memberAddressList The list of memberAddress. (NotNull, EmptyAllowed)
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<ImmuRegion> pulloutRegion(List<ImmuMemberAddress> memberAddressList)
     ...
     */
    public List<Integer> extractMemberAddressIdList(List<ImmuMemberAddress> memberAddressList)
     ...
     * <pre>
     * ImmuMemberAddress memberAddress = <span style="color: #70226C">new</span> ImmuMemberAddress();
     ...
     */
    public void insert(ImmuMemberAddress memberAddress) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuMemberAddress memberAddress) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(ImmuMemberAddress memberAddress) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuMemberAddress memberAddress) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdateNonstrict(ImmuMemberAddress memberAddress) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuMemberAddress memberAddress) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrict(ImmuMemberAddress memberAddress) {
     ...
     */
    public int[] batchInsert(List<ImmuMemberAddress> memberAddressList) {
     ...
     */
    public int[] batchUpdate(List<ImmuMemberAddress> memberAddressList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<ImmuMemberAddress> memberAddressList) {
     ...
     * @throws BatchEntityAlreadyUpdatedException When the entity has already been updated. This exception extends EntityAlreadyUpdatedException.
     */
    public int[] batchDelete(List<ImmuMemberAddress> memberAddressList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDeleteNonstrict(List<ImmuMemberAddress> memberAddressList) {
     ...
     * <pre>
     * <span style="color: #0000C0">memberAddressBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuMemberAddress, ImmuMemberAddressCB&gt;() {
     *     public ConditionBean setup(ImmuMemberAddress entity, ImmuMemberAddressCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuMemberAddress, ImmuMemberAddressCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuMemberAddress memberAddress, CBCall<ImmuMemberAddressCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuMemberAddressCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuMemberAddress memberAddress, WritableOptionCall<ImmuMemberAddressCB, InsertOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuMemberAddress memberAddress, WritableOptionCall<ImmuMemberAddressCB, UpdateOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdateNonstrict(ImmuMemberAddress memberAddress, WritableOptionCall<ImmuMemberAddressCB, UpdateOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuMemberAddress memberAddress, WritableOptionCall<ImmuMemberAddressCB, InsertOption<ImmuMemberAddressCB>> insertOpLambda, WritableOptionCall<ImmuMemberAddressCB, UpdateOption<ImmuMemberAddressCB>> updateOpLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdateNonstrict(ImmuMemberAddress memberAddress, WritableOptionCall<ImmuMemberAddressCB, InsertOption<ImmuMemberAddressCB>> insertOpLambda, WritableOptionCall<ImmuMemberAddressCB, UpdateOption<ImmuMemberAddressCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuMemberAddress memberAddress, WritableOptionCall<ImmuMemberAddressCB, DeleteOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDeleteNonstrict(ImmuMemberAddress memberAddress, WritableOptionCall<ImmuMemberAddressCB, DeleteOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuMemberAddress> memberAddressList, WritableOptionCall<ImmuMemberAddressCB, InsertOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuMemberAddress> memberAddressList, WritableOptionCall<ImmuMemberAddressCB, UpdateOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdateNonstrict(List<ImmuMemberAddress> memberAddressList, WritableOptionCall<ImmuMemberAddressCB, UpdateOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuMemberAddress> memberAddressList, WritableOptionCall<ImmuMemberAddressCB, DeleteOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDeleteNonstrict(List<ImmuMemberAddress> memberAddressList, WritableOptionCall<ImmuMemberAddressCB, DeleteOption<ImmuMemberAddressCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuMemberAddress, ImmuMemberAddressCB> manyArgLambda, WritableOptionCall<ImmuMemberAddressCB, InsertOption<ImmuMemberAddressCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuMemberAddress memberAddress, CBCall<ImmuMemberAddressCB> cbLambda, WritableOptionCall<ImmuMemberAddressCB, UpdateOption<ImmuMemberAddressCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuMemberAddressCB> cbLambda, WritableOptionCall<ImmuMemberAddressCB, DeleteOption<ImmuMemberAddressCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuMemberAddressBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuMemberAddress> typeOfSelectedEntity() { return ImmuMemberAddress.class; }
    protected Class<ImmuMemberAddress> typeOfHandlingEntity() { return ImmuMemberAddress.class; }
    protected Class<ImmuMemberAddressCB> typeOfHandlingConditionBean() { return ImmuMemberAddressCB.class; }
}
