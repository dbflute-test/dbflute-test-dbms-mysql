 ...
 */
public abstract class ImmuBsMemberStatus extends AbstractEntity implements DomainEntity {
    ...
    protected List<ImmuMember> _memberList;
     ...
     */
    public List<ImmuMember> getMemberList() {
     ...
     */
    public void setMemberList(List<ImmuMember> memberList) {
    ...
    /**
     * [get] (会員ログイン情報)MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'memberLoginList'.
    ...
    /**
     * [set] (会員ログイン情報)MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'memberLoginList'.
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_memberList != null) { for (ImmuMember et : _memberList)
