 ...
 */
public class ImmuBsMemberAddressCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuMemberAddressCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsMemberAddressCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuMemberAddressCB acceptPK(Integer memberAddressId) {
        assertObjectNotNull("memberAddressId", memberAddressId);
        ImmuBsMemberAddressCB cb = this;
        cb.query().setMemberAddressId_Equal(memberAddressId);
        return (ImmuMemberAddressCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ImmuMemberAddressCB acceptUniqueOf(Integer memberId, java.time.LocalDate validBeginDate) {
     ...
     */
    public ImmuMemberAddressCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuMemberAddressCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuMemberAddressCQ doGetConditionQuery() {
    ...
    protected ImmuMemberAddressCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuMemberAddressCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuMemberAddressCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuMemberAddressCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuMemberAddressCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuMemberAddressCB> unionCBLambda) {
        final ImmuMemberAddressCB cb = new ImmuMemberAddressCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberAddressCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuMemberAddressCB> unionCBLambda) {
        final ImmuMemberAddressCB cb = new ImmuMemberAddressCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberAddressCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuMemberAddressCQ> {
         ...
         */
        public HpSDRFunction<ImmuMemberAddressCB, ImmuMemberAddressCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberAddressCB> sq, ImmuMemberAddressCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuMemberAddressCB dreamCruiseCB() {
        ImmuMemberAddressCB cb = new ImmuMemberAddressCB();
        cb.xsetupForDreamCruise((ImmuMemberAddressCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuMemberAddressCB> columnQuery(final SpecifyQuery<ImmuMemberAddressCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuMemberAddressCB xcreateColumnQueryCB() {
        ImmuMemberAddressCB cb = new ImmuMemberAddressCB();
        cb.xsetupForColumnQuery((ImmuMemberAddressCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuMemberAddressCB> orCBLambda) {
        xorSQ((ImmuMemberAddressCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuMemberAddressCB> andCBLambda) {
        xorSQAP((ImmuMemberAddressCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuMemberAddressCB cb;
        if (mainCB != null) {
            cb = (ImmuMemberAddressCB)mainCB;
        } else {
            cb = new ImmuMemberAddressCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuMemberAddressCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuMemberAddressCQ.class.getName(); }
