...
/**
 * The abstract condition-query of member_profile.
 * @author DBFlute(AutoGenerator)
 */
public abstract class ImmuAbstractBsMemberProfileCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsMemberProfileCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param memberProfileId The value of memberProfileId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberProfileId_Equal(Long memberProfileId) {
        doSetMemberProfileId_Equal(memberProfileId);
    }

    protected void doSetMemberProfileId_Equal(Long memberProfileId) {
        regMemberProfileId(CK_EQ, memberProfileId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberProfileId The value of memberProfileId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberProfileId_NotEqual(Long memberProfileId) {
        doSetMemberProfileId_NotEqual(memberProfileId);
    }

    protected void doSetMemberProfileId_NotEqual(Long memberProfileId) {
        regMemberProfileId(CK_NES, memberProfileId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberProfileId The value of memberProfileId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberProfileId_GreaterThan(Long memberProfileId) {
        regMemberProfileId(CK_GT, memberProfileId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberProfileId The value of memberProfileId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberProfileId_LessThan(Long memberProfileId) {
        regMemberProfileId(CK_LT, memberProfileId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberProfileId The value of memberProfileId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberProfileId_GreaterEqual(Long memberProfileId) {
        regMemberProfileId(CK_GE, memberProfileId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberProfileId The value of memberProfileId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMemberProfileId_LessEqual(Long memberProfileId) {
        regMemberProfileId(CK_LE, memberProfileId);
    }
     ...
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of memberProfileId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of memberProfileId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setMemberProfileId_RangeOf(Long minNumber, Long maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setMemberProfileId_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     */
    protected void setMemberProfileId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueMemberProfileId(), "MEMBER_PROFILE_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberProfileIdList The collection of memberProfileId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setMemberProfileId_InScope(Collection<Long> memberProfileIdList) {
        doSetMemberProfileId_InScope(memberProfileIdList);
    }

    protected void doSetMemberProfileId_InScope(Collection<Long> memberProfileIdList) {
        regINS(CK_INS, cTL(memberProfileIdList), xgetCValueMemberProfileId(), "MEMBER_PROFILE_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param memberProfileIdList The collection of memberProfileId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setMemberProfileId_NotInScope(Collection<Long> memberProfileIdList) {
        doSetMemberProfileId_NotInScope(memberProfileIdList);
    }

    protected void doSetMemberProfileId_NotInScope(Collection<Long> memberProfileIdList) {
        regINS(CK_NINS, cTL(memberProfileIdList), xgetCValueMemberProfileId(), "MEMBER_PROFILE_ID");
    }
     ...
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setMemberProfileId_IsNull() { regMemberProfileId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setMemberProfileId_IsNotNull() { regMemberProfileId(CK_ISNN, DOBJ); }

    protected void regMemberProfileId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueMemberProfileId(), "MEMBER_PROFILE_ID"); }
    protected abstract ConditionValue xgetCValueMemberProfileId();
     ...
     * (会員名称)MEMBER_NAME: {NotNull, VARCHAR(100)} <br>
     ...
     */
    public HpSLCFunction<ImmuMemberProfileCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuMemberProfileCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberProfileCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuMemberProfileCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberProfileCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuMemberProfileCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberProfileCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuMemberProfileCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberProfileCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuMemberProfileCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuMemberProfileCB&gt;() {
     *     public void query(ImmuMemberProfileCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberProfileCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuMemberProfileCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberProfileCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuMemberProfileCQ sq);

    protected ImmuMemberProfileCB xcreateScalarConditionCB() {
        ImmuMemberProfileCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuMemberProfileCB xcreateScalarConditionPartitionByCB() {
        ImmuMemberProfileCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuMemberProfileCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberProfileCB cb = new ImmuMemberProfileCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "MEMBER_PROFILE_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuMemberProfileCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuMemberProfileCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuMemberProfileCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberProfileCB cb = new ImmuMemberProfileCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_PROFILE_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuMemberProfileCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuMemberProfileCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuMemberProfileCB cb = new ImmuMemberProfileCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuMemberProfileCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuMemberProfileCB newMyCB() {
        return new ImmuMemberProfileCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuMemberProfileCQ.class.getName(); }
