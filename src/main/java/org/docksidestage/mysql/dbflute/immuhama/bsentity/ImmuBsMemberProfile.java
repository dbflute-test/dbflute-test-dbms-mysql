...
/**
 * The entity of (会員プロフィール)MEMBER_PROFILE as TABLE. <br>
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long memberProfileId = entity.getMemberProfileId();
 ...
 * entity.setMemberProfileId(memberProfileId);
 ...
 */
public abstract class ImmuBsMemberProfile extends AbstractEntity implements DomainEntity, ImmuEntityDefinedCommonColumn {
    ...
    protected Long _memberProfileId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_memberProfileId == null) { return false; }
        return true;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsMemberProfile) {
            ImmuBsMemberProfile other = (ImmuBsMemberProfile)obj;
            if (!xSV(_memberProfileId, other._memberProfileId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_memberProfileId));
    ...
    @Override
    public ImmuMemberProfile clone() {
        return (ImmuMemberProfile)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * @return The value of the column 'MEMBER_PROFILE_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getMemberProfileId() {
        checkSpecifiedProperty("memberProfileId");
        return _memberProfileId;
    }

    /**
     * [set] (会員プロフィールID)MEMBER_PROFILE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * @param memberProfileId The value of the column 'MEMBER_PROFILE_ID'. (basically NotNull if update: for the constraint)
     */
    public void setMemberProfileId(Long memberProfileId) {
        registerModifiedProperty("memberProfileId");
        _memberProfileId = memberProfileId;
    }
    ...
    /**
     * [get] (会員名称)MEMBER_NAME: {NotNull, VARCHAR(100)} <br>
     * 会員のフルネームの名称。<br>
    ...
    /**
     * [set] (会員名称)MEMBER_NAME: {NotNull, VARCHAR(100)} <br>
     * 会員のフルネームの名称。<br>
     * 苗字と名前を分けて管理することが多いが、ここでは単純にひとまとめ。
    ...
    /**
     * [get] (生年月日)BIRTHDATE: {NotNull, DATE(10)} <br>
    ...
    /**
     * [set] (生年月日)BIRTHDATE: {NotNull, DATE(10)} <br>
