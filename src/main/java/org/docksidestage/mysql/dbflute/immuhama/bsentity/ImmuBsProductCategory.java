 ...
 */
public abstract class ImmuBsProductCategory extends AbstractEntity implements DomainEntity {
    ...
    protected OptionalEntity<ImmuProductCategory> _productCategorySelf;
     ...
     */
    public OptionalEntity<ImmuProductCategory> getProductCategorySelf() {
     ...
     */
    public void setProductCategorySelf(OptionalEntity<ImmuProductCategory> productCategorySelf) {
    ...
    protected List<ImmuProduct> _productList;
     ...
     */
    public List<ImmuProduct> getProductList() {
     ...
     */
    public void setProductList(List<ImmuProduct> productList) {
        _productList = productList;
    }

    /** (商品カテゴリ)PRODUCT_CATEGORY by PARENT_CATEGORY_CODE, named 'productCategorySelfList'. */
    protected List<ImmuProductCategory> _productCategorySelfList;
     ...
     */
    public List<ImmuProductCategory> getProductCategorySelfList() {
     ...
     */
    public void setProductCategorySelfList(List<ImmuProductCategory> productCategorySelfList) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof ImmuBsProductCategory) {
            ImmuBsProductCategory other = (ImmuBsProductCategory)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_productList != null) { for (ImmuProduct et : _productList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "productList")); } } }
        if (_productCategorySelfList != null) { for (ImmuProductCategory et : _productCategorySelfList)
    ...
    @Override
    public ImmuProductCategory clone() {
        return (ImmuProductCategory)super.clone();
    }
