 ...
 */
public abstract class ImmuBsMemberServiceBhv extends AbstractBehaviorWritable<ImmuMemberService, ImmuMemberServiceCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuMemberServiceDbm asDBMeta() { return ImmuMemberServiceDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuMemberServiceCB newConditionBean() { return new ImmuMemberServiceCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberService. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuMemberServiceCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuMemberService> selectEntity(CBCall<ImmuMemberServiceCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuMemberService> facadeSelectEntity(ImmuMemberServiceCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberService> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuMemberServiceCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuMemberService <span style="color: #553000">memberService</span> = <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuMemberService selectEntityWithDeletedCheck(CBCall<ImmuMemberServiceCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuMemberService> selectByPK(Integer memberServiceId) {
        return facadeSelectByPK(memberServiceId);
    }

    protected OptionalEntity<ImmuMemberService> facadeSelectByPK(Integer memberServiceId) {
        return doSelectOptionalByPK(memberServiceId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberService> ENTITY doSelectByPK(Integer memberServiceId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberServiceId), tp);
    }

    protected <ENTITY extends ImmuMemberService> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberServiceId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(memberServiceId, tp), memberServiceId);
    }

    protected ImmuMemberServiceCB xprepareCBAsPK(Integer memberServiceId) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuMemberService> selectByUniqueOf(Integer memberId) {
        return facadeSelectByUniqueOf(memberId);
    }

    protected OptionalEntity<ImmuMemberService> facadeSelectByUniqueOf(Integer memberId) {
        return doSelectByUniqueOf(memberId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberService> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer memberId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(memberId), tp), memberId);
    }

    protected ImmuMemberServiceCB xprepareCBAsUniqueOf(Integer memberId) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuMemberService&gt; <span style="color: #553000">memberServiceList</span> = <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuMemberService <span style="color: #553000">memberService</span> : <span style="color: #553000">memberServiceList</span>) {
     *     ... = <span style="color: #553000">memberService</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberService. (NotNull)
     ...
     */
    public ListResultBean<ImmuMemberService> selectList(CBCall<ImmuMemberServiceCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuMemberService&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuMemberService memberService : <span style="color: #553000">page</span>) {
     *     ... = memberService.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberService. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuMemberService> selectPage(CBCall<ImmuMemberServiceCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberService. (NotNull)
     * @param entityLambda The handler of entity row of ImmuMemberService. (NotNull)
     */
    public void selectCursor(CBCall<ImmuMemberServiceCB> cbLambda, EntityRowHandler<ImmuMemberService> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuMemberServiceCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuMemberService> memberServiceList, ReferrerLoaderHandler<ImmuLoaderOfMemberService> loaderLambda) {
        xassLRArg(memberServiceList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberService().ready(memberServiceList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuMemberService memberService, ReferrerLoaderHandler<ImmuLoaderOfMemberService> loaderLambda) {
        xassLRArg(memberService, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberService().ready(xnewLRAryLs(memberService), _behaviorSelector));
    }
     ...
     */
    public List<ImmuMember> pulloutMember(List<ImmuMemberService> memberServiceList)
     ...
     */
    public List<Integer> extractMemberServiceIdList(List<ImmuMemberService> memberServiceList)
     ...
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Integer> extractMemberIdList(List<ImmuMemberService> memberServiceList)
     ...
     */
    public void insert(ImmuMemberService memberService) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuMemberService memberService) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuMemberService memberService) {
     ...
     */
    public int[] batchInsert(List<ImmuMemberService> memberServiceList) {
     ...
     * <pre>
     * <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuMemberService, ImmuMemberServiceCB&gt;() {
     *     public ConditionBean setup(ImmuMemberService entity, ImmuMemberServiceCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuMemberService, ImmuMemberServiceCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuMemberService memberService, CBCall<ImmuMemberServiceCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuMemberServiceCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuMemberService memberService, WritableOptionCall<ImmuMemberServiceCB, InsertOption<ImmuMemberServiceCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuMemberService memberService, WritableOptionCall<ImmuMemberServiceCB, UpdateOption<ImmuMemberServiceCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuMemberService memberService, WritableOptionCall<ImmuMemberServiceCB, InsertOption<ImmuMemberServiceCB>> insertOpLambda, WritableOptionCall<ImmuMemberServiceCB, UpdateOption<ImmuMemberServiceCB>> updateOpLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuMemberService> memberServiceList, WritableOptionCall<ImmuMemberServiceCB, InsertOption<ImmuMemberServiceCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuMemberService> memberServiceList, WritableOptionCall<ImmuMemberServiceCB, UpdateOption<ImmuMemberServiceCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuMemberService, ImmuMemberServiceCB> manyArgLambda, WritableOptionCall<ImmuMemberServiceCB, InsertOption<ImmuMemberServiceCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuMemberService memberService, CBCall<ImmuMemberServiceCB> cbLambda, WritableOptionCall<ImmuMemberServiceCB, UpdateOption<ImmuMemberServiceCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuMemberServiceCB> cbLambda, WritableOptionCall<ImmuMemberServiceCB, DeleteOption<ImmuMemberServiceCB>> opLambda) {
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuMemberService> typeOfSelectedEntity() { return ImmuMemberService.class; }
    protected Class<ImmuMemberService> typeOfHandlingEntity() { return ImmuMemberService.class; }
    protected Class<ImmuMemberServiceCB> typeOfHandlingConditionBean() { return ImmuMemberServiceCB.class; }
}
