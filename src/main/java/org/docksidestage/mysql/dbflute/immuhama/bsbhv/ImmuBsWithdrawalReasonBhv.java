 ...
 */
public abstract class ImmuBsWithdrawalReasonBhv extends AbstractBehaviorWritable<ImmuWithdrawalReason, ImmuWithdrawalReasonCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuWithdrawalReasonDbm asDBMeta() { return ImmuWithdrawalReasonDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuWithdrawalReasonCB newConditionBean() { return new ImmuWithdrawalReasonCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuWithdrawalReason. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuWithdrawalReasonCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuWithdrawalReason> selectEntity(CBCall<ImmuWithdrawalReasonCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuWithdrawalReason> facadeSelectEntity(ImmuWithdrawalReasonCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuWithdrawalReason> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuWithdrawalReasonCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuWithdrawalReason <span style="color: #553000">withdrawalReason</span> = <span style="color: #0000C0">withdrawalReasonBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuWithdrawalReason selectEntityWithDeletedCheck(CBCall<ImmuWithdrawalReasonCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuWithdrawalReason> selectByPK(ImmuCDef.WithdrawalReason withdrawalReasonCode) {
        return facadeSelectByPK(withdrawalReasonCode);
    }

    protected OptionalEntity<ImmuWithdrawalReason> facadeSelectByPK(ImmuCDef.WithdrawalReason withdrawalReasonCode) {
        return doSelectOptionalByPK(withdrawalReasonCode, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuWithdrawalReason> ENTITY doSelectByPK(ImmuCDef.WithdrawalReason withdrawalReasonCode, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(withdrawalReasonCode), tp);
    }

    protected <ENTITY extends ImmuWithdrawalReason> OptionalEntity<ENTITY> doSelectOptionalByPK(ImmuCDef.WithdrawalReason withdrawalReasonCode, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(withdrawalReasonCode, tp), withdrawalReasonCode);
    }

    protected ImmuWithdrawalReasonCB xprepareCBAsPK(ImmuCDef.WithdrawalReason withdrawalReasonCode) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuWithdrawalReason> selectByUniqueOf(Integer displayOrder) {
        return facadeSelectByUniqueOf(displayOrder);
    }

    protected OptionalEntity<ImmuWithdrawalReason> facadeSelectByUniqueOf(Integer displayOrder) {
        return doSelectByUniqueOf(displayOrder, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuWithdrawalReason> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer displayOrder, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(displayOrder), tp), displayOrder);
    }

    protected ImmuWithdrawalReasonCB xprepareCBAsUniqueOf(Integer displayOrder) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuWithdrawalReason&gt; <span style="color: #553000">withdrawalReasonList</span> = <span style="color: #0000C0">withdrawalReasonBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuWithdrawalReason <span style="color: #553000">withdrawalReason</span> : <span style="color: #553000">withdrawalReasonList</span>) {
     *     ... = <span style="color: #553000">withdrawalReason</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuWithdrawalReason. (NotNull)
     ...
     */
    public ListResultBean<ImmuWithdrawalReason> selectList(CBCall<ImmuWithdrawalReasonCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuWithdrawalReason&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">withdrawalReasonBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuWithdrawalReason withdrawalReason : <span style="color: #553000">page</span>) {
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuWithdrawalReason> selectPage(CBCall<ImmuWithdrawalReasonCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuWithdrawalReason. (NotNull)
     * @param entityLambda The handler of entity row of ImmuWithdrawalReason. (NotNull)
     */
    public void selectCursor(CBCall<ImmuWithdrawalReasonCB> cbLambda, EntityRowHandler<ImmuWithdrawalReason> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuWithdrawalReasonCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuWithdrawalReason> withdrawalReasonList, ReferrerLoaderHandler<ImmuLoaderOfWithdrawalReason> loaderLambda) {
        xassLRArg(withdrawalReasonList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfWithdrawalReason().ready(withdrawalReasonList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuWithdrawalReason withdrawalReason, ReferrerLoaderHandler<ImmuLoaderOfWithdrawalReason> loaderLambda) {
        xassLRArg(withdrawalReason, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfWithdrawalReason().ready(xnewLRAryLs(withdrawalReason), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (ImmuWithdrawalReason withdrawalReason : <span style="color: #553000">withdrawalReasonList</span>) {
     ...
     */
    public NestedReferrerListGateway<ImmuMemberWithdrawal> loadMemberWithdrawal(List<ImmuWithdrawalReason> withdrawalReasonList, ReferrerConditionSetupper<ImmuMemberWithdrawalCB> refCBLambda) {
        xassLRArg(withdrawalReasonList, refCBLambda);
        return doLoadMemberWithdrawal(withdrawalReasonList, new LoadReferrerOption<ImmuMemberWithdrawalCB, ImmuMemberWithdrawal>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ImmuMemberWithdrawal> loadMemberWithdrawal(ImmuWithdrawalReason withdrawalReason, ReferrerConditionSetupper<ImmuMemberWithdrawalCB> refCBLambda) {
        xassLRArg(withdrawalReason, refCBLambda);
        return doLoadMemberWithdrawal(xnewLRLs(withdrawalReason), new LoadReferrerOption<ImmuMemberWithdrawalCB, ImmuMemberWithdrawal>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<ImmuMemberWithdrawal> doLoadMemberWithdrawal(List<ImmuWithdrawalReason> withdrawalReasonList, LoadReferrerOption<ImmuMemberWithdrawalCB, ImmuMemberWithdrawal> option) {
     ...
     */
    public List<String> extractWithdrawalReasonCodeList(List<ImmuWithdrawalReason> withdrawalReasonList)
     ...
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Integer> extractDisplayOrderList(List<ImmuWithdrawalReason> withdrawalReasonList)
     ...
     * <pre>
     * ImmuWithdrawalReason withdrawalReason = <span style="color: #70226C">new</span> ImmuWithdrawalReason();
     ...
     */
    public void insert(ImmuWithdrawalReason withdrawalReason) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuWithdrawalReason withdrawalReason) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuWithdrawalReason withdrawalReason) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuWithdrawalReason withdrawalReason) {
     ...
     */
    public int[] batchInsert(List<ImmuWithdrawalReason> withdrawalReasonList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<ImmuWithdrawalReason> withdrawalReasonList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<ImmuWithdrawalReason> withdrawalReasonList) {
     ...
     * <pre>
     * <span style="color: #0000C0">withdrawalReasonBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuWithdrawalReason, ImmuWithdrawalReasonCB&gt;() {
     *     public ConditionBean setup(ImmuWithdrawalReason entity, ImmuWithdrawalReasonCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuWithdrawalReason, ImmuWithdrawalReasonCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuWithdrawalReason withdrawalReason, CBCall<ImmuWithdrawalReasonCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuWithdrawalReasonCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuWithdrawalReason withdrawalReason, WritableOptionCall<ImmuWithdrawalReasonCB, InsertOption<ImmuWithdrawalReasonCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuWithdrawalReason withdrawalReason, WritableOptionCall<ImmuWithdrawalReasonCB, UpdateOption<ImmuWithdrawalReasonCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuWithdrawalReason withdrawalReason, WritableOptionCall<ImmuWithdrawalReasonCB, InsertOption<ImmuWithdrawalReasonCB>> insertOpLambda, WritableOptionCall<ImmuWithdrawalReasonCB, UpdateOption<ImmuWithdrawalReasonCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuWithdrawalReason withdrawalReason, WritableOptionCall<ImmuWithdrawalReasonCB, DeleteOption<ImmuWithdrawalReasonCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuWithdrawalReason> withdrawalReasonList, WritableOptionCall<ImmuWithdrawalReasonCB, InsertOption<ImmuWithdrawalReasonCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuWithdrawalReason> withdrawalReasonList, WritableOptionCall<ImmuWithdrawalReasonCB, UpdateOption<ImmuWithdrawalReasonCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuWithdrawalReason> withdrawalReasonList, WritableOptionCall<ImmuWithdrawalReasonCB, DeleteOption<ImmuWithdrawalReasonCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuWithdrawalReason, ImmuWithdrawalReasonCB> manyArgLambda, WritableOptionCall<ImmuWithdrawalReasonCB, InsertOption<ImmuWithdrawalReasonCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuWithdrawalReason withdrawalReason, CBCall<ImmuWithdrawalReasonCB> cbLambda, WritableOptionCall<ImmuWithdrawalReasonCB, UpdateOption<ImmuWithdrawalReasonCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuWithdrawalReasonCB> cbLambda, WritableOptionCall<ImmuWithdrawalReasonCB, DeleteOption<ImmuWithdrawalReasonCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuWithdrawalReasonBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuWithdrawalReason> typeOfSelectedEntity() { return ImmuWithdrawalReason.class; }
    protected Class<ImmuWithdrawalReason> typeOfHandlingEntity() { return ImmuWithdrawalReason.class; }
    protected Class<ImmuWithdrawalReasonCB> typeOfHandlingConditionBean() { return ImmuWithdrawalReasonCB.class; }
}
