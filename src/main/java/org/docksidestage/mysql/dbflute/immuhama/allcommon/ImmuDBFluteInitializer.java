 ...
 */
public class ImmuDBFluteInitializer {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(ImmuDBFluteInitializer.class);
    ...
    protected void standBy() {
        if (!ImmuDBFluteConfig.getInstance().isLocked()) {
            ImmuDBFluteConfig.getInstance().lock();
        }
