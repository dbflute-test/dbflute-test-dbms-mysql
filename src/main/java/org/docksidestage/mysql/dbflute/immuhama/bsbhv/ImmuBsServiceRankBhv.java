 ...
 */
public abstract class ImmuBsServiceRankBhv extends AbstractBehaviorWritable<ImmuServiceRank, ImmuServiceRankCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuServiceRankDbm asDBMeta() { return ImmuServiceRankDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuServiceRankCB newConditionBean() { return new ImmuServiceRankCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuServiceRank. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuServiceRankCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuServiceRank> selectEntity(CBCall<ImmuServiceRankCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuServiceRank> facadeSelectEntity(ImmuServiceRankCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuServiceRank> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuServiceRankCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuServiceRank <span style="color: #553000">serviceRank</span> = <span style="color: #0000C0">serviceRankBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuServiceRank selectEntityWithDeletedCheck(CBCall<ImmuServiceRankCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuServiceRank> selectByPK(String serviceRankCode) {
        return facadeSelectByPK(serviceRankCode);
    }

    protected OptionalEntity<ImmuServiceRank> facadeSelectByPK(String serviceRankCode) {
        return doSelectOptionalByPK(serviceRankCode, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuServiceRank> ENTITY doSelectByPK(String serviceRankCode, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(serviceRankCode), tp);
    }

    protected <ENTITY extends ImmuServiceRank> OptionalEntity<ENTITY> doSelectOptionalByPK(String serviceRankCode, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(serviceRankCode, tp), serviceRankCode);
    }

    protected ImmuServiceRankCB xprepareCBAsPK(String serviceRankCode) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuServiceRank> selectByUniqueOf(Integer displayOrder) {
        return facadeSelectByUniqueOf(displayOrder);
    }

    protected OptionalEntity<ImmuServiceRank> facadeSelectByUniqueOf(Integer displayOrder) {
        return doSelectByUniqueOf(displayOrder, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuServiceRank> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer displayOrder, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(displayOrder), tp), displayOrder);
    }

    protected ImmuServiceRankCB xprepareCBAsUniqueOf(Integer displayOrder) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuServiceRank&gt; <span style="color: #553000">serviceRankList</span> = <span style="color: #0000C0">serviceRankBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuServiceRank <span style="color: #553000">serviceRank</span> : <span style="color: #553000">serviceRankList</span>) {
     *     ... = <span style="color: #553000">serviceRank</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuServiceRank. (NotNull)
     ...
     */
    public ListResultBean<ImmuServiceRank> selectList(CBCall<ImmuServiceRankCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuServiceRank&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">serviceRankBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuServiceRank serviceRank : <span style="color: #553000">page</span>) {
     *     ... = serviceRank.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuServiceRank. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuServiceRank> selectPage(CBCall<ImmuServiceRankCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuServiceRank. (NotNull)
     * @param entityLambda The handler of entity row of ImmuServiceRank. (NotNull)
     */
    public void selectCursor(CBCall<ImmuServiceRankCB> cbLambda, EntityRowHandler<ImmuServiceRank> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuServiceRankCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuServiceRank> serviceRankList, ReferrerLoaderHandler<ImmuLoaderOfServiceRank> loaderLambda) {
        xassLRArg(serviceRankList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfServiceRank().ready(serviceRankList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuServiceRank serviceRank, ReferrerLoaderHandler<ImmuLoaderOfServiceRank> loaderLambda) {
        xassLRArg(serviceRank, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfServiceRank().ready(xnewLRAryLs(serviceRank), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (ImmuServiceRank serviceRank : <span style="color: #553000">serviceRankList</span>) {
     ...
     */
    public NestedReferrerListGateway<ImmuMemberService> loadMemberService(List<ImmuServiceRank> serviceRankList, ReferrerConditionSetupper<ImmuMemberServiceCB> refCBLambda) {
        xassLRArg(serviceRankList, refCBLambda);
        return doLoadMemberService(serviceRankList, new LoadReferrerOption<ImmuMemberServiceCB, ImmuMemberService>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ImmuMemberService> loadMemberService(ImmuServiceRank serviceRank, ReferrerConditionSetupper<ImmuMemberServiceCB> refCBLambda) {
        xassLRArg(serviceRank, refCBLambda);
        return doLoadMemberService(xnewLRLs(serviceRank), new LoadReferrerOption<ImmuMemberServiceCB, ImmuMemberService>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<ImmuMemberService> doLoadMemberService(List<ImmuServiceRank> serviceRankList, LoadReferrerOption<ImmuMemberServiceCB, ImmuMemberService> option) {
     ...
     */
    public List<String> extractServiceRankCodeList(List<ImmuServiceRank> serviceRankList)
     ...
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Integer> extractDisplayOrderList(List<ImmuServiceRank> serviceRankList)
     ...
     * <pre>
     * ImmuServiceRank serviceRank = <span style="color: #70226C">new</span> ImmuServiceRank();
     ...
     */
    public void insert(ImmuServiceRank serviceRank) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuServiceRank serviceRank) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuServiceRank serviceRank) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuServiceRank serviceRank) {
     ...
     */
    public int[] batchInsert(List<ImmuServiceRank> serviceRankList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<ImmuServiceRank> serviceRankList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<ImmuServiceRank> serviceRankList) {
     ...
     * <pre>
     * <span style="color: #0000C0">serviceRankBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuServiceRank, ImmuServiceRankCB&gt;() {
     *     public ConditionBean setup(ImmuServiceRank entity, ImmuServiceRankCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuServiceRank, ImmuServiceRankCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuServiceRank serviceRank, CBCall<ImmuServiceRankCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuServiceRankCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuServiceRank serviceRank, WritableOptionCall<ImmuServiceRankCB, InsertOption<ImmuServiceRankCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuServiceRank serviceRank, WritableOptionCall<ImmuServiceRankCB, UpdateOption<ImmuServiceRankCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuServiceRank serviceRank, WritableOptionCall<ImmuServiceRankCB, InsertOption<ImmuServiceRankCB>> insertOpLambda, WritableOptionCall<ImmuServiceRankCB, UpdateOption<ImmuServiceRankCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuServiceRank serviceRank, WritableOptionCall<ImmuServiceRankCB, DeleteOption<ImmuServiceRankCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuServiceRank> serviceRankList, WritableOptionCall<ImmuServiceRankCB, InsertOption<ImmuServiceRankCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuServiceRank> serviceRankList, WritableOptionCall<ImmuServiceRankCB, UpdateOption<ImmuServiceRankCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuServiceRank> serviceRankList, WritableOptionCall<ImmuServiceRankCB, DeleteOption<ImmuServiceRankCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuServiceRank, ImmuServiceRankCB> manyArgLambda, WritableOptionCall<ImmuServiceRankCB, InsertOption<ImmuServiceRankCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuServiceRank serviceRank, CBCall<ImmuServiceRankCB> cbLambda, WritableOptionCall<ImmuServiceRankCB, UpdateOption<ImmuServiceRankCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuServiceRankCB> cbLambda, WritableOptionCall<ImmuServiceRankCB, DeleteOption<ImmuServiceRankCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuServiceRankBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuServiceRank> typeOfSelectedEntity() { return ImmuServiceRank.class; }
    protected Class<ImmuServiceRank> typeOfHandlingEntity() { return ImmuServiceRank.class; }
    protected Class<ImmuServiceRankCB> typeOfHandlingConditionBean() { return ImmuServiceRankCB.class; }
}
