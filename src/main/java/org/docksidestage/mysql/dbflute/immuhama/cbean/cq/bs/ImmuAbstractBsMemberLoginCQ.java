 ...
 */
public abstract class ImmuAbstractBsMemberLoginCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsMemberLoginCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void setMobileLoginFlg_Equal_AsFlg(ImmuCDef.Flg cdef) {
    ...
    public void setMobileLoginFlg_Equal_True() {
        setMobileLoginFlg_Equal_AsFlg(ImmuCDef.Flg.True);
    }
    ...
    public void setMobileLoginFlg_Equal_False() {
        setMobileLoginFlg_Equal_AsFlg(ImmuCDef.Flg.False);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setMobileLoginFlg_NotEqual_AsFlg(ImmuCDef.Flg cdef) {
    ...
    public void setMobileLoginFlg_NotEqual_True() {
        setMobileLoginFlg_NotEqual_AsFlg(ImmuCDef.Flg.True);
    }
    ...
    public void setMobileLoginFlg_NotEqual_False() {
        setMobileLoginFlg_NotEqual_AsFlg(ImmuCDef.Flg.False);
    }
     ...
     */
    public void setMobileLoginFlg_InScope_AsFlg(Collection<ImmuCDef.Flg> cdefList) {
     ...
     * @param cdefList The list of classification definition (as ENUM type). (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setMobileLoginFlg_NotInScope_AsFlg(Collection<ImmuCDef.Flg> cdefList) {
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setLoginMemberStatusCode_Equal_AsMemberStatus(ImmuCDef.MemberStatus cdef) {
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setLoginMemberStatusCode_NotEqual_AsMemberStatus(ImmuCDef.MemberStatus cdef) {
     ...
     * @param cdefList The list of classification definition (as ENUM type). (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setLoginMemberStatusCode_InScope_AsMemberStatus(Collection<ImmuCDef.MemberStatus> cdefList) {
     ...
     * @param cdefList The list of classification definition (as ENUM type). (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setLoginMemberStatusCode_NotInScope_AsMemberStatus(Collection<ImmuCDef.MemberStatus> cdefList) {
     ...
     */
    public HpSLCFunction<ImmuMemberLoginCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuMemberLoginCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuMemberLoginCB&gt;() {
     *     public void query(ImmuMemberLoginCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuMemberLoginCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuMemberLoginCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberLoginCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuMemberLoginCQ sq);

    protected ImmuMemberLoginCB xcreateScalarConditionCB() {
        ImmuMemberLoginCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuMemberLoginCB xcreateScalarConditionPartitionByCB() {
        ImmuMemberLoginCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuMemberLoginCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(ImmuMemberLoginCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuMemberLoginCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuMemberLoginCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberLoginCB cb = new ImmuMemberLoginCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_LOGIN_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuMemberLoginCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuMemberLoginCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuMemberLoginCB cb = new ImmuMemberLoginCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuMemberLoginCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuMemberLoginCB newMyCB() {
        return new ImmuMemberLoginCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuMemberLoginCQ.class.getName(); }
