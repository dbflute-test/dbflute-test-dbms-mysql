 ...
 */
public abstract class ImmuBsPurchaseBhv extends AbstractBehaviorWritable<ImmuPurchase, ImmuPurchaseCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuPurchaseDbm asDBMeta() { return ImmuPurchaseDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuPurchaseCB newConditionBean() { return new ImmuPurchaseCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuPurchase. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuPurchaseCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuPurchase> selectEntity(CBCall<ImmuPurchaseCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuPurchase> facadeSelectEntity(ImmuPurchaseCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuPurchase> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuPurchaseCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuPurchase <span style="color: #553000">purchase</span> = <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuPurchase selectEntityWithDeletedCheck(CBCall<ImmuPurchaseCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuPurchase> selectByPK(Long purchaseId) {
        return facadeSelectByPK(purchaseId);
    }

    protected OptionalEntity<ImmuPurchase> facadeSelectByPK(Long purchaseId) {
        return doSelectOptionalByPK(purchaseId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuPurchase> ENTITY doSelectByPK(Long purchaseId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(purchaseId), tp);
    }

    protected <ENTITY extends ImmuPurchase> OptionalEntity<ENTITY> doSelectOptionalByPK(Long purchaseId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(purchaseId, tp), purchaseId);
    }

    protected ImmuPurchaseCB xprepareCBAsPK(Long purchaseId) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuPurchase&gt; <span style="color: #553000">purchaseList</span> = <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuPurchase <span style="color: #553000">purchase</span> : <span style="color: #553000">purchaseList</span>) {
     *     ... = <span style="color: #553000">purchase</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuPurchase. (NotNull)
     ...
     */
    public ListResultBean<ImmuPurchase> selectList(CBCall<ImmuPurchaseCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuPurchase&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuPurchase purchase : <span style="color: #553000">page</span>) {
     *     ... = purchase.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuPurchase. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuPurchase> selectPage(CBCall<ImmuPurchaseCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuPurchase. (NotNull)
     * @param entityLambda The handler of entity row of ImmuPurchase. (NotNull)
     */
    public void selectCursor(CBCall<ImmuPurchaseCB> cbLambda, EntityRowHandler<ImmuPurchase> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuPurchaseCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuPurchase> purchaseList, ReferrerLoaderHandler<ImmuLoaderOfPurchase> loaderLambda) {
        xassLRArg(purchaseList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfPurchase().ready(purchaseList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuPurchase purchase, ReferrerLoaderHandler<ImmuLoaderOfPurchase> loaderLambda) {
        xassLRArg(purchase, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfPurchase().ready(xnewLRAryLs(purchase), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (ImmuPurchase purchase : <span style="color: #553000">purchaseList</span>) {
     ...
     */
    public NestedReferrerListGateway<ImmuPurchasePayment> loadPurchasePayment(List<ImmuPurchase> purchaseList, ReferrerConditionSetupper<ImmuPurchasePaymentCB> refCBLambda) {
        xassLRArg(purchaseList, refCBLambda);
        return doLoadPurchasePayment(purchaseList, new LoadReferrerOption<ImmuPurchasePaymentCB, ImmuPurchasePayment>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ImmuPurchasePayment> loadPurchasePayment(ImmuPurchase purchase, ReferrerConditionSetupper<ImmuPurchasePaymentCB> refCBLambda) {
        xassLRArg(purchase, refCBLambda);
        return doLoadPurchasePayment(xnewLRLs(purchase), new LoadReferrerOption<ImmuPurchasePaymentCB, ImmuPurchasePayment>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<ImmuPurchasePayment> doLoadPurchasePayment(List<ImmuPurchase> purchaseList, LoadReferrerOption<ImmuPurchasePaymentCB, ImmuPurchasePayment> option) {
     ...
     */
    public List<ImmuMember> pulloutMember(List<ImmuPurchase> purchaseList)
     ...
     */
    public List<Long> extractPurchaseIdList(List<ImmuPurchase> purchaseList)
     ...
     */
    public void insert(ImmuPurchase purchase) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuPurchase purchase) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuPurchase purchase) {
     ...
     */
    public int[] batchInsert(List<ImmuPurchase> purchaseList) {
     ...
     * <pre>
     * <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuPurchase, ImmuPurchaseCB&gt;() {
     *     public ConditionBean setup(ImmuPurchase entity, ImmuPurchaseCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuPurchase, ImmuPurchaseCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuPurchase purchase, CBCall<ImmuPurchaseCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuPurchaseCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuPurchase purchase, WritableOptionCall<ImmuPurchaseCB, InsertOption<ImmuPurchaseCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuPurchase purchase, WritableOptionCall<ImmuPurchaseCB, UpdateOption<ImmuPurchaseCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuPurchase purchase, WritableOptionCall<ImmuPurchaseCB, InsertOption<ImmuPurchaseCB>> insertOpLambda, WritableOptionCall<ImmuPurchaseCB, UpdateOption<ImmuPurchaseCB>> updateOpLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuPurchase> purchaseList, WritableOptionCall<ImmuPurchaseCB, InsertOption<ImmuPurchaseCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuPurchase> purchaseList, WritableOptionCall<ImmuPurchaseCB, UpdateOption<ImmuPurchaseCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuPurchase, ImmuPurchaseCB> manyArgLambda, WritableOptionCall<ImmuPurchaseCB, InsertOption<ImmuPurchaseCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuPurchase purchase, CBCall<ImmuPurchaseCB> cbLambda, WritableOptionCall<ImmuPurchaseCB, UpdateOption<ImmuPurchaseCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuPurchaseCB> cbLambda, WritableOptionCall<ImmuPurchaseCB, DeleteOption<ImmuPurchaseCB>> opLambda) {
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuPurchase> typeOfSelectedEntity() { return ImmuPurchase.class; }
    protected Class<ImmuPurchase> typeOfHandlingEntity() { return ImmuPurchase.class; }
    protected Class<ImmuPurchaseCB> typeOfHandlingConditionBean() { return ImmuPurchaseCB.class; }
}
