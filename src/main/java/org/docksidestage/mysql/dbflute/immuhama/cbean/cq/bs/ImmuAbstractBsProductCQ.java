 ...
 */
public abstract class ImmuAbstractBsProductCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsProductCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public abstract String keepProductId_ExistsReferrer_PurchaseList(ImmuPurchaseCQ sq);
    ...
    public abstract String keepProductId_NotExistsReferrer_PurchaseList(ImmuPurchaseCQ sq);
    ...
    public abstract String keepProductId_SpecifyDerivedReferrer_PurchaseList(ImmuPurchaseCQ sq);
    ...
    public abstract String keepProductId_QueryDerivedReferrer_PurchaseList(ImmuPurchaseCQ sq);
     ...
     */
    public HpSLCFunction<ImmuProductCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuProductCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuProductCB&gt;() {
     *     public void query(ImmuProductCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuProductCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuProductCQ sq);

    protected ImmuProductCB xcreateScalarConditionCB() {
        ImmuProductCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuProductCB xcreateScalarConditionPartitionByCB() {
        ImmuProductCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuProductCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(ImmuProductCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuProductCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuProductCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductCB cb = new ImmuProductCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuProductCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuProductCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductCB cb = new ImmuProductCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuProductCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuProductCB newMyCB() {
        return new ImmuProductCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuProductCQ.class.getName(); }
