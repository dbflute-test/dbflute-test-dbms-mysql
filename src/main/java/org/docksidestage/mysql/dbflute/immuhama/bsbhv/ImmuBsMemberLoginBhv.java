 ...
 */
public abstract class ImmuBsMemberLoginBhv extends AbstractBehaviorWritable<ImmuMemberLogin, ImmuMemberLoginCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public ImmuMemberLoginDbm asDBMeta() { return ImmuMemberLoginDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public ImmuMemberLoginCB newConditionBean() { return new ImmuMemberLoginCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberLogin. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<ImmuMemberLoginCB> cbLambda) {
     ...
     */
    public OptionalEntity<ImmuMemberLogin> selectEntity(CBCall<ImmuMemberLoginCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<ImmuMemberLogin> facadeSelectEntity(ImmuMemberLoginCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberLogin> OptionalEntity<ENTITY> doSelectOptionalEntity(ImmuMemberLoginCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ImmuMemberLogin <span style="color: #553000">memberLogin</span> = <span style="color: #0000C0">memberLoginBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public ImmuMemberLogin selectEntityWithDeletedCheck(CBCall<ImmuMemberLoginCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuMemberLogin> selectByPK(Long memberLoginId) {
        return facadeSelectByPK(memberLoginId);
    }

    protected OptionalEntity<ImmuMemberLogin> facadeSelectByPK(Long memberLoginId) {
        return doSelectOptionalByPK(memberLoginId, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberLogin> ENTITY doSelectByPK(Long memberLoginId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberLoginId), tp);
    }

    protected <ENTITY extends ImmuMemberLogin> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberLoginId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(memberLoginId, tp), memberLoginId);
    }

    protected ImmuMemberLoginCB xprepareCBAsPK(Long memberLoginId) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<ImmuMemberLogin> selectByUniqueOf(Integer memberId, java.time.LocalDateTime loginDatetime) {
        return facadeSelectByUniqueOf(memberId, loginDatetime);
    }

    protected OptionalEntity<ImmuMemberLogin> facadeSelectByUniqueOf(Integer memberId, java.time.LocalDateTime loginDatetime) {
        return doSelectByUniqueOf(memberId, loginDatetime, typeOfSelectedEntity());
    }

    protected <ENTITY extends ImmuMemberLogin> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer memberId, java.time.LocalDateTime loginDatetime, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(memberId, loginDatetime), tp), memberId, loginDatetime);
    }

    protected ImmuMemberLoginCB xprepareCBAsUniqueOf(Integer memberId, java.time.LocalDateTime loginDatetime) {
     ...
     * <pre>
     * ListResultBean&lt;ImmuMemberLogin&gt; <span style="color: #553000">memberLoginList</span> = <span style="color: #0000C0">memberLoginBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (ImmuMemberLogin <span style="color: #553000">memberLogin</span> : <span style="color: #553000">memberLoginList</span>) {
     *     ... = <span style="color: #553000">memberLogin</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberLogin. (NotNull)
     ...
     */
    public ListResultBean<ImmuMemberLogin> selectList(CBCall<ImmuMemberLoginCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;ImmuMemberLogin&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">memberLoginBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (ImmuMemberLogin memberLogin : <span style="color: #553000">page</span>) {
     *     ... = memberLogin.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberLogin. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<ImmuMemberLogin> selectPage(CBCall<ImmuMemberLoginCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of ImmuMemberLogin. (NotNull)
     * @param entityLambda The handler of entity row of ImmuMemberLogin. (NotNull)
     */
    public void selectCursor(CBCall<ImmuMemberLoginCB> cbLambda, EntityRowHandler<ImmuMemberLogin> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<ImmuMemberLoginCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<ImmuMemberLogin> memberLoginList, ReferrerLoaderHandler<ImmuLoaderOfMemberLogin> loaderLambda) {
        xassLRArg(memberLoginList, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberLogin().ready(memberLoginList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(ImmuMemberLogin memberLogin, ReferrerLoaderHandler<ImmuLoaderOfMemberLogin> loaderLambda) {
        xassLRArg(memberLogin, loaderLambda);
        loaderLambda.handle(new ImmuLoaderOfMemberLogin().ready(xnewLRAryLs(memberLogin), _behaviorSelector));
    }
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<ImmuMember> pulloutMember(List<ImmuMemberLogin> memberLoginList)
     ...
     */
    public List<Long> extractMemberLoginIdList(List<ImmuMemberLogin> memberLoginList)
     ...
     * <pre>
     * ImmuMemberLogin memberLogin = <span style="color: #70226C">new</span> ImmuMemberLogin();
     ...
     */
    public void insert(ImmuMemberLogin memberLogin) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(ImmuMemberLogin memberLogin) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(ImmuMemberLogin memberLogin) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(ImmuMemberLogin memberLogin) {
     ...
     */
    public int[] batchInsert(List<ImmuMemberLogin> memberLoginList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<ImmuMemberLogin> memberLoginList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<ImmuMemberLogin> memberLoginList) {
     ...
     * <pre>
     * <span style="color: #0000C0">memberLoginBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ImmuMemberLogin, ImmuMemberLoginCB&gt;() {
     *     public ConditionBean setup(ImmuMemberLogin entity, ImmuMemberLoginCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<ImmuMemberLogin, ImmuMemberLoginCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(ImmuMemberLogin memberLogin, CBCall<ImmuMemberLoginCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<ImmuMemberLoginCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ImmuMemberLogin memberLogin, WritableOptionCall<ImmuMemberLoginCB, InsertOption<ImmuMemberLoginCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ImmuMemberLogin memberLogin, WritableOptionCall<ImmuMemberLoginCB, UpdateOption<ImmuMemberLoginCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ImmuMemberLogin memberLogin, WritableOptionCall<ImmuMemberLoginCB, InsertOption<ImmuMemberLoginCB>> insertOpLambda, WritableOptionCall<ImmuMemberLoginCB, UpdateOption<ImmuMemberLoginCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ImmuMemberLogin memberLogin, WritableOptionCall<ImmuMemberLoginCB, DeleteOption<ImmuMemberLoginCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ImmuMemberLogin> memberLoginList, WritableOptionCall<ImmuMemberLoginCB, InsertOption<ImmuMemberLoginCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ImmuMemberLogin> memberLoginList, WritableOptionCall<ImmuMemberLoginCB, UpdateOption<ImmuMemberLoginCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ImmuMemberLogin> memberLoginList, WritableOptionCall<ImmuMemberLoginCB, DeleteOption<ImmuMemberLoginCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ImmuMemberLogin, ImmuMemberLoginCB> manyArgLambda, WritableOptionCall<ImmuMemberLoginCB, InsertOption<ImmuMemberLoginCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(ImmuMemberLogin memberLogin, CBCall<ImmuMemberLoginCB> cbLambda, WritableOptionCall<ImmuMemberLoginCB, UpdateOption<ImmuMemberLoginCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<ImmuMemberLoginCB> cbLambda, WritableOptionCall<ImmuMemberLoginCB, DeleteOption<ImmuMemberLoginCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<ImmuMemberLoginBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends ImmuMemberLogin> typeOfSelectedEntity() { return ImmuMemberLogin.class; }
    protected Class<ImmuMemberLogin> typeOfHandlingEntity() { return ImmuMemberLogin.class; }
    protected Class<ImmuMemberLoginCB> typeOfHandlingConditionBean() { return ImmuMemberLoginCB.class; }
}
