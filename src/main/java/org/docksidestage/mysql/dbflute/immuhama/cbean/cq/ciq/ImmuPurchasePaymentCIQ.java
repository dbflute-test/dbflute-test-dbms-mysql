 ...
 */
public class ImmuPurchasePaymentCIQ extends ImmuAbstractBsPurchasePaymentCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuBsPurchasePaymentCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuPurchasePaymentCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, ImmuBsPurchasePaymentCQ myCQ) {
    ...
    public String keepScalarCondition(ImmuPurchasePaymentCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ImmuPurchasePaymentCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ImmuPurchasePaymentCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ImmuPurchasePaymentCQ sq)
    ...
    protected String xinCB() { return ImmuPurchasePaymentCB.class.getName(); }
    protected String xinCQ() { return ImmuPurchasePaymentCQ.class.getName(); }
}
