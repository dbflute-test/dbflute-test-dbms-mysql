...
/**
 * The abstract condition-query of product_detail.
 * @author DBFlute(AutoGenerator)
 */
public abstract class ImmuAbstractBsProductDetailCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsProductDetailCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * {exists (select PRODUCT_DETAIL_ID from purchase where ...)} <br>
     * (購入)purchase by PRODUCT_DETAIL_ID, named 'purchaseAsOne'.
     * <pre>
    ...
    public void existsPurchase(SubQuery<ImmuPurchaseCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductDetailId_ExistsReferrer_PurchaseList(cb.query());
        registerExistsReferrer(cb.query(), "PRODUCT_DETAIL_ID", "PRODUCT_DETAIL_ID", pp, "purchaseList");
    }
    public abstract String keepProductDetailId_ExistsReferrer_PurchaseList(ImmuPurchaseCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select PRODUCT_DETAIL_ID from purchase where ...)} <br>
     * (購入)purchase by PRODUCT_DETAIL_ID, named 'purchaseAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of ProductDetailId_NotExistsReferrer_PurchaseList for 'not exists'. (NotNull)
     */
    public void notExistsPurchase(SubQuery<ImmuPurchaseCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuPurchaseCB cb = new ImmuPurchaseCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductDetailId_NotExistsReferrer_PurchaseList(cb.query());
        registerNotExistsReferrer(cb.query(), "PRODUCT_DETAIL_ID", "PRODUCT_DETAIL_ID", pp, "purchaseList");
    }
    public abstract String keepProductDetailId_NotExistsReferrer_PurchaseList(ImmuPurchaseCQ sq);
    ...
    public void xsderivePurchaseList(String fn, SubQuery<ImmuPurchaseCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepProductDetailId_SpecifyDerivedReferrer_PurchaseList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PRODUCT_DETAIL_ID", "PRODUCT_DETAIL_ID", pp, "purchaseList", al, op);
    }
    public abstract String keepProductDetailId_SpecifyDerivedReferrer_PurchaseList(ImmuPurchaseCQ sq);
    ...
    public void xqderivePurchaseList(String fn, SubQuery<ImmuPurchaseCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuPurchaseCB cb = new ImmuPurchaseCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepProductDetailId_QueryDerivedReferrer_PurchaseList(cb.query()); String prpp = keepProductDetailId_QueryDerivedReferrer_PurchaseListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PRODUCT_DETAIL_ID", "PRODUCT_DETAIL_ID", sqpp, "purchaseList", rd, vl, prpp, op);
    }
    public abstract String keepProductDetailId_QueryDerivedReferrer_PurchaseList(ImmuPurchaseCQ sq);
    public abstract String keepProductDetailId_QueryDerivedReferrer_PurchaseListParameter(Object vl);

    /**
     * IsNull {is null}. And OnlyOnceRegistered. <br>
     * (商品詳細ID)PRODUCT_DETAIL_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setProductDetailId_IsNull() { regProductDetailId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * (商品詳細ID)PRODUCT_DETAIL_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setProductDetailId_IsNotNull() { regProductDetailId(CK_ISNN, DOBJ); }
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * (商品カテゴリコード)PRODUCT_CATEGORY_CODE: {IX, NotNull, CHAR(3), FK to cdef_product_category} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * (商品ステータスコード)PRODUCT_STATUS_CODE: {IX, NotNull, CHAR(3), FK to cdef_product_status} <br>
     ...
     */
    public HpSLCFunction<ImmuProductDetailCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuProductDetailCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductDetailCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuProductDetailCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductDetailCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuProductDetailCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductDetailCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuProductDetailCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductDetailCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuProductDetailCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuProductDetailCB&gt;() {
     *     public void query(ImmuProductDetailCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuProductDetailCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuProductDetailCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductDetailCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuProductDetailCQ sq);

    protected ImmuProductDetailCB xcreateScalarConditionCB() {
        ImmuProductDetailCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuProductDetailCB xcreateScalarConditionPartitionByCB() {
        ImmuProductDetailCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuProductDetailCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductDetailCB cb = new ImmuProductDetailCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PRODUCT_DETAIL_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuProductDetailCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuProductDetailCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuProductDetailCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuProductDetailCB cb = new ImmuProductDetailCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_DETAIL_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuProductDetailCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuProductDetailCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuProductDetailCB cb = new ImmuProductDetailCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuProductDetailCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuProductDetailCB newMyCB() {
        return new ImmuProductDetailCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuProductDetailCQ.class.getName(); }
