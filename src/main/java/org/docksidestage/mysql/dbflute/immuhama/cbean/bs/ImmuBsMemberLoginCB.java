 ...
 */
public class ImmuBsMemberLoginCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuMemberLoginCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsMemberLoginCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuMemberLoginCB acceptPK(Long memberLoginId) {
        assertObjectNotNull("memberLoginId", memberLoginId);
        ImmuBsMemberLoginCB cb = this;
        cb.query().setMemberLoginId_Equal(memberLoginId);
        return (ImmuMemberLoginCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ImmuMemberLoginCB acceptUniqueOf(Integer memberId, java.time.LocalDateTime loginDatetime) {
     ...
     */
    public ImmuMemberLoginCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuMemberLoginCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuMemberLoginCQ doGetConditionQuery() {
    ...
    protected ImmuMemberLoginCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuMemberLoginCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuMemberLoginCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuMemberLoginCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuMemberLoginCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuMemberLoginCB> unionCBLambda) {
        final ImmuMemberLoginCB cb = new ImmuMemberLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberLoginCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuMemberLoginCB> unionCBLambda) {
        final ImmuMemberLoginCB cb = new ImmuMemberLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberLoginCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuMemberLoginCQ> {
         ...
         */
        public HpSDRFunction<ImmuMemberLoginCB, ImmuMemberLoginCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberLoginCB> sq, ImmuMemberLoginCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuMemberLoginCB dreamCruiseCB() {
        ImmuMemberLoginCB cb = new ImmuMemberLoginCB();
        cb.xsetupForDreamCruise((ImmuMemberLoginCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuMemberLoginCB> columnQuery(final SpecifyQuery<ImmuMemberLoginCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuMemberLoginCB xcreateColumnQueryCB() {
        ImmuMemberLoginCB cb = new ImmuMemberLoginCB();
        cb.xsetupForColumnQuery((ImmuMemberLoginCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuMemberLoginCB> orCBLambda) {
        xorSQ((ImmuMemberLoginCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuMemberLoginCB> andCBLambda) {
        xorSQAP((ImmuMemberLoginCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuMemberLoginCB cb;
        if (mainCB != null) {
            cb = (ImmuMemberLoginCB)mainCB;
        } else {
            cb = new ImmuMemberLoginCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuMemberLoginCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuMemberLoginCQ.class.getName(); }
