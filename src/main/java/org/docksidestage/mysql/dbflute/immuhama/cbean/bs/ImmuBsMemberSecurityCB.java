 ...
 */
public class ImmuBsMemberSecurityCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ImmuMemberSecurityCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuBsMemberSecurityCB() {
     ...
     * @return this. (NotNull)
     */
    public ImmuMemberSecurityCB acceptPK(Integer memberId) {
        assertObjectNotNull("memberId", memberId);
        ImmuBsMemberSecurityCB cb = this;
        cb.query().setMemberId_Equal(memberId);
        return (ImmuMemberSecurityCB)this;
    }
     ...
     */
    public ImmuMemberSecurityCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ImmuMemberSecurityCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ImmuMemberSecurityCQ doGetConditionQuery() {
    ...
    protected ImmuMemberSecurityCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ImmuMemberSecurityCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ImmuMemberSecurityCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ImmuMemberSecurityCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ImmuMemberSecurityCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ImmuMemberSecurityCB> unionCBLambda) {
        final ImmuMemberSecurityCB cb = new ImmuMemberSecurityCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberSecurityCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ImmuMemberSecurityCB> unionCBLambda) {
        final ImmuMemberSecurityCB cb = new ImmuMemberSecurityCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ImmuMemberSecurityCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ImmuMemberSecurityCQ> {
        protected ImmuMemberCB.HpSpecification _member;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ImmuMemberSecurityCQ> qyCall
         ...
         */
        public HpSDRFunction<ImmuMemberSecurityCB, ImmuMemberSecurityCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ImmuMemberSecurityCB> sq, ImmuMemberSecurityCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ImmuMemberSecurityCB dreamCruiseCB() {
        ImmuMemberSecurityCB cb = new ImmuMemberSecurityCB();
        cb.xsetupForDreamCruise((ImmuMemberSecurityCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ImmuMemberSecurityCB> columnQuery(final SpecifyQuery<ImmuMemberSecurityCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ImmuMemberSecurityCB xcreateColumnQueryCB() {
        ImmuMemberSecurityCB cb = new ImmuMemberSecurityCB();
        cb.xsetupForColumnQuery((ImmuMemberSecurityCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ImmuMemberSecurityCB> orCBLambda) {
        xorSQ((ImmuMemberSecurityCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ImmuMemberSecurityCB> andCBLambda) {
        xorSQAP((ImmuMemberSecurityCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ImmuMemberSecurityCB cb;
        if (mainCB != null) {
            cb = (ImmuMemberSecurityCB)mainCB;
        } else {
            cb = new ImmuMemberSecurityCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ImmuMemberSecurityCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ImmuMemberSecurityCQ.class.getName(); }
