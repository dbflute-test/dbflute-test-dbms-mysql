...
/**
 * The abstract condition-query of cdef_service_rank.
 * @author DBFlute(AutoGenerator)
 */
public abstract class ImmuAbstractBsCdefServiceRankCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ImmuAbstractBsCdefServiceRankCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * (サービスランクコード)SERVICE_RANK_CODE: {PK, NotNull, CHAR(3)}
     * @param serviceRankCode The value of serviceRankCode as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * (サービスランクコード)SERVICE_RANK_CODE: {PK, NotNull, CHAR(3)}
     * @param serviceRankCode The value of serviceRankCode as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * (サービスランクコード)SERVICE_RANK_CODE: {PK, NotNull, CHAR(3)}
     * @param serviceRankCode The value of serviceRankCode as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * (サービスランクコード)SERVICE_RANK_CODE: {PK, NotNull, CHAR(3)}
     * @param serviceRankCode The value of serviceRankCode as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     */
    protected void setServiceRankCode_LikeSearch(String serviceRankCode, LikeSearchOption likeSearchOption) {
     ...
     */
    protected void setServiceRankCode_NotLikeSearch(String serviceRankCode, LikeSearchOption likeSearchOption) {
     ...
     */
    public void existsMemberService(SubQuery<ImmuMemberServiceCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuMemberServiceCB cb = new ImmuMemberServiceCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepServiceRankCode_ExistsReferrer_MemberServiceList(ImmuMemberServiceCQ sq);
     ...
     */
    public void notExistsMemberService(SubQuery<ImmuMemberServiceCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuMemberServiceCB cb = new ImmuMemberServiceCB(); cb.xsetupForExistsReferrer(this);
    ...
    public abstract String keepServiceRankCode_NotExistsReferrer_MemberServiceList(ImmuMemberServiceCQ sq);

    public void xsderiveMemberServiceList(String fn, SubQuery<ImmuMemberServiceCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberServiceCB cb = new ImmuMemberServiceCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepServiceRankCode_SpecifyDerivedReferrer_MemberServiceList(ImmuMemberServiceCQ sq);
     ...
     */
    public HpQDRFunction<ImmuMemberServiceCB> derivedMemberService() {
        return xcreateQDRFunctionMemberServiceList();
    }
    protected HpQDRFunction<ImmuMemberServiceCB> xcreateQDRFunctionMemberServiceList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveMemberServiceList(fn, sq, rd, vl, op));
    }
    public void xqderiveMemberServiceList(String fn, SubQuery<ImmuMemberServiceCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuMemberServiceCB cb = new ImmuMemberServiceCB(); cb.xsetupForDerivedReferrer(this);
    ...
    public abstract String keepServiceRankCode_QueryDerivedReferrer_MemberServiceList(ImmuMemberServiceCQ sq);
     ...
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * (サービスランク名称)SERVICE_RANK_NAME: {NotNull, VARCHAR(50)}
     * @param serviceRankName The value of serviceRankName as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * (サービスランク名称)SERVICE_RANK_NAME: {NotNull, VARCHAR(50)}
     * @param serviceRankName The value of serviceRankName as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * (サービスランク名称)SERVICE_RANK_NAME: {NotNull, VARCHAR(50)}
     * @param serviceRankName The value of serviceRankName as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * (サービスランク名称)SERVICE_RANK_NAME: {NotNull, VARCHAR(50)}
     * @param serviceRankName The value of serviceRankName as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     */
    public void setNewAcceptableFlg_Equal_AsFlg(ImmuCDef.Flg cdef) {
    ...
    public void setNewAcceptableFlg_Equal_True() {
        setNewAcceptableFlg_Equal_AsFlg(ImmuCDef.Flg.True);
    }
    ...
    public void setNewAcceptableFlg_Equal_False() {
        setNewAcceptableFlg_Equal_AsFlg(ImmuCDef.Flg.False);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (basically NotNull: error as default, or no condition as option)
     */
    public void setNewAcceptableFlg_NotEqual_AsFlg(ImmuCDef.Flg cdef) {
    ...
    public void setNewAcceptableFlg_NotEqual_True() {
        setNewAcceptableFlg_NotEqual_AsFlg(ImmuCDef.Flg.True);
    }
    ...
    public void setNewAcceptableFlg_NotEqual_False() {
        setNewAcceptableFlg_NotEqual_AsFlg(ImmuCDef.Flg.False);
    }
     ...
     */
    public void setNewAcceptableFlg_InScope_AsFlg(Collection<ImmuCDef.Flg> cdefList) {
     ...
     * @param cdefList The list of classification definition (as ENUM type). (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setNewAcceptableFlg_NotInScope_AsFlg(Collection<ImmuCDef.Flg> cdefList) {
     ...
     */
    public HpSLCFunction<ImmuCdefServiceRankCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ImmuCdefServiceRankCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefServiceRankCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ImmuCdefServiceRankCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefServiceRankCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ImmuCdefServiceRankCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefServiceRankCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ImmuCdefServiceRankCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefServiceRankCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ImmuCdefServiceRankCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImmuCdefServiceRankCB&gt;() {
     *     public void query(ImmuCdefServiceRankCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ImmuCdefServiceRankCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ImmuCdefServiceRankCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefServiceRankCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ImmuCdefServiceRankCQ sq);

    protected ImmuCdefServiceRankCB xcreateScalarConditionCB() {
        ImmuCdefServiceRankCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ImmuCdefServiceRankCB xcreateScalarConditionPartitionByCB() {
        ImmuCdefServiceRankCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ImmuCdefServiceRankCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefServiceRankCB cb = new ImmuCdefServiceRankCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "SERVICE_RANK_CODE";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ImmuCdefServiceRankCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImmuCdefServiceRankCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ImmuCdefServiceRankCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ImmuCdefServiceRankCB cb = new ImmuCdefServiceRankCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "SERVICE_RANK_CODE";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ImmuCdefServiceRankCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ImmuCdefServiceRankCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ImmuCdefServiceRankCB cb = new ImmuCdefServiceRankCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ImmuCdefServiceRankCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ImmuCdefServiceRankCB newMyCB() {
        return new ImmuCdefServiceRankCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ImmuCdefServiceRankCQ.class.getName(); }
