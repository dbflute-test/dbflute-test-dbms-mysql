...
/**
 * The referrer loader of ([区分値]退会理由)CDEF_WITHDRAWAL_REASON as TABLE. <br>
 * <pre>
 * [primary key]
 ...
 */
public class ImmuLoaderOfCdefWithdrawalReason {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<ImmuCdefWithdrawalReason> _selectedList;
    protected BehaviorSelector _selector;
    protected ImmuCdefWithdrawalReasonBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public ImmuLoaderOfCdefWithdrawalReason ready(List<ImmuCdefWithdrawalReason> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected ImmuCdefWithdrawalReasonBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(ImmuCdefWithdrawalReasonBhv.class); return _myBhv; } }
     ...
     * <pre>
     * <span style="color: #0000C0">cdefWithdrawalReasonBhv</span>.<span style="color: #994747">load</span>(<span style="color: #553000">cdefWithdrawalReasonList</span>, <span style="color: #553000">reasonLoader</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * });
     * for (ImmuCdefWithdrawalReason cdefWithdrawalReason : <span style="color: #553000">cdefWithdrawalReasonList</span>) {
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<ImmuCdefWithdrawalReason> getSelectedList() { return _selectedList; }
