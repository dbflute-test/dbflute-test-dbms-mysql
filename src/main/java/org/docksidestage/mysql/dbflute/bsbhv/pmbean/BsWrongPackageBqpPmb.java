...
/**
 * The base class for parameter-bean of WrongPackageBqp.
 * @author DBFlute(AutoGenerator)
 */
public class BsWrongPackageBqpPmb implements ParameterBean, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the parameter-bean of WrongPackageBqp.
     */
    public BsWrongPackageBqpPmb() {
    }
