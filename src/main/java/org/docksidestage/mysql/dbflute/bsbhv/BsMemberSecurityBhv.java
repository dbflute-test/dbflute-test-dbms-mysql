...
public abstract class BsMemberSecurityBhv extends AbstractBehaviorWritable<MemberSecurity, MemberSecurityCB> {
     ...
     * MemberSecurity memberSecurity = memberSecurityBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(memberSecurity -&gt; {
     ...
     * MemberSecurity memberSecurity = memberSecurityBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(memberSecurity -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * memberSecurityBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(memberSecurity -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = memberSecurity.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * memberSecurityBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(memberSecurity -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = memberSecurity.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
