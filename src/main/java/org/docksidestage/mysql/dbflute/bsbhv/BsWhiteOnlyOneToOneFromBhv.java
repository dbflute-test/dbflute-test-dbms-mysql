...
public abstract class BsWhiteOnlyOneToOneFromBhv extends AbstractBehaviorWritable<WhiteOnlyOneToOneFrom, WhiteOnlyOneToOneFromCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteOnlyOneToOneFromBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteOnlyOneToOneFromCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <span style="color: #0000C0">whiteOnlyOneToOneFromBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteOnlyOneToOneFrom, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * whiteOnlyOneToOneFrom.setFoo...(value);
     * whiteOnlyOneToOneFrom.setBar...(value);
     * <span style="color: #0000C0">whiteOnlyOneToOneFromBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteOnlyOneToOneFrom, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteOnlyOneToOneFromBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteOnlyOneToOneFrom, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteOnlyOneToOneFrom.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteOnlyOneToOneFromBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteOnlyOneToOneFrom, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteOnlyOneToOneFromCB cb = <span style="color: #70226C">new</span> WhiteOnlyOneToOneFromCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteOnlyOneToOneFromBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteOnlyOneToOneFrom, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhiteOnlyOneToOneFromBhv> outsideSql() {
        return doOutsideSql();
    }
