...
public abstract class BsWhitePerrottaOverTraceBhv extends AbstractBehaviorWritable<WhitePerrottaOverTrace, WhitePerrottaOverTraceCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whitePerrottaOverTraceBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whitePerrottaOverTraceBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhitePerrottaOverTrace <span style="color: #553000">whitePerrottaOverTrace</span> : <span style="color: #553000">whitePerrottaOverTraceList</span>) {
     *     ... = <span style="color: #553000">whitePerrottaOverTrace</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePerrottaOverTrace. (NotNull)
     ...
     * for (WhitePerrottaOverTrace whitePerrottaOverTrace : <span style="color: #553000">whitePerrottaOverTraceList</span>) {
     *     ... = whitePerrottaOverTrace.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhitePerrottaOverTrace. (NotNull)
     ...
     * ...
     * for (WhitePerrottaOverTrace whitePerrottaOverTrace : <span style="color: #553000">page</span>) {
     *     ... = whitePerrottaOverTrace.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePerrottaOverTrace. (NotNull)
     ...
     * WhitePerrottaOverTraceCB cb = new WhitePerrottaOverTraceCB();
     * cb.query().set...
     * <span style="color: #0000C0">whitePerrottaOverTraceBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhitePerrottaOverTrace&gt;() {
