...
public abstract class BsWhitePerrottaOverTraceBhv extends AbstractBehaviorWritable<WhitePerrottaOverTrace, WhitePerrottaOverTraceCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public WhitePerrottaOverTraceDbm asDBMeta() { return WhitePerrottaOverTraceDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "white_perrotta_over_trace"; }
     ...
     * <pre>
     * <span style="color: #0000C0">whitePerrottaOverTraceBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhitePerrottaOverTraceCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <span style="color: #0000C0">whitePerrottaOverTraceBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whitePerrottaOverTrace, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * whitePerrottaOverTrace.setFoo...(value);
     * whitePerrottaOverTrace.setBar...(value);
     * <span style="color: #0000C0">whitePerrottaOverTraceBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whitePerrottaOverTrace, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whitePerrottaOverTraceBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whitePerrottaOverTrace, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whitePerrottaOverTrace.setVersionNo(value);</span>
     * <span style="color: #0000C0">whitePerrottaOverTraceBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whitePerrottaOverTrace, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhitePerrottaOverTraceCB cb = <span style="color: #70226C">new</span> WhitePerrottaOverTraceCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whitePerrottaOverTraceBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whitePerrottaOverTrace, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhitePerrottaOverTraceBhv> outsideSql() {
        return doOutsideSql();
    }
