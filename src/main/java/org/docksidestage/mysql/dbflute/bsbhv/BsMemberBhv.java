...
public abstract class BsMemberBhv extends AbstractBehaviorWritable<Member, MemberCB> {
     ...
     * <pre>
     * memberBhv.<span style="color: #DD4747">loadMemberAddressList</span>(memberList, addressCB -&gt; {
     ...
     */
    public NestedReferrerListGateway<MemberAddress> loadMemberAddressList(List<Member> memberList, ConditionBeanSetupper<MemberAddressCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadMemberAddressList(memberList, new LoadReferrerOption<MemberAddressCB, MemberAddress>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MemberAddress> loadMemberAddressList(Member member, ConditionBeanSetupper<MemberAddressCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadMemberAddressList(xnewLRLs(member), new LoadReferrerOption<MemberAddressCB, MemberAddress>().xinit(refCBLambda));
    }
     ...
     * <pre>
     * memberBhv.<span style="color: #DD4747">loadMemberLoginList</span>(memberList, loginCB -&gt; {
     *     loginCB.setupSelect...();
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MemberLogin> loadMemberLoginList(List<Member> memberList, ConditionBeanSetupper<MemberLoginCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadMemberLoginList(memberList, new LoadReferrerOption<MemberLoginCB, MemberLogin>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MemberLogin> loadMemberLoginList(Member member, ConditionBeanSetupper<MemberLoginCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadMemberLoginList(xnewLRLs(member), new LoadReferrerOption<MemberLoginCB, MemberLogin>().xinit(refCBLambda));
    }
     ...
     * <pre>
     * memberBhv.<span style="color: #DD4747">loadPurchaseList</span>(memberList, purchaseCB -&gt; {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Purchase> loadPurchaseList(List<Member> memberList, ConditionBeanSetupper<PurchaseCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadPurchaseList(memberList, new LoadReferrerOption<PurchaseCB, Purchase>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Purchase> loadPurchaseList(Member member, ConditionBeanSetupper<PurchaseCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadPurchaseList(xnewLRLs(member), new LoadReferrerOption<PurchaseCB, Purchase>().xinit(refCBLambda));
    }
    ...
    { return helpPulloutInternally(memberList, "memberAddressAsValidBefore"); }
    ...
    { return helpPulloutInternally(memberList, "memberAddressAsIfComment"); }
    ...
    { return helpPulloutInternally(memberList, "memberAddressAsOnlyOneDate"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsLocalBindOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsLocalForeignOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsForeignForeignBindOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsForeignForeignEachOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsForeignForeignOptimizedBasicOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsForeignForeignOptimizedMarkOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsForeignForeignOptimizedPartOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsForeignForeignOptimizedWholeOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsForeignForeignParameterOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsForeignForeignVariousOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsReferrerOverTest"); }
    ...
    { return helpPulloutInternally(memberList, "memberAddressAsFormattedBasic"); }
    ...
    { return helpPulloutInternally(memberList, "memberAddressAsFormattedLong"); }
    ...
    { return helpPulloutInternally(memberList, "memberLoginAsFormattedMany"); }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(Member member, MemberCB cb, WOptionCall<MemberCB, UpdateOption<MemberCB>> opLambda) {
        return doQueryUpdate(member, cb, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(MemberCB cb, WOptionCall<MemberCB, DeleteOption<MemberCB>> opLambda) {
