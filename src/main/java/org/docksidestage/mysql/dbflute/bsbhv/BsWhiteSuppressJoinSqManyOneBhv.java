...
public abstract class BsWhiteSuppressJoinSqManyOneBhv extends AbstractBehaviorWritable<WhiteSuppressJoinSqManyOne, WhiteSuppressJoinSqManyOneCB> {
     ...
     * WhiteSuppressJoinSqManyOneCB cb = new WhiteSuppressJoinSqManyOneCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhiteSuppressJoinSqManyOne&gt; entity = whiteSuppressJoinSqManyOneBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whiteSuppressJoinSqManyOne -&gt; {
     *     ...
     * });
     * WhiteSuppressJoinSqManyOne whiteSuppressJoinSqManyOne = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whiteSuppressJoinSqManyOne -&gt; {
     *     ...
     * });
     ...
     * <pre>
     * whiteSuppressJoinSqManyOneBhv.<span style="color: #DD4747">loadWhiteSuppressJoinSqManyList</span>(whiteSuppressJoinSqManyOneList, manyCB -&gt; {
     *     manyCB.setupSelect...();
    ...
    public int queryUpdate(WhiteSuppressJoinSqManyOne whiteSuppressJoinSqManyOne, CBCall<WhiteSuppressJoinSqManyOneCB> cbLambda) {
        return doQueryUpdate(whiteSuppressJoinSqManyOne, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteSuppressJoinSqManyOne whiteSuppressJoinSqManyOne, WOptionCall<WhiteSuppressJoinSqManyOneCB, InsertOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
        doInsert(whiteSuppressJoinSqManyOne, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteSuppressJoinSqManyOne whiteSuppressJoinSqManyOne, WOptionCall<WhiteSuppressJoinSqManyOneCB, UpdateOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
        doUpdate(whiteSuppressJoinSqManyOne, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteSuppressJoinSqManyOne whiteSuppressJoinSqManyOne, WOptionCall<WhiteSuppressJoinSqManyOneCB, InsertOption<WhiteSuppressJoinSqManyOneCB>> insertOpLambda, WOptionCall<WhiteSuppressJoinSqManyOneCB, UpdateOption<WhiteSuppressJoinSqManyOneCB>> updateOpLambda) {
        doInsertOrUpdate(whiteSuppressJoinSqManyOne, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteSuppressJoinSqManyOne whiteSuppressJoinSqManyOne, WOptionCall<WhiteSuppressJoinSqManyOneCB, DeleteOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
        doDelete(whiteSuppressJoinSqManyOne, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteSuppressJoinSqManyOne> whiteSuppressJoinSqManyOneList, WOptionCall<WhiteSuppressJoinSqManyOneCB, InsertOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
        return doBatchInsert(whiteSuppressJoinSqManyOneList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteSuppressJoinSqManyOne> whiteSuppressJoinSqManyOneList, WOptionCall<WhiteSuppressJoinSqManyOneCB, UpdateOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
        return doBatchUpdate(whiteSuppressJoinSqManyOneList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteSuppressJoinSqManyOne> whiteSuppressJoinSqManyOneList, WOptionCall<WhiteSuppressJoinSqManyOneCB, DeleteOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
        return doBatchDelete(whiteSuppressJoinSqManyOneList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteSuppressJoinSqManyOne, WhiteSuppressJoinSqManyOneCB> manyArgLambda, WOptionCall<WhiteSuppressJoinSqManyOneCB, InsertOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteSuppressJoinSqManyOne whiteSuppressJoinSqManyOne, CBCall<WhiteSuppressJoinSqManyOneCB> cbLambda, WOptionCall<WhiteSuppressJoinSqManyOneCB, UpdateOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
        return doQueryUpdate(whiteSuppressJoinSqManyOne, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteSuppressJoinSqManyOne whiteSuppressJoinSqManyOne, WhiteSuppressJoinSqManyOneCB cb, WOptionCall<WhiteSuppressJoinSqManyOneCB, UpdateOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
        return doQueryUpdate(whiteSuppressJoinSqManyOne, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteSuppressJoinSqManyOneCB> cbLambda, WOptionCall<WhiteSuppressJoinSqManyOneCB, DeleteOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteSuppressJoinSqManyOneCB cb, WOptionCall<WhiteSuppressJoinSqManyOneCB, DeleteOption<WhiteSuppressJoinSqManyOneCB>> opLambda) {
