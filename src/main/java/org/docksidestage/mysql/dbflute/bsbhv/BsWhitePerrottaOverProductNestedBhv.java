...
public abstract class BsWhitePerrottaOverProductNestedBhv extends AbstractBehaviorWritable<WhitePerrottaOverProductNested, WhitePerrottaOverProductNestedCB> {
     ...
     * WhitePerrottaOverProductNestedCB cb = new WhitePerrottaOverProductNestedCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhitePerrottaOverProductNested&gt; entity = whitePerrottaOverProductNestedBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whitePerrottaOverProductNested -&gt; {
     *     ...
     * });
     * WhitePerrottaOverProductNested whitePerrottaOverProductNested = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whitePerrottaOverProductNested -&gt; {
     *     ...
     * });
     ...
     * <pre>
     * whitePerrottaOverProductNestedBhv.<span style="color: #DD4747">loadWhitePerrottaOverProductList</span>(whitePerrottaOverProductNestedList, productCB -&gt; {
    ...
    public int queryUpdate(WhitePerrottaOverProductNested whitePerrottaOverProductNested, CBCall<WhitePerrottaOverProductNestedCB> cbLambda) {
        return doQueryUpdate(whitePerrottaOverProductNested, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhitePerrottaOverProductNested whitePerrottaOverProductNested, WOptionCall<WhitePerrottaOverProductNestedCB, InsertOption<WhitePerrottaOverProductNestedCB>> opLambda) {
        doInsert(whitePerrottaOverProductNested, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhitePerrottaOverProductNested whitePerrottaOverProductNested, WOptionCall<WhitePerrottaOverProductNestedCB, UpdateOption<WhitePerrottaOverProductNestedCB>> opLambda) {
        doUpdate(whitePerrottaOverProductNested, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhitePerrottaOverProductNested whitePerrottaOverProductNested, WOptionCall<WhitePerrottaOverProductNestedCB, InsertOption<WhitePerrottaOverProductNestedCB>> insertOpLambda, WOptionCall<WhitePerrottaOverProductNestedCB, UpdateOption<WhitePerrottaOverProductNestedCB>> updateOpLambda) {
        doInsertOrUpdate(whitePerrottaOverProductNested, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhitePerrottaOverProductNested whitePerrottaOverProductNested, WOptionCall<WhitePerrottaOverProductNestedCB, DeleteOption<WhitePerrottaOverProductNestedCB>> opLambda) {
        doDelete(whitePerrottaOverProductNested, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhitePerrottaOverProductNested> whitePerrottaOverProductNestedList, WOptionCall<WhitePerrottaOverProductNestedCB, InsertOption<WhitePerrottaOverProductNestedCB>> opLambda) {
        return doBatchInsert(whitePerrottaOverProductNestedList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhitePerrottaOverProductNested> whitePerrottaOverProductNestedList, WOptionCall<WhitePerrottaOverProductNestedCB, UpdateOption<WhitePerrottaOverProductNestedCB>> opLambda) {
        return doBatchUpdate(whitePerrottaOverProductNestedList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhitePerrottaOverProductNested> whitePerrottaOverProductNestedList, WOptionCall<WhitePerrottaOverProductNestedCB, DeleteOption<WhitePerrottaOverProductNestedCB>> opLambda) {
        return doBatchDelete(whitePerrottaOverProductNestedList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhitePerrottaOverProductNested, WhitePerrottaOverProductNestedCB> manyArgLambda, WOptionCall<WhitePerrottaOverProductNestedCB, InsertOption<WhitePerrottaOverProductNestedCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhitePerrottaOverProductNested whitePerrottaOverProductNested, CBCall<WhitePerrottaOverProductNestedCB> cbLambda, WOptionCall<WhitePerrottaOverProductNestedCB, UpdateOption<WhitePerrottaOverProductNestedCB>> opLambda) {
        return doQueryUpdate(whitePerrottaOverProductNested, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhitePerrottaOverProductNested whitePerrottaOverProductNested, WhitePerrottaOverProductNestedCB cb, WOptionCall<WhitePerrottaOverProductNestedCB, UpdateOption<WhitePerrottaOverProductNestedCB>> opLambda) {
        return doQueryUpdate(whitePerrottaOverProductNested, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhitePerrottaOverProductNestedCB> cbLambda, WOptionCall<WhitePerrottaOverProductNestedCB, DeleteOption<WhitePerrottaOverProductNestedCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhitePerrottaOverProductNestedCB cb, WOptionCall<WhitePerrottaOverProductNestedCB, DeleteOption<WhitePerrottaOverProductNestedCB>> opLambda) {
