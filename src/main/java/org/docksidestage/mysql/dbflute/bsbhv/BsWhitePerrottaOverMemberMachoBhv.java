...
public abstract class BsWhitePerrottaOverMemberMachoBhv extends AbstractBehaviorWritable<WhitePerrottaOverMemberMacho, WhitePerrottaOverMemberMachoCB> {
     ...
     * WhitePerrottaOverMemberMachoCB cb = new WhitePerrottaOverMemberMachoCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhitePerrottaOverMemberMacho&gt; entity = whitePerrottaOverMemberMachoBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whitePerrottaOverMemberMacho -&gt; {
     *     ...
     * });
     * WhitePerrottaOverMemberMacho whitePerrottaOverMemberMacho = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whitePerrottaOverMemberMacho -&gt; {
     *     ...
     * });
     ...
     * <pre>
     * whitePerrottaOverMemberMachoBhv.<span style="color: #DD4747">loadWhitePerrottaOverMemberList</span>(whitePerrottaOverMemberMachoList, memberCB -&gt; {
    ...
    public int queryUpdate(WhitePerrottaOverMemberMacho whitePerrottaOverMemberMacho, CBCall<WhitePerrottaOverMemberMachoCB> cbLambda) {
        return doQueryUpdate(whitePerrottaOverMemberMacho, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhitePerrottaOverMemberMacho whitePerrottaOverMemberMacho, WOptionCall<WhitePerrottaOverMemberMachoCB, InsertOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
        doInsert(whitePerrottaOverMemberMacho, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhitePerrottaOverMemberMacho whitePerrottaOverMemberMacho, WOptionCall<WhitePerrottaOverMemberMachoCB, UpdateOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
        doUpdate(whitePerrottaOverMemberMacho, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhitePerrottaOverMemberMacho whitePerrottaOverMemberMacho, WOptionCall<WhitePerrottaOverMemberMachoCB, InsertOption<WhitePerrottaOverMemberMachoCB>> insertOpLambda, WOptionCall<WhitePerrottaOverMemberMachoCB, UpdateOption<WhitePerrottaOverMemberMachoCB>> updateOpLambda) {
        doInsertOrUpdate(whitePerrottaOverMemberMacho, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhitePerrottaOverMemberMacho whitePerrottaOverMemberMacho, WOptionCall<WhitePerrottaOverMemberMachoCB, DeleteOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
        doDelete(whitePerrottaOverMemberMacho, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhitePerrottaOverMemberMacho> whitePerrottaOverMemberMachoList, WOptionCall<WhitePerrottaOverMemberMachoCB, InsertOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
        return doBatchInsert(whitePerrottaOverMemberMachoList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhitePerrottaOverMemberMacho> whitePerrottaOverMemberMachoList, WOptionCall<WhitePerrottaOverMemberMachoCB, UpdateOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
        return doBatchUpdate(whitePerrottaOverMemberMachoList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhitePerrottaOverMemberMacho> whitePerrottaOverMemberMachoList, WOptionCall<WhitePerrottaOverMemberMachoCB, DeleteOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
        return doBatchDelete(whitePerrottaOverMemberMachoList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhitePerrottaOverMemberMacho, WhitePerrottaOverMemberMachoCB> manyArgLambda, WOptionCall<WhitePerrottaOverMemberMachoCB, InsertOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhitePerrottaOverMemberMacho whitePerrottaOverMemberMacho, CBCall<WhitePerrottaOverMemberMachoCB> cbLambda, WOptionCall<WhitePerrottaOverMemberMachoCB, UpdateOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
        return doQueryUpdate(whitePerrottaOverMemberMacho, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhitePerrottaOverMemberMacho whitePerrottaOverMemberMacho, WhitePerrottaOverMemberMachoCB cb, WOptionCall<WhitePerrottaOverMemberMachoCB, UpdateOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
        return doQueryUpdate(whitePerrottaOverMemberMacho, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhitePerrottaOverMemberMachoCB> cbLambda, WOptionCall<WhitePerrottaOverMemberMachoCB, DeleteOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhitePerrottaOverMemberMachoCB cb, WOptionCall<WhitePerrottaOverMemberMachoCB, DeleteOption<WhitePerrottaOverMemberMachoCB>> opLambda) {
