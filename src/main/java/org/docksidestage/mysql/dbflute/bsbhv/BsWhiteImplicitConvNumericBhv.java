...
public abstract class BsWhiteImplicitConvNumericBhv extends AbstractBehaviorWritable<WhiteImplicitConvNumeric, WhiteImplicitConvNumericCB> {
     ...
     * int count = whiteImplicitConvNumericBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteImplicitConvNumeric whiteImplicitConvNumeric = whiteImplicitConvNumericBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteImplicitConvNumeric -&gt; {
     ...
     * WhiteImplicitConvNumeric whiteImplicitConvNumeric = whiteImplicitConvNumericBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteImplicitConvNumeric -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteImplicitConvNumericBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteImplicitConvNumeric -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteImplicitConvNumeric.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteImplicitConvNumeric -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteImplicitConvNumeric.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteImplicitConvNumericCB cb = new WhiteImplicitConvNumericCB();
     * cb.query().setFoo...(value);
     * WhiteImplicitConvNumeric whiteImplicitConvNumeric = whiteImplicitConvNumericBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteImplicitConvNumeric&gt; whiteImplicitConvNumericList = whiteImplicitConvNumericBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteImplicitConvNumericList.forEach(whiteImplicitConvNumeric -&gt; {
     *     ... = whiteImplicitConvNumeric.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteImplicitConvNumeric. (NotNull)
     ...
     * PagingResultBean&lt;WhiteImplicitConvNumeric&gt; page = whiteImplicitConvNumericBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteImplicitConvNumericCB cb = new WhiteImplicitConvNumericCB();
     * cb.query().setFoo...(value);
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteImplicitConvNumeric&gt;() {
     ...
     * <pre>
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">loadWhiteImplicitConvIntegerList</span>(whiteImplicitConvNumericList, integerCB -&gt; {
     ...
     * <pre>
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">loadWhiteImplicitConvStringList</span>(whiteImplicitConvNumericList, stringCB -&gt; {
     ...
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">insert</span>(whiteImplicitConvNumeric);
     ...
     * try {
     *     whiteImplicitConvNumericBhv.<span style="color: #CC4747">update</span>(whiteImplicitConvNumeric);
     ...
     * whiteImplicitConvNumeric.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteImplicitConvNumericBhv.<span style="color: #CC4747">delete</span>(whiteImplicitConvNumeric);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">batchInsert</span>(whiteImplicitConvNumericList);
     * </pre>
     ...
     *     whiteImplicitConvNumericList.add(whiteImplicitConvNumeric);
     * }
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">batchUpdate</span>(whiteImplicitConvNumericList);
     * </pre>
     ...
     * <pre>
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteImplicitConvNumeric, WhiteImplicitConvNumericCB&gt;() {
     ...
     * WhiteImplicitConvNumericCB cb = new WhiteImplicitConvNumericCB();
     * cb.query().setFoo...(value);
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">queryUpdate</span>(whiteImplicitConvNumeric, cb);
     * </pre>
     ...
     * WhiteImplicitConvNumericCB cb = new WhiteImplicitConvNumericCB();
     * cb.query().setFoo...(value);
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">queryDelete</span>(whiteImplicitConvNumeric, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteImplicitConvNumeric. (NotNull)
     ...
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">varyingInsert</span>(whiteImplicitConvNumeric, option);
     * ... = whiteImplicitConvNumeric.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteImplicitConvNumeric The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteImplicitConvNumericBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteImplicitConvNumeric, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteImplicitConvNumericBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteImplicitConvNumeric, cb, option);
     * </pre>
