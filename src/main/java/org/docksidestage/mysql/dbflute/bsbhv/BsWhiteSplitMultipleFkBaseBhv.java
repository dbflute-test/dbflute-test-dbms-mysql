...
public abstract class BsWhiteSplitMultipleFkBaseBhv extends AbstractBehaviorWritable<WhiteSplitMultipleFkBase, WhiteSplitMultipleFkBaseCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public WhiteSplitMultipleFkBaseDbm asDBMeta() { return WhiteSplitMultipleFkBaseDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "white_split_multiple_fk_base"; }
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public int selectCount(CBCall<WhiteSplitMultipleFkBaseCB> cbLambda) {
     ...
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">whiteSplitMultipleFkBase</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = <span style="color: #553000">whiteSplitMultipleFkBase</span>.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">whiteSplitMultipleFkBase</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public OptionalEntity<WhiteSplitMultipleFkBase> selectEntity(CBCall<WhiteSplitMultipleFkBaseCB> cbLambda) {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteSplitMultipleFkBase <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteSplitMultipleFkBase.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteSplitMultipleFkBase <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteSplitMultipleFkBase.get...
     * }).<span style="color: #994747">orElse</span>(() <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteSplitMultipleFkBase> selectEntity(WhiteSplitMultipleFkBaseCB cb) {
        return facadeSelectEntity(cb);
    }

    protected OptionalEntity<WhiteSplitMultipleFkBase> facadeSelectEntity(WhiteSplitMultipleFkBaseCB cb) {
     ...
     * <pre>
     * WhiteSplitMultipleFkBase <span style="color: #553000">whiteSplitMultipleFkBase</span> = <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">whiteSplitMultipleFkBase</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSplitMultipleFkBase. (NotNull)
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public WhiteSplitMultipleFkBase selectEntityWithDeletedCheck(CBCall<WhiteSplitMultipleFkBaseCB> cbLambda) {
     ...
     * WhiteSplitMultipleFkBaseCB cb = <span style="color: #70226C">new</span> WhiteSplitMultipleFkBaseCB();
     * cb.query().set...;
     * WhiteSplitMultipleFkBase whiteSplitMultipleFkBase = <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteSplitMultipleFkBase> selectByPK(Long baseId) {
        return facadeSelectByPK(baseId);
    }

    protected OptionalEntity<WhiteSplitMultipleFkBase> facadeSelectByPK(Long baseId) {
     ...
     * <pre>
     * ListResultBean&lt;WhiteSplitMultipleFkBase&gt; <span style="color: #553000">whiteSplitMultipleFkBaseList</span> = <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (WhiteSplitMultipleFkBase <span style="color: #553000">whiteSplitMultipleFkBase</span> : <span style="color: #553000">whiteSplitMultipleFkBaseList</span>) {
     *     ... = <span style="color: #553000">whiteSplitMultipleFkBase</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSplitMultipleFkBase. (NotNull)
     ...
     */
    public ListResultBean<WhiteSplitMultipleFkBase> selectList(CBCall<WhiteSplitMultipleFkBaseCB> cbLambda) {
     ...
     * cb.query().set...;
     * cb.query().addOrderBy...;
     * ListResultBean&lt;WhiteSplitMultipleFkBase&gt; <span style="color: #553000">whiteSplitMultipleFkBaseList</span> = <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectList</span>(cb);
     * <span style="color: #70226C">for</span> (WhiteSplitMultipleFkBase whiteSplitMultipleFkBase : <span style="color: #553000">whiteSplitMultipleFkBaseList</span>) {
     *     ... = whiteSplitMultipleFkBase.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteSplitMultipleFkBase. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;WhiteSplitMultipleFkBase&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteSplitMultipleFkBase whiteSplitMultipleFkBase : <span style="color: #553000">page</span>) {
     *     ... = whiteSplitMultipleFkBase.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSplitMultipleFkBase. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<WhiteSplitMultipleFkBase> selectPage(CBCall<WhiteSplitMultipleFkBaseCB> cbLambda) {
     ...
     * PagingResultBean&lt;WhiteSplitMultipleFkBase&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectPage</span>(cb);
     * <span style="color: #70226C">int</span> allRecordCount = <span style="color: #553000">page</span>.getAllRecordCount();
     * <span style="color: #70226C">int</span> allPageCount = <span style="color: #553000">page</span>.getAllPageCount();
     * <span style="color: #70226C">boolean</span> isExistPrePage = <span style="color: #553000">page</span>.isExistPrePage();
     * <span style="color: #70226C">boolean</span> isExistNextPage = <span style="color: #553000">page</span>.isExistNextPage();
     ...
     * <pre>
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSplitMultipleFkBase. (NotNull)
     * @param entityLambda The handler of entity row of WhiteSplitMultipleFkBase. (NotNull)
     */
    public void selectCursor(CBCall<WhiteSplitMultipleFkBaseCB> cbLambda, EntityRowHandler<WhiteSplitMultipleFkBase> entityLambda) {
     ...
     * WhiteSplitMultipleFkBaseCB cb = <span style="color: #70226C">new</span> WhiteSplitMultipleFkBaseCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteSplitMultipleFkBase. (NotNull)
     ...
     */
    public void load(List<WhiteSplitMultipleFkBase> whiteSplitMultipleFkBaseList, ReferrerLoaderHandler<LoaderOfWhiteSplitMultipleFkBase> loaderLambda) {
        xassLRArg(whiteSplitMultipleFkBaseList, loaderLambda);
        loaderLambda.handle(new LoaderOfWhiteSplitMultipleFkBase().ready(whiteSplitMultipleFkBaseList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(WhiteSplitMultipleFkBase whiteSplitMultipleFkBase, ReferrerLoaderHandler<LoaderOfWhiteSplitMultipleFkBase> loaderLambda) {
        xassLRArg(whiteSplitMultipleFkBase, loaderLambda);
        loaderLambda.handle(new LoaderOfWhiteSplitMultipleFkBase().ready(xnewLRAryLs(whiteSplitMultipleFkBase), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">whiteSplitMultipleFkBase</span>.<span style="color: #CC4747">getWhiteSplitMultipleFkChildList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * <pre>
     * WhiteSplitMultipleFkBase whiteSplitMultipleFkBase = <span style="color: #70226C">new</span> WhiteSplitMultipleFkBase();
     ...
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">insert</span>(whiteSplitMultipleFkBase);
     ...
     *     <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">delete</span>(whiteSplitMultipleFkBase);
     ...
     * }
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">batchInsert</span>(whiteSplitMultipleFkBaseList);
     * </pre>
     ...
     *     whiteSplitMultipleFkBaseList.add(whiteSplitMultipleFkBase);
     * }
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">batchUpdate</span>(whiteSplitMultipleFkBaseList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">whiteSplitMultipleFkBaseBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteSplitMultipleFkBase, WhiteSplitMultipleFkBaseCB&gt;() {
     ...
     */
    public int queryInsert(QueryInsertSetupper<WhiteSplitMultipleFkBase, WhiteSplitMultipleFkBaseCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(WhiteSplitMultipleFkBase whiteSplitMultipleFkBase, CBCall<WhiteSplitMultipleFkBaseCB> cbLambda) {
        return doQueryUpdate(whiteSplitMultipleFkBase, createCB(cbLambda), null);
    }
     ...
     */
    public int queryDelete(CBCall<WhiteSplitMultipleFkBaseCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteSplitMultipleFkBase whiteSplitMultipleFkBase, WritableOptionCall<WhiteSplitMultipleFkBaseCB, InsertOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
        doInsert(whiteSplitMultipleFkBase, createInsertOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteSplitMultipleFkBase whiteSplitMultipleFkBase, WritableOptionCall<WhiteSplitMultipleFkBaseCB, UpdateOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
        doUpdate(whiteSplitMultipleFkBase, createUpdateOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteSplitMultipleFkBase whiteSplitMultipleFkBase, WritableOptionCall<WhiteSplitMultipleFkBaseCB, InsertOption<WhiteSplitMultipleFkBaseCB>> insertOpLambda, WritableOptionCall<WhiteSplitMultipleFkBaseCB, UpdateOption<WhiteSplitMultipleFkBaseCB>> updateOpLambda) {
        doInsertOrUpdate(whiteSplitMultipleFkBase, createInsertOption(insertOpLambda), createUpdateOption(updateOpLambda));
    }
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteSplitMultipleFkBase whiteSplitMultipleFkBase, WritableOptionCall<WhiteSplitMultipleFkBaseCB, DeleteOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
        doDelete(whiteSplitMultipleFkBase, createDeleteOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteSplitMultipleFkBase> whiteSplitMultipleFkBaseList, WritableOptionCall<WhiteSplitMultipleFkBaseCB, InsertOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
        return doBatchInsert(whiteSplitMultipleFkBaseList, createInsertOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteSplitMultipleFkBase> whiteSplitMultipleFkBaseList, WritableOptionCall<WhiteSplitMultipleFkBaseCB, UpdateOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
        return doBatchUpdate(whiteSplitMultipleFkBaseList, createUpdateOption(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteSplitMultipleFkBase> whiteSplitMultipleFkBaseList, WritableOptionCall<WhiteSplitMultipleFkBaseCB, DeleteOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
        return doBatchDelete(whiteSplitMultipleFkBaseList, createDeleteOption(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteSplitMultipleFkBase, WhiteSplitMultipleFkBaseCB> manyArgLambda, WritableOptionCall<WhiteSplitMultipleFkBaseCB, InsertOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteSplitMultipleFkBase whiteSplitMultipleFkBase, CBCall<WhiteSplitMultipleFkBaseCB> cbLambda, WritableOptionCall<WhiteSplitMultipleFkBaseCB, UpdateOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
        return doQueryUpdate(whiteSplitMultipleFkBase, createCB(cbLambda), createUpdateOption(opLambda));
    }
     ...
     * @throws NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteSplitMultipleFkBase whiteSplitMultipleFkBase, WhiteSplitMultipleFkBaseCB cb, WritableOptionCall<WhiteSplitMultipleFkBaseCB, UpdateOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
        return doQueryUpdate(whiteSplitMultipleFkBase, cb, createUpdateOption(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteSplitMultipleFkBaseCB> cbLambda, WritableOptionCall<WhiteSplitMultipleFkBaseCB, DeleteOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
     ...
     * @throws NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteSplitMultipleFkBaseCB cb, WritableOptionCall<WhiteSplitMultipleFkBaseCB, DeleteOption<WhiteSplitMultipleFkBaseCB>> opLambda) {
     ...
     * whiteSplitMultipleFkBaseBhv.outideSql().selectEntity(pmb); <span style="color: #3F7E5E">// optional</span> 
     * whiteSplitMultipleFkBaseBhv.outideSql().selectList(pmb); <span style="color: #3F7E5E">// ListResultBean</span>
     * whiteSplitMultipleFkBaseBhv.outideSql().selectPage(pmb); <span style="color: #3F7E5E">// PagingResultBean</span>
     * whiteSplitMultipleFkBaseBhv.outideSql().selectPagedListOnly(pmb); <span style="color: #3F7E5E">// ListResultBean</span>
     * whiteSplitMultipleFkBaseBhv.outideSql().selectCursor(pmb, handler); <span style="color: #3F7E5E">// (by handler)</span>
     * whiteSplitMultipleFkBaseBhv.outideSql().execute(pmb); <span style="color: #3F7E5E">// int (updated count)</span>
     * whiteSplitMultipleFkBaseBhv.outideSql().call(pmb); <span style="color: #3F7E5E">// void (pmb has OUT parameters)</span>
     *
     * <span style="color: #3F7E5E">// traditional style</span> 
     * whiteSplitMultipleFkBaseBhv.outideSql().traditionalStyle().selectEntity(path, pmb, entityType);
     * whiteSplitMultipleFkBaseBhv.outideSql().traditionalStyle().selectList(path, pmb, entityType);
     * whiteSplitMultipleFkBaseBhv.outideSql().traditionalStyle().selectPage(path, pmb, entityType);
     * whiteSplitMultipleFkBaseBhv.outideSql().traditionalStyle().selectPagedListOnly(path, pmb, entityType);
     * whiteSplitMultipleFkBaseBhv.outideSql().traditionalStyle().selectCursor(path, pmb, handler);
     * whiteSplitMultipleFkBaseBhv.outideSql().traditionalStyle().execute(path, pmb);
     *
     * <span style="color: #3F7E5E">// options</span> 
     * whiteSplitMultipleFkBaseBhv.outideSql().removeBlockComment().selectList()
     * whiteSplitMultipleFkBaseBhv.outideSql().removeLineComment().selectList()
     * whiteSplitMultipleFkBaseBhv.outideSql().formatSql().selectList()
     * </pre>
