...
public abstract class BsVendorTheLongAndWindingTableAndColumnBhv extends AbstractBehaviorWritable<VendorTheLongAndWindingTableAndColumn, VendorTheLongAndWindingTableAndColumnCB> {
     ...
     * int count = <span style="color: #0000C0">vendorTheLongAndWindingTableAndColumnBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * VendorTheLongAndWindingTableAndColumnCB cb = new VendorTheLongAndWindingTableAndColumnCB();
     * cb.query().set...
     * <span style="color: #0000C0">vendorTheLongAndWindingTableAndColumnBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorTheLongAndWindingTableAndColumn&gt;() {
