...
public abstract class BsWhiteSplitMultipleFkChildBhv extends AbstractBehaviorWritable<WhiteSplitMultipleFkChild, WhiteSplitMultipleFkChildCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteSplitMultipleFkChildBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteSplitMultipleFkChildBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteSplitMultipleFkChild <span style="color: #553000">whiteSplitMultipleFkChild</span> : <span style="color: #553000">whiteSplitMultipleFkChildList</span>) {
     *     ... = <span style="color: #553000">whiteSplitMultipleFkChild</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSplitMultipleFkChild. (NotNull)
     ...
     * for (WhiteSplitMultipleFkChild whiteSplitMultipleFkChild : <span style="color: #553000">whiteSplitMultipleFkChildList</span>) {
     *     ... = whiteSplitMultipleFkChild.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteSplitMultipleFkChild. (NotNull)
     ...
     * ...
     * for (WhiteSplitMultipleFkChild whiteSplitMultipleFkChild : <span style="color: #553000">page</span>) {
     *     ... = whiteSplitMultipleFkChild.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSplitMultipleFkChild. (NotNull)
     ...
     * WhiteSplitMultipleFkChildCB cb = new WhiteSplitMultipleFkChildCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteSplitMultipleFkChildBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteSplitMultipleFkChild&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteSplitMultipleFkChildBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteSplitMultipleFkChildBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteSplitMultipleFkChild, option);
     * ... = whiteSplitMultipleFkChild.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteSplitMultipleFkChild The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteSplitMultipleFkChildBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteSplitMultipleFkChild, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #0000C0">whiteSplitMultipleFkChildBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSplitMultipleFkChild, cb, option);
     * </pre>
