...
public abstract class BsWhiteUqFkBhv extends AbstractBehaviorWritable<WhiteUqFk, WhiteUqFkCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteUqFkBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteUqFkBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteUqFk <span style="color: #553000">whiteUqFk</span> : <span style="color: #553000">whiteUqFkList</span>) {
     *     ... = <span style="color: #553000">whiteUqFk</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteUqFk. (NotNull)
     ...
     * ...
     * for (WhiteUqFk whiteUqFk : <span style="color: #553000">page</span>) {
     *     ... = whiteUqFk.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteUqFk. (NotNull)
     ...
     * WhiteUqFkCB cb = new WhiteUqFkCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteUqFkBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteUqFk&gt;() {
