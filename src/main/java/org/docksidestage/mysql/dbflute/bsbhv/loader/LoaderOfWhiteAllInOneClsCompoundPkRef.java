...
/**
 * The referrer loader of WHITE_ALL_IN_ONE_CLS_COMPOUND_PK_REF as TABLE.
 * @author DBFlute(AutoGenerator)
 */
public class LoaderOfWhiteAllInOneClsCompoundPkRef {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<WhiteAllInOneClsCompoundPkRef> _selectedList;
    protected BehaviorSelector _selector;
    protected WhiteAllInOneClsCompoundPkRefBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfWhiteAllInOneClsCompoundPkRef ready(List<WhiteAllInOneClsCompoundPkRef> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected WhiteAllInOneClsCompoundPkRefBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(WhiteAllInOneClsCompoundPkRefBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<WhiteAllInOneClsCompoundPkRef> getSelectedList() { return _selectedList; }
