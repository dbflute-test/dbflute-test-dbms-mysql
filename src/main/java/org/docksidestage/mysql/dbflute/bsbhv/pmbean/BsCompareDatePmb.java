...
public class BsCompareDatePmb implements ExecuteHandlingPmb<MemberBhv>, FetchBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** The parameter of memberId:ref(MEMBER) :: refers to (会員ID)MEMBER_ID: {PK, ID, NotNull, INT(10)}. */
    protected Integer _memberId;

    /** The parameter of birthdateFrom:ref(MEMBER.BIRTHDATE) :: refers to (生年月日)BIRTHDATE: {DATE(10)}. */
    protected Date _birthdateFrom;

    /** The parameter of formalizedDatetimeFrom:ref(MEMBER.FORMALIZED_DATETIME) :: refers to (正式会員日時)FORMALIZED_DATETIME: {IX, DATETIME(19)}. */
    ...
    //                                                                            ========
    /**
     * [get] memberId:ref(MEMBER) :: refers to (会員ID)MEMBER_ID: {PK, ID, NotNull, INT(10)} <br />
    ...
    /**
     * [set] memberId:ref(MEMBER) :: refers to (会員ID)MEMBER_ID: {PK, ID, NotNull, INT(10)} <br />
    ...
    /**
     * [get] formalizedDatetimeFrom:ref(MEMBER.FORMALIZED_DATETIME) :: refers to (正式会員日時)FORMALIZED_DATETIME: {IX, DATETIME(19)} <br />
    ...
    /**
     * [set] formalizedDatetimeFrom:ref(MEMBER.FORMALIZED_DATETIME) :: refers to (正式会員日時)FORMALIZED_DATETIME: {IX, DATETIME(19)} <br />
