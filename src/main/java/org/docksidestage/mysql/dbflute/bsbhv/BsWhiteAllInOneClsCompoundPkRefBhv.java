...
/**
 * The behavior of WHITE_ALL_IN_ONE_CLS_COMPOUND_PK_REF as TABLE.
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsWhiteAllInOneClsCompoundPkRefBhv extends AbstractBehaviorWritable<WhiteAllInOneClsCompoundPkRef, WhiteAllInOneClsCompoundPkRefCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public WhiteAllInOneClsCompoundPkRefDbm asDBMeta() { return WhiteAllInOneClsCompoundPkRefDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "white_all_in_one_cls_compound_pk_ref"; }

    // ===================================================================================
    //                                                                        New Instance
    //                                                                        ============
    /** {@inheritDoc} */
    public WhiteAllInOneClsCompoundPkRefCB newConditionBean() { return new WhiteAllInOneClsCompoundPkRefCB(); }
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">whiteAllInOneClsCompoundPkRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">whiteAllInOneClsCompoundPkRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteAllInOneClsCompoundPkRef> selectEntity(WhiteAllInOneClsCompoundPkRefCB cb) {
        return facadeSelectEntity(cb);
    }

    protected OptionalEntity<WhiteAllInOneClsCompoundPkRef> facadeSelectEntity(WhiteAllInOneClsCompoundPkRefCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends WhiteAllInOneClsCompoundPkRef> OptionalEntity<ENTITY> doSelectOptionalEntity(WhiteAllInOneClsCompoundPkRefCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * WhiteAllInOneClsCompoundPkRef <span style="color: #553000">whiteAllInOneClsCompoundPkRef</span> = <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">whiteAllInOneClsCompoundPkRef</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAllInOneClsCompoundPkRef. (NotNull)
     ...
     * WhiteAllInOneClsCompoundPkRefCB cb = <span style="color: #70226C">new</span> WhiteAllInOneClsCompoundPkRefCB();
     * cb.query().set...;
     * WhiteAllInOneClsCompoundPkRef whiteAllInOneClsCompoundPkRef = <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteAllInOneClsCompoundPkRef> selectByPK(String fooCode, String barCode, String quxCode) {
        return facadeSelectByPK(fooCode, barCode, quxCode);
    }

    protected OptionalEntity<WhiteAllInOneClsCompoundPkRef> facadeSelectByPK(String fooCode, String barCode, String quxCode) {
        return doSelectOptionalByPK(fooCode, barCode, quxCode, typeOfSelectedEntity());
    }

    protected <ENTITY extends WhiteAllInOneClsCompoundPkRef> ENTITY doSelectByPK(String fooCode, String barCode, String quxCode, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(fooCode, barCode, quxCode), tp);
    }

    protected <ENTITY extends WhiteAllInOneClsCompoundPkRef> OptionalEntity<ENTITY> doSelectOptionalByPK(String fooCode, String barCode, String quxCode, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * ListResultBean&lt;WhiteAllInOneClsCompoundPkRef&gt; <span style="color: #553000">whiteAllInOneClsCompoundPkRefList</span> = <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (WhiteAllInOneClsCompoundPkRef <span style="color: #553000">whiteAllInOneClsCompoundPkRef</span> : <span style="color: #553000">whiteAllInOneClsCompoundPkRefList</span>) {
     *     ... = <span style="color: #553000">whiteAllInOneClsCompoundPkRef</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAllInOneClsCompoundPkRef. (NotNull)
     ...
     * cb.query().set...;
     * cb.query().addOrderBy...;
     * ListResultBean&lt;WhiteAllInOneClsCompoundPkRef&gt; <span style="color: #553000">whiteAllInOneClsCompoundPkRefList</span> = <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectList</span>(cb);
     * <span style="color: #70226C">for</span> (WhiteAllInOneClsCompoundPkRef whiteAllInOneClsCompoundPkRef : <span style="color: #553000">whiteAllInOneClsCompoundPkRefList</span>) {
     *     ... = whiteAllInOneClsCompoundPkRef.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteAllInOneClsCompoundPkRef. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;WhiteAllInOneClsCompoundPkRef&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteAllInOneClsCompoundPkRef whiteAllInOneClsCompoundPkRef : <span style="color: #553000">page</span>) {
     *     ... = whiteAllInOneClsCompoundPkRef.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAllInOneClsCompoundPkRef. (NotNull)
     ...
     * PagingResultBean&lt;WhiteAllInOneClsCompoundPkRef&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectPage</span>(cb);
     * <span style="color: #70226C">int</span> allRecordCount = <span style="color: #553000">page</span>.getAllRecordCount();
     * <span style="color: #70226C">int</span> allPageCount = <span style="color: #553000">page</span>.getAllPageCount();
     * <span style="color: #70226C">boolean</span> isExistPrePage = <span style="color: #553000">page</span>.isExistPrePage();
     * <span style="color: #70226C">boolean</span> isExistNextPage = <span style="color: #553000">page</span>.isExistNextPage();
     ...
     * <pre>
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * WhiteAllInOneClsCompoundPkRefCB cb = <span style="color: #70226C">new</span> WhiteAllInOneClsCompoundPkRefCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteAllInOneClsCompoundPkRef. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteAllInOneClsCompoundPkRefCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * @param whiteAllInOneClsCompoundPkRefList The entity list of whiteAllInOneClsCompoundPkRef. (NotNull)
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(List<WhiteAllInOneClsCompoundPkRef> whiteAllInOneClsCompoundPkRefList, ReferrerLoaderHandler<LoaderOfWhiteAllInOneClsCompoundPkRef> loaderLambda) {
        xassLRArg(whiteAllInOneClsCompoundPkRefList, loaderLambda);
        loaderLambda.handle(new LoaderOfWhiteAllInOneClsCompoundPkRef().ready(whiteAllInOneClsCompoundPkRefList, _behaviorSelector));
    }
     ...
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has order by FK before callback.
     * @param whiteAllInOneClsCompoundPkRef The entity of whiteAllInOneClsCompoundPkRef. (NotNull)
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(WhiteAllInOneClsCompoundPkRef whiteAllInOneClsCompoundPkRef, ReferrerLoaderHandler<LoaderOfWhiteAllInOneClsCompoundPkRef> loaderLambda) {
        xassLRArg(whiteAllInOneClsCompoundPkRef, loaderLambda);
        loaderLambda.handle(new LoaderOfWhiteAllInOneClsCompoundPkRef().ready(xnewLRAryLs(whiteAllInOneClsCompoundPkRef), _behaviorSelector));
    }
    ...
    { return helpPulloutInternally(whiteAllInOneClsCompoundPkRefList, "whiteAllInOneClsElementAsFoo"); }
    ...
    { return helpPulloutInternally(whiteAllInOneClsCompoundPkRefList, "whiteAllInOneClsElementAsBar"); }
     ...
     * <pre>
     * WhiteAllInOneClsCompoundPkRef whiteAllInOneClsCompoundPkRef = <span style="color: #70226C">new</span> WhiteAllInOneClsCompoundPkRef();
     ...
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">insert</span>(whiteAllInOneClsCompoundPkRef);
     ...
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">update</span>(whiteAllInOneClsCompoundPkRef);
     * </pre>
     * @param whiteAllInOneClsCompoundPkRef The entity of update. (NotNull, PrimaryKeyNotNull)
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @throws EntityDuplicatedException When the entity has been duplicated.
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(WhiteAllInOneClsCompoundPkRef whiteAllInOneClsCompoundPkRef) {
    ...
    public void insertOrUpdate(WhiteAllInOneClsCompoundPkRef whiteAllInOneClsCompoundPkRef) {
        doInsertOrUpdate(whiteAllInOneClsCompoundPkRef, null, null);
    }
     ...
     *     <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">delete</span>(whiteAllInOneClsCompoundPkRef);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     * @param whiteAllInOneClsCompoundPkRef The entity of delete. (NotNull, PrimaryKeyNotNull)
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
     ...
     * }
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">batchInsert</span>(whiteAllInOneClsCompoundPkRefList);
     * </pre>
    ...
    public int[] batchInsert(List<WhiteAllInOneClsCompoundPkRef> whiteAllInOneClsCompoundPkRefList) {
        return doBatchInsert(whiteAllInOneClsCompoundPkRefList, null);
    }
     ...
     *     whiteAllInOneClsCompoundPkRefList.add(whiteAllInOneClsCompoundPkRef);
     * }
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">batchUpdate</span>(whiteAllInOneClsCompoundPkRefList);
     * </pre>
    ...
    public int[] batchUpdate(List<WhiteAllInOneClsCompoundPkRef> whiteAllInOneClsCompoundPkRefList) {
        return doBatchUpdate(whiteAllInOneClsCompoundPkRefList, null);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteAllInOneClsCompoundPkRef, WhiteAllInOneClsCompoundPkRefCB&gt;() {
     ...
     */
    public int queryInsert(QueryInsertSetupper<WhiteAllInOneClsCompoundPkRef, WhiteAllInOneClsCompoundPkRefCB> manyArgLambda) {
     ...
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteAllInOneClsCompoundPkRef, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * WhiteAllInOneClsCompoundPkRefCB cb = <span style="color: #70226C">new</span> WhiteAllInOneClsCompoundPkRefCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteAllInOneClsCompoundPkRef, cb);
     * </pre>
     * @param whiteAllInOneClsCompoundPkRef The entity that contains update values. (NotNull, PrimaryKeyNullAllowed)
     * @param cb The condition-bean of WhiteAllInOneClsCompoundPkRef. (NotNull)
     * @return The updated count.
     ...
     * <pre>
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAllInOneClsCompoundPkRef. (NotNull)
     ...
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteAllInOneClsCompoundPkRef, cb);
     * </pre>
     * @param cb The condition-bean of WhiteAllInOneClsCompoundPkRef. (NotNull)
     * @return The deleted count.
     * @throws NonQueryDeleteNotAllowedException When the query has no condition.
     ...
     * whiteAllInOneClsCompoundPkRef.setFoo...(value);
     * whiteAllInOneClsCompoundPkRef.setBar...(value);
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteAllInOneClsCompoundPkRef, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteAllInOneClsCompoundPkRef, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @param whiteAllInOneClsCompoundPkRef The entity of insert or update. (NotNull)
     ...
     * @param whiteAllInOneClsCompoundPkRef The entity of delete. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteAllInOneClsCompoundPkRef.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteAllInOneClsCompoundPkRef, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteAllInOneClsCompoundPkRefCB cb = <span style="color: #70226C">new</span> WhiteAllInOneClsCompoundPkRefCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteAllInOneClsCompoundPkRef, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     * <pre>
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteAllInOneClsCompoundPkRef, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * }, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * whiteAllInOneClsCompoundPkRefBhv.outideSql().selectCursor(pmb, handler); <span style="color: #3F7E5E">// (by handler)</span>
     ...
     * whiteAllInOneClsCompoundPkRefBhv.outideSql().traditionalStyle().selectPagedListOnly(path, pmb, entityType);
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhiteAllInOneClsCompoundPkRefBhv> outsideSql() {
        return doOutsideSql();
    }
