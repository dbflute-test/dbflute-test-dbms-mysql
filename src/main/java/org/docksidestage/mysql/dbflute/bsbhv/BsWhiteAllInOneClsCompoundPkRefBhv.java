...
public abstract class BsWhiteAllInOneClsCompoundPkRefBhv extends AbstractBehaviorWritable<WhiteAllInOneClsCompoundPkRef, WhiteAllInOneClsCompoundPkRefCB> {
     ...
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteAllInOneClsCompoundPkRef, option);
     * ... = whiteAllInOneClsCompoundPkRef.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteAllInOneClsCompoundPkRef The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteAllInOneClsCompoundPkRef, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * WhiteAllInOneClsCompoundPkRefCB cb = new WhiteAllInOneClsCompoundPkRefCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;WhiteAllInOneClsCompoundPkRefCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;WhiteAllInOneClsCompoundPkRefCB&gt;();
     * option.self(new SpecifyQuery&lt;WhiteAllInOneClsCompoundPkRefCB&gt;() {
     *     public void specify(WhiteAllInOneClsCompoundPkRefCB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">whiteAllInOneClsCompoundPkRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteAllInOneClsCompoundPkRef, cb, option);
     * </pre>
