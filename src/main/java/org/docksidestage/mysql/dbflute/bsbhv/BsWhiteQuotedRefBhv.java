...
public abstract class BsWhiteQuotedRefBhv extends AbstractBehaviorWritable<WhiteQuotedRef, WhiteQuotedRefCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteQuotedRefBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteQuotedRefBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteQuotedRef <span style="color: #553000">whiteQuotedRef</span> : <span style="color: #553000">whiteQuotedRefList</span>) {
     *     ... = <span style="color: #553000">whiteQuotedRef</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteQuotedRef. (NotNull)
     ...
     * for (WhiteQuotedRef whiteQuotedRef : <span style="color: #553000">whiteQuotedRefList</span>) {
     *     ... = whiteQuotedRef.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteQuotedRef. (NotNull)
     ...
     * ...
     * for (WhiteQuotedRef whiteQuotedRef : <span style="color: #553000">page</span>) {
     *     ... = whiteQuotedRef.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteQuotedRef. (NotNull)
     ...
     * WhiteQuotedRefCB cb = new WhiteQuotedRefCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteQuotedRefBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteQuotedRef&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteQuotedRefBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteQuotedRefBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteQuotedRef, option);
     * ... = whiteQuotedRef.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteQuotedRef The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteQuotedRefBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteQuotedRef, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #0000C0">whiteQuotedRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteQuotedRef, cb, option);
     * </pre>
