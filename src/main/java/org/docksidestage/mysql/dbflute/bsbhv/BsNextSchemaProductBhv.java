...
public abstract class BsNextSchemaProductBhv extends AbstractBehaviorWritable<NextSchemaProduct, NextSchemaProductCB> {
     ...
     * int count = nextSchemaProductBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * NextSchemaProduct nextSchemaProduct = nextSchemaProductBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(nextSchemaProduct -&gt; {
     ...
     * NextSchemaProduct nextSchemaProduct = nextSchemaProductBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(nextSchemaProduct -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * nextSchemaProductBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(nextSchemaProduct -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = nextSchemaProduct.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * nextSchemaProductBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(nextSchemaProduct -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = nextSchemaProduct.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * NextSchemaProductCB cb = new NextSchemaProductCB();
     * cb.query().setFoo...(value);
     * NextSchemaProduct nextSchemaProduct = nextSchemaProductBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;NextSchemaProduct&gt; nextSchemaProductList = nextSchemaProductBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * nextSchemaProductList.forEach(nextSchemaProduct -&gt; {
     *     ... = nextSchemaProduct.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of NextSchemaProduct. (NotNull)
     ...
     * PagingResultBean&lt;NextSchemaProduct&gt; page = nextSchemaProductBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * NextSchemaProductCB cb = new NextSchemaProductCB();
     * cb.query().setFoo...(value);
     * nextSchemaProductBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;NextSchemaProduct&gt;() {
     ...
     * <pre>
     * nextSchemaProductBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * nextSchemaProductBhv.<span style="color: #CC4747">insert</span>(nextSchemaProduct);
     ...
     * try {
     *     nextSchemaProductBhv.<span style="color: #CC4747">update</span>(nextSchemaProduct);
     ...
     * nextSchemaProduct.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     nextSchemaProductBhv.<span style="color: #CC4747">delete</span>(nextSchemaProduct);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * nextSchemaProductBhv.<span style="color: #CC4747">batchInsert</span>(nextSchemaProductList);
     * </pre>
     ...
     *     nextSchemaProductList.add(nextSchemaProduct);
     * }
     * nextSchemaProductBhv.<span style="color: #CC4747">batchUpdate</span>(nextSchemaProductList);
     * </pre>
     ...
     * <pre>
     * nextSchemaProductBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;NextSchemaProduct, NextSchemaProductCB&gt;() {
     ...
     * NextSchemaProductCB cb = new NextSchemaProductCB();
     * cb.query().setFoo...(value);
     * nextSchemaProductBhv.<span style="color: #CC4747">queryUpdate</span>(nextSchemaProduct, cb);
     * </pre>
     ...
     * NextSchemaProductCB cb = new NextSchemaProductCB();
     * cb.query().setFoo...(value);
     * nextSchemaProductBhv.<span style="color: #CC4747">queryDelete</span>(nextSchemaProduct, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of NextSchemaProduct. (NotNull)
     ...
     * nextSchemaProductBhv.<span style="color: #CC4747">varyingInsert</span>(nextSchemaProduct, option);
     * ... = nextSchemaProduct.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param nextSchemaProduct The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     nextSchemaProductBhv.<span style="color: #CC4747">varyingUpdate</span>(nextSchemaProduct, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * nextSchemaProductBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(nextSchemaProduct, cb, option);
     * </pre>
