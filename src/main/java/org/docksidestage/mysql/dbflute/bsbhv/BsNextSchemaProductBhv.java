...
public abstract class BsNextSchemaProductBhv extends AbstractBehaviorWritable<NextSchemaProduct, NextSchemaProductCB> {
     ...
     * NextSchemaProductCB cb = new NextSchemaProductCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;NextSchemaProduct&gt; entity = nextSchemaProductBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(nextSchemaProduct -&gt; {
     *     ...
     * });
     * NextSchemaProduct nextSchemaProduct = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(nextSchemaProduct -&gt; {
     *     ...
     * });
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<NextSchemaProduct> selectByPK(Long productId) {
        return facadeSelectByPK(productId);
    }

    protected OptionalEntity<NextSchemaProduct> facadeSelectByPK(Long productId) {
    ...
    public int queryUpdate(NextSchemaProduct nextSchemaProduct, CBCall<NextSchemaProductCB> cbLambda) {
        return doQueryUpdate(nextSchemaProduct, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(NextSchemaProduct nextSchemaProduct, WOptionCall<NextSchemaProductCB, InsertOption<NextSchemaProductCB>> opLambda) {
        doInsert(nextSchemaProduct, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(NextSchemaProduct nextSchemaProduct, WOptionCall<NextSchemaProductCB, UpdateOption<NextSchemaProductCB>> opLambda) {
        doUpdate(nextSchemaProduct, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(NextSchemaProduct nextSchemaProduct, WOptionCall<NextSchemaProductCB, InsertOption<NextSchemaProductCB>> insertOpLambda, WOptionCall<NextSchemaProductCB, UpdateOption<NextSchemaProductCB>> updateOpLambda) {
        doInsertOrUpdate(nextSchemaProduct, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(NextSchemaProduct nextSchemaProduct, WOptionCall<NextSchemaProductCB, DeleteOption<NextSchemaProductCB>> opLambda) {
        doDelete(nextSchemaProduct, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<NextSchemaProduct> nextSchemaProductList, WOptionCall<NextSchemaProductCB, InsertOption<NextSchemaProductCB>> opLambda) {
        return doBatchInsert(nextSchemaProductList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<NextSchemaProduct> nextSchemaProductList, WOptionCall<NextSchemaProductCB, UpdateOption<NextSchemaProductCB>> opLambda) {
        return doBatchUpdate(nextSchemaProductList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<NextSchemaProduct> nextSchemaProductList, WOptionCall<NextSchemaProductCB, DeleteOption<NextSchemaProductCB>> opLambda) {
        return doBatchDelete(nextSchemaProductList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<NextSchemaProduct, NextSchemaProductCB> manyArgLambda, WOptionCall<NextSchemaProductCB, InsertOption<NextSchemaProductCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(NextSchemaProduct nextSchemaProduct, CBCall<NextSchemaProductCB> cbLambda, WOptionCall<NextSchemaProductCB, UpdateOption<NextSchemaProductCB>> opLambda) {
        return doQueryUpdate(nextSchemaProduct, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(NextSchemaProduct nextSchemaProduct, NextSchemaProductCB cb, WOptionCall<NextSchemaProductCB, UpdateOption<NextSchemaProductCB>> opLambda) {
        return doQueryUpdate(nextSchemaProduct, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<NextSchemaProductCB> cbLambda, WOptionCall<NextSchemaProductCB, DeleteOption<NextSchemaProductCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(NextSchemaProductCB cb, WOptionCall<NextSchemaProductCB, DeleteOption<NextSchemaProductCB>> opLambda) {
