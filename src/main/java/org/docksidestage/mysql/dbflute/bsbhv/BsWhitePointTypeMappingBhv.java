...
public abstract class BsWhitePointTypeMappingBhv extends AbstractBehaviorWritable<WhitePointTypeMapping, WhitePointTypeMappingCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whitePointTypeMappingBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * SpecifyColumn is ignored but you can use it only to remove text type column for union's distinct.
     * <pre>
     * WhitePointTypeMappingCB cb = <span style="color: #70226C">new</span> WhitePointTypeMappingCB();
     * cb.query().setFoo...(value);
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whitePointTypeMappingBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * <span style="color: #70226C">for</span> (WhitePointTypeMapping <span style="color: #553000">whitePointTypeMapping</span> : <span style="color: #553000">whitePointTypeMappingList</span>) {
     *     ... = <span style="color: #553000">whitePointTypeMapping</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePointTypeMapping. (NotNull)
     ...
     * <span style="color: #70226C">for</span> (WhitePointTypeMapping whitePointTypeMapping : <span style="color: #553000">whitePointTypeMappingList</span>) {
     *     ... = whitePointTypeMapping.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhitePointTypeMapping. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhitePointTypeMapping whitePointTypeMapping : <span style="color: #553000">page</span>) {
     *     ... = whitePointTypeMapping.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePointTypeMapping. (NotNull)
     ...
     * WhitePointTypeMappingCB cb = <span style="color: #70226C">new</span> WhitePointTypeMappingCB();
     * cb.query().set...
     * <span style="color: #0000C0">whitePointTypeMappingBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhitePointTypeMapping. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whitePointTypeMappingBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhitePointTypeMappingCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <pre>
     * WhitePointTypeMapping whitePointTypeMapping = <span style="color: #70226C">new</span> WhitePointTypeMapping();
     ...
     * <span style="color: #0000C0">whitePointTypeMappingBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whitePointTypeMapping, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * whitePointTypeMapping.setFoo...(value);
     * whitePointTypeMapping.setBar...(value);
     * <span style="color: #0000C0">whitePointTypeMappingBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whitePointTypeMapping, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whitePointTypeMappingBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whitePointTypeMapping, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whitePointTypeMapping.setVersionNo(value);</span>
     * <span style="color: #0000C0">whitePointTypeMappingBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whitePointTypeMapping, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhitePointTypeMappingCB cb = <span style="color: #70226C">new</span> WhitePointTypeMappingCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whitePointTypeMappingBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whitePointTypeMapping, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhitePointTypeMappingBhv> outsideSql() {
        return doOutsideSql();
    }
