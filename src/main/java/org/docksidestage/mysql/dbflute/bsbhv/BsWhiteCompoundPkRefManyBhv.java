...
public abstract class BsWhiteCompoundPkRefManyBhv extends AbstractBehaviorWritable<WhiteCompoundPkRefMany, WhiteCompoundPkRefManyCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteCompoundPkRefManyBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteCompoundPkRefManyBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteCompoundPkRefMany <span style="color: #553000">whiteCompoundPkRefMany</span> : <span style="color: #553000">whiteCompoundPkRefManyList</span>) {
     *     ... = <span style="color: #553000">whiteCompoundPkRefMany</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteCompoundPkRefMany. (NotNull)
     ...
     * for (WhiteCompoundPkRefMany whiteCompoundPkRefMany : <span style="color: #553000">whiteCompoundPkRefManyList</span>) {
     *     ... = whiteCompoundPkRefMany.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteCompoundPkRefMany. (NotNull)
     ...
     * ...
     * for (WhiteCompoundPkRefMany whiteCompoundPkRefMany : <span style="color: #553000">page</span>) {
     *     ... = whiteCompoundPkRefMany.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteCompoundPkRefMany. (NotNull)
     ...
     * WhiteCompoundPkRefManyCB cb = new WhiteCompoundPkRefManyCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteCompoundPkRefManyBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteCompoundPkRefMany&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteCompoundPkRefManyBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteCompoundPkRefManyBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteCompoundPkRefMany, option);
     * ... = whiteCompoundPkRefMany.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteCompoundPkRefMany The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteCompoundPkRefManyBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteCompoundPkRefMany, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #0000C0">whiteCompoundPkRefManyBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteCompoundPkRefMany, cb, option);
     * </pre>
