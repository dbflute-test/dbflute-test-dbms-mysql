...
/**
 * The behavior of WHITE_STILETTO_ALIAS as TABLE.
...
public abstract class BsWhiteStilettoAliasBhv extends AbstractBehaviorWritable<WhiteStilettoAlias, WhiteStilettoAliasCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public WhiteStilettoAliasDbm asDBMeta() { return WhiteStilettoAliasDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "white_stiletto_alias"; }
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteStilettoAliasBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteStilettoAliasBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * <span style="color: #70226C">for</span> (WhiteStilettoAlias <span style="color: #553000">whiteStilettoAlias</span> : <span style="color: #553000">whiteStilettoAliasList</span>) {
     *     ... = <span style="color: #553000">whiteStilettoAlias</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteStilettoAlias. (NotNull)
     ...
     * <span style="color: #70226C">for</span> (WhiteStilettoAlias whiteStilettoAlias : <span style="color: #553000">whiteStilettoAliasList</span>) {
     *     ... = whiteStilettoAlias.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteStilettoAlias. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteStilettoAlias whiteStilettoAlias : <span style="color: #553000">page</span>) {
     *     ... = whiteStilettoAlias.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteStilettoAlias. (NotNull)
     ...
     * WhiteStilettoAliasCB cb = <span style="color: #70226C">new</span> WhiteStilettoAliasCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteStilettoAliasBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteStilettoAlias. (NotNull)
     ...
     * <pre>
     * WhiteStilettoAlias whiteStilettoAlias = <span style="color: #70226C">new</span> WhiteStilettoAlias();
     ...
     * <pre>
     * <span style="color: #0000C0">whiteStilettoAliasBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteStilettoAlias. (NotNull)
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteStilettoAlias> whiteStilettoAliasList, WritableOptionCall<WhiteStilettoAliasCB, InsertOption<WhiteStilettoAliasCB>> opLambda) {
        return doBatchInsert(whiteStilettoAliasList, createInsertOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteStilettoAlias> whiteStilettoAliasList, WritableOptionCall<WhiteStilettoAliasCB, UpdateOption<WhiteStilettoAliasCB>> opLambda) {
        return doBatchUpdate(whiteStilettoAliasList, createUpdateOption(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteStilettoAlias> whiteStilettoAliasList, WritableOptionCall<WhiteStilettoAliasCB, DeleteOption<WhiteStilettoAliasCB>> opLambda) {
        return doBatchDelete(whiteStilettoAliasList, createDeleteOption(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteStilettoAlias, WhiteStilettoAliasCB> manyArgLambda, WritableOptionCall<WhiteStilettoAliasCB, InsertOption<WhiteStilettoAliasCB>> opLambda) {
