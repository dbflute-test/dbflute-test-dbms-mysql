...
public abstract class BsWhiteIncludeQueryBhv extends AbstractBehaviorWritable<WhiteIncludeQuery, WhiteIncludeQueryCB> {
     ...
     * int count = whiteIncludeQueryBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteIncludeQuery whiteIncludeQuery = whiteIncludeQueryBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteIncludeQuery -&gt; {
     ...
     * WhiteIncludeQuery whiteIncludeQuery = whiteIncludeQueryBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteIncludeQuery -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteIncludeQueryBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteIncludeQuery -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteIncludeQuery.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteIncludeQueryBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteIncludeQuery -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteIncludeQuery.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteIncludeQueryCB cb = new WhiteIncludeQueryCB();
     * cb.query().setFoo...(value);
     * WhiteIncludeQuery whiteIncludeQuery = whiteIncludeQueryBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteIncludeQuery&gt; whiteIncludeQueryList = whiteIncludeQueryBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteIncludeQueryList.forEach(whiteIncludeQuery -&gt; {
     *     ... = whiteIncludeQuery.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteIncludeQuery. (NotNull)
     ...
     * PagingResultBean&lt;WhiteIncludeQuery&gt; page = whiteIncludeQueryBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteIncludeQueryCB cb = new WhiteIncludeQueryCB();
     * cb.query().setFoo...(value);
     * whiteIncludeQueryBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteIncludeQuery&gt;() {
     ...
     * <pre>
     * whiteIncludeQueryBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * whiteIncludeQueryBhv.<span style="color: #CC4747">insert</span>(whiteIncludeQuery);
     ...
     * try {
     *     whiteIncludeQueryBhv.<span style="color: #CC4747">update</span>(whiteIncludeQuery);
     ...
     * whiteIncludeQuery.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteIncludeQueryBhv.<span style="color: #CC4747">delete</span>(whiteIncludeQuery);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteIncludeQueryBhv.<span style="color: #CC4747">batchInsert</span>(whiteIncludeQueryList);
     * </pre>
     ...
     *     whiteIncludeQueryList.add(whiteIncludeQuery);
     * }
     * whiteIncludeQueryBhv.<span style="color: #CC4747">batchUpdate</span>(whiteIncludeQueryList);
     * </pre>
     ...
     * <pre>
     * whiteIncludeQueryBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteIncludeQuery, WhiteIncludeQueryCB&gt;() {
     ...
     * WhiteIncludeQueryCB cb = new WhiteIncludeQueryCB();
     * cb.query().setFoo...(value);
     * whiteIncludeQueryBhv.<span style="color: #CC4747">queryUpdate</span>(whiteIncludeQuery, cb);
     * </pre>
     ...
     * WhiteIncludeQueryCB cb = new WhiteIncludeQueryCB();
     * cb.query().setFoo...(value);
     * whiteIncludeQueryBhv.<span style="color: #CC4747">queryDelete</span>(whiteIncludeQuery, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteIncludeQuery. (NotNull)
     ...
     * whiteIncludeQueryBhv.<span style="color: #CC4747">varyingInsert</span>(whiteIncludeQuery, option);
     * ... = whiteIncludeQuery.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteIncludeQuery The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteIncludeQueryBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteIncludeQuery, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteIncludeQueryBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteIncludeQuery, cb, option);
     * </pre>
