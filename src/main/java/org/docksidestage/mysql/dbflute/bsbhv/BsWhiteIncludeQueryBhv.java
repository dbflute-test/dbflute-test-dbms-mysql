...
public abstract class BsWhiteIncludeQueryBhv extends AbstractBehaviorWritable<WhiteIncludeQuery, WhiteIncludeQueryCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteIncludeQueryBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteIncludeQueryBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteIncludeQuery <span style="color: #553000">whiteIncludeQuery</span> : <span style="color: #553000">whiteIncludeQueryList</span>) {
     *     ... = <span style="color: #553000">whiteIncludeQuery</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteIncludeQuery. (NotNull)
     ...
     * for (WhiteIncludeQuery whiteIncludeQuery : <span style="color: #553000">whiteIncludeQueryList</span>) {
     *     ... = whiteIncludeQuery.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteIncludeQuery. (NotNull)
     ...
     * ...
     * for (WhiteIncludeQuery whiteIncludeQuery : <span style="color: #553000">page</span>) {
     *     ... = whiteIncludeQuery.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteIncludeQuery. (NotNull)
     ...
     * WhiteIncludeQueryCB cb = new WhiteIncludeQueryCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteIncludeQueryBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteIncludeQuery&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteIncludeQueryBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteIncludeQueryBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteIncludeQuery, option);
     * ... = whiteIncludeQuery.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteIncludeQuery The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteIncludeQueryBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteIncludeQuery, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #0000C0">whiteIncludeQueryBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteIncludeQuery, cb, option);
     * </pre>
