...
public abstract class BsWhiteMyselfBhv extends AbstractBehaviorWritable<WhiteMyself, WhiteMyselfCB> {
     ...
     * int count = whiteMyselfBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteMyself whiteMyself = whiteMyselfBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteMyself -&gt; {
     ...
     * WhiteMyself whiteMyself = whiteMyselfBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteMyself -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteMyselfBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteMyself -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteMyself.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteMyselfBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteMyself -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteMyself.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteMyselfCB cb = new WhiteMyselfCB();
     * cb.query().setFoo...(value);
     * WhiteMyself whiteMyself = whiteMyselfBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteMyself&gt; whiteMyselfList = whiteMyselfBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteMyselfList.forEach(whiteMyself -&gt; {
     *     ... = whiteMyself.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteMyself. (NotNull)
     ...
     * PagingResultBean&lt;WhiteMyself&gt; page = whiteMyselfBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteMyselfCB cb = new WhiteMyselfCB();
     * cb.query().setFoo...(value);
     * whiteMyselfBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteMyself&gt;() {
     ...
     * <pre>
     * whiteMyselfBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * whiteMyselfBhv.<span style="color: #CC4747">loadWhiteMyselfCheckList</span>(whiteMyselfList, checkCB -&gt; {
     *     checkCB.setupSelect...();
     ...
     * whiteMyselfBhv.<span style="color: #CC4747">insert</span>(whiteMyself);
     ...
     * try {
     *     whiteMyselfBhv.<span style="color: #CC4747">update</span>(whiteMyself);
     ...
     * whiteMyself.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteMyselfBhv.<span style="color: #CC4747">delete</span>(whiteMyself);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteMyselfBhv.<span style="color: #CC4747">batchInsert</span>(whiteMyselfList);
     * </pre>
     ...
     *     whiteMyselfList.add(whiteMyself);
     * }
     * whiteMyselfBhv.<span style="color: #CC4747">batchUpdate</span>(whiteMyselfList);
     * </pre>
     ...
     * <pre>
     * whiteMyselfBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteMyself, WhiteMyselfCB&gt;() {
     ...
     * WhiteMyselfCB cb = new WhiteMyselfCB();
     * cb.query().setFoo...(value);
     * whiteMyselfBhv.<span style="color: #CC4747">queryUpdate</span>(whiteMyself, cb);
     * </pre>
     ...
     * WhiteMyselfCB cb = new WhiteMyselfCB();
     * cb.query().setFoo...(value);
     * whiteMyselfBhv.<span style="color: #CC4747">queryDelete</span>(whiteMyself, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteMyself. (NotNull)
     ...
     * whiteMyselfBhv.<span style="color: #CC4747">varyingInsert</span>(whiteMyself, option);
     * ... = whiteMyself.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteMyself The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteMyselfBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteMyself, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteMyselfBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteMyself, cb, option);
     * </pre>
