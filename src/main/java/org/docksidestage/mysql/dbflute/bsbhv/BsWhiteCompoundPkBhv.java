...
public abstract class BsWhiteCompoundPkBhv extends AbstractBehaviorWritable<WhiteCompoundPk, WhiteCompoundPkCB> {
     ...
     * int count = whiteCompoundPkBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteCompoundPk whiteCompoundPk = whiteCompoundPkBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteCompoundPk -&gt; {
     ...
     * WhiteCompoundPk whiteCompoundPk = whiteCompoundPkBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteCompoundPk -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteCompoundPkBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteCompoundPk -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteCompoundPk.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteCompoundPkBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteCompoundPk -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteCompoundPk.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteCompoundPkCB cb = new WhiteCompoundPkCB();
     * cb.query().setFoo...(value);
     * WhiteCompoundPk whiteCompoundPk = whiteCompoundPkBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteCompoundPk&gt; whiteCompoundPkList = whiteCompoundPkBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteCompoundPkList.forEach(whiteCompoundPk -&gt; {
     *     ... = whiteCompoundPk.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteCompoundPk. (NotNull)
     ...
     * PagingResultBean&lt;WhiteCompoundPk&gt; page = whiteCompoundPkBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteCompoundPkCB cb = new WhiteCompoundPkCB();
     * cb.query().setFoo...(value);
     * whiteCompoundPkBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteCompoundPk&gt;() {
     ...
     * <pre>
     * whiteCompoundPkBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * whiteCompoundPkBhv.<span style="color: #CC4747">loadWhiteCompoundPkRefList</span>(whiteCompoundPkList, refCB -&gt; {
     *     refCB.setupSelect...();
     ...
     * <pre>
     * whiteCompoundPkBhv.<span style="color: #CC4747">loadWhiteCompoundPkRefManyToPKList</span>(whiteCompoundPkList, manyCB -&gt; {
     *     manyCB.setupSelect...();
     ...
     * whiteCompoundPkBhv.<span style="color: #CC4747">insert</span>(whiteCompoundPk);
     ...
     * try {
     *     whiteCompoundPkBhv.<span style="color: #CC4747">update</span>(whiteCompoundPk);
     ...
     * whiteCompoundPk.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteCompoundPkBhv.<span style="color: #CC4747">delete</span>(whiteCompoundPk);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteCompoundPkBhv.<span style="color: #CC4747">batchInsert</span>(whiteCompoundPkList);
     * </pre>
     ...
     *     whiteCompoundPkList.add(whiteCompoundPk);
     * }
     * whiteCompoundPkBhv.<span style="color: #CC4747">batchUpdate</span>(whiteCompoundPkList);
     * </pre>
     ...
     * <pre>
     * whiteCompoundPkBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteCompoundPk, WhiteCompoundPkCB&gt;() {
     ...
     * WhiteCompoundPkCB cb = new WhiteCompoundPkCB();
     * cb.query().setFoo...(value);
     * whiteCompoundPkBhv.<span style="color: #CC4747">queryUpdate</span>(whiteCompoundPk, cb);
     * </pre>
     ...
     * WhiteCompoundPkCB cb = new WhiteCompoundPkCB();
     * cb.query().setFoo...(value);
     * whiteCompoundPkBhv.<span style="color: #CC4747">queryDelete</span>(whiteCompoundPk, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteCompoundPk. (NotNull)
     ...
     * whiteCompoundPkBhv.<span style="color: #CC4747">varyingInsert</span>(whiteCompoundPk, option);
     * ... = whiteCompoundPk.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteCompoundPk The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteCompoundPkBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteCompoundPk, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteCompoundPkBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteCompoundPk, cb, option);
     * </pre>
