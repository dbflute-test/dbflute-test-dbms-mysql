...
public abstract class BsWhiteCompoundPkBhv extends AbstractBehaviorWritable<WhiteCompoundPk, WhiteCompoundPkCB> {
     ...
     * WhiteCompoundPkCB cb = new WhiteCompoundPkCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhiteCompoundPk&gt; entity = whiteCompoundPkBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whiteCompoundPk -&gt; {
     *     ...
     * });
     * WhiteCompoundPk whiteCompoundPk = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whiteCompoundPk -&gt; {
     *     ...
     * });
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteCompoundPk> selectEntity(WhiteCompoundPkCB cb) {
    ...
    public OptionalEntity<WhiteCompoundPk> selectByUniqueOfPkSecondIdReferredId(Integer pkSecondId, Integer referredId) {
        return facadeSelectByUniqueOfPkSecondIdReferredId(pkSecondId, referredId);
    }

    protected OptionalEntity<WhiteCompoundPk> facadeSelectByUniqueOfPkSecondIdReferredId(Integer pkSecondId, Integer referredId) {
        return doSelectByUniqueOfPkSecondIdReferredId(pkSecondId, referredId, typeOfSelectedEntity());
    }

    protected <ENTITY extends WhiteCompoundPk> OptionalEntity<ENTITY> doSelectByUniqueOfPkSecondIdReferredId(Integer pkSecondId, Integer referredId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOfPkSecondIdReferredId(pkSecondId, referredId), tp), pkSecondId, referredId);
    }
    ...
    protected WhiteCompoundPkCB xprepareCBAsUniqueOfPkSecondIdReferredId(Integer pkSecondId, Integer referredId) {
        ...
        return newConditionBean().acceptUniqueOfPkSecondIdReferredId(pkSecondId, referredId);
    }
    ...
    public OptionalEntity<WhiteCompoundPk> selectByUniqueOfPkSecondIdPkFirstId(Integer pkSecondId, Integer pkFirstId) {
        return facadeSelectByUniqueOfPkSecondIdPkFirstId(pkSecondId, pkFirstId);
    }

    protected OptionalEntity<WhiteCompoundPk> facadeSelectByUniqueOfPkSecondIdPkFirstId(Integer pkSecondId, Integer pkFirstId) {
        return doSelectByUniqueOfPkSecondIdPkFirstId(pkSecondId, pkFirstId, typeOfSelectedEntity());
    }

    protected <ENTITY extends WhiteCompoundPk> OptionalEntity<ENTITY> doSelectByUniqueOfPkSecondIdPkFirstId(Integer pkSecondId, Integer pkFirstId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOfPkSecondIdPkFirstId(pkSecondId, pkFirstId), tp), pkSecondId, pkFirstId);
    }
    ...
    protected WhiteCompoundPkCB xprepareCBAsUniqueOfPkSecondIdPkFirstId(Integer pkSecondId, Integer pkFirstId) {
        ...
        return newConditionBean().acceptUniqueOfPkSecondIdPkFirstId(pkSecondId, pkFirstId);
    }
     ...
     * <pre>
     * whiteCompoundPkBhv.<span style="color: #DD4747">loadWhiteCompoundPkRefList</span>(whiteCompoundPkList, refCB -&gt; {
     *     refCB.setupSelect...();
     ...
     * <pre>
     * whiteCompoundPkBhv.<span style="color: #DD4747">loadWhiteCompoundPkRefManyToPKList</span>(whiteCompoundPkList, manyCB -&gt; {
     *     manyCB.setupSelect...();
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WhiteCompoundPkRefMany> loadWhiteCompoundPkRefManyToPKList(List<WhiteCompoundPk> whiteCompoundPkList, ConditionBeanSetupper<WhiteCompoundPkRefManyCB> refCBLambda) {
        xassLRArg(whiteCompoundPkList, refCBLambda);
        return doLoadWhiteCompoundPkRefManyToPKList(whiteCompoundPkList, new LoadReferrerOption<WhiteCompoundPkRefManyCB, WhiteCompoundPkRefMany>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WhiteCompoundPkRefMany> loadWhiteCompoundPkRefManyToPKList(WhiteCompoundPk whiteCompoundPk, ConditionBeanSetupper<WhiteCompoundPkRefManyCB> refCBLambda) {
        xassLRArg(whiteCompoundPk, refCBLambda);
        return doLoadWhiteCompoundPkRefManyToPKList(xnewLRLs(whiteCompoundPk), new LoadReferrerOption<WhiteCompoundPkRefManyCB, WhiteCompoundPkRefMany>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WhiteCompoundPkRefMany> loadWhiteCompoundPkRefManyToPKList(WhiteCompoundPk whiteCompoundPk, LoadReferrerOption<WhiteCompoundPkRefManyCB, WhiteCompoundPkRefMany> loadReferrerOption) {
        xassLRArg(whiteCompoundPk, loadReferrerOption);
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<WhiteCompoundPkRefMany> loadWhiteCompoundPkRefManyToPKList(List<WhiteCompoundPk> whiteCompoundPkList, LoadReferrerOption<WhiteCompoundPkRefManyCB, WhiteCompoundPkRefMany> loadReferrerOption) {
        xassLRArg(whiteCompoundPkList, loadReferrerOption);
        if (whiteCompoundPkList.isEmpty()) { return (NestedReferrerListGateway<WhiteCompoundPkRefMany>)EMPTY_NREF_LGWAY; }
        return doLoadWhiteCompoundPkRefManyToPKList(whiteCompoundPkList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<WhiteCompoundPkRefMany> doLoadWhiteCompoundPkRefManyToPKList(List<WhiteCompoundPk> whiteCompoundPkList, LoadReferrerOption<WhiteCompoundPkRefManyCB, WhiteCompoundPkRefMany> option) {
        return helpLoadReferrerInternally(whiteCompoundPkList, option, "whiteCompoundPkRefManyToPKList");
    }
    ...
    { return helpPulloutInternally(whiteCompoundPkList, "whiteCompoundReferredNormally"); }
    ...
    { return helpPulloutInternally(whiteCompoundPkList, "whiteCompoundReferredPrimary"); }
    ...
    { return helpPulloutInternally(whiteCompoundPkList, "whiteCompoundPkRefManyAsMax"); }
    ...
    { return helpPulloutInternally(whiteCompoundPkList, "whiteCompoundPkRefManyAsMin"); }
    ...
    public int queryUpdate(WhiteCompoundPk whiteCompoundPk, CBCall<WhiteCompoundPkCB> cbLambda) {
        return doQueryUpdate(whiteCompoundPk, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteCompoundPk whiteCompoundPk, WOptionCall<WhiteCompoundPkCB, InsertOption<WhiteCompoundPkCB>> opLambda) {
        doInsert(whiteCompoundPk, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteCompoundPk whiteCompoundPk, WOptionCall<WhiteCompoundPkCB, UpdateOption<WhiteCompoundPkCB>> opLambda) {
        doUpdate(whiteCompoundPk, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteCompoundPk whiteCompoundPk, WOptionCall<WhiteCompoundPkCB, InsertOption<WhiteCompoundPkCB>> insertOpLambda, WOptionCall<WhiteCompoundPkCB, UpdateOption<WhiteCompoundPkCB>> updateOpLambda) {
        doInsertOrUpdate(whiteCompoundPk, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteCompoundPk whiteCompoundPk, WOptionCall<WhiteCompoundPkCB, DeleteOption<WhiteCompoundPkCB>> opLambda) {
        doDelete(whiteCompoundPk, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteCompoundPk> whiteCompoundPkList, WOptionCall<WhiteCompoundPkCB, InsertOption<WhiteCompoundPkCB>> opLambda) {
        return doBatchInsert(whiteCompoundPkList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteCompoundPk> whiteCompoundPkList, WOptionCall<WhiteCompoundPkCB, UpdateOption<WhiteCompoundPkCB>> opLambda) {
        return doBatchUpdate(whiteCompoundPkList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteCompoundPk> whiteCompoundPkList, WOptionCall<WhiteCompoundPkCB, DeleteOption<WhiteCompoundPkCB>> opLambda) {
        return doBatchDelete(whiteCompoundPkList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteCompoundPk, WhiteCompoundPkCB> manyArgLambda, WOptionCall<WhiteCompoundPkCB, InsertOption<WhiteCompoundPkCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteCompoundPk whiteCompoundPk, CBCall<WhiteCompoundPkCB> cbLambda, WOptionCall<WhiteCompoundPkCB, UpdateOption<WhiteCompoundPkCB>> opLambda) {
        return doQueryUpdate(whiteCompoundPk, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteCompoundPk whiteCompoundPk, WhiteCompoundPkCB cb, WOptionCall<WhiteCompoundPkCB, UpdateOption<WhiteCompoundPkCB>> opLambda) {
        return doQueryUpdate(whiteCompoundPk, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteCompoundPkCB> cbLambda, WOptionCall<WhiteCompoundPkCB, DeleteOption<WhiteCompoundPkCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteCompoundPkCB cb, WOptionCall<WhiteCompoundPkCB, DeleteOption<WhiteCompoundPkCB>> opLambda) {
