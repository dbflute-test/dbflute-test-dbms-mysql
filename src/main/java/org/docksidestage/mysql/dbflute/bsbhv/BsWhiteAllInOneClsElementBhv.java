...
public abstract class BsWhiteAllInOneClsElementBhv extends AbstractBehaviorWritable<WhiteAllInOneClsElement, WhiteAllInOneClsElementCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">whiteAllInOneClsElement</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = <span style="color: #553000">whiteAllInOneClsElement</span>.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">whiteAllInOneClsElement</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteAllInOneClsElement <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteAllInOneClsElement.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteAllInOneClsElement <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteAllInOneClsElement.get...
     * }).<span style="color: #994747">orElse</span>(() <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * <pre>
     * WhiteAllInOneClsElement <span style="color: #553000">whiteAllInOneClsElement</span> = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">whiteAllInOneClsElement</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAllInOneClsElement. (NotNull)
     ...
     * WhiteAllInOneClsElementCB cb = <span style="color: #70226C">new</span> WhiteAllInOneClsElementCB();
     * cb.query().set...;
     * WhiteAllInOneClsElement whiteAllInOneClsElement = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteAllInOneClsElement&gt; <span style="color: #553000">whiteAllInOneClsElementList</span> = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (WhiteAllInOneClsElement <span style="color: #553000">whiteAllInOneClsElement</span> : <span style="color: #553000">whiteAllInOneClsElementList</span>) {
     *     ... = <span style="color: #553000">whiteAllInOneClsElement</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAllInOneClsElement. (NotNull)
     ...
     * cb.query().set...;
     * cb.query().addOrderBy...;
     * ListResultBean&lt;WhiteAllInOneClsElement&gt; <span style="color: #553000">whiteAllInOneClsElementList</span> = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectList</span>(cb);
     * <span style="color: #70226C">for</span> (WhiteAllInOneClsElement whiteAllInOneClsElement : <span style="color: #553000">whiteAllInOneClsElementList</span>) {
     *     ... = whiteAllInOneClsElement.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteAllInOneClsElement. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;WhiteAllInOneClsElement&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteAllInOneClsElement whiteAllInOneClsElement : <span style="color: #553000">page</span>) {
     *     ... = whiteAllInOneClsElement.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAllInOneClsElement. (NotNull)
     ...
     * PagingResultBean&lt;WhiteAllInOneClsElement&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectPage</span>(cb);
     * <span style="color: #70226C">int</span> allRecordCount = <span style="color: #553000">page</span>.getAllRecordCount();
     * <span style="color: #70226C">int</span> allPageCount = <span style="color: #553000">page</span>.getAllPageCount();
     * <span style="color: #70226C">boolean</span> isExistPrePage = <span style="color: #553000">page</span>.isExistPrePage();
     * <span style="color: #70226C">boolean</span> isExistNextPage = <span style="color: #553000">page</span>.isExistNextPage();
     ...
     * <pre>
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * WhiteAllInOneClsElementCB cb = <span style="color: #70226C">new</span> WhiteAllInOneClsElementCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteAllInOneClsElement. (NotNull)
     ...
     * <pre>
     * WhiteAllInOneClsElement whiteAllInOneClsElement = <span style="color: #70226C">new</span> WhiteAllInOneClsElement();
     ...
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">insert</span>(whiteAllInOneClsElement);
     ...
     *     <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">delete</span>(whiteAllInOneClsElement);
     ...
     * }
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">batchInsert</span>(whiteAllInOneClsElementList);
     * </pre>
     ...
     *     whiteAllInOneClsElementList.add(whiteAllInOneClsElement);
     * }
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">batchUpdate</span>(whiteAllInOneClsElementList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteAllInOneClsElement, WhiteAllInOneClsElementCB&gt;() {
