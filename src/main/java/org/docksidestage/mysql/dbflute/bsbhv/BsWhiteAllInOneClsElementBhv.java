...
public abstract class BsWhiteAllInOneClsElementBhv extends AbstractBehaviorWritable<WhiteAllInOneClsElement, WhiteAllInOneClsElementCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteAllInOneClsElement <span style="color: #553000">whiteAllInOneClsElement</span> : <span style="color: #553000">whiteAllInOneClsElementList</span>) {
     *     ... = <span style="color: #553000">whiteAllInOneClsElement</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAllInOneClsElement. (NotNull)
     ...
     * for (WhiteAllInOneClsElement whiteAllInOneClsElement : <span style="color: #553000">whiteAllInOneClsElementList</span>) {
     *     ... = whiteAllInOneClsElement.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteAllInOneClsElement. (NotNull)
     ...
     * ...
     * for (WhiteAllInOneClsElement whiteAllInOneClsElement : <span style="color: #553000">page</span>) {
     *     ... = whiteAllInOneClsElement.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAllInOneClsElement. (NotNull)
     ...
     * WhiteAllInOneClsElementCB cb = new WhiteAllInOneClsElementCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteAllInOneClsElementBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteAllInOneClsElement&gt;() {
