...
public abstract class BsWhiteDeprecatedClsElementBhv extends AbstractBehaviorWritable<WhiteDeprecatedClsElement, WhiteDeprecatedClsElementCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteDeprecatedClsElement <span style="color: #553000">whiteDeprecatedClsElement</span> : <span style="color: #553000">whiteDeprecatedClsElementList</span>) {
     *     ... = <span style="color: #553000">whiteDeprecatedClsElement</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDeprecatedClsElement. (NotNull)
     ...
     * for (WhiteDeprecatedClsElement whiteDeprecatedClsElement : <span style="color: #553000">whiteDeprecatedClsElementList</span>) {
     *     ... = whiteDeprecatedClsElement.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteDeprecatedClsElement. (NotNull)
     ...
     * ...
     * for (WhiteDeprecatedClsElement whiteDeprecatedClsElement : <span style="color: #553000">page</span>) {
     *     ... = whiteDeprecatedClsElement.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDeprecatedClsElement. (NotNull)
     ...
     * WhiteDeprecatedClsElementCB cb = new WhiteDeprecatedClsElementCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteDeprecatedClsElement&gt;() {
