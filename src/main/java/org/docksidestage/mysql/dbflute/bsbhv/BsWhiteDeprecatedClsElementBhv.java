...
public abstract class BsWhiteDeprecatedClsElementBhv extends AbstractBehaviorWritable<WhiteDeprecatedClsElement, WhiteDeprecatedClsElementCB> {
     ...
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteDeprecatedClsElement, option);
     * ... = whiteDeprecatedClsElement.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteDeprecatedClsElement The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteDeprecatedClsElement, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * WhiteDeprecatedClsElementCB cb = new WhiteDeprecatedClsElementCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;WhiteDeprecatedClsElementCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;WhiteDeprecatedClsElementCB&gt;();
     * option.self(new SpecifyQuery&lt;WhiteDeprecatedClsElementCB&gt;() {
     *     public void specify(WhiteDeprecatedClsElementCB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteDeprecatedClsElement, cb, option);
     * </pre>
