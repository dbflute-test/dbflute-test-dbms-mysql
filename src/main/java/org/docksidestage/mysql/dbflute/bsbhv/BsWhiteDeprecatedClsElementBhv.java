...
/**
 * The behavior of WHITE_DEPRECATED_CLS_ELEMENT as TABLE.
...
public abstract class BsWhiteDeprecatedClsElementBhv extends AbstractBehaviorWritable<WhiteDeprecatedClsElement, WhiteDeprecatedClsElementCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * SpecifyColumn is ignored but you can use it only to remove text type column for union's distinct.
     * <pre>
     * WhiteDeprecatedClsElementCB cb = <span style="color: #70226C">new</span> WhiteDeprecatedClsElementCB();
     * cb.query().setFoo...(value);
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">whiteDeprecatedClsElement</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = <span style="color: #553000">whiteDeprecatedClsElement</span>.get...
     * });
     *
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">whiteDeprecatedClsElement</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteDeprecatedClsElement <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteDeprecatedClsElement.get...
     * });
     *
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteDeprecatedClsElement <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteDeprecatedClsElement.get...
     * }).<span style="color: #994747">orElse</span>(() <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * <pre>
     * WhiteDeprecatedClsElement <span style="color: #553000">whiteDeprecatedClsElement</span> = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">whiteDeprecatedClsElement</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDeprecatedClsElement. (NotNull)
     ...
     * WhiteDeprecatedClsElementCB cb = <span style="color: #70226C">new</span> WhiteDeprecatedClsElementCB();
     * cb.query().set...;
     * WhiteDeprecatedClsElement whiteDeprecatedClsElement = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteDeprecatedClsElement&gt; <span style="color: #553000">whiteDeprecatedClsElementList</span> = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (WhiteDeprecatedClsElement <span style="color: #553000">whiteDeprecatedClsElement</span> : <span style="color: #553000">whiteDeprecatedClsElementList</span>) {
     *     ... = <span style="color: #553000">whiteDeprecatedClsElement</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDeprecatedClsElement. (NotNull)
     ...
     * cb.query().set...;
     * cb.query().addOrderBy...;
     * ListResultBean&lt;WhiteDeprecatedClsElement&gt; <span style="color: #553000">whiteDeprecatedClsElementList</span> = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectList</span>(cb);
     * <span style="color: #70226C">for</span> (WhiteDeprecatedClsElement whiteDeprecatedClsElement : <span style="color: #553000">whiteDeprecatedClsElementList</span>) {
     *     ... = whiteDeprecatedClsElement.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteDeprecatedClsElement. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;WhiteDeprecatedClsElement&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteDeprecatedClsElement whiteDeprecatedClsElement : <span style="color: #553000">page</span>) {
     *     ... = whiteDeprecatedClsElement.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDeprecatedClsElement. (NotNull)
     ...
     * PagingResultBean&lt;WhiteDeprecatedClsElement&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectPage</span>(cb);
     * <span style="color: #70226C">int</span> allRecordCount = <span style="color: #553000">page</span>.getAllRecordCount();
     * <span style="color: #70226C">int</span> allPageCount = <span style="color: #553000">page</span>.getAllPageCount();
     * <span style="color: #70226C">boolean</span> isExistPrePage = <span style="color: #553000">page</span>.isExistPrePage();
     * <span style="color: #70226C">boolean</span> isExistNextPage = <span style="color: #553000">page</span>.isExistNextPage();
     ...
     * <pre>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * WhiteDeprecatedClsElementCB cb = <span style="color: #70226C">new</span> WhiteDeprecatedClsElementCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteDeprecatedClsElement. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteDeprecatedClsElementCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <pre>
     * WhiteDeprecatedClsElement whiteDeprecatedClsElement = <span style="color: #70226C">new</span> WhiteDeprecatedClsElement();
     ...
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">insert</span>(whiteDeprecatedClsElement);
     ...
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">update</span>(whiteDeprecatedClsElement);
     * </pre>
     ...
     *     <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">delete</span>(whiteDeprecatedClsElement);
     ...
     * }
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">batchInsert</span>(whiteDeprecatedClsElementList);
     * </pre>
     ...
     *     whiteDeprecatedClsElementList.add(whiteDeprecatedClsElement);
     * }
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">batchUpdate</span>(whiteDeprecatedClsElementList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteDeprecatedClsElement, WhiteDeprecatedClsElementCB&gt;() {
     ...
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteDeprecatedClsElement, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * WhiteDeprecatedClsElementCB cb = <span style="color: #70226C">new</span> WhiteDeprecatedClsElementCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteDeprecatedClsElement, cb);
     * </pre>
     * @param whiteDeprecatedClsElement The entity that contains update values. (NotNull, PrimaryKeyNullAllowed)
     * @param cb The condition-bean of WhiteDeprecatedClsElement. (NotNull)
     * @return The updated count.
     ...
     * <pre>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDeprecatedClsElement. (NotNull)
     ...
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteDeprecatedClsElement, cb);
     * </pre>
     * @param cb The condition-bean of WhiteDeprecatedClsElement. (NotNull)
     * @return The deleted count.
     * @throws NonQueryDeleteNotAllowedException When the query has no condition.
     ...
     * whiteDeprecatedClsElement.setFoo...(value);
     * whiteDeprecatedClsElement.setBar...(value);
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteDeprecatedClsElement, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteDeprecatedClsElement, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteDeprecatedClsElement.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteDeprecatedClsElement, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteDeprecatedClsElementCB cb = <span style="color: #70226C">new</span> WhiteDeprecatedClsElementCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteDeprecatedClsElement, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     * <pre>
     * <span style="color: #0000C0">whiteDeprecatedClsElementBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteDeprecatedClsElement, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * }, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhiteDeprecatedClsElementBhv> outsideSql() {
        return doOutsideSql();
    }
