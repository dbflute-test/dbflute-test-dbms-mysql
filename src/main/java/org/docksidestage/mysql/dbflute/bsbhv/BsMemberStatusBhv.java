...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable<MemberStatus, MemberStatusCB> {
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #DD4747">loadMemberList</span>(memberStatusList, memberCB -&gt; {
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #DD4747">loadMemberLoginList</span>(memberStatusList, loginCB -&gt; {
     *     loginCB.setupSelect...();
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(MemberStatus memberStatus, MemberStatusCB cb, WOptionCall<MemberStatusCB, UpdateOption<MemberStatusCB>> opLambda) {
        return doQueryUpdate(memberStatus, cb, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(MemberStatusCB cb, WOptionCall<MemberStatusCB, DeleteOption<MemberStatusCB>> opLambda) {
