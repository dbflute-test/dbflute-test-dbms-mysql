...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable<MemberStatus, MemberStatusCB> {
     ...
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(memberStatus -&gt; {
     ...
     * MemberStatus memberStatus = memberStatusBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(memberStatus -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * memberStatusBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(memberStatus -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = memberStatus.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * memberStatusBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(memberStatus -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = memberStatus.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #CC4747">loadMemberList</span>(memberStatusList, memberCB -&gt; {
     ...
     * <pre>
     * memberStatusBhv.<span style="color: #CC4747">loadMemberLoginList</span>(memberStatusList, loginCB -&gt; {
     *     loginCB.setupSelect...();
