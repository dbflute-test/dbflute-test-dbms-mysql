...
public abstract class BsWhiteStilettoAliasRefBhv extends AbstractBehaviorWritable<WhiteStilettoAliasRef, WhiteStilettoAliasRefCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteStilettoAliasRefBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * SpecifyColumn is ignored but you can use it only to remove text type column for union's distinct.
     * <pre>
     * WhiteStilettoAliasRefCB cb = <span style="color: #70226C">new</span> WhiteStilettoAliasRefCB();
     * cb.query().setFoo...(value);
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteStilettoAliasRefBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * <span style="color: #70226C">for</span> (WhiteStilettoAliasRef <span style="color: #553000">whiteStilettoAliasRef</span> : <span style="color: #553000">whiteStilettoAliasRefList</span>) {
     *     ... = <span style="color: #553000">whiteStilettoAliasRef</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteStilettoAliasRef. (NotNull)
     ...
     * <span style="color: #70226C">for</span> (WhiteStilettoAliasRef whiteStilettoAliasRef : <span style="color: #553000">whiteStilettoAliasRefList</span>) {
     *     ... = whiteStilettoAliasRef.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteStilettoAliasRef. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteStilettoAliasRef whiteStilettoAliasRef : <span style="color: #553000">page</span>) {
     *     ... = whiteStilettoAliasRef.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteStilettoAliasRef. (NotNull)
     ...
     * WhiteStilettoAliasRefCB cb = <span style="color: #70226C">new</span> WhiteStilettoAliasRefCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteStilettoAliasRefBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteStilettoAliasRef. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whiteStilettoAliasRefBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteStilettoAliasRefCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <pre>
     * WhiteStilettoAliasRef whiteStilettoAliasRef = <span style="color: #70226C">new</span> WhiteStilettoAliasRef();
     ...
     * <span style="color: #0000C0">whiteStilettoAliasRefBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteStilettoAliasRef, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * whiteStilettoAliasRef.setFoo...(value);
     * whiteStilettoAliasRef.setBar...(value);
     * <span style="color: #0000C0">whiteStilettoAliasRefBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteStilettoAliasRef, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteStilettoAliasRefBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteStilettoAliasRef, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteStilettoAliasRef.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteStilettoAliasRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteStilettoAliasRef, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteStilettoAliasRefCB cb = <span style="color: #70226C">new</span> WhiteStilettoAliasRefCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteStilettoAliasRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteStilettoAliasRef, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhiteStilettoAliasRefBhv> outsideSql() {
        return doOutsideSql();
    }
