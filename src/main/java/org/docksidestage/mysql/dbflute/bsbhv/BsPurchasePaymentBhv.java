...
public abstract class BsPurchasePaymentBhv extends AbstractBehaviorWritable<PurchasePayment, PurchasePaymentCB> {
     ...
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(purchasePayment -&gt; {
     ...
     * PurchasePayment purchasePayment = purchasePaymentBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(purchasePayment -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * purchasePaymentBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(purchasePayment -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = purchasePayment.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * purchasePaymentBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(purchasePayment -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = purchasePayment.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
