...
/**
 * The behavior of VENDOR_CONSTRAINT_NAME_AUTO_REF as TABLE.
...
public abstract class BsVendorConstraintNameAutoRefBhv extends AbstractBehaviorWritable<VendorConstraintNameAutoRef, VendorConstraintNameAutoRefCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">vendorConstraintNameAutoRefBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorConstraintNameAutoRef. (NotNull)
     ...
     * VendorConstraintNameAutoRefCB cb = <span style="color: #70226C">new</span> VendorConstraintNameAutoRefCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">vendorConstraintNameAutoRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorConstraintNameAutoRef, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
