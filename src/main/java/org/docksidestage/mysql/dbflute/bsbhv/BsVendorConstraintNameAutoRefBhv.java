...
public abstract class BsVendorConstraintNameAutoRefBhv extends AbstractBehaviorWritable<VendorConstraintNameAutoRef, VendorConstraintNameAutoRefCB> {
     ...
     * SpecifyColumn is ignored but you can use it only to remove text type column for union's distinct.
     * <pre>
     * VendorConstraintNameAutoRefCB cb = <span style="color: #70226C">new</span> VendorConstraintNameAutoRefCB();
     * cb.query().setFoo...(value);
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">vendorConstraintNameAutoRefBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <span style="color: #70226C">for</span> (VendorConstraintNameAutoRef vendorConstraintNameAutoRef : <span style="color: #553000">vendorConstraintNameAutoRefList</span>) {
     *     ... = vendorConstraintNameAutoRef.get...;
     * }
     * </pre>
     * @param cb The condition-bean of VendorConstraintNameAutoRef. (NotNull)
     ...
     * VendorConstraintNameAutoRefCB cb = <span style="color: #70226C">new</span> VendorConstraintNameAutoRefCB();
     * cb.query().set...
     * <span style="color: #0000C0">vendorConstraintNameAutoRefBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of VendorConstraintNameAutoRef. (NotNull)
     ...
     * VendorConstraintNameAutoRefCB cb = new VendorConstraintNameAutoRefCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;VendorConstraintNameAutoRefCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;VendorConstraintNameAutoRefCB&gt;();
     * option.self(new SpecifyQuery&lt;VendorConstraintNameAutoRefCB&gt;() {
     *     public void specify(VendorConstraintNameAutoRefCB cb) {
