...
/**
 * The behavior of WHITE_DATE_ADJUSTMENT as TABLE.
...
public abstract class BsWhiteDateAdjustmentBhv extends AbstractBehaviorWritable<WhiteDateAdjustment, WhiteDateAdjustmentCB> {
     ...
     * <span style="color: #0000C0">whiteDateAdjustmentBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteDateAdjustment, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteDateAdjustmentBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDateAdjustment. (NotNull)
     ...
     * whiteDateAdjustment.setFoo...(value);
     * whiteDateAdjustment.setBar...(value);
     * <span style="color: #0000C0">whiteDateAdjustmentBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteDateAdjustment, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteDateAdjustmentBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteDateAdjustment, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteDateAdjustment.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteDateAdjustmentBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteDateAdjustment, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteDateAdjustmentCB cb = <span style="color: #70226C">new</span> WhiteDateAdjustmentCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteDateAdjustmentBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteDateAdjustment, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     * <pre>
     * <span style="color: #0000C0">whiteDateAdjustmentBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteDateAdjustment, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * }, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
