...
public abstract class BsVendorConstraintNameAutoQuxBhv extends AbstractBehaviorWritable<VendorConstraintNameAutoQux, VendorConstraintNameAutoQuxCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">vendorConstraintNameAutoQuxBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">vendorConstraintNameAutoQuxBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (VendorConstraintNameAutoQux <span style="color: #553000">vendorConstraintNameAutoQux</span> : <span style="color: #553000">vendorConstraintNameAutoQuxList</span>) {
     *     ... = <span style="color: #553000">vendorConstraintNameAutoQux</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorConstraintNameAutoQux. (NotNull)
     ...
     * ...
     * for (VendorConstraintNameAutoQux vendorConstraintNameAutoQux : <span style="color: #553000">page</span>) {
     *     ... = vendorConstraintNameAutoQux.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorConstraintNameAutoQux. (NotNull)
     ...
     * VendorConstraintNameAutoQuxCB cb = new VendorConstraintNameAutoQuxCB();
     * cb.query().set...
     * <span style="color: #0000C0">vendorConstraintNameAutoQuxBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorConstraintNameAutoQux&gt;() {
