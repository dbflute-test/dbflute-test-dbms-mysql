...
public abstract class BsWhiteVariantRelationMasterBarBhv extends AbstractBehaviorWritable<WhiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB> {
     ...
     * WhiteVariantRelationMasterBarCB cb = new WhiteVariantRelationMasterBarCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhiteVariantRelationMasterBar&gt; entity = whiteVariantRelationMasterBarBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whiteVariantRelationMasterBar -&gt; {
     *     ...
     * });
     * WhiteVariantRelationMasterBar whiteVariantRelationMasterBar = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whiteVariantRelationMasterBar -&gt; {
     *     ...
     * });
     ...
     * <pre>
     * whiteVariantRelationMasterBarBhv.<span style="color: #DD4747">loadWhiteVariantRelationReferrerAsVariantList</span>(whiteVariantRelationMasterBarList, referrerCB -&gt; {
    ...
    public int queryUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, CBCall<WhiteVariantRelationMasterBarCB> cbLambda) {
        return doQueryUpdate(whiteVariantRelationMasterBar, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WOptionCall<WhiteVariantRelationMasterBarCB, InsertOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        doInsert(whiteVariantRelationMasterBar, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        doUpdate(whiteVariantRelationMasterBar, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WOptionCall<WhiteVariantRelationMasterBarCB, InsertOption<WhiteVariantRelationMasterBarCB>> insertOpLambda, WOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> updateOpLambda) {
        doInsertOrUpdate(whiteVariantRelationMasterBar, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WOptionCall<WhiteVariantRelationMasterBarCB, DeleteOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        doDelete(whiteVariantRelationMasterBar, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteVariantRelationMasterBar> whiteVariantRelationMasterBarList, WOptionCall<WhiteVariantRelationMasterBarCB, InsertOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doBatchInsert(whiteVariantRelationMasterBarList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteVariantRelationMasterBar> whiteVariantRelationMasterBarList, WOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doBatchUpdate(whiteVariantRelationMasterBarList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteVariantRelationMasterBar> whiteVariantRelationMasterBarList, WOptionCall<WhiteVariantRelationMasterBarCB, DeleteOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doBatchDelete(whiteVariantRelationMasterBarList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB> manyArgLambda, WOptionCall<WhiteVariantRelationMasterBarCB, InsertOption<WhiteVariantRelationMasterBarCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, CBCall<WhiteVariantRelationMasterBarCB> cbLambda, WOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doQueryUpdate(whiteVariantRelationMasterBar, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB cb, WOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doQueryUpdate(whiteVariantRelationMasterBar, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteVariantRelationMasterBarCB> cbLambda, WOptionCall<WhiteVariantRelationMasterBarCB, DeleteOption<WhiteVariantRelationMasterBarCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteVariantRelationMasterBarCB cb, WOptionCall<WhiteVariantRelationMasterBarCB, DeleteOption<WhiteVariantRelationMasterBarCB>> opLambda) {
