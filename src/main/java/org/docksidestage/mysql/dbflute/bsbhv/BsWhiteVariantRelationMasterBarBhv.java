...
public abstract class BsWhiteVariantRelationMasterBarBhv extends AbstractBehaviorWritable<WhiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB> {
     ...
     * int count = whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteVariantRelationMasterBar whiteVariantRelationMasterBar = whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteVariantRelationMasterBar -&gt; {
     ...
     * WhiteVariantRelationMasterBar whiteVariantRelationMasterBar = whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteVariantRelationMasterBar -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteVariantRelationMasterBarBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteVariantRelationMasterBar -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteVariantRelationMasterBar.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteVariantRelationMasterBar -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteVariantRelationMasterBar.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteVariantRelationMasterBarCB cb = new WhiteVariantRelationMasterBarCB();
     * cb.query().setFoo...(value);
     * WhiteVariantRelationMasterBar whiteVariantRelationMasterBar = whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteVariantRelationMasterBar&gt; whiteVariantRelationMasterBarList = whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteVariantRelationMasterBarList.forEach(whiteVariantRelationMasterBar -&gt; {
     *     ... = whiteVariantRelationMasterBar.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterBar. (NotNull)
     ...
     * PagingResultBean&lt;WhiteVariantRelationMasterBar&gt; page = whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteVariantRelationMasterBarCB cb = new WhiteVariantRelationMasterBarCB();
     * cb.query().setFoo...(value);
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteVariantRelationMasterBar&gt;() {
     ...
     * <pre>
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">loadWhiteVariantRelationReferrerAsVariantList</span>(whiteVariantRelationMasterBarList, referrerCB -&gt; {
     ...
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">insert</span>(whiteVariantRelationMasterBar);
     ...
     * try {
     *     whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">update</span>(whiteVariantRelationMasterBar);
     ...
     * whiteVariantRelationMasterBar.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">delete</span>(whiteVariantRelationMasterBar);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">batchInsert</span>(whiteVariantRelationMasterBarList);
     * </pre>
     ...
     *     whiteVariantRelationMasterBarList.add(whiteVariantRelationMasterBar);
     * }
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">batchUpdate</span>(whiteVariantRelationMasterBarList);
     * </pre>
     ...
     * <pre>
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB&gt;() {
     ...
     * WhiteVariantRelationMasterBarCB cb = new WhiteVariantRelationMasterBarCB();
     * cb.query().setFoo...(value);
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">queryUpdate</span>(whiteVariantRelationMasterBar, cb);
     * </pre>
     ...
     * WhiteVariantRelationMasterBarCB cb = new WhiteVariantRelationMasterBarCB();
     * cb.query().setFoo...(value);
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">queryDelete</span>(whiteVariantRelationMasterBar, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterBar. (NotNull)
     ...
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">varyingInsert</span>(whiteVariantRelationMasterBar, option);
     * ... = whiteVariantRelationMasterBar.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteVariantRelationMasterBar The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteVariantRelationMasterBar, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteVariantRelationMasterBarBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteVariantRelationMasterBar, cb, option);
     * </pre>
