...
public abstract class BsWhiteVariantRelationMasterBarBhv extends AbstractBehaviorWritable<WhiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB> {
     ...
     */
    public int selectCount(CBCall<WhiteVariantRelationMasterBarCB> cbLambda) {
     ...
     * <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">whiteVariantRelationMasterBar</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">whiteVariantRelationMasterBar</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public OptionalEntity<WhiteVariantRelationMasterBar> selectEntity(CBCall<WhiteVariantRelationMasterBarCB> cbLambda) {
     ...
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteVariantRelationMasterBar <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteVariantRelationMasterBar.get...
     * });
     *
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteVariantRelationMasterBar <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteVariantRelationMasterBar.get...
     * }).<span style="color: #994747">orElse</span>(() <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteVariantRelationMasterBar> selectEntity(WhiteVariantRelationMasterBarCB cb) {
        return facadeSelectEntity(cb);
    }

    protected OptionalEntity<WhiteVariantRelationMasterBar> facadeSelectEntity(WhiteVariantRelationMasterBarCB cb) {
     ...
     * <pre>
     * WhiteVariantRelationMasterBar <span style="color: #553000">whiteVariantRelationMasterBar</span> = <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">whiteVariantRelationMasterBar</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterBar. (NotNull)
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public WhiteVariantRelationMasterBar selectEntityWithDeletedCheck(CBCall<WhiteVariantRelationMasterBarCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteVariantRelationMasterBar> selectByPK(Long masterBarId) {
        return facadeSelectByPK(masterBarId);
    }

    protected OptionalEntity<WhiteVariantRelationMasterBar> facadeSelectByPK(Long masterBarId) {
        return doSelectOptionalByPK(masterBarId, typeOfSelectedEntity());
    }
     ...
     * <pre>
     * ListResultBean&lt;WhiteVariantRelationMasterBar&gt; <span style="color: #553000">whiteVariantRelationMasterBarList</span> = <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     ...
     */
    public ListResultBean<WhiteVariantRelationMasterBar> selectList(CBCall<WhiteVariantRelationMasterBarCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;WhiteVariantRelationMasterBar&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<WhiteVariantRelationMasterBar> selectPage(CBCall<WhiteVariantRelationMasterBarCB> cbLambda) {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterBar. (NotNull)
     * @param entityLambda The handler of entity row of WhiteVariantRelationMasterBar. (NotNull)
     */
    public void selectCursor(CBCall<WhiteVariantRelationMasterBarCB> cbLambda, EntityRowHandler<WhiteVariantRelationMasterBar> entityLambda) {
     ...
     */
    public void load(List<WhiteVariantRelationMasterBar> whiteVariantRelationMasterBarList, ReferrerLoaderHandler<LoaderOfWhiteVariantRelationMasterBar> loaderLambda) {
        xassLRArg(whiteVariantRelationMasterBarList, loaderLambda);
        loaderLambda.handle(new LoaderOfWhiteVariantRelationMasterBar().ready(whiteVariantRelationMasterBarList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, ReferrerLoaderHandler<LoaderOfWhiteVariantRelationMasterBar> loaderLambda) {
        xassLRArg(whiteVariantRelationMasterBar, loaderLambda);
        loaderLambda.handle(new LoaderOfWhiteVariantRelationMasterBar().ready(xnewLRAryLs(whiteVariantRelationMasterBar), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">whiteVariantRelationMasterBar</span>.<span style="color: #CC4747">getWhiteVariantRelationReferrerAsVariantList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">insert</span>(whiteVariantRelationMasterBar);
     ...
     * }
     * <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">batchInsert</span>(whiteVariantRelationMasterBarList);
     * </pre>
     ...
     *     whiteVariantRelationMasterBarList.add(whiteVariantRelationMasterBar);
     * }
     * <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">batchUpdate</span>(whiteVariantRelationMasterBarList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">whiteVariantRelationMasterBarBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB&gt;() {
     ...
     */
    public int queryInsert(QueryInsertSetupper<WhiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, CBCall<WhiteVariantRelationMasterBarCB> cbLambda) {
        return doQueryUpdate(whiteVariantRelationMasterBar, createCB(cbLambda), null);
    }
     ...
     */
    public int queryDelete(CBCall<WhiteVariantRelationMasterBarCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WritableOptionCall<WhiteVariantRelationMasterBarCB, InsertOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        doInsert(whiteVariantRelationMasterBar, createInsertOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WritableOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        doUpdate(whiteVariantRelationMasterBar, createUpdateOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WritableOptionCall<WhiteVariantRelationMasterBarCB, InsertOption<WhiteVariantRelationMasterBarCB>> insertOpLambda, WritableOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> updateOpLambda) {
        doInsertOrUpdate(whiteVariantRelationMasterBar, createInsertOption(insertOpLambda), createUpdateOption(updateOpLambda));
    }
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WritableOptionCall<WhiteVariantRelationMasterBarCB, DeleteOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        doDelete(whiteVariantRelationMasterBar, createDeleteOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteVariantRelationMasterBar> whiteVariantRelationMasterBarList, WritableOptionCall<WhiteVariantRelationMasterBarCB, InsertOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doBatchInsert(whiteVariantRelationMasterBarList, createInsertOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteVariantRelationMasterBar> whiteVariantRelationMasterBarList, WritableOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doBatchUpdate(whiteVariantRelationMasterBarList, createUpdateOption(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteVariantRelationMasterBar> whiteVariantRelationMasterBarList, WritableOptionCall<WhiteVariantRelationMasterBarCB, DeleteOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doBatchDelete(whiteVariantRelationMasterBarList, createDeleteOption(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB> manyArgLambda, WritableOptionCall<WhiteVariantRelationMasterBarCB, InsertOption<WhiteVariantRelationMasterBarCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, CBCall<WhiteVariantRelationMasterBarCB> cbLambda, WritableOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doQueryUpdate(whiteVariantRelationMasterBar, createCB(cbLambda), createUpdateOption(opLambda));
    }
     ...
     * @throws NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteVariantRelationMasterBar whiteVariantRelationMasterBar, WhiteVariantRelationMasterBarCB cb, WritableOptionCall<WhiteVariantRelationMasterBarCB, UpdateOption<WhiteVariantRelationMasterBarCB>> opLambda) {
        return doQueryUpdate(whiteVariantRelationMasterBar, cb, createUpdateOption(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteVariantRelationMasterBarCB> cbLambda, WritableOptionCall<WhiteVariantRelationMasterBarCB, DeleteOption<WhiteVariantRelationMasterBarCB>> opLambda) {
     ...
     * @throws NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteVariantRelationMasterBarCB cb, WritableOptionCall<WhiteVariantRelationMasterBarCB, DeleteOption<WhiteVariantRelationMasterBarCB>> opLambda) {
     ...
     * whiteVariantRelationMasterBarBhv.outideSql().selectEntity(pmb); <span style="color: #3F7E5E">// optional</span>
     * whiteVariantRelationMasterBarBhv.outideSql().selectList(pmb); <span style="color: #3F7E5E">// ListResultBean</span>
     * whiteVariantRelationMasterBarBhv.outideSql().selectPage(pmb); <span style="color: #3F7E5E">// PagingResultBean</span>
     * whiteVariantRelationMasterBarBhv.outideSql().selectPagedListOnly(pmb); <span style="color: #3F7E5E">// ListResultBean</span>
     * whiteVariantRelationMasterBarBhv.outideSql().selectCursor(pmb, handler); <span style="color: #3F7E5E">// (by handler)</span>
     * whiteVariantRelationMasterBarBhv.outideSql().execute(pmb); <span style="color: #3F7E5E">// int (updated count)</span>
     * whiteVariantRelationMasterBarBhv.outideSql().call(pmb); <span style="color: #3F7E5E">// void (pmb has OUT parameters)</span>
     *
     * <span style="color: #3F7E5E">// traditional style</span>
     * whiteVariantRelationMasterBarBhv.outideSql().traditionalStyle().selectEntity(path, pmb, entityType);
     * whiteVariantRelationMasterBarBhv.outideSql().traditionalStyle().selectList(path, pmb, entityType);
     * whiteVariantRelationMasterBarBhv.outideSql().traditionalStyle().selectPage(path, pmb, entityType);
     * whiteVariantRelationMasterBarBhv.outideSql().traditionalStyle().selectPagedListOnly(path, pmb, entityType);
     * whiteVariantRelationMasterBarBhv.outideSql().traditionalStyle().selectCursor(path, pmb, handler);
     * whiteVariantRelationMasterBarBhv.outideSql().traditionalStyle().execute(path, pmb);
     *
     * <span style="color: #3F7E5E">// options</span>
     * whiteVariantRelationMasterBarBhv.outideSql().removeBlockComment().selectList()
     * whiteVariantRelationMasterBarBhv.outideSql().removeLineComment().selectList()
     * whiteVariantRelationMasterBarBhv.outideSql().formatSql().selectList()
     * </pre>
