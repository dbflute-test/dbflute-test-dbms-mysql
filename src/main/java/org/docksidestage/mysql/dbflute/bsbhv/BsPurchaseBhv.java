...
public abstract class BsPurchaseBhv extends AbstractBehaviorWritable<Purchase, PurchaseCB> {
     ...
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(purchase -&gt; {
     ...
     * Purchase purchase = purchaseBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(purchase -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * purchaseBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(purchase -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = purchase.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * purchaseBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(purchase -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = purchase.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * <pre>
     * purchaseBhv.<span style="color: #CC4747">loadPurchasePaymentList</span>(purchaseList, paymentCB -&gt; {
