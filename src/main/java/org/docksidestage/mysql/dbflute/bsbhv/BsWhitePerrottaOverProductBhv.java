...
/**
 * The behavior of WHITE_PERROTTA_OVER_PRODUCT as TABLE.
...
public abstract class BsWhitePerrottaOverProductBhv extends AbstractBehaviorWritable<WhitePerrottaOverProduct, WhitePerrottaOverProductCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">whitePerrottaOverProduct</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">whitePerrottaOverProduct</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * ... = <span style="color: #553000">whitePerrottaOverProduct</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePerrottaOverProduct. (NotNull)
     ...
     * WhitePerrottaOverProductCB cb = <span style="color: #70226C">new</span> WhitePerrottaOverProductCB();
     * cb.query().set...;
     * WhitePerrottaOverProduct whitePerrottaOverProduct = <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhitePerrottaOverProduct&gt; <span style="color: #553000">whitePerrottaOverProductList</span> = <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (WhitePerrottaOverProduct <span style="color: #553000">whitePerrottaOverProduct</span> : <span style="color: #553000">whitePerrottaOverProductList</span>) {
     *     ... = <span style="color: #553000">whitePerrottaOverProduct</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePerrottaOverProduct. (NotNull)
     ...
     * cb.query().set...;
     * cb.query().addOrderBy...;
     * ListResultBean&lt;WhitePerrottaOverProduct&gt; <span style="color: #553000">whitePerrottaOverProductList</span> = <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectList</span>(cb);
     * <span style="color: #70226C">for</span> (WhitePerrottaOverProduct whitePerrottaOverProduct : <span style="color: #553000">whitePerrottaOverProductList</span>) {
     *     ... = whitePerrottaOverProduct.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhitePerrottaOverProduct. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhitePerrottaOverProduct whitePerrottaOverProduct : <span style="color: #553000">page</span>) {
     *     ... = whitePerrottaOverProduct.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePerrottaOverProduct. (NotNull)
     ...
     * PagingResultBean&lt;WhitePerrottaOverProduct&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectPage</span>(cb);
     * <span style="color: #70226C">int</span> allRecordCount = <span style="color: #553000">page</span>.getAllRecordCount();
     * <span style="color: #70226C">int</span> allPageCount = <span style="color: #553000">page</span>.getAllPageCount();
     * <span style="color: #70226C">boolean</span> isExistPrePage = <span style="color: #553000">page</span>.isExistPrePage();
     * <span style="color: #70226C">boolean</span> isExistNextPage = <span style="color: #553000">page</span>.isExistNextPage();
     ...
     * <pre>
     * <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * WhitePerrottaOverProductCB cb = <span style="color: #70226C">new</span> WhitePerrottaOverProductCB();
     * cb.query().set...
     * <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhitePerrottaOverProduct. (NotNull)
     ...
     * <pre>
     * WhitePerrottaOverProduct whitePerrottaOverProduct = <span style="color: #70226C">new</span> WhitePerrottaOverProduct();
     ...
     * <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">insert</span>(whitePerrottaOverProduct);
     ...
     *     <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">delete</span>(whitePerrottaOverProduct);
     ...
     * }
     * <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">batchInsert</span>(whitePerrottaOverProductList);
     * </pre>
     ...
     *     whitePerrottaOverProductList.add(whitePerrottaOverProduct);
     * }
     * <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">batchUpdate</span>(whitePerrottaOverProductList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhitePerrottaOverProduct, WhitePerrottaOverProductCB&gt;() {
    ...
    public int queryUpdate(WhitePerrottaOverProduct whitePerrottaOverProduct, CBCall<WhitePerrottaOverProductCB> cbLambda) {
        return doQueryUpdate(whitePerrottaOverProduct, createCB(cbLambda), null);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePerrottaOverProduct. (NotNull)
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhitePerrottaOverProduct whitePerrottaOverProduct, WritableOptionCall<WhitePerrottaOverProductCB, InsertOption<WhitePerrottaOverProductCB>> opLambda) {
        doInsert(whitePerrottaOverProduct, createInsertOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhitePerrottaOverProduct whitePerrottaOverProduct, WritableOptionCall<WhitePerrottaOverProductCB, UpdateOption<WhitePerrottaOverProductCB>> opLambda) {
        doUpdate(whitePerrottaOverProduct, createUpdateOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhitePerrottaOverProduct whitePerrottaOverProduct, WritableOptionCall<WhitePerrottaOverProductCB, InsertOption<WhitePerrottaOverProductCB>> insertOpLambda, WritableOptionCall<WhitePerrottaOverProductCB, UpdateOption<WhitePerrottaOverProductCB>> updateOpLambda) {
        doInsertOrUpdate(whitePerrottaOverProduct, createInsertOption(insertOpLambda), createUpdateOption(updateOpLambda));
    }
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhitePerrottaOverProduct whitePerrottaOverProduct, WritableOptionCall<WhitePerrottaOverProductCB, DeleteOption<WhitePerrottaOverProductCB>> opLambda) {
        doDelete(whitePerrottaOverProduct, createDeleteOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhitePerrottaOverProduct> whitePerrottaOverProductList, WritableOptionCall<WhitePerrottaOverProductCB, InsertOption<WhitePerrottaOverProductCB>> opLambda) {
        return doBatchInsert(whitePerrottaOverProductList, createInsertOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhitePerrottaOverProduct> whitePerrottaOverProductList, WritableOptionCall<WhitePerrottaOverProductCB, UpdateOption<WhitePerrottaOverProductCB>> opLambda) {
        return doBatchUpdate(whitePerrottaOverProductList, createUpdateOption(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhitePerrottaOverProduct> whitePerrottaOverProductList, WritableOptionCall<WhitePerrottaOverProductCB, DeleteOption<WhitePerrottaOverProductCB>> opLambda) {
        return doBatchDelete(whitePerrottaOverProductList, createDeleteOption(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhitePerrottaOverProduct, WhitePerrottaOverProductCB> manyArgLambda, WritableOptionCall<WhitePerrottaOverProductCB, InsertOption<WhitePerrottaOverProductCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhitePerrottaOverProduct whitePerrottaOverProduct, CBCall<WhitePerrottaOverProductCB> cbLambda, WritableOptionCall<WhitePerrottaOverProductCB, UpdateOption<WhitePerrottaOverProductCB>> opLambda) {
        return doQueryUpdate(whitePerrottaOverProduct, createCB(cbLambda), createUpdateOption(opLambda));
    }
     ...
     * @throws NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhitePerrottaOverProduct whitePerrottaOverProduct, WhitePerrottaOverProductCB cb, WritableOptionCall<WhitePerrottaOverProductCB, UpdateOption<WhitePerrottaOverProductCB>> opLambda) {
        return doQueryUpdate(whitePerrottaOverProduct, cb, createUpdateOption(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhitePerrottaOverProductCB> cbLambda, WritableOptionCall<WhitePerrottaOverProductCB, DeleteOption<WhitePerrottaOverProductCB>> opLambda) {
     ...
     * @throws NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhitePerrottaOverProductCB cb, WritableOptionCall<WhitePerrottaOverProductCB, DeleteOption<WhitePerrottaOverProductCB>> opLambda) {
