...
public abstract class BsWhitePerrottaOverProductBhv extends AbstractBehaviorWritable<WhitePerrottaOverProduct, WhitePerrottaOverProductCB> {
     ...
     * int count = <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * ...
     * for (WhitePerrottaOverProduct whitePerrottaOverProduct : <span style="color: #553000">page</span>) {
     *     ... = whitePerrottaOverProduct.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePerrottaOverProduct. (NotNull)
     ...
     * WhitePerrottaOverProductCB cb = new WhitePerrottaOverProductCB();
     * cb.query().set...
     * <span style="color: #0000C0">whitePerrottaOverProductBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhitePerrottaOverProduct&gt;() {
