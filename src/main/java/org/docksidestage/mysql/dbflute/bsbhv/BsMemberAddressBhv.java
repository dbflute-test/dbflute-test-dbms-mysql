...
public abstract class BsMemberAddressBhv extends AbstractBehaviorWritable<MemberAddress, MemberAddressCB> {
     ...
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(memberAddress -&gt; {
     ...
     * MemberAddress memberAddress = memberAddressBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(memberAddress -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * memberAddressBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(memberAddress -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = memberAddress.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * memberAddressBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(memberAddress -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = memberAddress.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
