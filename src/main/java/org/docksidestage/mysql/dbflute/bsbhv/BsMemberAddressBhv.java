...
public abstract class BsMemberAddressBhv extends AbstractBehaviorWritable<MemberAddress, MemberAddressCB> {
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(MemberAddress memberAddress, MemberAddressCB cb, WOptionCall<MemberAddressCB, UpdateOption<MemberAddressCB>> opLambda) {
        return doQueryUpdate(memberAddress, cb, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(MemberAddressCB cb, WOptionCall<MemberAddressCB, DeleteOption<MemberAddressCB>> opLambda) {
