...
public abstract class BsWhiteAdditionalBhv extends AbstractBehaviorWritable<WhiteAdditional, WhiteAdditionalCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteAdditionalBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteAdditionalBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteAdditional <span style="color: #553000">whiteAdditional</span> : <span style="color: #553000">whiteAdditionalList</span>) {
     *     ... = <span style="color: #553000">whiteAdditional</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAdditional. (NotNull)
     ...
     * for (WhiteAdditional whiteAdditional : <span style="color: #553000">whiteAdditionalList</span>) {
     *     ... = whiteAdditional.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteAdditional. (NotNull)
     ...
     * ...
     * for (WhiteAdditional whiteAdditional : <span style="color: #553000">page</span>) {
     *     ... = whiteAdditional.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteAdditional. (NotNull)
     ...
     * WhiteAdditionalCB cb = new WhiteAdditionalCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteAdditionalBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteAdditional&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteAdditionalBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteAdditionalBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteAdditional, option);
     * ... = whiteAdditional.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteAdditional The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteAdditionalBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteAdditional, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #0000C0">whiteAdditionalBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteAdditional, cb, option);
     * </pre>
