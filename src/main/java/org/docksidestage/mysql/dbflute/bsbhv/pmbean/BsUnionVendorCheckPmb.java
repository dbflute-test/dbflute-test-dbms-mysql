...
/**
 * The base class for typed parameter-bean of UnionVendorCheck. <br />
 * This is related to "<span style="color: #AD4747">whitebox:vendorcheck:selectUnionVendorCheck</span>" on VendorCheckBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsUnionVendorCheckPmb implements ListHandlingPmb<VendorCheckBhv, UnionVendorCheck>, EntityHandlingPmb<VendorCheckBhv, UnionVendorCheck>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of UnionVendorCheck. <br />
     * This is related to "<span style="color: #AD4747">whitebox:vendorcheck:selectUnionVendorCheck</span>" on VendorCheckBhv.
     */
    public BsUnionVendorCheckPmb() {
    }
    ...
    public String getOutsideSqlPath() {
        return "whitebox:vendorcheck:selectUnionVendorCheck";
    }
     ...
     */
    public Class<UnionVendorCheck> getEntityType() {
        return UnionVendorCheck.class;
    }
