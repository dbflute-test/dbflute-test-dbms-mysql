...
public abstract class BsWhiteImplicitReverseFkSuppressBhv extends AbstractBehaviorWritable<WhiteImplicitReverseFkSuppress, WhiteImplicitReverseFkSuppressCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteImplicitReverseFkSuppressBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteImplicitReverseFkSuppressBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteImplicitReverseFkSuppress <span style="color: #553000">whiteImplicitReverseFkSuppress</span> : <span style="color: #553000">whiteImplicitReverseFkSuppressList</span>) {
     *     ... = <span style="color: #553000">whiteImplicitReverseFkSuppress</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteImplicitReverseFkSuppress. (NotNull)
     ...
     * for (WhiteImplicitReverseFkSuppress whiteImplicitReverseFkSuppress : <span style="color: #553000">whiteImplicitReverseFkSuppressList</span>) {
     *     ... = whiteImplicitReverseFkSuppress.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteImplicitReverseFkSuppress. (NotNull)
     ...
     * ...
     * for (WhiteImplicitReverseFkSuppress whiteImplicitReverseFkSuppress : <span style="color: #553000">page</span>) {
     *     ... = whiteImplicitReverseFkSuppress.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteImplicitReverseFkSuppress. (NotNull)
     ...
     * WhiteImplicitReverseFkSuppressCB cb = new WhiteImplicitReverseFkSuppressCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteImplicitReverseFkSuppressBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteImplicitReverseFkSuppress&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteImplicitReverseFkSuppressBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
