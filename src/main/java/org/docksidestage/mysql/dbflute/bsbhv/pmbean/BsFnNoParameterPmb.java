...
/**
 * The base class for procedure parameter-bean of FnNoParameter. <br>
 * This is related to "<span style="color: #AD4747">FN_NO_PARAMETER</span>".
 * @author DBFlute(AutoGenerator)
 */
public class BsFnNoParameterPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of FnNoParameter. <br>
     * This is related to "<span style="color: #AD4747">FN_NO_PARAMETER</span>".
     */
    public BsFnNoParameterPmb() {
    }
     ...
     * {@inheritDoc}
     */
    public String getProcedureName() { return "FN_NO_PARAMETER"; }
