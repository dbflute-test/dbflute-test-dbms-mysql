...
public abstract class BsWhiteLoadDataBhv extends AbstractBehaviorWritable<WhiteLoadData, WhiteLoadDataCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteLoadDataBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteLoadDataBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteLoadData <span style="color: #553000">whiteLoadData</span> : <span style="color: #553000">whiteLoadDataList</span>) {
     *     ... = <span style="color: #553000">whiteLoadData</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteLoadData. (NotNull)
     ...
     * for (WhiteLoadData whiteLoadData : <span style="color: #553000">whiteLoadDataList</span>) {
     *     ... = whiteLoadData.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteLoadData. (NotNull)
     ...
     * ...
     * for (WhiteLoadData whiteLoadData : <span style="color: #553000">page</span>) {
     *     ... = whiteLoadData.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteLoadData. (NotNull)
     ...
     * WhiteLoadDataCB cb = new WhiteLoadDataCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteLoadDataBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteLoadData&gt;() {
