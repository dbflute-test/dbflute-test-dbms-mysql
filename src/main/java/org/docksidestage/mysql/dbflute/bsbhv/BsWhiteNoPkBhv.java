...
public abstract class BsWhiteNoPkBhv extends AbstractBehaviorReadable<WhiteNoPk, WhiteNoPkCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteNoPk <span style="color: #553000">whiteNoPk</span> : <span style="color: #553000">whiteNoPkList</span>) {
     *     ... = <span style="color: #553000">whiteNoPk</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteNoPk. (NotNull)
     ...
     * for (WhiteNoPk whiteNoPk : <span style="color: #553000">whiteNoPkList</span>) {
     *     ... = whiteNoPk.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteNoPk. (NotNull)
     ...
     * ...
     * for (WhiteNoPk whiteNoPk : <span style="color: #553000">page</span>) {
     *     ... = whiteNoPk.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteNoPk. (NotNull)
     ...
     * WhiteNoPkCB cb = new WhiteNoPkCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteNoPk&gt;() {
