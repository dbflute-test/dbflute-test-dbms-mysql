...
public abstract class BsWhiteNoPkBhv extends AbstractBehaviorReadable<WhiteNoPk, WhiteNoPkCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">whiteNoPk</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">whiteNoPk</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * WhiteNoPk <span style="color: #553000">whiteNoPk</span> = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">whiteNoPk</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteNoPk. (NotNull)
     ...
     * WhiteNoPkCB cb = <span style="color: #70226C">new</span> WhiteNoPkCB();
     * cb.query().set...;
     * WhiteNoPk whiteNoPk = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteNoPk&gt; <span style="color: #553000">whiteNoPkList</span> = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (WhiteNoPk <span style="color: #553000">whiteNoPk</span> : <span style="color: #553000">whiteNoPkList</span>) {
     *     ... = <span style="color: #553000">whiteNoPk</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteNoPk. (NotNull)
     ...
     * cb.query().set...;
     * cb.query().addOrderBy...;
     * ListResultBean&lt;WhiteNoPk&gt; <span style="color: #553000">whiteNoPkList</span> = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectList</span>(cb);
     * <span style="color: #70226C">for</span> (WhiteNoPk whiteNoPk : <span style="color: #553000">whiteNoPkList</span>) {
     *     ... = whiteNoPk.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteNoPk. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;WhiteNoPk&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteNoPk whiteNoPk : <span style="color: #553000">page</span>) {
     *     ... = whiteNoPk.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteNoPk. (NotNull)
     ...
     * PagingResultBean&lt;WhiteNoPk&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectPage</span>(cb);
     * <span style="color: #70226C">int</span> allRecordCount = <span style="color: #553000">page</span>.getAllRecordCount();
     * <span style="color: #70226C">int</span> allPageCount = <span style="color: #553000">page</span>.getAllPageCount();
     * <span style="color: #70226C">boolean</span> isExistPrePage = <span style="color: #553000">page</span>.isExistPrePage();
     * <span style="color: #70226C">boolean</span> isExistNextPage = <span style="color: #553000">page</span>.isExistNextPage();
     ...
     * <pre>
     * <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * WhiteNoPkCB cb = <span style="color: #70226C">new</span> WhiteNoPkCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteNoPkBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteNoPk. (NotNull)
