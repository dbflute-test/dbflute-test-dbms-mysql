...
/**
 * The behavior of WHITE_COMPOUND_PK_REF_NEST as TABLE.
...
public abstract class BsWhiteCompoundPkRefNestBhv extends AbstractBehaviorWritable<WhiteCompoundPkRefNest, WhiteCompoundPkRefNestCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * SpecifyColumn is ignored but you can use it only to remove text type column for union's distinct.
     * <pre>
     * WhiteCompoundPkRefNestCB cb = <span style="color: #70226C">new</span> WhiteCompoundPkRefNestCB();
     * cb.query().setFoo...(value);
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * <span style="color: #70226C">for</span> (WhiteCompoundPkRefNest <span style="color: #553000">whiteCompoundPkRefNest</span> : <span style="color: #553000">whiteCompoundPkRefNestList</span>) {
     *     ... = <span style="color: #553000">whiteCompoundPkRefNest</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteCompoundPkRefNest. (NotNull)
     ...
     * <span style="color: #70226C">for</span> (WhiteCompoundPkRefNest whiteCompoundPkRefNest : <span style="color: #553000">whiteCompoundPkRefNestList</span>) {
     *     ... = whiteCompoundPkRefNest.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteCompoundPkRefNest. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteCompoundPkRefNest whiteCompoundPkRefNest : <span style="color: #553000">page</span>) {
     *     ... = whiteCompoundPkRefNest.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteCompoundPkRefNest. (NotNull)
     ...
     * WhiteCompoundPkRefNestCB cb = <span style="color: #70226C">new</span> WhiteCompoundPkRefNestCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteCompoundPkRefNest. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteCompoundPkRefNestCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <pre>
     * WhiteCompoundPkRefNest whiteCompoundPkRefNest = <span style="color: #70226C">new</span> WhiteCompoundPkRefNest();
     ...
     * <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteCompoundPkRefNest, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteCompoundPkRefNest. (NotNull)
     ...
     * whiteCompoundPkRefNest.setFoo...(value);
     * whiteCompoundPkRefNest.setBar...(value);
     * <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteCompoundPkRefNest, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteCompoundPkRefNest, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteCompoundPkRefNest.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteCompoundPkRefNest, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteCompoundPkRefNestCB cb = <span style="color: #70226C">new</span> WhiteCompoundPkRefNestCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteCompoundPkRefNest, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     * <pre>
     * <span style="color: #0000C0">whiteCompoundPkRefNestBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteCompoundPkRefNest, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * }, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhiteCompoundPkRefNestBhv> outsideSql() {
        return doOutsideSql();
    }
