...
public abstract class BsWhiteUqClassificationBhv extends AbstractBehaviorWritable<WhiteUqClassification, WhiteUqClassificationCB> {
     ...
     * WhiteUqClassificationCB cb = new WhiteUqClassificationCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhiteUqClassification&gt; entity = whiteUqClassificationBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whiteUqClassification -&gt; {
     *     ...
     * });
     * WhiteUqClassification whiteUqClassification = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whiteUqClassification -&gt; {
     *     ...
     * });
    ...
    public int queryUpdate(WhiteUqClassification whiteUqClassification, CBCall<WhiteUqClassificationCB> cbLambda) {
        return doQueryUpdate(whiteUqClassification, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteUqClassification whiteUqClassification, WOptionCall<WhiteUqClassificationCB, InsertOption<WhiteUqClassificationCB>> opLambda) {
        doInsert(whiteUqClassification, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteUqClassification whiteUqClassification, WOptionCall<WhiteUqClassificationCB, UpdateOption<WhiteUqClassificationCB>> opLambda) {
        doUpdate(whiteUqClassification, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteUqClassification whiteUqClassification, WOptionCall<WhiteUqClassificationCB, InsertOption<WhiteUqClassificationCB>> insertOpLambda, WOptionCall<WhiteUqClassificationCB, UpdateOption<WhiteUqClassificationCB>> updateOpLambda) {
        doInsertOrUpdate(whiteUqClassification, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteUqClassification whiteUqClassification, WOptionCall<WhiteUqClassificationCB, DeleteOption<WhiteUqClassificationCB>> opLambda) {
        doDelete(whiteUqClassification, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteUqClassification> whiteUqClassificationList, WOptionCall<WhiteUqClassificationCB, InsertOption<WhiteUqClassificationCB>> opLambda) {
        return doBatchInsert(whiteUqClassificationList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteUqClassification> whiteUqClassificationList, WOptionCall<WhiteUqClassificationCB, UpdateOption<WhiteUqClassificationCB>> opLambda) {
        return doBatchUpdate(whiteUqClassificationList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteUqClassification> whiteUqClassificationList, WOptionCall<WhiteUqClassificationCB, DeleteOption<WhiteUqClassificationCB>> opLambda) {
        return doBatchDelete(whiteUqClassificationList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteUqClassification, WhiteUqClassificationCB> manyArgLambda, WOptionCall<WhiteUqClassificationCB, InsertOption<WhiteUqClassificationCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteUqClassification whiteUqClassification, CBCall<WhiteUqClassificationCB> cbLambda, WOptionCall<WhiteUqClassificationCB, UpdateOption<WhiteUqClassificationCB>> opLambda) {
        return doQueryUpdate(whiteUqClassification, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteUqClassification whiteUqClassification, WhiteUqClassificationCB cb, WOptionCall<WhiteUqClassificationCB, UpdateOption<WhiteUqClassificationCB>> opLambda) {
        return doQueryUpdate(whiteUqClassification, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteUqClassificationCB> cbLambda, WOptionCall<WhiteUqClassificationCB, DeleteOption<WhiteUqClassificationCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteUqClassificationCB cb, WOptionCall<WhiteUqClassificationCB, DeleteOption<WhiteUqClassificationCB>> opLambda) {
