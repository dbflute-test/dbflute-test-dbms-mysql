...
public abstract class BsProductStatusBhv extends AbstractBehaviorWritable<ProductStatus, ProductStatusCB> {
     ...
     * ProductStatusCB cb = new ProductStatusCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;ProductStatus&gt; entity = productStatusBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(productStatus -&gt; {
     *     ...
     * });
     * ProductStatus productStatus = entity.entity.<span style="color: #DD4747">get()</span>;
     *
