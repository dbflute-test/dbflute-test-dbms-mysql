...
public abstract class BsProductStatusBhv extends AbstractBehaviorWritable<ProductStatus, ProductStatusCB> {
     ...
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(productStatus -&gt; {
     ...
     * ProductStatus productStatus = productStatusBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(productStatus -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * productStatusBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(productStatus -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = productStatus.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * productStatusBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(productStatus -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = productStatus.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
