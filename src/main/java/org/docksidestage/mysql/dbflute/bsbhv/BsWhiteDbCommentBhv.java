...
/**
 * The behavior of WHITE_DB_COMMENT as TABLE.
...
public abstract class BsWhiteDbCommentBhv extends AbstractBehaviorWritable<WhiteDbComment, WhiteDbCommentCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public WhiteDbCommentDbm asDBMeta() { return WhiteDbCommentDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "white_db_comment"; }
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteDbCommentBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * SpecifyColumn is ignored but you can use it only to remove text type column for union's distinct.
     * <pre>
     * WhiteDbCommentCB cb = <span style="color: #70226C">new</span> WhiteDbCommentCB();
     * cb.query().setFoo...(value);
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteDbCommentBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * <span style="color: #70226C">for</span> (WhiteDbComment <span style="color: #553000">whiteDbComment</span> : <span style="color: #553000">whiteDbCommentList</span>) {
     *     ... = <span style="color: #553000">whiteDbComment</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDbComment. (NotNull)
     ...
     * <span style="color: #70226C">for</span> (WhiteDbComment whiteDbComment : <span style="color: #553000">whiteDbCommentList</span>) {
     *     ... = whiteDbComment.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteDbComment. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteDbComment whiteDbComment : <span style="color: #553000">page</span>) {
     *     ... = whiteDbComment.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDbComment. (NotNull)
     ...
     * WhiteDbCommentCB cb = <span style="color: #70226C">new</span> WhiteDbCommentCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteDbCommentBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteDbComment. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whiteDbCommentBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteDbCommentCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <pre>
     * WhiteDbComment whiteDbComment = <span style="color: #70226C">new</span> WhiteDbComment();
     ...
     * <span style="color: #0000C0">whiteDbCommentBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteDbComment, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * whiteDbComment.setFoo...(value);
     * whiteDbComment.setBar...(value);
     * <span style="color: #0000C0">whiteDbCommentBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteDbComment, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteDbCommentBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteDbComment, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteDbComment> whiteDbCommentList, WritableOptionCall<WhiteDbCommentCB, InsertOption<WhiteDbCommentCB>> opLambda) {
        return doBatchInsert(whiteDbCommentList, createInsertOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteDbComment> whiteDbCommentList, WritableOptionCall<WhiteDbCommentCB, UpdateOption<WhiteDbCommentCB>> opLambda) {
        return doBatchUpdate(whiteDbCommentList, createUpdateOption(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteDbComment> whiteDbCommentList, WritableOptionCall<WhiteDbCommentCB, DeleteOption<WhiteDbCommentCB>> opLambda) {
        return doBatchDelete(whiteDbCommentList, createDeleteOption(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteDbComment, WhiteDbCommentCB> manyArgLambda, WritableOptionCall<WhiteDbCommentCB, InsertOption<WhiteDbCommentCB>> opLambda) {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteDbComment.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteDbCommentBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteDbComment, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteDbCommentCB cb = <span style="color: #70226C">new</span> WhiteDbCommentCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteDbCommentBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteDbComment, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhiteDbCommentBhv> outsideSql() {
        return doOutsideSql();
    }
