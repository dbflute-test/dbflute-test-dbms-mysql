...
public abstract class BsWhitePgReservRefBhv extends AbstractBehaviorWritable<WhitePgReservRef, WhitePgReservRefCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whitePgReservRefBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whitePgReservRefBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhitePgReservRef <span style="color: #553000">whitePgReservRef</span> : <span style="color: #553000">whitePgReservRefList</span>) {
     *     ... = <span style="color: #553000">whitePgReservRef</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePgReservRef. (NotNull)
     ...
     * for (WhitePgReservRef whitePgReservRef : <span style="color: #553000">whitePgReservRefList</span>) {
     *     ... = whitePgReservRef.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhitePgReservRef. (NotNull)
     ...
     * ...
     * for (WhitePgReservRef whitePgReservRef : <span style="color: #553000">page</span>) {
     *     ... = whitePgReservRef.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePgReservRef. (NotNull)
     ...
     * WhitePgReservRefCB cb = new WhitePgReservRefCB();
     * cb.query().set...
     * <span style="color: #0000C0">whitePgReservRefBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhitePgReservRef&gt;() {
