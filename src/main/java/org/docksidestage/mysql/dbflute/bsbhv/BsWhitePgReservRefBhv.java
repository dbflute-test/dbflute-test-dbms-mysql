...
public abstract class BsWhitePgReservRefBhv extends AbstractBehaviorWritable<WhitePgReservRef, WhitePgReservRefCB> {
     ...
     * <span style="color: #0000C0">whitePgReservRefBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whitePgReservRef, option);
     * ... = whitePgReservRef.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whitePgReservRef The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whitePgReservRefBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whitePgReservRef, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * WhitePgReservRefCB cb = new WhitePgReservRefCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;WhitePgReservRefCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;WhitePgReservRefCB&gt;();
     * option.self(new SpecifyQuery&lt;WhitePgReservRefCB&gt;() {
     *     public void specify(WhitePgReservRefCB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">whitePgReservRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whitePgReservRef, cb, option);
     * </pre>
