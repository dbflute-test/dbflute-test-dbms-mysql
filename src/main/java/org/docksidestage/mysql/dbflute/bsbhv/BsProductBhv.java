...
public abstract class BsProductBhv extends AbstractBehaviorWritable<Product, ProductCB> {
     ...
     * int count = productBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * Product product = productBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(product -&gt; {
     ...
     * Product product = productBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(product -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * productBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(product -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = product.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * productBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(product -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = product.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * ProductCB cb = new ProductCB();
     * cb.query().setFoo...(value);
     * Product product = productBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;Product&gt; productList = productBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     ...
     * PagingResultBean&lt;Product&gt; page = productBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * ProductCB cb = new ProductCB();
     * cb.query().setFoo...(value);
     * productBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;Product&gt;() {
     ...
     * <pre>
     * productBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * productBhv.<span style="color: #CC4747">loadPurchaseList</span>(productList, purchaseCB -&gt; {
     ...
     * productBhv.<span style="color: #CC4747">insert</span>(product);
     ...
     * try {
     *     productBhv.<span style="color: #CC4747">update</span>(product);
     ...
     * productBhv.<span style="color: #CC4747">updateNonstrict</span>(product);
     * </pre>
     ...
     * product.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     productBhv.<span style="color: #CC4747">delete</span>(product);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//product.setVersionNo(value);</span>
     * productBhv.<span style="color: #CC4747">deleteNonstrict</span>(product);
     * </pre>
     ...
     * }
     * productBhv.<span style="color: #CC4747">batchInsert</span>(productList);
     * </pre>
     ...
     *     productList.add(product);
     * }
     * productBhv.<span style="color: #CC4747">batchUpdate</span>(productList);
     * </pre>
     ...
     * <pre>
     * productBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;Product, ProductCB&gt;() {
     ...
     * ProductCB cb = new ProductCB();
     * cb.query().setFoo...(value);
     * productBhv.<span style="color: #CC4747">queryUpdate</span>(product, cb);
     * </pre>
     ...
     * ProductCB cb = new ProductCB();
     * cb.query().setFoo...(value);
     * productBhv.<span style="color: #CC4747">queryDelete</span>(product, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of Product. (NotNull)
     ...
     * productBhv.<span style="color: #CC4747">varyingInsert</span>(product, option);
     * ... = product.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param product The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     productBhv.<span style="color: #CC4747">varyingUpdate</span>(product, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * productBhv.<span style="color: #CC4747">varyingUpdateNonstrict</span>(product, option);
     * </pre>
     * @param product The entity of update. (NotNull, PrimaryKeyNotNull)
     * @param opLambda The callback for option of update for varying requests. (NotNull)
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     ...
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * productBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(product, cb, option);
     * </pre>
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(Product product, ProductCB cb, WritableOptionCall<ProductCB, UpdateOption<ProductCB>> opLambda) {
        return doQueryUpdate(product, cb, createUpdateOption(opLambda));
    }
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(ProductCB cb, WritableOptionCall<ProductCB, DeleteOption<ProductCB>> opLambda) {
