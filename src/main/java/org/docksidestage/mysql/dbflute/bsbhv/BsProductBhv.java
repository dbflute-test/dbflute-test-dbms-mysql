...
public abstract class BsProductBhv extends AbstractBehaviorWritable<Product, ProductCB> {
     ...
     * int count = <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * ProductCB cb = new ProductCB();
     * cb.query().set...
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;Product&gt;() {
