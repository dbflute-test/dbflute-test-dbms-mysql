...
public abstract class BsWhitePurchaseReferrerBhv extends AbstractBehaviorWritable<WhitePurchaseReferrer, WhitePurchaseReferrerCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhitePurchaseReferrer <span style="color: #553000">whitePurchaseReferrer</span> : <span style="color: #553000">whitePurchaseReferrerList</span>) {
     *     ... = <span style="color: #553000">whitePurchaseReferrer</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePurchaseReferrer. (NotNull)
     ...
     * for (WhitePurchaseReferrer whitePurchaseReferrer : <span style="color: #553000">whitePurchaseReferrerList</span>) {
     *     ... = whitePurchaseReferrer.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhitePurchaseReferrer. (NotNull)
     ...
     * ...
     * for (WhitePurchaseReferrer whitePurchaseReferrer : <span style="color: #553000">page</span>) {
     *     ... = whitePurchaseReferrer.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePurchaseReferrer. (NotNull)
     ...
     * WhitePurchaseReferrerCB cb = new WhitePurchaseReferrerCB();
     * cb.query().set...
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhitePurchaseReferrer&gt;() {
