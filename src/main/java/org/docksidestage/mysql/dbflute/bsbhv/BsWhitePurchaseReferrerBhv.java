...
public abstract class BsWhitePurchaseReferrerBhv extends AbstractBehaviorWritable<WhitePurchaseReferrer, WhitePurchaseReferrerCB> {
     ...
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whitePurchaseReferrer, option);
     * ... = whitePurchaseReferrer.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whitePurchaseReferrer The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whitePurchaseReferrer, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * WhitePurchaseReferrerCB cb = new WhitePurchaseReferrerCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;WhitePurchaseReferrerCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;WhitePurchaseReferrerCB&gt;();
     * option.self(new SpecifyQuery&lt;WhitePurchaseReferrerCB&gt;() {
     *     public void specify(WhitePurchaseReferrerCB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whitePurchaseReferrer, cb, option);
     * </pre>
