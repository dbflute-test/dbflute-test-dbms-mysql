...
public abstract class BsWhitePurchaseReferrerBhv extends AbstractBehaviorWritable<WhitePurchaseReferrer, WhitePurchaseReferrerCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * SpecifyColumn is ignored but you can use it only to remove text type column for union's distinct.
     * <pre>
     * WhitePurchaseReferrerCB cb = <span style="color: #70226C">new</span> WhitePurchaseReferrerCB();
     * cb.query().setFoo...(value);
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">whitePurchaseReferrer</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = <span style="color: #553000">whitePurchaseReferrer</span>.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">whitePurchaseReferrer</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whitePurchaseReferrer <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whitePurchaseReferrer.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whitePurchaseReferrer <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whitePurchaseReferrer.get...
     * }).<span style="color: #994747">orElse</span>(() <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhitePurchaseReferrer> selectEntity(WhitePurchaseReferrerCB cb) {
        return facadeSelectEntity(cb);
    }

    protected OptionalEntity<WhitePurchaseReferrer> facadeSelectEntity(WhitePurchaseReferrerCB cb) {
     ...
     * <pre>
     * WhitePurchaseReferrer <span style="color: #553000">whitePurchaseReferrer</span> = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">whitePurchaseReferrer</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePurchaseReferrer. (NotNull)
     ...
     * WhitePurchaseReferrerCB cb = <span style="color: #70226C">new</span> WhitePurchaseReferrerCB();
     * cb.query().set...;
     * WhitePurchaseReferrer whitePurchaseReferrer = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhitePurchaseReferrer> selectByPK(Long purchaseReferrerId) {
        return facadeSelectByPK(purchaseReferrerId);
    }

    protected OptionalEntity<WhitePurchaseReferrer> facadeSelectByPK(Long purchaseReferrerId) {
        return doSelectOptionalByPK(purchaseReferrerId, typeOfSelectedEntity());
    }
     ...
     * <pre>
     * ListResultBean&lt;WhitePurchaseReferrer&gt; <span style="color: #553000">whitePurchaseReferrerList</span> = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (WhitePurchaseReferrer <span style="color: #553000">whitePurchaseReferrer</span> : <span style="color: #553000">whitePurchaseReferrerList</span>) {
     *     ... = <span style="color: #553000">whitePurchaseReferrer</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePurchaseReferrer. (NotNull)
     ...
     * cb.query().set...;
     * cb.query().addOrderBy...;
     * ListResultBean&lt;WhitePurchaseReferrer&gt; <span style="color: #553000">whitePurchaseReferrerList</span> = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectList</span>(cb);
     * <span style="color: #70226C">for</span> (WhitePurchaseReferrer whitePurchaseReferrer : <span style="color: #553000">whitePurchaseReferrerList</span>) {
     *     ... = whitePurchaseReferrer.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhitePurchaseReferrer. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;WhitePurchaseReferrer&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhitePurchaseReferrer whitePurchaseReferrer : <span style="color: #553000">page</span>) {
     *     ... = whitePurchaseReferrer.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhitePurchaseReferrer. (NotNull)
     ...
     * PagingResultBean&lt;WhitePurchaseReferrer&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectPage</span>(cb);
     * <span style="color: #70226C">int</span> allRecordCount = <span style="color: #553000">page</span>.getAllRecordCount();
     * <span style="color: #70226C">int</span> allPageCount = <span style="color: #553000">page</span>.getAllPageCount();
     * <span style="color: #70226C">boolean</span> isExistPrePage = <span style="color: #553000">page</span>.isExistPrePage();
     * <span style="color: #70226C">boolean</span> isExistNextPage = <span style="color: #553000">page</span>.isExistNextPage();
     ...
     * <pre>
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * WhitePurchaseReferrerCB cb = <span style="color: #70226C">new</span> WhitePurchaseReferrerCB();
     * cb.query().set...
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhitePurchaseReferrer. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhitePurchaseReferrerCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<WhitePurchaseReferrer> whitePurchaseReferrerList, ReferrerLoaderHandler<LoaderOfWhitePurchaseReferrer> loaderLambda) {
        xassLRArg(whitePurchaseReferrerList, loaderLambda);
        loaderLambda.handle(new LoaderOfWhitePurchaseReferrer().ready(whitePurchaseReferrerList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(WhitePurchaseReferrer whitePurchaseReferrer, ReferrerLoaderHandler<LoaderOfWhitePurchaseReferrer> loaderLambda) {
        xassLRArg(whitePurchaseReferrer, loaderLambda);
        loaderLambda.handle(new LoaderOfWhitePurchaseReferrer().ready(xnewLRAryLs(whitePurchaseReferrer), _behaviorSelector));
    }
     ...
     * <pre>
     * WhitePurchaseReferrer whitePurchaseReferrer = <span style="color: #70226C">new</span> WhitePurchaseReferrer();
     ...
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">insert</span>(whitePurchaseReferrer);
     ...
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">update</span>(whitePurchaseReferrer);
     * </pre>
     ...
     *     <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">delete</span>(whitePurchaseReferrer);
     ...
     * }
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">batchInsert</span>(whitePurchaseReferrerList);
     * </pre>
     ...
     *     whitePurchaseReferrerList.add(whitePurchaseReferrer);
     * }
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">batchUpdate</span>(whitePurchaseReferrerList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhitePurchaseReferrer, WhitePurchaseReferrerCB&gt;() {
     ...
     */
    public int queryInsert(QueryInsertSetupper<WhitePurchaseReferrer, WhitePurchaseReferrerCB> manyArgLambda) {
     ...
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whitePurchaseReferrer, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * WhitePurchaseReferrerCB cb = <span style="color: #70226C">new</span> WhitePurchaseReferrerCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whitePurchaseReferrer, cb);
     * </pre>
     * @param whitePurchaseReferrer The entity that contains update values. (NotNull, PrimaryKeyNullAllowed)
     * @param cb The condition-bean of WhitePurchaseReferrer. (NotNull)
     * @return The updated count.
     ...
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">queryDelete</span>(whitePurchaseReferrer, cb);
     * </pre>
     * @param cb The condition-bean of WhitePurchaseReferrer. (NotNull)
     * @return The deleted count.
     * @throws NonQueryDeleteNotAllowedException When the query has no condition.
     ...
     * whitePurchaseReferrer.setFoo...(value);
     * whitePurchaseReferrer.setBar...(value);
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whitePurchaseReferrer, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whitePurchaseReferrer, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whitePurchaseReferrer.setVersionNo(value);</span>
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whitePurchaseReferrer, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhitePurchaseReferrerCB cb = <span style="color: #70226C">new</span> WhitePurchaseReferrerCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whitePurchaseReferrerBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whitePurchaseReferrer, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     * whitePurchaseReferrerBhv.outideSql().selectEntity(pmb); <span style="color: #3F7E5E">// optional</span> 
     * whitePurchaseReferrerBhv.outideSql().selectList(pmb); <span style="color: #3F7E5E">// ListResultBean</span>
     * whitePurchaseReferrerBhv.outideSql().selectPage(pmb); <span style="color: #3F7E5E">// PagingResultBean</span>
     * whitePurchaseReferrerBhv.outideSql().selectPagedListOnly(pmb); <span style="color: #3F7E5E">// ListResultBean</span>
     * whitePurchaseReferrerBhv.outideSql().selectCursor(pmb, handler); <span style="color: #3F7E5E">// (by handler)</span>
     * whitePurchaseReferrerBhv.outideSql().execute(pmb); <span style="color: #3F7E5E">// int (updated count)</span>
     * whitePurchaseReferrerBhv.outideSql().call(pmb); <span style="color: #3F7E5E">// void (pmb has OUT parameters)</span>
     *
     * <span style="color: #3F7E5E">// traditional style</span> 
     * whitePurchaseReferrerBhv.outideSql().traditionalStyle().selectEntity(path, pmb, entityType);
     * whitePurchaseReferrerBhv.outideSql().traditionalStyle().selectList(path, pmb, entityType);
     * whitePurchaseReferrerBhv.outideSql().traditionalStyle().selectPage(path, pmb, entityType);
     * whitePurchaseReferrerBhv.outideSql().traditionalStyle().selectPagedListOnly(path, pmb, entityType);
     * whitePurchaseReferrerBhv.outideSql().traditionalStyle().selectCursor(path, pmb, handler);
     * whitePurchaseReferrerBhv.outideSql().traditionalStyle().execute(path, pmb);
     *
     * <span style="color: #3F7E5E">// options</span> 
     * whitePurchaseReferrerBhv.outideSql().removeBlockComment().selectList()
     * whitePurchaseReferrerBhv.outideSql().removeLineComment().selectList()
     * whitePurchaseReferrerBhv.outideSql().formatSql().selectList()
     * </pre>
     * <p>The invoker of behavior command should be not null when you call this method.</p>
     * @return The new-created all facade executor of outside-SQL. (NotNull)
     */
    public OutsideSqlAllFacadeExecutor<WhitePurchaseReferrerBhv> outsideSql() {
        return doOutsideSql();
    }
