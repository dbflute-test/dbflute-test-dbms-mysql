...
public abstract class BsProductCategoryBhv extends AbstractBehaviorWritable<ProductCategory, ProductCategoryCB> {
     ...
     * int count = productCategoryBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * ProductCategory productCategory = productCategoryBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(productCategory -&gt; {
     ...
     * ProductCategory productCategory = productCategoryBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(productCategory -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * productCategoryBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(productCategory -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = productCategory.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * productCategoryBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(productCategory -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = productCategory.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * ProductCategoryCB cb = new ProductCategoryCB();
     * cb.query().setFoo...(value);
     * ProductCategory productCategory = productCategoryBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;ProductCategory&gt; productCategoryList = productCategoryBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     ...
     * PagingResultBean&lt;ProductCategory&gt; page = productCategoryBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * ProductCategoryCB cb = new ProductCategoryCB();
     * cb.query().setFoo...(value);
     * productCategoryBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;ProductCategory&gt;() {
     ...
     * <pre>
     * productCategoryBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * productCategoryBhv.<span style="color: #CC4747">loadProductList</span>(productCategoryList, productCB -&gt; {
     ...
     * <pre>
     * productCategoryBhv.<span style="color: #CC4747">loadProductCategorySelfList</span>(productCategoryList, categoryCB -&gt; {
     *     categoryCB.setupSelect...();
     *     categoryCB.query().setFoo...(value);
     *     categoryCB.query().addOrderBy_Bar...();
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     * <span style="color: #3F7E5E">//}).withNestedList(referrerList -&gt {</span>
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     ...
     * productCategoryBhv.<span style="color: #CC4747">insert</span>(productCategory);
     ...
     * try {
     *     productCategoryBhv.<span style="color: #CC4747">update</span>(productCategory);
     ...
     * productCategory.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     productCategoryBhv.<span style="color: #CC4747">delete</span>(productCategory);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * productCategoryBhv.<span style="color: #CC4747">batchInsert</span>(productCategoryList);
     * </pre>
     ...
     *     productCategoryList.add(productCategory);
     * }
     * productCategoryBhv.<span style="color: #CC4747">batchUpdate</span>(productCategoryList);
     * </pre>
     ...
     * <pre>
     * productCategoryBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;ProductCategory, ProductCategoryCB&gt;() {
     ...
     * ProductCategoryCB cb = new ProductCategoryCB();
     * cb.query().setFoo...(value);
     * productCategoryBhv.<span style="color: #CC4747">queryUpdate</span>(productCategory, cb);
     * </pre>
     ...
     * ProductCategoryCB cb = new ProductCategoryCB();
     * cb.query().setFoo...(value);
     * productCategoryBhv.<span style="color: #CC4747">queryDelete</span>(productCategory, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of ProductCategory. (NotNull)
     ...
     * productCategoryBhv.<span style="color: #CC4747">varyingInsert</span>(productCategory, option);
     * ... = productCategory.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param productCategory The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     productCategoryBhv.<span style="color: #CC4747">varyingUpdate</span>(productCategory, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * productCategoryBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(productCategory, cb, option);
     * </pre>
