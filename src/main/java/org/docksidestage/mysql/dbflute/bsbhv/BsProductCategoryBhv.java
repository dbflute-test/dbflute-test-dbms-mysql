...
public abstract class BsProductCategoryBhv extends AbstractBehaviorWritable<ProductCategory, ProductCategoryCB> {
     ...
     * <pre>
     * productCategoryBhv.<span style="color: #DD4747">loadProductList</span>(productCategoryList, productCB -&gt; {
     ...
     * <pre>
     * productCategoryBhv.<span style="color: #DD4747">loadProductCategorySelfList</span>(productCategoryList, categoryCB -&gt; {
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(ProductCategory productCategory, WOptionCall<ProductCategoryCB, InsertOption<ProductCategoryCB>> opLambda) {
        doInsert(productCategory, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(ProductCategory productCategory, WOptionCall<ProductCategoryCB, UpdateOption<ProductCategoryCB>> opLambda) {
        doUpdate(productCategory, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(ProductCategory productCategory, WOptionCall<ProductCategoryCB, InsertOption<ProductCategoryCB>> insertOpLambda, WOptionCall<ProductCategoryCB, UpdateOption<ProductCategoryCB>> updateOpLambda) {
        doInsertOrUpdate(productCategory, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(ProductCategory productCategory, WOptionCall<ProductCategoryCB, DeleteOption<ProductCategoryCB>> opLambda) {
        doDelete(productCategory, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<ProductCategory> productCategoryList, WOptionCall<ProductCategoryCB, InsertOption<ProductCategoryCB>> opLambda) {
        return doBatchInsert(productCategoryList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<ProductCategory> productCategoryList, WOptionCall<ProductCategoryCB, UpdateOption<ProductCategoryCB>> opLambda) {
        return doBatchUpdate(productCategoryList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<ProductCategory> productCategoryList, WOptionCall<ProductCategoryCB, DeleteOption<ProductCategoryCB>> opLambda) {
        return doBatchDelete(productCategoryList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<ProductCategory, ProductCategoryCB> manyArgLambda, WOptionCall<ProductCategoryCB, InsertOption<ProductCategoryCB>> opLambda) {
