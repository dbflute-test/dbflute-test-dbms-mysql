...
public abstract class BsWhiteSuppressJoinSqBhv extends AbstractBehaviorWritable<WhiteSuppressJoinSq, WhiteSuppressJoinSqCB> {
     ...
     * int count = whiteSuppressJoinSqBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteSuppressJoinSq whiteSuppressJoinSq = whiteSuppressJoinSqBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteSuppressJoinSq -&gt; {
     ...
     * WhiteSuppressJoinSq whiteSuppressJoinSq = whiteSuppressJoinSqBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteSuppressJoinSq -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteSuppressJoinSqBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteSuppressJoinSq -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteSuppressJoinSq.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteSuppressJoinSq -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteSuppressJoinSq.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteSuppressJoinSqCB cb = new WhiteSuppressJoinSqCB();
     * cb.query().setFoo...(value);
     * WhiteSuppressJoinSq whiteSuppressJoinSq = whiteSuppressJoinSqBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteSuppressJoinSq&gt; whiteSuppressJoinSqList = whiteSuppressJoinSqBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteSuppressJoinSqList.forEach(whiteSuppressJoinSq -&gt; {
     *     ... = whiteSuppressJoinSq.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressJoinSq. (NotNull)
     ...
     * PagingResultBean&lt;WhiteSuppressJoinSq&gt; page = whiteSuppressJoinSqBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteSuppressJoinSqCB cb = new WhiteSuppressJoinSqCB();
     * cb.query().setFoo...(value);
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteSuppressJoinSq&gt;() {
     ...
     * <pre>
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">loadWhiteSuppressJoinSqManyList</span>(whiteSuppressJoinSqList, manyCB -&gt; {
     *     manyCB.setupSelect...();
     ...
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">insert</span>(whiteSuppressJoinSq);
     ...
     * try {
     *     whiteSuppressJoinSqBhv.<span style="color: #CC4747">update</span>(whiteSuppressJoinSq);
     ...
     * whiteSuppressJoinSq.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteSuppressJoinSqBhv.<span style="color: #CC4747">delete</span>(whiteSuppressJoinSq);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">batchInsert</span>(whiteSuppressJoinSqList);
     * </pre>
     ...
     *     whiteSuppressJoinSqList.add(whiteSuppressJoinSq);
     * }
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">batchUpdate</span>(whiteSuppressJoinSqList);
     * </pre>
     ...
     * <pre>
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteSuppressJoinSq, WhiteSuppressJoinSqCB&gt;() {
     ...
     * WhiteSuppressJoinSqCB cb = new WhiteSuppressJoinSqCB();
     * cb.query().setFoo...(value);
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">queryUpdate</span>(whiteSuppressJoinSq, cb);
     * </pre>
     ...
     * WhiteSuppressJoinSqCB cb = new WhiteSuppressJoinSqCB();
     * cb.query().setFoo...(value);
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">queryDelete</span>(whiteSuppressJoinSq, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressJoinSq. (NotNull)
     ...
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">varyingInsert</span>(whiteSuppressJoinSq, option);
     * ... = whiteSuppressJoinSq.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteSuppressJoinSq The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteSuppressJoinSqBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteSuppressJoinSq, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteSuppressJoinSqBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSuppressJoinSq, cb, option);
     * </pre>
