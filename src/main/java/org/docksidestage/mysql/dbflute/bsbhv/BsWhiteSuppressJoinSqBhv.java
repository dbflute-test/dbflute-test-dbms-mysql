...
public abstract class BsWhiteSuppressJoinSqBhv extends AbstractBehaviorWritable<WhiteSuppressJoinSq, WhiteSuppressJoinSqCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteSuppressJoinSqBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteSuppressJoinSqBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteSuppressJoinSq <span style="color: #553000">whiteSuppressJoinSq</span> : <span style="color: #553000">whiteSuppressJoinSqList</span>) {
     *     ... = <span style="color: #553000">whiteSuppressJoinSq</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressJoinSq. (NotNull)
     ...
     * ...
     * for (WhiteSuppressJoinSq whiteSuppressJoinSq : <span style="color: #553000">page</span>) {
     *     ... = whiteSuppressJoinSq.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressJoinSq. (NotNull)
     ...
     * WhiteSuppressJoinSqCB cb = new WhiteSuppressJoinSqCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteSuppressJoinSqBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteSuppressJoinSq&gt;() {
