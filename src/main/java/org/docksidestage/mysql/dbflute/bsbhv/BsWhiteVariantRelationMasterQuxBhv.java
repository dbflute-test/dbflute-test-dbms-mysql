...
public abstract class BsWhiteVariantRelationMasterQuxBhv extends AbstractBehaviorWritable<WhiteVariantRelationMasterQux, WhiteVariantRelationMasterQuxCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteVariantRelationMasterQuxBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * SpecifyColumn is ignored but you can use it only to remove text type column for union's distinct.
     * <pre>
     * WhiteVariantRelationMasterQuxCB cb = <span style="color: #70226C">new</span> WhiteVariantRelationMasterQuxCB();
     * cb.query().setFoo...(value);
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteVariantRelationMasterQuxBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * <span style="color: #70226C">for</span> (WhiteVariantRelationMasterQux <span style="color: #553000">whiteVariantRelationMasterQux</span> : <span style="color: #553000">whiteVariantRelationMasterQuxList</span>) {
     *     ... = <span style="color: #553000">whiteVariantRelationMasterQux</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterQux. (NotNull)
     ...
     * <span style="color: #70226C">for</span> (WhiteVariantRelationMasterQux whiteVariantRelationMasterQux : <span style="color: #553000">whiteVariantRelationMasterQuxList</span>) {
     *     ... = whiteVariantRelationMasterQux.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteVariantRelationMasterQux. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteVariantRelationMasterQux whiteVariantRelationMasterQux : <span style="color: #553000">page</span>) {
     *     ... = whiteVariantRelationMasterQux.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterQux. (NotNull)
     ...
     * WhiteVariantRelationMasterQuxCB cb = <span style="color: #70226C">new</span> WhiteVariantRelationMasterQuxCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteVariantRelationMasterQuxBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteVariantRelationMasterQux. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whiteVariantRelationMasterQuxBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteVariantRelationMasterQuxCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <pre>
     * WhiteVariantRelationMasterQux whiteVariantRelationMasterQux = <span style="color: #70226C">new</span> WhiteVariantRelationMasterQux();
     ...
     * <span style="color: #0000C0">whiteVariantRelationMasterQuxBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteVariantRelationMasterQux, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * whiteVariantRelationMasterQux.setFoo...(value);
     * whiteVariantRelationMasterQux.setBar...(value);
     * <span style="color: #0000C0">whiteVariantRelationMasterQuxBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteVariantRelationMasterQux, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteVariantRelationMasterQuxBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteVariantRelationMasterQux, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteVariantRelationMasterQux.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteVariantRelationMasterQuxBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteVariantRelationMasterQux, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteVariantRelationMasterQuxCB cb = <span style="color: #70226C">new</span> WhiteVariantRelationMasterQuxCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteVariantRelationMasterQuxBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteVariantRelationMasterQux, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhiteVariantRelationMasterQuxBhv> outsideSql() {
        return doOutsideSql();
    }
