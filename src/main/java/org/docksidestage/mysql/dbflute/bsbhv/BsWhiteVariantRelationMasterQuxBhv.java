...
public abstract class BsWhiteVariantRelationMasterQuxBhv extends AbstractBehaviorWritable<WhiteVariantRelationMasterQux, WhiteVariantRelationMasterQuxCB> {
     ...
     * int count = whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteVariantRelationMasterQux whiteVariantRelationMasterQux = whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteVariantRelationMasterQux -&gt; {
     ...
     * WhiteVariantRelationMasterQux whiteVariantRelationMasterQux = whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteVariantRelationMasterQux -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteVariantRelationMasterQuxBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteVariantRelationMasterQux -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteVariantRelationMasterQux.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteVariantRelationMasterQux -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteVariantRelationMasterQux.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteVariantRelationMasterQuxCB cb = new WhiteVariantRelationMasterQuxCB();
     * cb.query().setFoo...(value);
     * WhiteVariantRelationMasterQux whiteVariantRelationMasterQux = whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteVariantRelationMasterQux&gt; whiteVariantRelationMasterQuxList = whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteVariantRelationMasterQuxList.forEach(whiteVariantRelationMasterQux -&gt; {
     *     ... = whiteVariantRelationMasterQux.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterQux. (NotNull)
     ...
     * PagingResultBean&lt;WhiteVariantRelationMasterQux&gt; page = whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteVariantRelationMasterQuxCB cb = new WhiteVariantRelationMasterQuxCB();
     * cb.query().setFoo...(value);
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteVariantRelationMasterQux&gt;() {
     ...
     * <pre>
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">insert</span>(whiteVariantRelationMasterQux);
     ...
     * try {
     *     whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">update</span>(whiteVariantRelationMasterQux);
     ...
     * whiteVariantRelationMasterQux.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">delete</span>(whiteVariantRelationMasterQux);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">batchInsert</span>(whiteVariantRelationMasterQuxList);
     * </pre>
     ...
     *     whiteVariantRelationMasterQuxList.add(whiteVariantRelationMasterQux);
     * }
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">batchUpdate</span>(whiteVariantRelationMasterQuxList);
     * </pre>
     ...
     * <pre>
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteVariantRelationMasterQux, WhiteVariantRelationMasterQuxCB&gt;() {
     ...
     * WhiteVariantRelationMasterQuxCB cb = new WhiteVariantRelationMasterQuxCB();
     * cb.query().setFoo...(value);
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">queryUpdate</span>(whiteVariantRelationMasterQux, cb);
     * </pre>
     ...
     * WhiteVariantRelationMasterQuxCB cb = new WhiteVariantRelationMasterQuxCB();
     * cb.query().setFoo...(value);
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">queryDelete</span>(whiteVariantRelationMasterQux, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterQux. (NotNull)
     ...
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">varyingInsert</span>(whiteVariantRelationMasterQux, option);
     * ... = whiteVariantRelationMasterQux.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteVariantRelationMasterQux The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteVariantRelationMasterQux, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteVariantRelationMasterQuxBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteVariantRelationMasterQux, cb, option);
     * </pre>
