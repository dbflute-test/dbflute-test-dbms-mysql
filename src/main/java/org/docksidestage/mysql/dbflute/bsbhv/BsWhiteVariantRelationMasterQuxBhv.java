...
public abstract class BsWhiteVariantRelationMasterQuxBhv extends AbstractBehaviorWritable<WhiteVariantRelationMasterQux, WhiteVariantRelationMasterQuxCB> {
     ...
     * WhiteVariantRelationMasterQuxCB cb = new WhiteVariantRelationMasterQuxCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhiteVariantRelationMasterQux&gt; entity = whiteVariantRelationMasterQuxBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whiteVariantRelationMasterQux -&gt; {
     *     ...
     * });
     * WhiteVariantRelationMasterQux whiteVariantRelationMasterQux = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whiteVariantRelationMasterQux -&gt; {
     *     ...
     * });
    ...
    public int queryUpdate(WhiteVariantRelationMasterQux whiteVariantRelationMasterQux, CBCall<WhiteVariantRelationMasterQuxCB> cbLambda) {
        return doQueryUpdate(whiteVariantRelationMasterQux, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteVariantRelationMasterQux whiteVariantRelationMasterQux, WOptionCall<WhiteVariantRelationMasterQuxCB, InsertOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
        doInsert(whiteVariantRelationMasterQux, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteVariantRelationMasterQux whiteVariantRelationMasterQux, WOptionCall<WhiteVariantRelationMasterQuxCB, UpdateOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
        doUpdate(whiteVariantRelationMasterQux, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteVariantRelationMasterQux whiteVariantRelationMasterQux, WOptionCall<WhiteVariantRelationMasterQuxCB, InsertOption<WhiteVariantRelationMasterQuxCB>> insertOpLambda, WOptionCall<WhiteVariantRelationMasterQuxCB, UpdateOption<WhiteVariantRelationMasterQuxCB>> updateOpLambda) {
        doInsertOrUpdate(whiteVariantRelationMasterQux, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteVariantRelationMasterQux whiteVariantRelationMasterQux, WOptionCall<WhiteVariantRelationMasterQuxCB, DeleteOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
        doDelete(whiteVariantRelationMasterQux, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteVariantRelationMasterQux> whiteVariantRelationMasterQuxList, WOptionCall<WhiteVariantRelationMasterQuxCB, InsertOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
        return doBatchInsert(whiteVariantRelationMasterQuxList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteVariantRelationMasterQux> whiteVariantRelationMasterQuxList, WOptionCall<WhiteVariantRelationMasterQuxCB, UpdateOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
        return doBatchUpdate(whiteVariantRelationMasterQuxList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteVariantRelationMasterQux> whiteVariantRelationMasterQuxList, WOptionCall<WhiteVariantRelationMasterQuxCB, DeleteOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
        return doBatchDelete(whiteVariantRelationMasterQuxList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteVariantRelationMasterQux, WhiteVariantRelationMasterQuxCB> manyArgLambda, WOptionCall<WhiteVariantRelationMasterQuxCB, InsertOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteVariantRelationMasterQux whiteVariantRelationMasterQux, CBCall<WhiteVariantRelationMasterQuxCB> cbLambda, WOptionCall<WhiteVariantRelationMasterQuxCB, UpdateOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
        return doQueryUpdate(whiteVariantRelationMasterQux, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteVariantRelationMasterQux whiteVariantRelationMasterQux, WhiteVariantRelationMasterQuxCB cb, WOptionCall<WhiteVariantRelationMasterQuxCB, UpdateOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
        return doQueryUpdate(whiteVariantRelationMasterQux, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteVariantRelationMasterQuxCB> cbLambda, WOptionCall<WhiteVariantRelationMasterQuxCB, DeleteOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteVariantRelationMasterQuxCB cb, WOptionCall<WhiteVariantRelationMasterQuxCB, DeleteOption<WhiteVariantRelationMasterQuxCB>> opLambda) {
