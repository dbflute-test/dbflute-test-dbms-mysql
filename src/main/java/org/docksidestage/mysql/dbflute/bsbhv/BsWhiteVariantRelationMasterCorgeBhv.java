...
/**
 * The behavior of WHITE_VARIANT_RELATION_MASTER_CORGE as TABLE.
...
public abstract class BsWhiteVariantRelationMasterCorgeBhv extends AbstractBehaviorWritable<WhiteVariantRelationMasterCorge, WhiteVariantRelationMasterCorgeCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * <span style="color: #70226C">for</span> (WhiteVariantRelationMasterCorge <span style="color: #553000">whiteVariantRelationMasterCorge</span> : <span style="color: #553000">whiteVariantRelationMasterCorgeList</span>) {
     *     ... = <span style="color: #553000">whiteVariantRelationMasterCorge</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterCorge. (NotNull)
     ...
     * <span style="color: #70226C">for</span> (WhiteVariantRelationMasterCorge whiteVariantRelationMasterCorge : <span style="color: #553000">whiteVariantRelationMasterCorgeList</span>) {
     *     ... = whiteVariantRelationMasterCorge.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteVariantRelationMasterCorge. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteVariantRelationMasterCorge whiteVariantRelationMasterCorge : <span style="color: #553000">page</span>) {
     *     ... = whiteVariantRelationMasterCorge.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterCorge. (NotNull)
     ...
     * WhiteVariantRelationMasterCorgeCB cb = <span style="color: #70226C">new</span> WhiteVariantRelationMasterCorgeCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteVariantRelationMasterCorge. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteVariantRelationMasterCorgeCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <pre>
     * WhiteVariantRelationMasterCorge whiteVariantRelationMasterCorge = <span style="color: #70226C">new</span> WhiteVariantRelationMasterCorge();
     ...
     * <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteVariantRelationMasterCorge, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteVariantRelationMasterCorge. (NotNull)
     ...
     * whiteVariantRelationMasterCorge.setFoo...(value);
     * whiteVariantRelationMasterCorge.setBar...(value);
     * <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteVariantRelationMasterCorge, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteVariantRelationMasterCorge, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteVariantRelationMasterCorge.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteVariantRelationMasterCorge, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteVariantRelationMasterCorgeCB cb = <span style="color: #70226C">new</span> WhiteVariantRelationMasterCorgeCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteVariantRelationMasterCorge, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     * <pre>
     * <span style="color: #0000C0">whiteVariantRelationMasterCorgeBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteVariantRelationMasterCorge, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * }, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhiteVariantRelationMasterCorgeBhv> outsideSql() {
        return doOutsideSql();
    }
