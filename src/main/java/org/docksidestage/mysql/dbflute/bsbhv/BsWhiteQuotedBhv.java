...
public abstract class BsWhiteQuotedBhv extends AbstractBehaviorWritable<WhiteQuoted, WhiteQuotedCB> {
     ...
     * int count = whiteQuotedBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteQuoted whiteQuoted = whiteQuotedBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteQuoted -&gt; {
     ...
     * WhiteQuoted whiteQuoted = whiteQuotedBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteQuoted -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteQuotedBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteQuoted -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteQuoted.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteQuotedBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteQuoted -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteQuoted.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteQuotedCB cb = new WhiteQuotedCB();
     * cb.query().setFoo...(value);
     * WhiteQuoted whiteQuoted = whiteQuotedBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteQuoted&gt; whiteQuotedList = whiteQuotedBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteQuotedList.forEach(whiteQuoted -&gt; {
     *     ... = whiteQuoted.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteQuoted. (NotNull)
     ...
     * PagingResultBean&lt;WhiteQuoted&gt; page = whiteQuotedBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteQuotedCB cb = new WhiteQuotedCB();
     * cb.query().setFoo...(value);
     * whiteQuotedBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteQuoted&gt;() {
     ...
     * <pre>
     * whiteQuotedBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * whiteQuotedBhv.<span style="color: #CC4747">loadWhiteQuotedRefList</span>(whiteQuotedList, refCB -&gt; {
     *     refCB.setupSelect...();
     ...
     * whiteQuotedBhv.<span style="color: #CC4747">insert</span>(whiteQuoted);
     ...
     * try {
     *     whiteQuotedBhv.<span style="color: #CC4747">update</span>(whiteQuoted);
     ...
     * whiteQuoted.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteQuotedBhv.<span style="color: #CC4747">delete</span>(whiteQuoted);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteQuotedBhv.<span style="color: #CC4747">batchInsert</span>(whiteQuotedList);
     * </pre>
     ...
     *     whiteQuotedList.add(whiteQuoted);
     * }
     * whiteQuotedBhv.<span style="color: #CC4747">batchUpdate</span>(whiteQuotedList);
     * </pre>
     ...
     * <pre>
     * whiteQuotedBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteQuoted, WhiteQuotedCB&gt;() {
     ...
     * WhiteQuotedCB cb = new WhiteQuotedCB();
     * cb.query().setFoo...(value);
     * whiteQuotedBhv.<span style="color: #CC4747">queryUpdate</span>(whiteQuoted, cb);
     * </pre>
     ...
     * WhiteQuotedCB cb = new WhiteQuotedCB();
     * cb.query().setFoo...(value);
     * whiteQuotedBhv.<span style="color: #CC4747">queryDelete</span>(whiteQuoted, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteQuoted. (NotNull)
     ...
     * whiteQuotedBhv.<span style="color: #CC4747">varyingInsert</span>(whiteQuoted, option);
     * ... = whiteQuoted.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteQuoted The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteQuotedBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteQuoted, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteQuotedBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteQuoted, cb, option);
     * </pre>
