...
public abstract class BsWhiteQuotedBhv extends AbstractBehaviorWritable<WhiteQuoted, WhiteQuotedCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteQuotedBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteQuotedBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteQuoted <span style="color: #553000">whiteQuoted</span> : <span style="color: #553000">whiteQuotedList</span>) {
     *     ... = <span style="color: #553000">whiteQuoted</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteQuoted. (NotNull)
     ...
     * ...
     * for (WhiteQuoted whiteQuoted : <span style="color: #553000">page</span>) {
     *     ... = whiteQuoted.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteQuoted. (NotNull)
     ...
     * WhiteQuotedCB cb = new WhiteQuotedCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteQuotedBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteQuoted&gt;() {
