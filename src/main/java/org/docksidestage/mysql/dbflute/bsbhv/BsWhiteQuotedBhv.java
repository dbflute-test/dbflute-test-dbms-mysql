...
public abstract class BsWhiteQuotedBhv extends AbstractBehaviorWritable<WhiteQuoted, WhiteQuotedCB> {
     ...
     * WhiteQuotedCB cb = new WhiteQuotedCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhiteQuoted&gt; entity = whiteQuotedBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whiteQuoted -&gt; {
     *     ...
     * });
     * WhiteQuoted whiteQuoted = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whiteQuoted -&gt; {
     *     ...
     * });
     ...
     * <pre>
     * whiteQuotedBhv.<span style="color: #DD4747">loadWhiteQuotedRefList</span>(whiteQuotedList, refCB -&gt; {
     *     refCB.setupSelect...();
    ...
    public int queryUpdate(WhiteQuoted whiteQuoted, CBCall<WhiteQuotedCB> cbLambda) {
        return doQueryUpdate(whiteQuoted, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteQuoted whiteQuoted, WOptionCall<WhiteQuotedCB, InsertOption<WhiteQuotedCB>> opLambda) {
        doInsert(whiteQuoted, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteQuoted whiteQuoted, WOptionCall<WhiteQuotedCB, UpdateOption<WhiteQuotedCB>> opLambda) {
        doUpdate(whiteQuoted, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteQuoted whiteQuoted, WOptionCall<WhiteQuotedCB, InsertOption<WhiteQuotedCB>> insertOpLambda, WOptionCall<WhiteQuotedCB, UpdateOption<WhiteQuotedCB>> updateOpLambda) {
        doInsertOrUpdate(whiteQuoted, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteQuoted whiteQuoted, WOptionCall<WhiteQuotedCB, DeleteOption<WhiteQuotedCB>> opLambda) {
        doDelete(whiteQuoted, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteQuoted> whiteQuotedList, WOptionCall<WhiteQuotedCB, InsertOption<WhiteQuotedCB>> opLambda) {
        return doBatchInsert(whiteQuotedList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteQuoted> whiteQuotedList, WOptionCall<WhiteQuotedCB, UpdateOption<WhiteQuotedCB>> opLambda) {
        return doBatchUpdate(whiteQuotedList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteQuoted> whiteQuotedList, WOptionCall<WhiteQuotedCB, DeleteOption<WhiteQuotedCB>> opLambda) {
        return doBatchDelete(whiteQuotedList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteQuoted, WhiteQuotedCB> manyArgLambda, WOptionCall<WhiteQuotedCB, InsertOption<WhiteQuotedCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteQuoted whiteQuoted, CBCall<WhiteQuotedCB> cbLambda, WOptionCall<WhiteQuotedCB, UpdateOption<WhiteQuotedCB>> opLambda) {
        return doQueryUpdate(whiteQuoted, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteQuoted whiteQuoted, WhiteQuotedCB cb, WOptionCall<WhiteQuotedCB, UpdateOption<WhiteQuotedCB>> opLambda) {
        return doQueryUpdate(whiteQuoted, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteQuotedCB> cbLambda, WOptionCall<WhiteQuotedCB, DeleteOption<WhiteQuotedCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteQuotedCB cb, WOptionCall<WhiteQuotedCB, DeleteOption<WhiteQuotedCB>> opLambda) {
