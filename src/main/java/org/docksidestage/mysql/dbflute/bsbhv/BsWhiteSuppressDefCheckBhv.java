...
public abstract class BsWhiteSuppressDefCheckBhv extends AbstractBehaviorWritable<WhiteSuppressDefCheck, WhiteSuppressDefCheckCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteSuppressDefCheckBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteSuppressDefCheckBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteSuppressDefCheck <span style="color: #553000">whiteSuppressDefCheck</span> : <span style="color: #553000">whiteSuppressDefCheckList</span>) {
     *     ... = <span style="color: #553000">whiteSuppressDefCheck</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressDefCheck. (NotNull)
     ...
     * for (WhiteSuppressDefCheck whiteSuppressDefCheck : <span style="color: #553000">whiteSuppressDefCheckList</span>) {
     *     ... = whiteSuppressDefCheck.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteSuppressDefCheck. (NotNull)
     ...
     * ...
     * for (WhiteSuppressDefCheck whiteSuppressDefCheck : <span style="color: #553000">page</span>) {
     *     ... = whiteSuppressDefCheck.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressDefCheck. (NotNull)
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteSuppressDefCheckBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteSuppressDefCheck&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteSuppressDefCheckBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteSuppressDefCheckBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteSuppressDefCheck, option);
     * ... = whiteSuppressDefCheck.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteSuppressDefCheck The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteSuppressDefCheckBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteSuppressDefCheck, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #0000C0">whiteSuppressDefCheckBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSuppressDefCheck, cb, option);
     * </pre>
