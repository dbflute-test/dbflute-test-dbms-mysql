...
public abstract class BsWhiteSuppressDefCheckBhv extends AbstractBehaviorWritable<WhiteSuppressDefCheck, WhiteSuppressDefCheckCB> {
     ...
     * int count = whiteSuppressDefCheckBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteSuppressDefCheck whiteSuppressDefCheck = whiteSuppressDefCheckBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteSuppressDefCheck -&gt; {
     ...
     * WhiteSuppressDefCheck whiteSuppressDefCheck = whiteSuppressDefCheckBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteSuppressDefCheck -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteSuppressDefCheck -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteSuppressDefCheck.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteSuppressDefCheck -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteSuppressDefCheck.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().setFoo...(value);
     * WhiteSuppressDefCheck whiteSuppressDefCheck = whiteSuppressDefCheckBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteSuppressDefCheck&gt; whiteSuppressDefCheckList = whiteSuppressDefCheckBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteSuppressDefCheckList.forEach(whiteSuppressDefCheck -&gt; {
     *     ... = whiteSuppressDefCheck.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressDefCheck. (NotNull)
     ...
     * PagingResultBean&lt;WhiteSuppressDefCheck&gt; page = whiteSuppressDefCheckBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().setFoo...(value);
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteSuppressDefCheck&gt;() {
     ...
     * <pre>
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">insert</span>(whiteSuppressDefCheck);
     ...
     * try {
     *     whiteSuppressDefCheckBhv.<span style="color: #CC4747">update</span>(whiteSuppressDefCheck);
     ...
     * whiteSuppressDefCheck.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteSuppressDefCheckBhv.<span style="color: #CC4747">delete</span>(whiteSuppressDefCheck);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">batchInsert</span>(whiteSuppressDefCheckList);
     * </pre>
     ...
     *     whiteSuppressDefCheckList.add(whiteSuppressDefCheck);
     * }
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">batchUpdate</span>(whiteSuppressDefCheckList);
     * </pre>
     ...
     * <pre>
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteSuppressDefCheck, WhiteSuppressDefCheckCB&gt;() {
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().setFoo...(value);
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">queryUpdate</span>(whiteSuppressDefCheck, cb);
     * </pre>
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().setFoo...(value);
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">queryDelete</span>(whiteSuppressDefCheck, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressDefCheck. (NotNull)
     ...
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">varyingInsert</span>(whiteSuppressDefCheck, option);
     * ... = whiteSuppressDefCheck.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteSuppressDefCheck The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteSuppressDefCheckBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteSuppressDefCheck, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteSuppressDefCheckBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSuppressDefCheck, cb, option);
     * </pre>
