...
public abstract class BsWhiteSuppressDefCheckBhv extends AbstractBehaviorWritable<WhiteSuppressDefCheck, WhiteSuppressDefCheckCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public WhiteSuppressDefCheckDbm getDBMeta() { return WhiteSuppressDefCheckDbm.getInstance(); }
     ...
     * int count = whiteSuppressDefCheckBhv.<span style="color: #DD4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhiteSuppressDefCheck&gt; entity = whiteSuppressDefCheckBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whiteSuppressDefCheck -&gt; {
     *     ...
     * });
     * WhiteSuppressDefCheck whiteSuppressDefCheck = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whiteSuppressDefCheck -&gt; {
     *     ...
     * });
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().setFoo...(value);
     * WhiteSuppressDefCheck whiteSuppressDefCheck = whiteSuppressDefCheckBhv.<span style="color: #DD4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * ListResultBean&lt;WhiteSuppressDefCheck&gt; whiteSuppressDefCheckList = whiteSuppressDefCheckBhv.<span style="color: #DD4747">selectList</span>(cb);
     ...
     * PagingResultBean&lt;WhiteSuppressDefCheck&gt; page = whiteSuppressDefCheckBhv.<span style="color: #DD4747">selectPage</span>(cb);
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().setFoo...(value);
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteSuppressDefCheck&gt;() {
     ...
     * <pre>
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteSuppressDefCheckCB, RESULT> scalarSelect(Class<RESULT> resultType) {
     ...
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">insert</span>(whiteSuppressDefCheck);
     ...
     * whiteSuppressDefCheck.<span style="color: #DD4747">setVersionNo</span>(value);
     * try {
     *     whiteSuppressDefCheckBhv.<span style="color: #DD4747">update</span>(whiteSuppressDefCheck);
     ...
     * whiteSuppressDefCheck.<span style="color: #DD4747">setVersionNo</span>(value);
     * try {
     *     whiteSuppressDefCheckBhv.<span style="color: #DD4747">delete</span>(whiteSuppressDefCheck);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">batchInsert</span>(whiteSuppressDefCheckList);
     * </pre>
     ...
     *     whiteSuppressDefCheckList.add(whiteSuppressDefCheck);
     * }
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">batchUpdate</span>(whiteSuppressDefCheckList);
     * </pre>
     ...
     * <pre>
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteSuppressDefCheck, WhiteSuppressDefCheckCB&gt;() {
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().setFoo...(value);
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">queryUpdate</span>(whiteSuppressDefCheck, cb);
     * </pre>
    ...
    public int queryUpdate(WhiteSuppressDefCheck whiteSuppressDefCheck, CBCall<WhiteSuppressDefCheckCB> cbLambda) {
        return doQueryUpdate(whiteSuppressDefCheck, handleCBCall(cbLambda), null);
    }
     ...
     * WhiteSuppressDefCheckCB cb = new WhiteSuppressDefCheckCB();
     * cb.query().setFoo...(value);
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">queryDelete</span>(whiteSuppressDefCheck, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressDefCheck. (NotNull)
     ...
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">varyingInsert</span>(whiteSuppressDefCheck, option);
     * ... = whiteSuppressDefCheck.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteSuppressDefCheck The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteSuppressDefCheck whiteSuppressDefCheck, WOptionCall<WhiteSuppressDefCheckCB, InsertOption<WhiteSuppressDefCheckCB>> opLambda) {
        doInsert(whiteSuppressDefCheck, handleInsertOpCall(opLambda));
    }
     ...
     *     whiteSuppressDefCheckBhv.<span style="color: #DD4747">varyingUpdate</span>(whiteSuppressDefCheck, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteSuppressDefCheck whiteSuppressDefCheck, WOptionCall<WhiteSuppressDefCheckCB, UpdateOption<WhiteSuppressDefCheckCB>> opLambda) {
        doUpdate(whiteSuppressDefCheck, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteSuppressDefCheck whiteSuppressDefCheck, WOptionCall<WhiteSuppressDefCheckCB, InsertOption<WhiteSuppressDefCheckCB>> insertOpLambda, WOptionCall<WhiteSuppressDefCheckCB, UpdateOption<WhiteSuppressDefCheckCB>> updateOpLambda) {
        doInsertOrUpdate(whiteSuppressDefCheck, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteSuppressDefCheck whiteSuppressDefCheck, WOptionCall<WhiteSuppressDefCheckCB, DeleteOption<WhiteSuppressDefCheckCB>> opLambda) {
        doDelete(whiteSuppressDefCheck, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteSuppressDefCheck> whiteSuppressDefCheckList, WOptionCall<WhiteSuppressDefCheckCB, InsertOption<WhiteSuppressDefCheckCB>> opLambda) {
        return doBatchInsert(whiteSuppressDefCheckList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteSuppressDefCheck> whiteSuppressDefCheckList, WOptionCall<WhiteSuppressDefCheckCB, UpdateOption<WhiteSuppressDefCheckCB>> opLambda) {
        return doBatchUpdate(whiteSuppressDefCheckList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteSuppressDefCheck> whiteSuppressDefCheckList, WOptionCall<WhiteSuppressDefCheckCB, DeleteOption<WhiteSuppressDefCheckCB>> opLambda) {
        return doBatchDelete(whiteSuppressDefCheckList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteSuppressDefCheck, WhiteSuppressDefCheckCB> manyArgLambda, WOptionCall<WhiteSuppressDefCheckCB, InsertOption<WhiteSuppressDefCheckCB>> opLambda) {
     ...
     * whiteSuppressDefCheckBhv.<span style="color: #DD4747">varyingQueryUpdate</span>(whiteSuppressDefCheck, cb, option);
     * </pre>
     ...
     */
    public int varyingQueryUpdate(WhiteSuppressDefCheck whiteSuppressDefCheck, CBCall<WhiteSuppressDefCheckCB> cbLambda, WOptionCall<WhiteSuppressDefCheckCB, UpdateOption<WhiteSuppressDefCheckCB>> opLambda) {
        return doQueryUpdate(whiteSuppressDefCheck, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteSuppressDefCheck whiteSuppressDefCheck, WhiteSuppressDefCheckCB cb, WOptionCall<WhiteSuppressDefCheckCB, UpdateOption<WhiteSuppressDefCheckCB>> opLambda) {
        return doQueryUpdate(whiteSuppressDefCheck, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteSuppressDefCheckCB> cbLambda, WOptionCall<WhiteSuppressDefCheckCB, DeleteOption<WhiteSuppressDefCheckCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteSuppressDefCheckCB cb, WOptionCall<WhiteSuppressDefCheckCB, DeleteOption<WhiteSuppressDefCheckCB>> opLambda) {
    ...
    public OutsideSqlBasicExecutor<WhiteSuppressDefCheckBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<WhiteSuppressDefCheckBhv> facadeExecutor = doOutsideSql();
