...
public abstract class BsWhiteSuppressJoinSqManyOneOneBhv extends AbstractBehaviorWritable<WhiteSuppressJoinSqManyOneOne, WhiteSuppressJoinSqManyOneOneCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteSuppressJoinSqManyOneOneBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteSuppressJoinSqManyOneOneBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteSuppressJoinSqManyOneOne <span style="color: #553000">whiteSuppressJoinSqManyOneOne</span> : <span style="color: #553000">whiteSuppressJoinSqManyOneOneList</span>) {
     *     ... = <span style="color: #553000">whiteSuppressJoinSqManyOneOne</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressJoinSqManyOneOne. (NotNull)
     ...
     * ...
     * for (WhiteSuppressJoinSqManyOneOne whiteSuppressJoinSqManyOneOne : <span style="color: #553000">page</span>) {
     *     ... = whiteSuppressJoinSqManyOneOne.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressJoinSqManyOneOne. (NotNull)
     ...
     * WhiteSuppressJoinSqManyOneOneCB cb = new WhiteSuppressJoinSqManyOneOneCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteSuppressJoinSqManyOneOneBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteSuppressJoinSqManyOneOne&gt;() {
     ...
     * <span style="color: #0000C0">whiteSuppressJoinSqManyOneOneBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteSuppressJoinSqManyOneOne, option);
     * ... = whiteSuppressJoinSqManyOneOne.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteSuppressJoinSqManyOneOne The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteSuppressJoinSqManyOneOneBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteSuppressJoinSqManyOneOne, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #0000C0">whiteSuppressJoinSqManyOneOneBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSuppressJoinSqManyOneOne, cb, option);
     * </pre>
