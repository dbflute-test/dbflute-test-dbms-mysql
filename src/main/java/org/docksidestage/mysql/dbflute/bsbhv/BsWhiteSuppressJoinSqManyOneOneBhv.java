...
public abstract class BsWhiteSuppressJoinSqManyOneOneBhv extends AbstractBehaviorWritable<WhiteSuppressJoinSqManyOneOne, WhiteSuppressJoinSqManyOneOneCB> {
     ...
     * int count = whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteSuppressJoinSqManyOneOne whiteSuppressJoinSqManyOneOne = whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteSuppressJoinSqManyOneOne -&gt; {
     ...
     * WhiteSuppressJoinSqManyOneOne whiteSuppressJoinSqManyOneOne = whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteSuppressJoinSqManyOneOne -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteSuppressJoinSqManyOneOne -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteSuppressJoinSqManyOneOne.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteSuppressJoinSqManyOneOne -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteSuppressJoinSqManyOneOne.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteSuppressJoinSqManyOneOneCB cb = new WhiteSuppressJoinSqManyOneOneCB();
     * cb.query().setFoo...(value);
     * WhiteSuppressJoinSqManyOneOne whiteSuppressJoinSqManyOneOne = whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteSuppressJoinSqManyOneOne&gt; whiteSuppressJoinSqManyOneOneList = whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteSuppressJoinSqManyOneOneList.forEach(whiteSuppressJoinSqManyOneOne -&gt; {
     *     ... = whiteSuppressJoinSqManyOneOne.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressJoinSqManyOneOne. (NotNull)
     ...
     * PagingResultBean&lt;WhiteSuppressJoinSqManyOneOne&gt; page = whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteSuppressJoinSqManyOneOneCB cb = new WhiteSuppressJoinSqManyOneOneCB();
     * cb.query().setFoo...(value);
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteSuppressJoinSqManyOneOne&gt;() {
     ...
     * <pre>
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">loadWhiteSuppressJoinSqManyOneList</span>(whiteSuppressJoinSqManyOneOneList, oneCB -&gt; {
     *     oneCB.setupSelect...();
     ...
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">insert</span>(whiteSuppressJoinSqManyOneOne);
     ...
     * try {
     *     whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">update</span>(whiteSuppressJoinSqManyOneOne);
     ...
     * whiteSuppressJoinSqManyOneOne.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">delete</span>(whiteSuppressJoinSqManyOneOne);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">batchInsert</span>(whiteSuppressJoinSqManyOneOneList);
     * </pre>
     ...
     *     whiteSuppressJoinSqManyOneOneList.add(whiteSuppressJoinSqManyOneOne);
     * }
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">batchUpdate</span>(whiteSuppressJoinSqManyOneOneList);
     * </pre>
     ...
     * <pre>
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteSuppressJoinSqManyOneOne, WhiteSuppressJoinSqManyOneOneCB&gt;() {
     ...
     * WhiteSuppressJoinSqManyOneOneCB cb = new WhiteSuppressJoinSqManyOneOneCB();
     * cb.query().setFoo...(value);
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">queryUpdate</span>(whiteSuppressJoinSqManyOneOne, cb);
     * </pre>
     ...
     * WhiteSuppressJoinSqManyOneOneCB cb = new WhiteSuppressJoinSqManyOneOneCB();
     * cb.query().setFoo...(value);
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">queryDelete</span>(whiteSuppressJoinSqManyOneOne, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSuppressJoinSqManyOneOne. (NotNull)
     ...
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">varyingInsert</span>(whiteSuppressJoinSqManyOneOne, option);
     * ... = whiteSuppressJoinSqManyOneOne.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteSuppressJoinSqManyOneOne The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteSuppressJoinSqManyOneOne, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteSuppressJoinSqManyOneOneBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSuppressJoinSqManyOneOne, cb, option);
     * </pre>
