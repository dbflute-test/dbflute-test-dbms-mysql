...
public abstract class BsWhiteUqFkRefNestBhv extends AbstractBehaviorWritable<WhiteUqFkRefNest, WhiteUqFkRefNestCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteUqFkRefNestBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteUqFkRefNestBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteUqFkRefNest <span style="color: #553000">whiteUqFkRefNest</span> : <span style="color: #553000">whiteUqFkRefNestList</span>) {
     *     ... = <span style="color: #553000">whiteUqFkRefNest</span>.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteUqFkRefNest. (NotNull)
     ...
     * for (WhiteUqFkRefNest whiteUqFkRefNest : <span style="color: #553000">whiteUqFkRefNestList</span>) {
     *     ... = whiteUqFkRefNest.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteUqFkRefNest. (NotNull)
     ...
     * ...
     * for (WhiteUqFkRefNest whiteUqFkRefNest : <span style="color: #553000">page</span>) {
     *     ... = whiteUqFkRefNest.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteUqFkRefNest. (NotNull)
     ...
     * WhiteUqFkRefNestCB cb = new WhiteUqFkRefNestCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteUqFkRefNestBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteUqFkRefNest&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteUqFkRefNestBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteUqFkRefNestBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteUqFkRefNest, option);
     * ... = whiteUqFkRefNest.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteUqFkRefNest The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">whiteUqFkRefNestBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteUqFkRefNest, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #0000C0">whiteUqFkRefNestBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteUqFkRefNest, cb, option);
     * </pre>
