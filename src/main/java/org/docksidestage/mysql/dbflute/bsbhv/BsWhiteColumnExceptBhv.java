...
public abstract class BsWhiteColumnExceptBhv extends AbstractBehaviorWritable<WhiteColumnExcept, WhiteColumnExceptCB> {
     ...
     * int count = whiteColumnExceptBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * WhiteColumnExcept whiteColumnExcept = whiteColumnExceptBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(whiteColumnExcept -&gt; {
     ...
     * WhiteColumnExcept whiteColumnExcept = whiteColumnExceptBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(whiteColumnExcept -&gt; {
     ...
     * 
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * whiteColumnExceptBhv.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteColumnExcept -&gt; {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteColumnExcept.get...
     * });
     * 
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * whiteColumnExceptBhv.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteColumnExcept -&gt; {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteColumnExcept.get...
     * }).<span style="color: #994747">orElse</span>(() -&gt; {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * WhiteColumnExceptCB cb = new WhiteColumnExceptCB();
     * cb.query().setFoo...(value);
     * WhiteColumnExcept whiteColumnExcept = whiteColumnExceptBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteColumnExcept&gt; whiteColumnExceptList = whiteColumnExceptBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * whiteColumnExceptList.forEach(whiteColumnExcept -&gt; {
     *     ... = whiteColumnExcept.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteColumnExcept. (NotNull)
     ...
     * PagingResultBean&lt;WhiteColumnExcept&gt; page = whiteColumnExceptBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * WhiteColumnExceptCB cb = new WhiteColumnExceptCB();
     * cb.query().setFoo...(value);
     * whiteColumnExceptBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteColumnExcept&gt;() {
     ...
     * <pre>
     * whiteColumnExceptBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * whiteColumnExceptBhv.<span style="color: #CC4747">insert</span>(whiteColumnExcept);
     ...
     * try {
     *     whiteColumnExceptBhv.<span style="color: #CC4747">update</span>(whiteColumnExcept);
     ...
     * whiteColumnExcept.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     whiteColumnExceptBhv.<span style="color: #CC4747">delete</span>(whiteColumnExcept);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * whiteColumnExceptBhv.<span style="color: #CC4747">batchInsert</span>(whiteColumnExceptList);
     * </pre>
     ...
     *     whiteColumnExceptList.add(whiteColumnExcept);
     * }
     * whiteColumnExceptBhv.<span style="color: #CC4747">batchUpdate</span>(whiteColumnExceptList);
     * </pre>
     ...
     * <pre>
     * whiteColumnExceptBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;WhiteColumnExcept, WhiteColumnExceptCB&gt;() {
     ...
     * WhiteColumnExceptCB cb = new WhiteColumnExceptCB();
     * cb.query().setFoo...(value);
     * whiteColumnExceptBhv.<span style="color: #CC4747">queryUpdate</span>(whiteColumnExcept, cb);
     * </pre>
     ...
     * WhiteColumnExceptCB cb = new WhiteColumnExceptCB();
     * cb.query().setFoo...(value);
     * whiteColumnExceptBhv.<span style="color: #CC4747">queryDelete</span>(whiteColumnExcept, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteColumnExcept. (NotNull)
     ...
     * whiteColumnExceptBhv.<span style="color: #CC4747">varyingInsert</span>(whiteColumnExcept, option);
     * ... = whiteColumnExcept.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param whiteColumnExcept The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     whiteColumnExceptBhv.<span style="color: #CC4747">varyingUpdate</span>(whiteColumnExcept, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * whiteColumnExceptBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteColumnExcept, cb, option);
     * </pre>
