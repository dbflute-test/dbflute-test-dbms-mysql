...
/**
 * The behavior of WHITE_COLUMN_EXCEPT as TABLE.
...
public abstract class BsWhiteColumnExceptBhv extends AbstractBehaviorWritable<WhiteColumnExcept, WhiteColumnExceptCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public WhiteColumnExceptDbm asDBMeta() { return WhiteColumnExceptDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "white_column_except"; }
     ...
     * <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteColumnExcept, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteColumnExcept. (NotNull)
     ...
     * whiteColumnExcept.setFoo...(value);
     * whiteColumnExcept.setBar...(value);
     * <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteColumnExcept, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteColumnExcept, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteColumnExcept.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteColumnExcept, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteColumnExceptCB cb = <span style="color: #70226C">new</span> WhiteColumnExceptCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteColumnExcept, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     * <pre>
     * <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteColumnExcept, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * }, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
