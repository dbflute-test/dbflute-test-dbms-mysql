...
public abstract class BsWhiteColumnExceptBhv extends AbstractBehaviorWritable<WhiteColumnExcept, WhiteColumnExceptCB> {
     ...
     * WhiteColumnExceptCB cb = new WhiteColumnExceptCB();
     * cb.query().setFoo...(value);
     * OptionalEntity&lt;WhiteColumnExcept&gt; entity = whiteColumnExceptBhv.<span style="color: #DD4747">selectEntity</span>(cb);
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * entity.<span style="color: #DD4747">required</span>(whiteColumnExcept -&gt; {
     *     ...
     * });
     * WhiteColumnExcept whiteColumnExcept = entity.entity.<span style="color: #DD4747">get()</span>;
     *
     * <span style="color: #3F7E5E">// if it might be no data, ifPresent(), isPresent(), ...</span>
     * entity.<span style="color: #DD4747">ifPresent</span>(whiteColumnExcept -&gt; {
     *     ...
     * });
     ...
     */
    public <RESULT> HpSLSFunction<WhiteColumnExceptCB, RESULT> scalarSelect(Class<RESULT> resultType) {
    ...
    public int queryUpdate(WhiteColumnExcept whiteColumnExcept, CBCall<WhiteColumnExceptCB> cbLambda) {
        return doQueryUpdate(whiteColumnExcept, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteColumnExcept whiteColumnExcept, WOptionCall<WhiteColumnExceptCB, InsertOption<WhiteColumnExceptCB>> opLambda) {
        doInsert(whiteColumnExcept, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteColumnExcept whiteColumnExcept, WOptionCall<WhiteColumnExceptCB, UpdateOption<WhiteColumnExceptCB>> opLambda) {
        doUpdate(whiteColumnExcept, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteColumnExcept whiteColumnExcept, WOptionCall<WhiteColumnExceptCB, InsertOption<WhiteColumnExceptCB>> insertOpLambda, WOptionCall<WhiteColumnExceptCB, UpdateOption<WhiteColumnExceptCB>> updateOpLambda) {
        doInsertOrUpdate(whiteColumnExcept, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteColumnExcept whiteColumnExcept, WOptionCall<WhiteColumnExceptCB, DeleteOption<WhiteColumnExceptCB>> opLambda) {
        doDelete(whiteColumnExcept, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteColumnExcept> whiteColumnExceptList, WOptionCall<WhiteColumnExceptCB, InsertOption<WhiteColumnExceptCB>> opLambda) {
        return doBatchInsert(whiteColumnExceptList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteColumnExcept> whiteColumnExceptList, WOptionCall<WhiteColumnExceptCB, UpdateOption<WhiteColumnExceptCB>> opLambda) {
        return doBatchUpdate(whiteColumnExceptList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteColumnExcept> whiteColumnExceptList, WOptionCall<WhiteColumnExceptCB, DeleteOption<WhiteColumnExceptCB>> opLambda) {
        return doBatchDelete(whiteColumnExceptList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteColumnExcept, WhiteColumnExceptCB> manyArgLambda, WOptionCall<WhiteColumnExceptCB, InsertOption<WhiteColumnExceptCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteColumnExcept whiteColumnExcept, CBCall<WhiteColumnExceptCB> cbLambda, WOptionCall<WhiteColumnExceptCB, UpdateOption<WhiteColumnExceptCB>> opLambda) {
        return doQueryUpdate(whiteColumnExcept, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteColumnExcept whiteColumnExcept, WhiteColumnExceptCB cb, WOptionCall<WhiteColumnExceptCB, UpdateOption<WhiteColumnExceptCB>> opLambda) {
        return doQueryUpdate(whiteColumnExcept, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteColumnExceptCB> cbLambda, WOptionCall<WhiteColumnExceptCB, DeleteOption<WhiteColumnExceptCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteColumnExceptCB cb, WOptionCall<WhiteColumnExceptCB, DeleteOption<WhiteColumnExceptCB>> opLambda) {
    ...
    public OutsideSqlBasicExecutor<WhiteColumnExceptBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<WhiteColumnExceptBhv> facadeExecutor = doOutsideSql();
