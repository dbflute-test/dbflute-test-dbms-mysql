...
public abstract class BsWhiteColumnExceptBhv extends AbstractBehaviorWritable<WhiteColumnExcept, WhiteColumnExceptCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (WhiteColumnExcept <span style="color: #553000">whiteColumnExcept</span> : <span style="color: #553000">whiteColumnExceptList</span>) {
     *     ... = <span style="color: #553000">whiteColumnExcept</span>.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteColumnExcept. (NotNull)
     ...
     * for (WhiteColumnExcept whiteColumnExcept : <span style="color: #553000">whiteColumnExceptList</span>) {
     *     ... = whiteColumnExcept.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteColumnExcept. (NotNull)
     ...
     * ...
     * for (WhiteColumnExcept whiteColumnExcept : <span style="color: #553000">page</span>) {
     *     ... = whiteColumnExcept.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteColumnExcept. (NotNull)
     ...
     * WhiteColumnExceptCB cb = new WhiteColumnExceptCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteColumnExcept&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteColumnExceptBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
