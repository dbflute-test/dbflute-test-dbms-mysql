package org.docksidestage.mysql.dbflute.resola.cbean.cq.bs;
...
public abstract class ResolaAbstractBsStationCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;ResolaStationCB&gt;() {
     ...
     */
    public HpSSQFunction<ResolaStationCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, ResolaStationCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;ResolaStationCB&gt;() {
     *     public void query(ResolaStationCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ResolaStationCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, ResolaStationCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;ResolaStationCB&gt;() {
     *     public void query(ResolaStationCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ResolaStationCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, ResolaStationCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;ResolaStationCB&gt;() {
     *     public void query(ResolaStationCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ResolaStationCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, ResolaStationCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;ResolaStationCB&gt;() {
     *     public void query(ResolaStationCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ResolaStationCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, ResolaStationCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ResolaStationCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, ResolaStationCB.class);
    }
