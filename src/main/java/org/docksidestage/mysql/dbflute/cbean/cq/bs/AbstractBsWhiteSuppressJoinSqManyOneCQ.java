...
public abstract class AbstractBsWhiteSuppressJoinSqManyOneCQ extends AbstractConditionQuery {
     ...
     */
    public void setManyOneId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * white_suppress_join_sq_many by MANY_ONE_ID, named 'whiteSuppressJoinSqManyAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedWhiteSuppressJoinSqManyList()</span>.<span style="color: #DD4747">max</span>(manyCB -&gt; {
     *     manyCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     ...
     */
    public void setManyOneName_LikeSearch(String manyOneName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setManyOneName_NotLikeSearch(String manyOneName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setManyOneOneId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteSuppressJoinSqManyOneCB.class);
    }
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteSuppressJoinSqManyOneCB.class);
    }
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteSuppressJoinSqManyOneCB.class);
    }
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteSuppressJoinSqManyOneCB.class);
    }
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteSuppressJoinSqManyOneCB.class);
    }
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteSuppressJoinSqManyOneCB.class);
    }
