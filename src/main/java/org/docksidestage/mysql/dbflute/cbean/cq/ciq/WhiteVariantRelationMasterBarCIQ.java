...
public class WhiteVariantRelationMasterBarCIQ extends AbstractBsWhiteVariantRelationMasterBarCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteVariantRelationMasterBarCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueMasterBarId() { return _myCQ.xdfgetMasterBarId(); }
    ...
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    protected ConditionValue xgetCValueMasterBarName() { return _myCQ.xdfgetMasterBarName(); }
