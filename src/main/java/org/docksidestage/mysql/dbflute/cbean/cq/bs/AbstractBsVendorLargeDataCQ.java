...
public abstract class AbstractBsVendorLargeDataCQ extends AbstractConditionQuery {
     ...
     */
    public void setLargeDataId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * vendor_large_data_ref by LARGE_DATA_ID, named 'vendorLargeDataRefAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedVendorLargeDataRefList()</span>.<span style="color: #DD4747">max</span>(refCB -&gt; {
    ...
    protected HpQDRFunction<VendorLargeDataRefCB> xcreateQDRFunctionVendorLargeDataRefList() {
        return xcQDRFunc(new HpQDRSetupper<VendorLargeDataRefCB>() {
     ...
     */
    public void setStringIndex_LikeSearch(String stringIndex, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setStringIndex_NotLikeSearch(String stringIndex, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setStringNoIndex_LikeSearch(String stringNoIndex, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setStringNoIndex_NotLikeSearch(String stringNoIndex, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setStringUniqueIndex_LikeSearch(String stringUniqueIndex, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setStringUniqueIndex_NotLikeSearch(String stringUniqueIndex, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setIntflgIndex_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setNumericIntegerIndex_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setNumericIntegerNoIndex_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
