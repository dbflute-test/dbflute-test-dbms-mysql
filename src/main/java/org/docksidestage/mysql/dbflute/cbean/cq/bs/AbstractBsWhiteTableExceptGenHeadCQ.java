...
public abstract class AbstractBsWhiteTableExceptGenHeadCQ extends AbstractConditionQuery {
     ...
     */
    public void setGenHeadId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setGenHeadName_LikeSearch(String genHeadName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setGenHeadName_NotLikeSearch(String genHeadName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setNometaId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
