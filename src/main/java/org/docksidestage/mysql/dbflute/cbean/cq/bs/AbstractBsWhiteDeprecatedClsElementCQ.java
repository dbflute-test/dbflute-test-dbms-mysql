...
public abstract class AbstractBsWhiteDeprecatedClsElementCQ extends AbstractConditionQuery {
     ...
     */
    public void setDeprecatedClsElementName_LikeSearch(String deprecatedClsElementName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setDeprecatedClsElementName_NotLikeSearch(String deprecatedClsElementName, COptionCall<LikeSearchOption> opLambda) {
    ...
    public HpSSQFunction<WhiteDeprecatedClsElementCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteDeprecatedClsElementCB.class);
    }
    ...
    public HpSSQFunction<WhiteDeprecatedClsElementCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteDeprecatedClsElementCB.class);
    }
    ...
    public HpSSQFunction<WhiteDeprecatedClsElementCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteDeprecatedClsElementCB.class);
    }
    ...
    public HpSSQFunction<WhiteDeprecatedClsElementCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteDeprecatedClsElementCB.class);
    }
    ...
    public HpSSQFunction<WhiteDeprecatedClsElementCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteDeprecatedClsElementCB.class);
    }
    ...
    public HpSSQFunction<WhiteDeprecatedClsElementCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteDeprecatedClsElementCB.class);
    }
