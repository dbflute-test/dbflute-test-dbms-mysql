...
/**
 * The condition-query for in-line of white_compound_pk_ref_many.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteCompoundPkRefManyCIQ extends AbstractBsWhiteCompoundPkRefManyCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteCompoundPkRefManyCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteCompoundPkRefManyCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteCompoundPkRefManyCQ myCQ) {
    ...
    protected String xinCB() { return WhiteCompoundPkRefManyCB.class.getName(); }
    protected String xinCQ() { return WhiteCompoundPkRefManyCQ.class.getName(); }
}
