...
public class BsNextSchemaProductCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public NextSchemaProductCB acceptPK(Long productId) {
        assertObjectNotNull("productId", productId);
        BsNextSchemaProductCB cb = this;
        cb.query().setProductId_Equal(productId);
        return (NextSchemaProductCB)this;
    }
    ...
    public NextSchemaProductCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected NextSchemaProductCQ doGetConditionQuery() {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;NextSchemaProductCB&gt;() {
    ...
    public void union(UnionQuery<NextSchemaProductCB> unionQuery) {
        final NextSchemaProductCB cb = new NextSchemaProductCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;NextSchemaProductCB&gt;() {
     *     public void query(NextSchemaProductCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<NextSchemaProductCQ>() {
                ...
                public NextSchemaProductCQ qy() { return xdfgetConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<NextSchemaProductCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<NextSchemaProductCB, NextSchemaProductCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<NextSchemaProductCB, NextSchemaProductCQ>() {
                public void setup(String fn, SubQuery<NextSchemaProductCB> sq, NextSchemaProductCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;NextSchemaProductCB&gt;() {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<NextSchemaProductCB> columnQuery(final SpecifyQuery<NextSchemaProductCB> colCBLambda) {
        return xcreateColQyOperandMySql(new HpColQyHandler<NextSchemaProductCB>() {
            public ColumnCalculator handle(SpecifyQuery<NextSchemaProductCB> rightSp, String operand) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;NextSchemaProductCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<NextSchemaProductCB> orCBLambda) {
        xorSQ((NextSchemaProductCB)this, orCBLambda);
    }
     ...
     *     public void query(NextSchemaProductCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;NextSchemaProductCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<NextSchemaProductCB> andCBLambda) {
        xorSQAP((NextSchemaProductCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return NextSchemaProductCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return NextSchemaProductCQ.class.getName(); }
