...
public class BsMemberServiceCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberServiceCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<MemberServiceCB, MemberServiceCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<MemberServiceCB, MemberServiceCQ>() {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<MemberServiceCB> columnQuery(final SpecifyQuery<MemberServiceCB> colCBLambda) {
        return xcreateColQyOperandMySql(new HpColQyHandler<MemberServiceCB>() {
