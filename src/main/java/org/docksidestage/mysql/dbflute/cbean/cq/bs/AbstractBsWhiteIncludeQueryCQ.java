...
public abstract class AbstractBsWhiteIncludeQueryCQ extends AbstractConditionQuery {
    ...
    public void setIncludeQueryId_RangeOf(Long minNumber, Long maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setIncludeQueryId_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     * @param fromDatetime The from-datetime(yyyy/MM/dd HH:mm:ss.SSS) of includeQueryDatetime. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param toDatetime The to-datetime(yyyy/MM/dd HH:mm:ss.SSS) of includeQueryDatetime. (basically NotNull: if op.allowOneSide(), null allowed)
     ...
     */
    public HpSLCFunction<WhiteIncludeQueryCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteIncludeQueryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteIncludeQueryCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteIncludeQueryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteIncludeQueryCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteIncludeQueryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteIncludeQueryCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteIncludeQueryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteIncludeQueryCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteIncludeQueryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteIncludeQueryCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteIncludeQueryCB.class);
    }
    ...
    public void xsmyselfDerive(String fn, SubQuery<WhiteIncludeQueryCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "INCLUDE_QUERY_ID";
     ...
     */
    public void myselfExists(SubQuery<WhiteIncludeQueryCB> subCBLambda) {
