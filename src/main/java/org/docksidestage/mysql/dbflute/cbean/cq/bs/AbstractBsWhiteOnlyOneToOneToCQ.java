...
public abstract class AbstractBsWhiteOnlyOneToOneToCQ extends AbstractConditionQuery {
     ...
     */
    public void setToId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setToName_LikeSearch(String toName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setToName_NotLikeSearch(String toName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setFromId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
    ...
    public HpSSQFunction<WhiteOnlyOneToOneToCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteOnlyOneToOneToCB.class);
    }
    ...
    public HpSSQFunction<WhiteOnlyOneToOneToCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteOnlyOneToOneToCB.class);
    }
    ...
    public HpSSQFunction<WhiteOnlyOneToOneToCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteOnlyOneToOneToCB.class);
    }
    ...
    public HpSSQFunction<WhiteOnlyOneToOneToCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteOnlyOneToOneToCB.class);
    }
    ...
    public HpSSQFunction<WhiteOnlyOneToOneToCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteOnlyOneToOneToCB.class);
    }
    ...
    public HpSSQFunction<WhiteOnlyOneToOneToCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteOnlyOneToOneToCB.class);
    }
