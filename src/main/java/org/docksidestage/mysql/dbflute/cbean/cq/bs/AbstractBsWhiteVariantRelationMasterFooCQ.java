...
public abstract class AbstractBsWhiteVariantRelationMasterFooCQ extends AbstractConditionQuery {
     ...
     */
    public void setMasterFooId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setMasterFooName_LikeSearch(String masterFooName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setMasterFooName_NotLikeSearch(String masterFooName, COptionCall<LikeSearchOption> opLambda) {
