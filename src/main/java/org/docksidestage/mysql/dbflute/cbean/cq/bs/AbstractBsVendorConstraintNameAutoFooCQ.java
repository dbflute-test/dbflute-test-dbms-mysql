...
public abstract class AbstractBsVendorConstraintNameAutoFooCQ extends AbstractConditionQuery {
     ...
     */
    public void setConstraintNameAutoFooName_LikeSearch(String constraintNameAutoFooName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setConstraintNameAutoFooName_NotLikeSearch(String constraintNameAutoFooName, COptionCall<LikeSearchOption> opLambda) {
