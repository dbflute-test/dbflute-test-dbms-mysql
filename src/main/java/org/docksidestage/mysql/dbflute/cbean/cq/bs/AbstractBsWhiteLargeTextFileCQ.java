...
public abstract class AbstractBsWhiteLargeTextFileCQ extends AbstractConditionQuery {
     ...
     * @param largeTextFileId The value of largeTextFileId as equal. (NullAllowed: if null, no condition)
     */
     ...
     * LARGE_TEXT_FILE_ID: {PK, NotNull, BIGINT(19)}
     * @param largeTextFileId The value of largeTextFileId as greaterThan. (NullAllowed: if null, no condition)
     */
     ...
     * LARGE_TEXT_FILE_ID: {PK, NotNull, BIGINT(19)}
     * @param largeTextFileId The value of largeTextFileId as lessThan. (NullAllowed: if null, no condition)
     */
     ...
     * LARGE_TEXT_FILE_ID: {PK, NotNull, BIGINT(19)}
     * @param largeTextFileId The value of largeTextFileId as greaterEqual. (NullAllowed: if null, no condition)
     */
     ...
     * LARGE_TEXT_FILE_ID: {PK, NotNull, BIGINT(19)}
     * @param largeTextFileId The value of largeTextFileId as lessEqual. (NullAllowed: if null, no condition)
     */
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;WhiteLargeTextFileCB&gt;() {
     ...
     */
    public HpSSQFunction<WhiteLargeTextFileCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteLargeTextFileCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhiteLargeTextFileCB&gt;() {
     *     public void query(WhiteLargeTextFileCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WhiteLargeTextFileCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteLargeTextFileCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhiteLargeTextFileCB&gt;() {
     *     public void query(WhiteLargeTextFileCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WhiteLargeTextFileCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteLargeTextFileCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhiteLargeTextFileCB&gt;() {
     *     public void query(WhiteLargeTextFileCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WhiteLargeTextFileCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteLargeTextFileCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhiteLargeTextFileCB&gt;() {
     *     public void query(WhiteLargeTextFileCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WhiteLargeTextFileCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteLargeTextFileCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<WhiteLargeTextFileCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteLargeTextFileCB.class);
    }
