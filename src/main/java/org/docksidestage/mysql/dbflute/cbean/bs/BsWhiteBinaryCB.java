...
public class BsWhiteBinaryCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteBinaryCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteBinaryCB> unionCBLambda) {
        final WhiteBinaryCB cb = new WhiteBinaryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteBinaryCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteBinaryCB, WhiteBinaryCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteBinaryCB> sq, WhiteBinaryCQ cq, String al, DerivedReferrerOption op)
