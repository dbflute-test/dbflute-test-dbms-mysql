...
public abstract class AbstractBsWhiteSuppressJoinSqCQ extends AbstractConditionQuery {
     ...
     */
    public void setSuppressJoinSqName_LikeSearch(String suppressJoinSqName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setSuppressJoinSqName_NotLikeSearch(String suppressJoinSqName, COptionCall<LikeSearchOption> opLambda) {
