...
/**
 * The base condition-bean of white_myself.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteMyselfCB extends AbstractConditionBean {
    ...
    protected WhiteMyselfCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteMyselfCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteMyselfCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteMyselfCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<WhiteMyselfCB> unionCBLambda) {
        final WhiteMyselfCB cb = new WhiteMyselfCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteMyselfCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WhiteMyselfCB> unionCBLambda) {
        final WhiteMyselfCB cb = new WhiteMyselfCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteMyselfCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteMyselfCQ> {
        ...
        @Override
        protected String getTableDbName() { return "white_myself"; }
        /**
         ...
         *     checkCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, WhiteMyselfCheck.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteMyselfCheckCB, WhiteMyselfCQ> derivedWhiteMyselfCheck() {
            assertDerived("whiteMyselfCheckList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteMyselfCheckCB> sq, WhiteMyselfCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveWhiteMyselfCheckList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteMyselfCB, WhiteMyselfCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteMyselfCB> sq, WhiteMyselfCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WhiteMyselfCB dreamCruiseCB() {
        WhiteMyselfCB cb = new WhiteMyselfCB();
        cb.xsetupForDreamCruise((WhiteMyselfCB) this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WhiteMyselfCB> orCBLambda) {
        xorSQ((WhiteMyselfCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteMyselfCB> andCBLambda) {
        xorSQAP((WhiteMyselfCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteMyselfCB cb;
        if (mainCB != null) {
            cb = (WhiteMyselfCB)mainCB;
        } else {
            cb = new WhiteMyselfCB();
        }
