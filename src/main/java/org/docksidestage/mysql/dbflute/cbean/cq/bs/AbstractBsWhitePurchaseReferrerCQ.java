...
public abstract class AbstractBsWhitePurchaseReferrerCQ extends AbstractConditionQuery {
     ...
     */
    public void setPurchaseReferrerId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setPurchaseReferrerName_LikeSearch(String purchaseReferrerName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setPurchaseReferrerName_NotLikeSearch(String purchaseReferrerName, COptionCall<LikeSearchOption> opLambda) {
