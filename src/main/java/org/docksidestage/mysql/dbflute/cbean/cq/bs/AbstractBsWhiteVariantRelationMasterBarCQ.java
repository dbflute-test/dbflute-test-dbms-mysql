...
public abstract class AbstractBsWhiteVariantRelationMasterBarCQ extends AbstractConditionQuery {
     ...
     */
    public void setMasterBarId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * white_variant_relation_referrer by VARIANT_MASTER_ID, named 'whiteVariantRelationReferrerAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedWhiteVariantRelationReferrerAsVariantList()</span>.<span style="color: #DD4747">max</span>(referrerCB -&gt; {
     *     referrerCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     ...
     */
    public void setMasterBarName_LikeSearch(String masterBarName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setMasterBarName_NotLikeSearch(String masterBarName, COptionCall<LikeSearchOption> opLambda) {
    ...
    public void setMasterBarName_PrefixSearch(String masterBarName) {
        setMasterBarName_LikeSearch(masterBarName, xcLSOPPre());
    }
