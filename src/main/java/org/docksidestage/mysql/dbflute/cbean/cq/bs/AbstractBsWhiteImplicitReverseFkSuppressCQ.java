...
public abstract class AbstractBsWhiteImplicitReverseFkSuppressCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
    ...
    public HpSSQFunction<WhiteImplicitReverseFkSuppressCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteImplicitReverseFkSuppressCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *     public void query(WhiteImplicitReverseFkSuppressCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<WhiteImplicitReverseFkSuppressCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteImplicitReverseFkSuppressCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *     public void query(WhiteImplicitReverseFkSuppressCB subCB) {
    ...
    public HpSSQFunction<WhiteImplicitReverseFkSuppressCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteImplicitReverseFkSuppressCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *     public void query(WhiteImplicitReverseFkSuppressCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteImplicitReverseFkSuppressCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteImplicitReverseFkSuppressCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *     public void query(WhiteImplicitReverseFkSuppressCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteImplicitReverseFkSuppressCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteImplicitReverseFkSuppressCB.class);
    }
    ...
    public HpSSQFunction<WhiteImplicitReverseFkSuppressCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteImplicitReverseFkSuppressCB.class);
    }
