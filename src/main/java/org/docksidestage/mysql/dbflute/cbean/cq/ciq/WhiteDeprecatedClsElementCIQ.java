...
/**
 * The condition-query for in-line of white_deprecated_cls_element.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteDeprecatedClsElementCIQ extends AbstractBsWhiteDeprecatedClsElementCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteDeprecatedClsElementCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteDeprecatedClsElementCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteDeprecatedClsElementCQ myCQ) {
    ...
    protected String xinCB() { return WhiteDeprecatedClsElementCB.class.getName(); }
    protected String xinCQ() { return WhiteDeprecatedClsElementCQ.class.getName(); }
}
