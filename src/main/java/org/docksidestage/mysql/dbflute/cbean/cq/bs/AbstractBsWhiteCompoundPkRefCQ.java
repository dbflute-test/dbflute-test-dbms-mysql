...
public abstract class AbstractBsWhiteCompoundPkRefCQ extends AbstractConditionQuery {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setRefFirstId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setRefSecondId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setRefName_LikeSearch(String refName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setRefName_NotLikeSearch(String refName, COptionCall<LikeSearchOption> opLambda) {
