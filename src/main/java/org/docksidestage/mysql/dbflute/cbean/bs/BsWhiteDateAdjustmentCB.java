...
public class BsWhiteDateAdjustmentCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public WhiteDateAdjustmentCB acceptPK(Long dateAdjustmentId) {
        ...
        return (WhiteDateAdjustmentCB)this;
    }
     ...
     */
    public void union(UnionQuery<WhiteDateAdjustmentCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteDateAdjustmentCB> unionCBLambda) {
        final WhiteDateAdjustmentCB cb = new WhiteDateAdjustmentCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteDateAdjustmentCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteDateAdjustmentCB, WhiteDateAdjustmentCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteDateAdjustmentCB> sq, WhiteDateAdjustmentCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteDateAdjustmentCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteDateAdjustmentCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteDateAdjustmentCB> orCBLambda) {
        xorSQ((WhiteDateAdjustmentCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteDateAdjustmentCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteDateAdjustmentCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteDateAdjustmentCB> andCBLambda) {
        xorSQAP((WhiteDateAdjustmentCB)this, andCBLambda);
    }
