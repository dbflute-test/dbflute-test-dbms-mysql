...
/**
 * The condition-query for in-line of white_db_comment.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteDbCommentCIQ extends AbstractBsWhiteDbCommentCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteDbCommentCQ _myCQ;
    ...
    protected String xinCB() { return WhiteDbCommentCB.class.getName(); }
    protected String xinCQ() { return WhiteDbCommentCQ.class.getName(); }
}
