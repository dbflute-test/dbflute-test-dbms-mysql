...
/**
 * The condition-query for in-line of white_compound_referred_primary.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteCompoundReferredPrimaryCIQ extends AbstractBsWhiteCompoundReferredPrimaryCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteCompoundReferredPrimaryCQ _myCQ;
    ...
    protected String xinCB() { return WhiteCompoundReferredPrimaryCB.class.getName(); }
    protected String xinCQ() { return WhiteCompoundReferredPrimaryCQ.class.getName(); }
}
