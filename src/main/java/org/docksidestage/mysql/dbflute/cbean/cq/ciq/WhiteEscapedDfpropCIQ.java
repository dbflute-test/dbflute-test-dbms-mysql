...
/**
 * The condition-query for in-line of white_escaped_dfprop.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteEscapedDfpropCIQ extends AbstractBsWhiteEscapedDfpropCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteEscapedDfpropCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteEscapedDfpropCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteEscapedDfpropCQ myCQ) {
    ...
    protected String xinCB() { return WhiteEscapedDfpropCB.class.getName(); }
    protected String xinCQ() { return WhiteEscapedDfpropCQ.class.getName(); }
}
