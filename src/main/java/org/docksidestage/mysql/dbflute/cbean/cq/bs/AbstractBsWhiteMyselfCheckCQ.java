...
public abstract class AbstractBsWhiteMyselfCheckCQ extends AbstractConditionQuery {
     ...
     */
    public void setMyselfCheckId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setMyselfCheckName_LikeSearch(String myselfCheckName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setMyselfCheckName_NotLikeSearch(String myselfCheckName, COptionCall<LikeSearchOption> opLambda) {
    ...
    public HpSSQFunction<WhiteMyselfCheckCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteMyselfCheckCB.class);
    }
    ...
    public HpSSQFunction<WhiteMyselfCheckCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteMyselfCheckCB.class);
    }
    ...
    public HpSSQFunction<WhiteMyselfCheckCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteMyselfCheckCB.class);
    }
    ...
    public HpSSQFunction<WhiteMyselfCheckCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteMyselfCheckCB.class);
    }
    ...
    public HpSSQFunction<WhiteMyselfCheckCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteMyselfCheckCB.class);
    }
    ...
    public HpSSQFunction<WhiteMyselfCheckCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteMyselfCheckCB.class);
    }
