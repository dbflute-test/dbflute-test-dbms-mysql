...
/**
 * The condition-query for in-line of white_myself.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteMyselfCIQ extends AbstractBsWhiteMyselfCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteMyselfCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteMyselfCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteMyselfCQ myCQ) {
    ...
    protected String xinCB() { return WhiteMyselfCB.class.getName(); }
    protected String xinCQ() { return WhiteMyselfCQ.class.getName(); }
}
