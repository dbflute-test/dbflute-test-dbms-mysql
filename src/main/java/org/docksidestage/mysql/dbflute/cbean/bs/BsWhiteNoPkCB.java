...
/**
 * The base condition-bean of white_no_pk.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteNoPkCB extends AbstractConditionBean {
    ...
    public WhiteNoPkCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected WhiteNoPkCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteNoPkCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteNoPkCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteNoPkCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<WhiteNoPkCB> unionQuery) {
        final WhiteNoPkCB cb = new WhiteNoPkCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteNoPkCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WhiteNoPkCB> unionQuery) {
        final WhiteNoPkCB cb = new WhiteNoPkCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteNoPkCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteNoPkCQ> {
         ...
         */
        public HpSpecifiedColumn columnNoPkId() { return doColumn("NO_PK_ID"); }
        /**
         * NO_PK_NAME: {VARCHAR(32)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnNoPkName() { return doColumn("NO_PK_NAME"); }
        /**
         * NO_PK_INTEGER: {INT(10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnNoPkInteger() { return doColumn("NO_PK_INTEGER"); }
    ...
    public HpColQyOperand.HpExtendedColQyOperandMySql<WhiteNoPkCB> columnQuery(final SpecifyQuery<WhiteNoPkCB> colCBLambda) {
        return xcreateColQyOperandMySql(new HpColQyHandler<WhiteNoPkCB>() {
            public HpCalculator handle(SpecifyQuery<WhiteNoPkCB> rightSp, String operand) {
     ...
     */
    public WhiteNoPkCB dreamCruiseCB() {
        WhiteNoPkCB cb = new WhiteNoPkCB();
        cb.xsetupForDreamCruise((WhiteNoPkCB) this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WhiteNoPkCB> orCBLambda) {
        xorSQ((WhiteNoPkCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteNoPkCB> andCBLambda) {
        xorSQAP((WhiteNoPkCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteNoPkCB cb;
        if (mainCB != null) {
            cb = (WhiteNoPkCB)mainCB;
        } else {
            cb = new WhiteNoPkCB();
        }
    ...
    protected String getConditionBeanClassNameInternally() { return WhiteNoPkCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return WhiteNoPkCQ.class.getName(); }
