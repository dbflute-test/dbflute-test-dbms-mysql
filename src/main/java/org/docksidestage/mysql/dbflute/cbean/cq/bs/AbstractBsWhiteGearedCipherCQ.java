...
public abstract class AbstractBsWhiteGearedCipherCQ extends AbstractConditionQuery {
     ...
     */
    public void setCipherId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setCipherInteger_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setCipherVarchar_LikeSearch(String cipherVarchar, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setCipherVarchar_NotLikeSearch(String cipherVarchar, COptionCall<LikeSearchOption> opLambda) {
     ...
     */
    public void setCipherDate_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
     ...
     * @param opLambda The callback for option of from-to. (NotNull)
     */
    public void setCipherDatetime_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
    ...
    public HpSSQFunction<WhiteGearedCipherCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteGearedCipherCB.class);
    }
    ...
    public HpSSQFunction<WhiteGearedCipherCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteGearedCipherCB.class);
    }
    ...
    public HpSSQFunction<WhiteGearedCipherCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteGearedCipherCB.class);
    }
    ...
    public HpSSQFunction<WhiteGearedCipherCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteGearedCipherCB.class);
    }
    ...
    public HpSSQFunction<WhiteGearedCipherCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteGearedCipherCB.class);
    }
    ...
    public HpSSQFunction<WhiteGearedCipherCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteGearedCipherCB.class);
    }
