...
/**
 * The condition-query for in-line of white_compound_pk_ref_nest.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteCompoundPkRefNestCIQ extends AbstractBsWhiteCompoundPkRefNestCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteCompoundPkRefNestCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteCompoundPkRefNestCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteCompoundPkRefNestCQ myCQ) {
    ...
    protected String xinCB() { return WhiteCompoundPkRefNestCB.class.getName(); }
    protected String xinCQ() { return WhiteCompoundPkRefNestCQ.class.getName(); }
}
