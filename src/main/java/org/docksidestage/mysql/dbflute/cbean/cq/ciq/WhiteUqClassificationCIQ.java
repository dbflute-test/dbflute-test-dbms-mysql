...
/**
 * The condition-query for in-line of white_uq_classification.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteUqClassificationCIQ extends AbstractBsWhiteUqClassificationCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteUqClassificationCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteUqClassificationCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteUqClassificationCQ myCQ) {
    ...
    protected String xinCB() { return WhiteUqClassificationCB.class.getName(); }
    protected String xinCQ() { return WhiteUqClassificationCQ.class.getName(); }
}
