...
public abstract class AbstractBsWhiteUqFkCQ extends AbstractConditionQuery {
     ...
     */
    public void setUqFkId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * white_uq_fk_ref by FK_TO_PK_ID, named 'whiteUqFkRefByFkToPkIdAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedWhiteUqFkRefByFkToPkIdList()</span>.<span style="color: #DD4747">max</span>(refCB -&gt; {
     ...
     */
    public void setUqFkCode_LikeSearch(String uqFkCode, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setUqFkCode_NotLikeSearch(String uqFkCode, COptionCall<LikeSearchOption> opLambda) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">existsWhiteUqFkRefByFkToUqCodeList</span>(refCB -&gt; {
     *     refCB.query().setXxx...
     * });
     * </pre>
    ...
    public HpSSQFunction<WhiteUqFkCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteUqFkCB.class);
    }
    ...
    public HpSSQFunction<WhiteUqFkCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteUqFkCB.class);
    }
    ...
    public HpSSQFunction<WhiteUqFkCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteUqFkCB.class);
    }
    ...
    public HpSSQFunction<WhiteUqFkCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteUqFkCB.class);
    }
    ...
    public HpSSQFunction<WhiteUqFkCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteUqFkCB.class);
    }
    ...
    public HpSSQFunction<WhiteUqFkCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteUqFkCB.class);
    }
