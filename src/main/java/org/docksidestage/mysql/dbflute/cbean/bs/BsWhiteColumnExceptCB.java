...
/**
 * The base condition-bean of white_column_except.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteColumnExceptCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public WhiteColumnExceptCB acceptPK(Long exceptColumnId) {
        ...
        return (WhiteColumnExceptCB)this;
    }
    ...
    protected WhiteColumnExceptCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteColumnExceptCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteColumnExceptCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteColumnExceptCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteColumnExceptCB&gt;() {
     *     public void query(WhiteColumnExceptCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhiteColumnExceptCB> unionQuery) {
        final WhiteColumnExceptCB cb = new WhiteColumnExceptCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteColumnExceptCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteColumnExceptCB&gt;() {
     *     public void query(WhiteColumnExceptCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhiteColumnExceptCB> unionQuery) {
        final WhiteColumnExceptCB cb = new WhiteColumnExceptCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteColumnExceptCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteColumnExceptCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhiteColumnExceptCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "white_column_except"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteColumnExceptCB, WhiteColumnExceptCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteColumnExceptCB, WhiteColumnExceptCQ>() {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteColumnExceptCB&gt;() {
     ...
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhiteColumnExceptCB&gt;() {
     *     public void query(WhiteColumnExceptCB cb) {
     ...
     */
    public WhiteColumnExceptCB dreamCruiseCB() {
        WhiteColumnExceptCB cb = new WhiteColumnExceptCB();
        cb.xsetupForDreamCruise((WhiteColumnExceptCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteColumnExceptCB&gt;() {
     *     public void query(WhiteColumnExceptCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteColumnExceptCB> orCBLambda) {
        xorSQ((WhiteColumnExceptCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteColumnExceptCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteColumnExceptCB&gt;() {
     *             public void query(WhiteColumnExceptCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteColumnExceptCB> andCBLambda) {
        xorSQAP((WhiteColumnExceptCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteColumnExceptCB cb;
        if (mainCB != null) {
            cb = (WhiteColumnExceptCB)mainCB;
        } else {
            cb = new WhiteColumnExceptCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<WhiteColumnExceptCQ>() {
            public boolean has() { return true; }
            public WhiteColumnExceptCQ qy() { return cb.query(); }
        });
    }
