...
/**
 * The condition-query for in-line of white_implicit_reverse_fk_ref.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteImplicitReverseFkRefCIQ extends AbstractBsWhiteImplicitReverseFkRefCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteImplicitReverseFkRefCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteImplicitReverseFkRefCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteImplicitReverseFkRefCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueWhiteImplicitReverseFkRefId() { return _myCQ.xdfgetWhiteImplicitReverseFkRefId(); }
    ...
    protected String xinCB() { return WhiteImplicitReverseFkRefCB.class.getName(); }
    protected String xinCQ() { return WhiteImplicitReverseFkRefCQ.class.getName(); }
}
