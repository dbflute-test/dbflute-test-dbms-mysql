...
public abstract class AbstractBsWhiteEscapedDfpropCQ extends AbstractConditionQuery {
     ...
     * <pre>e.g. setEscapedDfpropName_LikeSearch("xxx", op -&gt; op.<span style="color: #CC4747">likeContain()</span>);</pre>
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;WhiteEscapedDfpropCB&gt;() {
    ...
    public HpSSQFunction<WhiteEscapedDfpropCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteEscapedDfpropCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhiteEscapedDfpropCB&gt;() {
     *     public void query(WhiteEscapedDfpropCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<WhiteEscapedDfpropCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteEscapedDfpropCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhiteEscapedDfpropCB&gt;() {
     *     public void query(WhiteEscapedDfpropCB subCB) {
    ...
    public HpSSQFunction<WhiteEscapedDfpropCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteEscapedDfpropCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhiteEscapedDfpropCB&gt;() {
     *     public void query(WhiteEscapedDfpropCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteEscapedDfpropCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteEscapedDfpropCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhiteEscapedDfpropCB&gt;() {
     *     public void query(WhiteEscapedDfpropCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteEscapedDfpropCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteEscapedDfpropCB.class);
    }
    ...
    public HpSSQFunction<WhiteEscapedDfpropCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteEscapedDfpropCB.class);
    }
