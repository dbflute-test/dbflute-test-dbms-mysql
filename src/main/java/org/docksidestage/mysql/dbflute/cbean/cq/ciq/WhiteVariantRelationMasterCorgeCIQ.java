...
/**
 * The condition-query for in-line of white_variant_relation_master_corge.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteVariantRelationMasterCorgeCIQ extends AbstractBsWhiteVariantRelationMasterCorgeCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteVariantRelationMasterCorgeCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteVariantRelationMasterCorgeCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteVariantRelationMasterCorgeCQ myCQ) {
    ...
    protected String xinCB() { return WhiteVariantRelationMasterCorgeCB.class.getName(); }
    protected String xinCQ() { return WhiteVariantRelationMasterCorgeCQ.class.getName(); }
}
