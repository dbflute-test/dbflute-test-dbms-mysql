...
/**
 * The base condition-bean of white_variant_relation_master_foo.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteVariantRelationMasterFooCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhiteVariantRelationMasterFooCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteVariantRelationMasterFooCB() {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_MasterFooId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_MasterFooId_Desc();
        return this;
    }
    ...
    protected WhiteVariantRelationMasterFooCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteVariantRelationMasterFooCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteVariantRelationMasterFooCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteVariantRelationMasterFooCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<WhiteVariantRelationMasterFooCB> unionCBLambda) {
        final WhiteVariantRelationMasterFooCB cb = new WhiteVariantRelationMasterFooCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteVariantRelationMasterFooCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WhiteVariantRelationMasterFooCB> unionCBLambda) {
        final WhiteVariantRelationMasterFooCB cb = new WhiteVariantRelationMasterFooCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteVariantRelationMasterFooCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * }).alwaysPresent(<span style="color: #553000">whiteVariantRelationMasterFoo</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteVariantRelationMasterFoo</span>.<span style="color: #CC4747">getWhiteVariantRelationReferrerAsBizOneToOneForBizManyToOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">whiteVariantRelationMasterFooBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_WhiteVariantRelationLocalPkReferrerAsOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">whiteVariantRelationMasterFoo</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteVariantRelationMasterFoo</span>.<span style="color: #CC4747">getWhiteVariantRelationLocalPkReferrerAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteVariantRelationMasterFooCQ> {
        protected WhiteVariantRelationReferrerCB.HpSpecification _whiteVariantRelationReferrerAsBizOneToOneForBizManyToOne;
        protected WhiteVariantRelationLocalPkReferrerCB.HpSpecification _whiteVariantRelationLocalPkReferrerAsOne;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhiteVariantRelationMasterFooCQ> qyCall
         ...
         *     referrerCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, WhiteVariantRelationReferrer.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteVariantRelationReferrerCB, WhiteVariantRelationMasterFooCQ> derivedWhiteVariantRelationReferrerAsVariant() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteVariantRelationReferrerCB> sq, WhiteVariantRelationMasterFooCQ cq, String al, DerivedReferrerOption op)
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteVariantRelationMasterFooCB, WhiteVariantRelationMasterFooCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteVariantRelationMasterFooCB> sq, WhiteVariantRelationMasterFooCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WhiteVariantRelationMasterFooCB dreamCruiseCB() {
        WhiteVariantRelationMasterFooCB cb = new WhiteVariantRelationMasterFooCB();
        cb.xsetupForDreamCruise((WhiteVariantRelationMasterFooCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     ...
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     *     public void query(WhiteVariantRelationMasterFooCB cb) {
    ...
    protected WhiteVariantRelationMasterFooCB xcreateColumnQueryCB() {
        WhiteVariantRelationMasterFooCB cb = new WhiteVariantRelationMasterFooCB();
        cb.xsetupForColumnQuery((WhiteVariantRelationMasterFooCB)this);
        return cb;
    }
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     *     public void query(WhiteVariantRelationMasterFooCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteVariantRelationMasterFooCB> orCBLambda) {
        xorSQ((WhiteVariantRelationMasterFooCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteVariantRelationMasterFooCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     *             public void query(WhiteVariantRelationMasterFooCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteVariantRelationMasterFooCB> andCBLambda) {
        xorSQAP((WhiteVariantRelationMasterFooCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteVariantRelationMasterFooCB cb;
        if (mainCB != null) {
            cb = (WhiteVariantRelationMasterFooCB)mainCB;
        } else {
