...
public class BsWhiteVariantRelationMasterFooCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     *     public void query(WhiteVariantRelationMasterFooCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhiteVariantRelationMasterFooCB> unionQuery) {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteVariantRelationMasterFooCB&gt;() {
     *     public void query(WhiteVariantRelationMasterFooCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhiteVariantRelationMasterFooCB> unionQuery) {
        final WhiteVariantRelationMasterFooCB cb = new WhiteVariantRelationMasterFooCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * cb.<span style="color: #CC4747">setupSelect_WhiteVariantRelationReferrerAsBizOneToOneForBizManyToOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteVariantRelationMasterFoo whiteVariantRelationMasterFoo = whiteVariantRelationMasterFooBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteVariantRelationMasterFoo.<span style="color: #CC4747">getWhiteVariantRelationReferrerAsBizOneToOneForBizManyToOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * <pre>
     * WhiteVariantRelationMasterFooCB cb = new WhiteVariantRelationMasterFooCB();
     * cb.<span style="color: #CC4747">setupSelect_WhiteVariantRelationLocalPkReferrerAsOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteVariantRelationMasterFoo whiteVariantRelationMasterFoo = whiteVariantRelationMasterFooBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteVariantRelationMasterFoo.<span style="color: #CC4747">getWhiteVariantRelationLocalPkReferrerAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteVariantRelationMasterFooCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(referrerCB -&gt; {
