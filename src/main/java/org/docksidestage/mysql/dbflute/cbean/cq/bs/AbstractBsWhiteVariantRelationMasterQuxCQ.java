...
public abstract class AbstractBsWhiteVariantRelationMasterQuxCQ extends AbstractConditionQuery {
     ...
     */
    public void setMasterQuxId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * <pre>e.g. setMasterQuxName_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
     * @param masterQuxName The value of masterQuxName as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setMasterQuxName_LikeSearch(String masterQuxName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setMasterQuxName_NotLikeSearch(String masterQuxName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;WhiteVariantRelationMasterQuxCB&gt;() {
    ...
    public HpSSQFunction<WhiteVariantRelationMasterQuxCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteVariantRelationMasterQuxCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhiteVariantRelationMasterQuxCB&gt;() {
     *     public void query(WhiteVariantRelationMasterQuxCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<WhiteVariantRelationMasterQuxCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteVariantRelationMasterQuxCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhiteVariantRelationMasterQuxCB&gt;() {
     *     public void query(WhiteVariantRelationMasterQuxCB subCB) {
    ...
    public HpSSQFunction<WhiteVariantRelationMasterQuxCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteVariantRelationMasterQuxCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhiteVariantRelationMasterQuxCB&gt;() {
     *     public void query(WhiteVariantRelationMasterQuxCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteVariantRelationMasterQuxCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteVariantRelationMasterQuxCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhiteVariantRelationMasterQuxCB&gt;() {
     *     public void query(WhiteVariantRelationMasterQuxCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteVariantRelationMasterQuxCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteVariantRelationMasterQuxCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WhiteVariantRelationMasterQuxCB&gt;() {
     *     public void query(WhiteVariantRelationMasterQuxCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteVariantRelationMasterQuxCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteVariantRelationMasterQuxCB.class);
    }
