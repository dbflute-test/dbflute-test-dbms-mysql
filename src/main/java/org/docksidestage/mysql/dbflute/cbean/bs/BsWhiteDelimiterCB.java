...
/**
 * The base condition-bean of white_delimiter.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteDelimiterCB extends AbstractConditionBean {
    ...
    protected WhiteDelimiterCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteDelimiterCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteDelimiterCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteDelimiterCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteDelimiterCB&gt;() {
     *     public void query(WhiteDelimiterCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhiteDelimiterCB> unionQuery) {
        final WhiteDelimiterCB cb = new WhiteDelimiterCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteDelimiterCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteDelimiterCB&gt;() {
     *     public void query(WhiteDelimiterCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhiteDelimiterCB> unionQuery) {
        final WhiteDelimiterCB cb = new WhiteDelimiterCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteDelimiterCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteDelimiterCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhiteDelimiterCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "white_delimiter"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteDelimiterCB, WhiteDelimiterCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteDelimiterCB, WhiteDelimiterCQ>() {
                public void setup(String fn, SubQuery<WhiteDelimiterCB> sq, WhiteDelimiterCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteDelimiterCB&gt;() {
     ...
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhiteDelimiterCB&gt;() {
     *     public void query(WhiteDelimiterCB cb) {
     ...
     */
    public WhiteDelimiterCB dreamCruiseCB() {
        WhiteDelimiterCB cb = new WhiteDelimiterCB();
        cb.xsetupForDreamCruise((WhiteDelimiterCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteDelimiterCB&gt;() {
     *     public void query(WhiteDelimiterCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteDelimiterCB> orCBLambda) {
        xorSQ((WhiteDelimiterCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteDelimiterCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteDelimiterCB&gt;() {
     *             public void query(WhiteDelimiterCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteDelimiterCB> andCBLambda) {
        xorSQAP((WhiteDelimiterCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteDelimiterCB cb;
        if (mainCB != null) {
            cb = (WhiteDelimiterCB)mainCB;
        } else {
            cb = new WhiteDelimiterCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<WhiteDelimiterCQ>() {
            public boolean has() { return true; }
            public WhiteDelimiterCQ qy() { return cb.query(); }
        });
    }
