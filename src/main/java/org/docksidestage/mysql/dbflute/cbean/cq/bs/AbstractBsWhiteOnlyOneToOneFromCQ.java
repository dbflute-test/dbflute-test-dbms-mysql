...
public abstract class AbstractBsWhiteOnlyOneToOneFromCQ extends AbstractConditionQuery {
     ...
     */
    public void setFromName_LikeSearch(String fromName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setFromName_NotLikeSearch(String fromName, COptionCall<LikeSearchOption> opLambda) {
