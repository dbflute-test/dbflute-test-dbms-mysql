...
public class BsProductCategoryCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<ProductCategoryCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<ProductCB, ProductCategoryCQ> derivedProduct() {
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<ProductCategoryCB, ProductCategoryCQ> derivedProductCategorySelf() {
