...
public class BsWhiteCompoundReferredPrimaryCB extends AbstractConditionBean {
    ...
    public WhiteCompoundReferredPrimaryCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WhiteCompoundReferredPrimaryCQ doGetConditionQuery() {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
    ...
    public void union(UnionQuery<WhiteCompoundReferredPrimaryCB> unionQuery) {
        final WhiteCompoundReferredPrimaryCB cb = new WhiteCompoundReferredPrimaryCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     *     public void query(WhiteCompoundReferredPrimaryCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<WhiteCompoundReferredPrimaryCQ>() {
                ...
                public WhiteCompoundReferredPrimaryCQ qy() { return xdfgetConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteCompoundReferredPrimaryCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteCompoundPkCB, WhiteCompoundReferredPrimaryCQ> derivedWhiteCompoundPkList() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteCompoundPkCB, WhiteCompoundReferredPrimaryCQ>() {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteCompoundReferredPrimaryCB, WhiteCompoundReferredPrimaryCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteCompoundReferredPrimaryCB, WhiteCompoundReferredPrimaryCQ>() {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<WhiteCompoundReferredPrimaryCB> columnQuery(final SpecifyQuery<WhiteCompoundReferredPrimaryCB> colCBLambda) {
        return xcreateColQyOperandMySql(new HpColQyHandler<WhiteCompoundReferredPrimaryCB>() {
            public ColumnCalculator handle(SpecifyQuery<WhiteCompoundReferredPrimaryCB> rightSp, String operand) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteCompoundReferredPrimaryCB> orCBLambda) {
        xorSQ((WhiteCompoundReferredPrimaryCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteCompoundReferredPrimaryCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteCompoundReferredPrimaryCB> andCBLambda) {
        xorSQAP((WhiteCompoundReferredPrimaryCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WhiteCompoundReferredPrimaryCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WhiteCompoundReferredPrimaryCQ.class.getName(); }
