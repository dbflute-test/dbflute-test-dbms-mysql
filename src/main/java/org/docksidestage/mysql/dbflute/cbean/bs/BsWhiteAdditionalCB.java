...
public class BsWhiteAdditionalCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteAdditionalCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteAdditionalCB&gt;() {
     *     public void query(WhiteAdditionalCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteAdditionalCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteAdditionalCB&gt;() {
     ...
     *     public void query(WhiteAdditionalCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteAdditionalCB&gt;() {
