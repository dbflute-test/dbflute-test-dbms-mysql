...
public class BsWhiteAdditionalCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteAdditionalCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteAdditionalCB> unionCBLambda) {
        final WhiteAdditionalCB cb = new WhiteAdditionalCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteAdditionalCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteAdditionalCB, WhiteAdditionalCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteAdditionalCB> sq, WhiteAdditionalCQ cq, String al, DerivedReferrerOption op)
