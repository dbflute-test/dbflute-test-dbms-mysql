...
/**
 * The base condition-bean of white_additional.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteAdditionalCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhiteAdditionalCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteAdditionalCB() {
    ...
    protected WhiteAdditionalCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteAdditionalCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteAdditionalCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteAdditionalCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;WhiteAdditionalCB&gt;() {
     *     public void query(WhiteAdditionalCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhiteAdditionalCB> unionQuery) {
        final WhiteAdditionalCB cb = new WhiteAdditionalCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteAdditionalCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;WhiteAdditionalCB&gt;() {
     *     public void query(WhiteAdditionalCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhiteAdditionalCB> unionQuery) {
        final WhiteAdditionalCB cb = new WhiteAdditionalCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteAdditionalCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteAdditionalCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhiteAdditionalCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "white_additional"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<WhiteAdditionalCB, WhiteAdditionalCQ> myselfDerived() {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteAdditionalCB&gt;() {
     *     public void query(WhiteAdditionalCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhiteAdditionalCB&gt;() {
     *     public void query(WhiteAdditionalCB cb) {
    ...
    protected WhiteAdditionalCB xcreateColumnQueryCB() {
        WhiteAdditionalCB cb = new WhiteAdditionalCB();
        cb.xsetupForColumnQuery((WhiteAdditionalCB)this);
        return cb;
    }
     ...
     */
    public WhiteAdditionalCB dreamCruiseCB() {
        WhiteAdditionalCB cb = new WhiteAdditionalCB();
        cb.xsetupForDreamCruise((WhiteAdditionalCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;WhiteAdditionalCB&gt;() {
     *     public void query(WhiteAdditionalCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteAdditionalCB> orCBLambda) {
        xorSQ((WhiteAdditionalCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteAdditionalCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteAdditionalCB&gt;() {
     *             public void query(WhiteAdditionalCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteAdditionalCB> andCBLambda) {
        xorSQAP((WhiteAdditionalCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteAdditionalCB cb;
        if (mainCB != null) {
            cb = (WhiteAdditionalCB)mainCB;
        } else {
