...
public abstract class AbstractBsMemberLoginCQ extends AbstractConditionQuery {
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * (ログイン日時)LOGIN_DATETIME: {+UQ, IX, NotNull, DATETIME(19)}
     * <pre>e.g. setLoginDatetime_FromTo(fromDate, toDate, op -&gt; op.<span style="color: #CC4747">compareAsDate()</span>);</pre>
    ...
    /**
     * Equal(=). As SubItemTable. And NullOrEmptyIgnored, OnlyOnceRegistered. <br />
     * (ログイン会員ステータスコード)LOGIN_MEMBER_STATUS_CODE: {IX, NotNull, CHAR(3), FK to member_status, classification=SubItemTable} <br />
     * the test of sub-item map for table classification
     * @param cdef The instance of classification definition (as ENUM type). (NullAllowed: if null, no condition)
     */
    public void setLoginMemberStatusCode_Equal_AsSubItemTable(CDef.SubItemTable cdef) {
    ...
    public void setLoginMemberStatusCode_Equal_正式会員() {
        setLoginMemberStatusCode_Equal_AsSubItemTable(CDef.SubItemTable.正式会員);
    }
    ...
    public void setLoginMemberStatusCode_Equal_退会会員() {
        setLoginMemberStatusCode_Equal_AsSubItemTable(CDef.SubItemTable.退会会員);
    }
    ...
    public void setLoginMemberStatusCode_Equal_仮会員() {
        setLoginMemberStatusCode_Equal_AsSubItemTable(CDef.SubItemTable.仮会員);
    }
    ...
    /**
     * NotEqual(&lt;&gt;). As SubItemTable. And NullOrEmptyIgnored, OnlyOnceRegistered. <br />
     * (ログイン会員ステータスコード)LOGIN_MEMBER_STATUS_CODE: {IX, NotNull, CHAR(3), FK to member_status, classification=SubItemTable} <br />
     * the test of sub-item map for table classification
     * @param cdef The instance of classification definition (as ENUM type). (NullAllowed: if null, no condition)
     */
    public void setLoginMemberStatusCode_NotEqual_AsSubItemTable(CDef.SubItemTable cdef) {
    ...
    public void setLoginMemberStatusCode_NotEqual_正式会員() {
        setLoginMemberStatusCode_NotEqual_AsSubItemTable(CDef.SubItemTable.正式会員);
    }
    ...
    public void setLoginMemberStatusCode_NotEqual_退会会員() {
        setLoginMemberStatusCode_NotEqual_AsSubItemTable(CDef.SubItemTable.退会会員);
    }
    ...
    public void setLoginMemberStatusCode_NotEqual_仮会員() {
        setLoginMemberStatusCode_NotEqual_AsSubItemTable(CDef.SubItemTable.仮会員);
    }
    ...
    /**
     * InScope {in ('a', 'b')}. As SubItemTable. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br />
     * (ログイン会員ステータスコード)LOGIN_MEMBER_STATUS_CODE: {IX, NotNull, CHAR(3), FK to member_status, classification=SubItemTable} <br />
     * the test of sub-item map for table classification
     * @param cdefList The list of classification definition (as ENUM type). (NullAllowed: if null (or empty), no condition)
     */
    public void setLoginMemberStatusCode_InScope_AsSubItemTable(Collection<CDef.SubItemTable> cdefList) {
        doSetLoginMemberStatusCode_InScope(cTStrL(cdefList));
    }

    /**
     * InScope {in ('a', 'b')}. As SubItemTable. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br />
     * the test of sub-item map for table classification <br />
     * サービスが利用できる会員 <br />
     * The group elements:[正式会員, 仮会員]
     */
    public void setLoginMemberStatusCode_InScope_ServiceAvailable() {
        setLoginMemberStatusCode_InScope_AsSubItemTable(CDef.SubItemTable.listOfServiceAvailable());
    }
     ...
     */
    public void setLoginMemberStatusCode_InScope_LastestStatus() {
        setLoginMemberStatusCode_InScope_AsSubItemTable(CDef.SubItemTable.listOfLastestStatus());
    }
    ...
    /**
     * NotInScope {not in ('a', 'b')}. As SubItemTable. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br />
     * (ログイン会員ステータスコード)LOGIN_MEMBER_STATUS_CODE: {IX, NotNull, CHAR(3), FK to member_status, classification=SubItemTable} <br />
     * the test of sub-item map for table classification
     * @param cdefList The list of classification definition (as ENUM type). (NullAllowed: if null (or empty), no condition)
     */
    public void setLoginMemberStatusCode_NotInScope_AsSubItemTable(Collection<CDef.SubItemTable> cdefList) {
