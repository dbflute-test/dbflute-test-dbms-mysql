...
public abstract class AbstractBsWhitePointTypeMappingCQ extends AbstractConditionQuery {
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * POINT_TYPE_MAPPING_SALE_DATE: {BIGINT(19)}
     * <pre>e.g. setPointTypeMappingSaleDate_FromTo(fromDate, toDate, op -&gt; op.<span style="color: #CC4747">compareAsDate()</span>);</pre>
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * POINT_TYPE_MAPPING_WANTED_DATETIME: {DATETIME(19)}
     * <pre>e.g. setPointTypeMappingWantedDatetime_FromTo(fromDate, toDate, op -&gt; op.<span style="color: #CC4747">compareAsDate()</span>);</pre>
