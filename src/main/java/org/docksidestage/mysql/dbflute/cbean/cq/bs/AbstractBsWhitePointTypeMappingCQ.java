...
public abstract class AbstractBsWhitePointTypeMappingCQ extends AbstractConditionQuery {
     ...
     */
    public void setPointTypeMappingId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setPointTypeMappingSaleDate_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
     ...
     * @param opLambda The callback for option of from-to. (NotNull)
     */
    public void setPointTypeMappingWantedDatetime_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
    ...
    public HpSSQFunction<WhitePointTypeMappingCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhitePointTypeMappingCB.class);
    }
    ...
    public HpSSQFunction<WhitePointTypeMappingCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhitePointTypeMappingCB.class);
    }
    ...
    public HpSSQFunction<WhitePointTypeMappingCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhitePointTypeMappingCB.class);
    }
    ...
    public HpSSQFunction<WhitePointTypeMappingCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhitePointTypeMappingCB.class);
    }
    ...
    public HpSSQFunction<WhitePointTypeMappingCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhitePointTypeMappingCB.class);
    }
    ...
    public HpSSQFunction<WhitePointTypeMappingCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhitePointTypeMappingCB.class);
    }
