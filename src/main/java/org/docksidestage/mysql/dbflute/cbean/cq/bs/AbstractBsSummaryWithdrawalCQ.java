...
public abstract class AbstractBsSummaryWithdrawalCQ extends AbstractConditionQuery {
     ...
     * @param maxPurchasePrice The value of maxPurchasePrice as equal. (basically NotNull: error as default, or no condition as option)
     */
     ...
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * MAX_PURCHASE_PRICE: {BIGINT(19)}
     * @param maxPurchasePrice The value of maxPurchasePrice as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
     ...
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * MAX_PURCHASE_PRICE: {BIGINT(19)}
     * @param maxPurchasePrice The value of maxPurchasePrice as lessThan. (basically NotNull: error as default, or no condition as option)
     */
     ...
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * MAX_PURCHASE_PRICE: {BIGINT(19)}
     * @param maxPurchasePrice The value of maxPurchasePrice as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
     ...
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * MAX_PURCHASE_PRICE: {BIGINT(19)}
     * @param maxPurchasePrice The value of maxPurchasePrice as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * MAX_PURCHASE_PRICE: {BIGINT(19)}
     * @param minNumber The min number of maxPurchasePrice. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of maxPurchasePrice. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setMaxPurchasePrice_RangeOf(Long minNumber, Long maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
     ...
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * MAX_PURCHASE_PRICE: {BIGINT(19)}
     * @param maxPurchasePriceList The collection of maxPurchasePrice as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * MAX_PURCHASE_PRICE: {BIGINT(19)}
     * @param maxPurchasePriceList The collection of maxPurchasePrice as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    ...
    public HpSLCFunction<SummaryWithdrawalCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, SummaryWithdrawalCB.class);
    }
    ...
    public HpSLCFunction<SummaryWithdrawalCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, SummaryWithdrawalCB.class);
    }
    ...
    public HpSLCFunction<SummaryWithdrawalCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, SummaryWithdrawalCB.class);
    }
    ...
    public HpSLCFunction<SummaryWithdrawalCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, SummaryWithdrawalCB.class);
    }
    ...
    public HpSLCFunction<SummaryWithdrawalCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, SummaryWithdrawalCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SummaryWithdrawalCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, SummaryWithdrawalCB.class);
    }
