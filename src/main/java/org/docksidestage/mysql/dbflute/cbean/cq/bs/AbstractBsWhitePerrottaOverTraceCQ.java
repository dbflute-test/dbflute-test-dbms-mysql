...
public abstract class AbstractBsWhitePerrottaOverTraceCQ extends AbstractConditionQuery {
     ...
     */
    public void setTraceId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setPreviousProductId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setNextProductId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
