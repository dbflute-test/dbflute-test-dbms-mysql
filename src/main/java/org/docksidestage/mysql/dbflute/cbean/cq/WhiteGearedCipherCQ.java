...
import org.docksidestage.mysql.dbflute.cbean.cq.bs.BsWhiteGearedCipherCQ;

/**
 * The condition-query of white_geared_cipher.
 * <p>
 ...
 */
public class WhiteGearedCipherCQ extends BsWhiteGearedCipherCQ {
     ...
     */
    public WhiteGearedCipherCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
