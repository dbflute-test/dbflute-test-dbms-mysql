...
/**
 * The condition-query for in-line of white_column_except.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteColumnExceptCIQ extends AbstractBsWhiteColumnExceptCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteColumnExceptCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteColumnExceptCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteColumnExceptCQ myCQ) {
    ...
    protected String xinCB() { return WhiteColumnExceptCB.class.getName(); }
    protected String xinCQ() { return WhiteColumnExceptCQ.class.getName(); }
}
