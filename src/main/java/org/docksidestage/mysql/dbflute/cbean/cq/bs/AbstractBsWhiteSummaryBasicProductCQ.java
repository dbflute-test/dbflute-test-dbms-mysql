...
/**
 * The abstract condition-query of white_summary_basic_product.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsWhiteSummaryBasicProductCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWhiteSummaryBasicProductCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<WhiteSummaryBasicProductCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteSummaryBasicProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryBasicProductCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteSummaryBasicProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryBasicProductCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteSummaryBasicProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryBasicProductCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteSummaryBasicProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryBasicProductCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteSummaryBasicProductCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WhiteSummaryBasicProductCB&gt;() {
     *     public void query(WhiteSummaryBasicProductCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryBasicProductCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteSummaryBasicProductCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        WhiteSummaryBasicProductCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(WhiteSummaryBasicProductCQ sq);

    protected WhiteSummaryBasicProductCB xcreateScalarConditionCB() {
        WhiteSummaryBasicProductCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected WhiteSummaryBasicProductCB xcreateScalarConditionPartitionByCB() {
        WhiteSummaryBasicProductCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected WhiteSummaryBasicProductCB newMyCB() {
        return new WhiteSummaryBasicProductCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return WhiteSummaryBasicProductCQ.class.getName(); }
