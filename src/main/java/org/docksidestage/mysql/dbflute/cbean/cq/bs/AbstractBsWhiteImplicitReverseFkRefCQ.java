...
public abstract class AbstractBsWhiteImplicitReverseFkRefCQ extends AbstractConditionQuery {
     ...
     * WHITE_IMPLICIT_REVERSE_FK_REF_ID: {PK, ID, NotNull, INT(10)}
     * @param minNumber The min number of whiteImplicitReverseFkRefId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of whiteImplicitReverseFkRefId. (basically NotNull: if op.allowOneSide(), null allowed)
     ...
     * WHITE_IMPLICIT_REVERSE_FK_REF_ID: {PK, ID, NotNull, INT(10)}
     * @param whiteImplicitReverseFkRefIdList The collection of whiteImplicitReverseFkRefId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * WHITE_IMPLICIT_REVERSE_FK_REF_ID: {PK, ID, NotNull, INT(10)}
     * @param whiteImplicitReverseFkRefIdList The collection of whiteImplicitReverseFkRefId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     */
    public HpSLCFunction<WhiteImplicitReverseFkRefCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteImplicitReverseFkRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkRefCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteImplicitReverseFkRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkRefCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteImplicitReverseFkRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkRefCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteImplicitReverseFkRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkRefCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteImplicitReverseFkRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkRefCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteImplicitReverseFkRefCB.class);
    }
