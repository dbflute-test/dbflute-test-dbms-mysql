...
public abstract class AbstractBsVendorConstraintNameAutoQuxCQ extends AbstractConditionQuery {
     ...
     */
    public void setConstraintNameAutoQuxName_LikeSearch(String constraintNameAutoQuxName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setConstraintNameAutoQuxName_NotLikeSearch(String constraintNameAutoQuxName, COptionCall<LikeSearchOption> opLambda) {
    ...
    public void setConstraintNameAutoQuxName_PrefixSearch(String constraintNameAutoQuxName) {
        setConstraintNameAutoQuxName_LikeSearch(constraintNameAutoQuxName, xcLSOPPre());
    }
