...
public class BsVendorConstraintNameAutoFooCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;VendorConstraintNameAutoFooCB&gt;() {
     ...
     */
    public void union(UnionQuery<VendorConstraintNameAutoFooCB> unionQuery) {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;VendorConstraintNameAutoFooCB&gt;() {
     *     public void query(VendorConstraintNameAutoFooCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<VendorConstraintNameAutoFooCB> unionQuery) {
        final VendorConstraintNameAutoFooCB cb = new VendorConstraintNameAutoFooCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
