...
/**
 * The base condition-query of white_no_pk_relation.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteNoPkRelationCQ extends AbstractBsWhiteNoPkRelationCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhiteNoPkRelationCIQ _inlineQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteNoPkRelationCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public WhiteNoPkRelationCIQ inline() {
        if (_inlineQuery == null) { _inlineQuery = xcreateCIQ(); }
        _inlineQuery.xsetOnClause(false); return _inlineQuery;
    }

    protected WhiteNoPkRelationCIQ xcreateCIQ() {
        WhiteNoPkRelationCIQ ciq = xnewCIQ();
        ciq.xsetBaseCB(_baseCB);
        return ciq;
    }

    protected WhiteNoPkRelationCIQ xnewCIQ() {
        return new WhiteNoPkRelationCIQ(xgetReferrerQuery(), xgetSqlClause(), xgetAliasName(), xgetNestLevel(), this);
    }
     ...
     */
    public WhiteNoPkRelationCIQ on() {
        if (isBaseQuery()) { throw new IllegalConditionBeanOperationException("OnClause for local table is unavailable!"); }
        WhiteNoPkRelationCIQ inlineQuery = inline(); inlineQuery.xsetOnClause(true); return inlineQuery;
    }
     ...
     * @return this. (NotNull)
     */
    public BsWhiteNoPkRelationCQ addOrderBy_LatestPurchaseDatetime_Desc() { regOBD("LATEST_PURCHASE_DATETIME"); return this; }
