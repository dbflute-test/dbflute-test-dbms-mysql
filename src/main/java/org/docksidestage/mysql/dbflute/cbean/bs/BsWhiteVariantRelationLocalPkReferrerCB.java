...
public class BsWhiteVariantRelationLocalPkReferrerCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteVariantRelationLocalPkReferrerCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteVariantRelationLocalPkReferrerCB> unionCBLambda) {
        final WhiteVariantRelationLocalPkReferrerCB cb = new WhiteVariantRelationLocalPkReferrerCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">whiteVariantRelationLocalPkReferrer</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteVariantRelationLocalPkReferrer</span>.<span style="color: #CC4747">getWhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public WhiteVariantRelationMasterFooNss setupSelect_WhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne() {
        ...
        doSetupSelect(() -> query().queryWhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne());
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteVariantRelationLocalPkReferrerCQ> {
        ...
        public WhiteVariantRelationMasterFooCB.HpSpecification specifyWhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne() {
            ...
            if (_whiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne == null) {
                _whiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne = new WhiteVariantRelationMasterFooCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryWhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne()
                                    , () -> _qyCall.qy().queryWhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _whiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryWhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne()
                      , () -> xsyncQyCall().qy().queryWhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne()));
                }
            }
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteVariantRelationLocalPkReferrerCB, WhiteVariantRelationLocalPkReferrerCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteVariantRelationLocalPkReferrerCB> sq, WhiteVariantRelationLocalPkReferrerCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteVariantRelationLocalPkReferrerCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteVariantRelationLocalPkReferrerCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteVariantRelationLocalPkReferrerCB> orCBLambda) {
        xorSQ((WhiteVariantRelationLocalPkReferrerCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteVariantRelationLocalPkReferrerCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteVariantRelationLocalPkReferrerCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteVariantRelationLocalPkReferrerCB> andCBLambda) {
        xorSQAP((WhiteVariantRelationLocalPkReferrerCB)this, andCBLambda);
    }
