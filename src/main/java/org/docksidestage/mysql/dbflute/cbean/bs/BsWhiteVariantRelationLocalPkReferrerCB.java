...
public class BsWhiteVariantRelationLocalPkReferrerCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteVariantRelationLocalPkReferrerCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteVariantRelationLocalPkReferrerCB&gt;() {
     *     public void query(WhiteVariantRelationLocalPkReferrerCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #CC4747">setupSelect_WhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     ...
     * ... = whiteVariantRelationLocalPkReferrer.<span style="color: #CC4747">getWhiteVariantRelationMasterFooAsBizManyToOneLikeBizOneToOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteVariantRelationLocalPkReferrerCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteVariantRelationLocalPkReferrerCB, WhiteVariantRelationLocalPkReferrerCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteVariantRelationLocalPkReferrerCB, WhiteVariantRelationLocalPkReferrerCQ>() {
