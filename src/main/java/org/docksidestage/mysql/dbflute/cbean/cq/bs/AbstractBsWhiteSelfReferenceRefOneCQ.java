...
public abstract class AbstractBsWhiteSelfReferenceRefOneCQ extends AbstractConditionQuery {
     ...
     */
    public void setSelfReferenceRefOneName_LikeSearch(String selfReferenceRefOneName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setSelfReferenceRefOneName_NotLikeSearch(String selfReferenceRefOneName, COptionCall<LikeSearchOption> opLambda) {
