...
public abstract class AbstractBsNextSchemaProductCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<NextSchemaProductCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, NextSchemaProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<NextSchemaProductCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, NextSchemaProductCB.class);
    }
    ...
    public HpSLCFunction<NextSchemaProductCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, NextSchemaProductCB.class);
    }
    ...
    public HpSLCFunction<NextSchemaProductCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, NextSchemaProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<NextSchemaProductCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, NextSchemaProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<NextSchemaProductCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, NextSchemaProductCB.class);
    }
