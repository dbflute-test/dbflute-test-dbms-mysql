...
import org.docksidestage.mysql.dbflute.cbean.cq.WhitePurchaseReferrerCQ;
...
public class WhitePurchaseReferrerNss {
    ...
    public PurchaseNss withPurchase() {
        _query.xdoNss(new WhitePurchaseReferrerCQ.NssCall() { public ConditionQuery qf() { return _query.queryPurchase(); }});
