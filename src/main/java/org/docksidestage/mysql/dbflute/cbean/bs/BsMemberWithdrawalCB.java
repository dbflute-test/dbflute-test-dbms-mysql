...
public class BsMemberWithdrawalCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberWithdrawalCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<MemberWithdrawalCB, MemberWithdrawalCQ> myselfDerived() {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<MemberWithdrawalCB> columnQuery(final SpecifyQuery<MemberWithdrawalCB> colCBLambda) {
