...
/**
 * The condition-query for in-line of white_pg_reserv_ref.
 * @author DBFlute(AutoGenerator)
 */
public class WhitePgReservRefCIQ extends AbstractBsWhitePgReservRefCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public WhitePgReservRefCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhitePgReservRefCQ myCQ) {
    ...
    protected String xinCB() { return WhitePgReservRefCB.class.getName(); }
    protected String xinCQ() { return WhitePgReservRefCQ.class.getName(); }
}
