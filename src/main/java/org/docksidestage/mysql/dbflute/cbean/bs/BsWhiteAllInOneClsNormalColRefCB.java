...
public class BsWhiteAllInOneClsNormalColRefCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteAllInOneClsNormalColRefCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteAllInOneClsNormalColRefCB> unionCBLambda) {
        final WhiteAllInOneClsNormalColRefCB cb = new WhiteAllInOneClsNormalColRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * <pre>
     * <span style="color: #0000C0">whiteAllInOneClsNormalColRefBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">whiteAllInOneClsNormalColRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteAllInOneClsNormalColRef</span>.<span style="color: #CC4747">getWhiteAllInOneClsElementAsFoo()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">whiteAllInOneClsNormalColRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteAllInOneClsNormalColRef</span>.<span style="color: #CC4747">getWhiteAllInOneClsElementAsBar()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
