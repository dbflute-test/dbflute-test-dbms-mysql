...
/**
 * The base condition-bean of white_all_in_one_cls_normal_col_ref.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteAllInOneClsNormalColRefCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhiteAllInOneClsNormalColRefCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteAllInOneClsNormalColRefCB() {
     ...
     */
    public WhiteAllInOneClsNormalColRefCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public WhiteAllInOneClsNormalColRefCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WhiteAllInOneClsNormalColRefCQ doGetConditionQuery() {
    ...
    protected WhiteAllInOneClsNormalColRefCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteAllInOneClsNormalColRefCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteAllInOneClsNormalColRefCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteAllInOneClsNormalColRefCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new WhiteAllInOneClsNormalColRefCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     *     public void query(WhiteAllInOneClsNormalColRefCB unionCB) {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     *     public void query(WhiteAllInOneClsNormalColRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #CC4747">setupSelect_WhiteAllInOneClsElementAsFoo()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteAllInOneClsNormalColRef whiteAllInOneClsNormalColRef = whiteAllInOneClsNormalColRefBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteAllInOneClsNormalColRef.<span style="color: #CC4747">getWhiteAllInOneClsElementAsFoo()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * <pre>
     * WhiteAllInOneClsNormalColRefCB cb = new WhiteAllInOneClsNormalColRefCB();
     * cb.<span style="color: #CC4747">setupSelect_WhiteAllInOneClsElementAsBar()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteAllInOneClsNormalColRef whiteAllInOneClsNormalColRef = whiteAllInOneClsNormalColRefBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteAllInOneClsNormalColRef.<span style="color: #CC4747">getWhiteAllInOneClsElementAsBar()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<WhiteAllInOneClsNormalColRefCQ>() {
                public boolean has() { return true; }
                public WhiteAllInOneClsNormalColRefCQ qy() { return xdfgetConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteAllInOneClsNormalColRefCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhiteAllInOneClsNormalColRefCQ> qyCall
         ...
         */
        public SpecifiedColumn columnClsRefId() { return doColumn("CLS_REF_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "white_all_in_one_cls_normal_col_ref"; }
        /**
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     ...
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     *     public void query(WhiteAllInOneClsNormalColRefCB cb) {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<WhiteAllInOneClsNormalColRefCB> columnQuery(final SpecifyQuery<WhiteAllInOneClsNormalColRefCB> colCBLambda) {
        return xcreateColQyOperandMySql(new HpColQyHandler<WhiteAllInOneClsNormalColRefCB>() {
            public ColumnCalculator handle(SpecifyQuery<WhiteAllInOneClsNormalColRefCB> rightSp, String operand) {
                return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
            }
        });
    }

    protected WhiteAllInOneClsNormalColRefCB xcreateColumnQueryCB() {
        WhiteAllInOneClsNormalColRefCB cb = new WhiteAllInOneClsNormalColRefCB();
        cb.xsetupForColumnQuery((WhiteAllInOneClsNormalColRefCB)this);
        return cb;
    }
     ...
     */
    public WhiteAllInOneClsNormalColRefCB dreamCruiseCB() {
        WhiteAllInOneClsNormalColRefCB cb = new WhiteAllInOneClsNormalColRefCB();
        cb.xsetupForDreamCruise((WhiteAllInOneClsNormalColRefCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     *     public void query(WhiteAllInOneClsNormalColRefCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteAllInOneClsNormalColRefCB> orCBLambda) {
        xorSQ((WhiteAllInOneClsNormalColRefCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteAllInOneClsNormalColRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteAllInOneClsNormalColRefCB&gt;() {
     *             public void query(WhiteAllInOneClsNormalColRefCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteAllInOneClsNormalColRefCB> andCBLambda) {
        xorSQAP((WhiteAllInOneClsNormalColRefCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteAllInOneClsNormalColRefCB cb;
        if (mainCB != null) {
            cb = (WhiteAllInOneClsNormalColRefCB)mainCB;
        } else {
            cb = new WhiteAllInOneClsNormalColRefCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<WhiteAllInOneClsNormalColRefCQ>() {
            public boolean has() { return true; }
            public WhiteAllInOneClsNormalColRefCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WhiteAllInOneClsNormalColRefCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WhiteAllInOneClsNormalColRefCQ.class.getName(); }
