...
public class BsWhiteUqFkCB extends AbstractConditionBean {
    ...
    public WhiteUqFkCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WhiteUqFkCQ doGetConditionQuery() {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteUqFkCB&gt;() {
    ...
    public void union(UnionQuery<WhiteUqFkCB> unionQuery) {
        final WhiteUqFkCB cb = new WhiteUqFkCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteUqFkCB&gt;() {
     *     public void query(WhiteUqFkCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteUqFkCQ> {
         ...
         */
        public SpecifiedColumn columnUqFkId() { return doColumn("UQ_FK_ID"); }
        /**
         ...
         * }, WhiteUqFkRef.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteUqFkCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteUqFkCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteUqFkCB> orCBLambda) {
        xorSQ((WhiteUqFkCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteUqFkCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteUqFkCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteUqFkCB> andCBLambda) {
        xorSQAP((WhiteUqFkCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WhiteUqFkCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WhiteUqFkCQ.class.getName(); }
