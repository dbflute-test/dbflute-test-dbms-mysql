...
/**
 * The condition-query for in-line of white_suppress_def_check.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteSuppressDefCheckCIQ extends AbstractBsWhiteSuppressDefCheckCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteSuppressDefCheckCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteSuppressDefCheckCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteSuppressDefCheckCQ myCQ) {
    ...
    protected String xinCB() { return WhiteSuppressDefCheckCB.class.getName(); }
    protected String xinCQ() { return WhiteSuppressDefCheckCQ.class.getName(); }
}
