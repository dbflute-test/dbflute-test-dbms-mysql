...
public class BsWhiteCompoundPkRefManyCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteCompoundPkRefManyCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteCompoundPkRefManyCB> unionCBLambda) {
        final WhiteCompoundPkRefManyCB cb = new WhiteCompoundPkRefManyCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">whiteCompoundPkRefMany</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteCompoundPkRefMany</span>.<span style="color: #CC4747">getWhiteCompoundPkToPK()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public WhiteCompoundPkNss setupSelect_WhiteCompoundPkToPK() {
        ...
        doSetupSelect(() -> query().queryWhiteCompoundPkToPK());
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteCompoundPkRefManyCQ> {
        ...
        public WhiteCompoundPkCB.HpSpecification specifyWhiteCompoundPkToPK() {
            ...
            if (_whiteCompoundPkToPK == null) {
                _whiteCompoundPkToPK = new WhiteCompoundPkCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryWhiteCompoundPkToPK()
                                    , () -> _qyCall.qy().queryWhiteCompoundPkToPK())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _whiteCompoundPkToPK.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryWhiteCompoundPkToPK()
                      , () -> xsyncQyCall().qy().queryWhiteCompoundPkToPK()));
                }
            }
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteCompoundPkRefManyCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteCompoundPkRefManyCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteCompoundPkRefManyCB> orCBLambda) {
        xorSQ((WhiteCompoundPkRefManyCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteCompoundPkRefManyCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteCompoundPkRefManyCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteCompoundPkRefManyCB> andCBLambda) {
        xorSQAP((WhiteCompoundPkRefManyCB)this, andCBLambda);
    }
