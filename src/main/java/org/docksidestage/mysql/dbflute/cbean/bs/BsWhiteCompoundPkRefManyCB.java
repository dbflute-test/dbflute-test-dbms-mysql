...
public class BsWhiteCompoundPkRefManyCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteCompoundPkRefManyCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteCompoundPkRefManyCB&gt;() {
     *     public void query(WhiteCompoundPkRefManyCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #CC4747">setupSelect_WhiteCompoundPkToPK()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteCompoundPkRefMany whiteCompoundPkRefMany = whiteCompoundPkRefManyBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteCompoundPkRefMany.<span style="color: #CC4747">getWhiteCompoundPkToPK()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
