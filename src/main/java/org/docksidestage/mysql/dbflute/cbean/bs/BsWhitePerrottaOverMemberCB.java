...
public class BsWhitePerrottaOverMemberCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhitePerrottaOverMemberCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhitePerrottaOverMemberCB> unionCBLambda) {
        final WhitePerrottaOverMemberCB cb = new WhitePerrottaOverMemberCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">whitePerrottaOverMember</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whitePerrottaOverMember</span>.<span style="color: #CC4747">getWhitePerrottaOverMemberMacho()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">whitePerrottaOverMember</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whitePerrottaOverMember</span>.<span style="color: #CC4747">getWhitePerrottaOverProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhitePerrottaOverMemberCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhitePerrottaOverMemberCB, WhitePerrottaOverMemberCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhitePerrottaOverMemberCB> sq, WhitePerrottaOverMemberCQ cq, String al, DerivedReferrerOption op)
