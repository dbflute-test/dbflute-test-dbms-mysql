...
/**
 * The abstract condition-query of white_summary_complex_product.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsWhiteSummaryComplexProductCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWhiteSummaryComplexProductCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<WhiteSummaryComplexProductCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteSummaryComplexProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryComplexProductCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteSummaryComplexProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryComplexProductCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteSummaryComplexProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryComplexProductCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteSummaryComplexProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryComplexProductCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteSummaryComplexProductCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WhiteSummaryComplexProductCB&gt;() {
     *     public void query(WhiteSummaryComplexProductCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSummaryComplexProductCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteSummaryComplexProductCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        WhiteSummaryComplexProductCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(WhiteSummaryComplexProductCQ sq);

    protected WhiteSummaryComplexProductCB xcreateScalarConditionCB() {
        WhiteSummaryComplexProductCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected WhiteSummaryComplexProductCB xcreateScalarConditionPartitionByCB() {
        WhiteSummaryComplexProductCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected WhiteSummaryComplexProductCB newMyCB() {
        return new WhiteSummaryComplexProductCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return WhiteSummaryComplexProductCQ.class.getName(); }
