...
public class BsMemberLoginCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberLoginCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<MemberLoginCB, MemberLoginCQ> myselfDerived() {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<MemberLoginCB> columnQuery(final SpecifyQuery<MemberLoginCB> colCBLambda) {
        return xcreateColQyOperandMySql(new HpColQyHandler<MemberLoginCB>() {
