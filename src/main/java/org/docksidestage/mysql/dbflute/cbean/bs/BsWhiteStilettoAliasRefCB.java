...
public class BsWhiteStilettoAliasRefCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteStilettoAliasRefCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteStilettoAliasRefCB> unionCBLambda) {
        final WhiteStilettoAliasRefCB cb = new WhiteStilettoAliasRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">whiteStilettoAliasRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteStilettoAliasRef</span>.<span style="color: #CC4747">getWhiteStilettoAlias()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteStilettoAliasRefCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteStilettoAliasRefCB, WhiteStilettoAliasRefCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteStilettoAliasRefCB> sq, WhiteStilettoAliasRefCQ cq, String al, DerivedReferrerOption op)
