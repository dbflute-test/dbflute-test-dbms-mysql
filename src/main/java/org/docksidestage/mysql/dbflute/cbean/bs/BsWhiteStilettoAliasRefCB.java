...
public class BsWhiteStilettoAliasRefCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     *     public void query(WhiteStilettoAliasRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #CC4747">setupSelect_WhiteStilettoAlias()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteStilettoAliasRef whiteStilettoAliasRef = whiteStilettoAliasRefBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteStilettoAliasRef.<span style="color: #CC4747">getWhiteStilettoAlias()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     */
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     ...
     *     public void query(WhiteStilettoAliasRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteStilettoAliasRefCB&gt;() {
