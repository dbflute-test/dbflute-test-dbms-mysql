...
/**
 * The base condition-bean of white_stiletto_alias_ref.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteStilettoAliasRefCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhiteStilettoAliasRefCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteStilettoAliasRefCB() {
     ...
     * @return this. (NotNull)
     */
    public WhiteStilettoAliasRefCB acceptPK(Integer refId) {
        assertObjectNotNull("refId", refId);
        BsWhiteStilettoAliasRefCB cb = this;
        cb.query().setRefId_Equal(refId);
        return (WhiteStilettoAliasRefCB)this;
    }
    ...
    protected WhiteStilettoAliasRefCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteStilettoAliasRefCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteStilettoAliasRefCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteStilettoAliasRefCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     *     public void query(WhiteStilettoAliasRefCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhiteStilettoAliasRefCB> unionQuery) {
        final WhiteStilettoAliasRefCB cb = new WhiteStilettoAliasRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteStilettoAliasRefCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     *     public void query(WhiteStilettoAliasRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhiteStilettoAliasRefCB> unionQuery) {
        final WhiteStilettoAliasRefCB cb = new WhiteStilettoAliasRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteStilettoAliasRefCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * cb.<span style="color: #DD4747">setupSelect_WhiteStilettoAlias()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteStilettoAliasRef whiteStilettoAliasRef = whiteStilettoAliasRefBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteStilettoAliasRef.<span style="color: #DD4747">getWhiteStilettoAlias()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteStilettoAliasRefCQ> {
        protected WhiteStilettoAliasCB.HpSpecification _whiteStilettoAlias;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhiteStilettoAliasRefCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            columnRefId(); // PK
            if (qyCall().qy().hasConditionQueryWhiteStilettoAlias()
                    || qyCall().qy().xgetReferrerQuery() instanceof WhiteStilettoAliasCQ) {
                columnStilettoAliasId(); // FK or one-to-one referrer
            }
        }
        @Override
         ...
         */
        public HpSDRFunction<WhiteStilettoAliasRefCB, WhiteStilettoAliasRefCQ> myselfDerived() {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     *     public void query(WhiteStilettoAliasRefCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     *     public void query(WhiteStilettoAliasRefCB cb) {
    ...
    protected WhiteStilettoAliasRefCB xcreateColumnQueryCB() {
        WhiteStilettoAliasRefCB cb = new WhiteStilettoAliasRefCB();
        cb.xsetupForColumnQuery((WhiteStilettoAliasRefCB)this);
        return cb;
    }
     ...
     */
    public WhiteStilettoAliasRefCB dreamCruiseCB() {
        WhiteStilettoAliasRefCB cb = new WhiteStilettoAliasRefCB();
        cb.xsetupForDreamCruise((WhiteStilettoAliasRefCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     *     public void query(WhiteStilettoAliasRefCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteStilettoAliasRefCB> orCBLambda) {
        xorSQ((WhiteStilettoAliasRefCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteStilettoAliasRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteStilettoAliasRefCB&gt;() {
     *             public void query(WhiteStilettoAliasRefCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteStilettoAliasRefCB> andCBLambda) {
        xorSQAP((WhiteStilettoAliasRefCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteStilettoAliasRefCB cb;
        if (mainCB != null) {
            cb = (WhiteStilettoAliasRefCB)mainCB;
        } else {
