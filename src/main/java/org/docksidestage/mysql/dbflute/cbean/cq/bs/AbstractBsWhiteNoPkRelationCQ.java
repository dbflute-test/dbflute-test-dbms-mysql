...
public abstract class AbstractBsWhiteNoPkRelationCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<WhiteNoPkRelationCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteNoPkRelationCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteNoPkRelationCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteNoPkRelationCB.class);
    }
    ...
    public HpSLCFunction<WhiteNoPkRelationCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteNoPkRelationCB.class);
    }
    ...
    public HpSLCFunction<WhiteNoPkRelationCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteNoPkRelationCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteNoPkRelationCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteNoPkRelationCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteNoPkRelationCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteNoPkRelationCB.class);
    }
