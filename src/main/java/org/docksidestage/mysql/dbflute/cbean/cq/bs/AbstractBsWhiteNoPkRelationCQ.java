...
public abstract class AbstractBsWhiteNoPkRelationCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;WhiteNoPkRelationCB&gt;() {
    ...
    public HpSSQFunction<WhiteNoPkRelationCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteNoPkRelationCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhiteNoPkRelationCB&gt;() {
     *     public void query(WhiteNoPkRelationCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<WhiteNoPkRelationCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteNoPkRelationCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhiteNoPkRelationCB&gt;() {
     *     public void query(WhiteNoPkRelationCB subCB) {
    ...
    public HpSSQFunction<WhiteNoPkRelationCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteNoPkRelationCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhiteNoPkRelationCB&gt;() {
     *     public void query(WhiteNoPkRelationCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteNoPkRelationCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteNoPkRelationCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhiteNoPkRelationCB&gt;() {
     *     public void query(WhiteNoPkRelationCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteNoPkRelationCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteNoPkRelationCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WhiteNoPkRelationCB&gt;() {
     *     public void query(WhiteNoPkRelationCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteNoPkRelationCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteNoPkRelationCB.class);
    }
