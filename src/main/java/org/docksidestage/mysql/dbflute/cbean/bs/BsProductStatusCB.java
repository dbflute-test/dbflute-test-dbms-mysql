...
public class BsProductStatusCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;ProductStatusCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;ProductStatusCB&gt;() {
     *     public void query(ProductStatusCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
