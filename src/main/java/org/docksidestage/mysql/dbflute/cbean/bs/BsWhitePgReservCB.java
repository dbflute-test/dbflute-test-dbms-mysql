...
public class BsWhitePgReservCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;WhitePgReservCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;WhitePgReservCB&gt;() {
     *     public void query(WhitePgReservCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhitePgReservCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #DD4747">derivedWhitePgReservRefList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;WhitePgReservRefCB&gt;() {
         *     public void query(WhitePgReservRefCB subCB) {
         *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, WhitePgReservRef.<span style="color: #DD4747">ALIAS_foo...</span>);
         * </pre>
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;WhitePgReservCB&gt;() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;WhitePgReservCB&gt;() {
     ...
     *     public void query(WhitePgReservCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhitePgReservCB&gt;() {
