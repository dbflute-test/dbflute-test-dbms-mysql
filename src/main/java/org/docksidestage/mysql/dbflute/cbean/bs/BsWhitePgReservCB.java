...
/**
 * The base condition-bean of white_pg_reserv.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhitePgReservCB extends AbstractConditionBean {
    ...
    protected WhitePgReservCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhitePgReservCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhitePgReservCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhitePgReservCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhitePgReservCB&gt;() {
     *     public void query(WhitePgReservCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhitePgReservCB> unionQuery) {
        final WhitePgReservCB cb = new WhitePgReservCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhitePgReservCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhitePgReservCB&gt;() {
     *     public void query(WhitePgReservCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhitePgReservCB> unionQuery) {
        final WhitePgReservCB cb = new WhitePgReservCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhitePgReservCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhitePgReservCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhitePgReservCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "white_pg_reserv"; }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br />
         * {select max(FOO) from white_pg_reserv_ref where ...) as FOO_MAX} <br />
         ...
         * }, WhitePgReservRef.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhitePgReservRefCB, WhitePgReservCQ> derivedWhitePgReservRefList() {
            assertDerived("whitePgReservRefList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhitePgReservRefCB, WhitePgReservCQ>() {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhitePgReservCB, WhitePgReservCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhitePgReservCB, WhitePgReservCQ>() {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhitePgReservCB&gt;() {
     ...
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhitePgReservCB&gt;() {
     *     public void query(WhitePgReservCB cb) {
     ...
     */
    public WhitePgReservCB dreamCruiseCB() {
        WhitePgReservCB cb = new WhitePgReservCB();
        cb.xsetupForDreamCruise((WhitePgReservCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhitePgReservCB&gt;() {
     *     public void query(WhitePgReservCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhitePgReservCB> orCBLambda) {
        xorSQ((WhitePgReservCB)this, orCBLambda);
    }
     ...
     *     public void query(WhitePgReservCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhitePgReservCB&gt;() {
     *             public void query(WhitePgReservCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhitePgReservCB> andCBLambda) {
        xorSQAP((WhitePgReservCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhitePgReservCB cb;
        if (mainCB != null) {
            cb = (WhitePgReservCB)mainCB;
        } else {
            cb = new WhitePgReservCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<WhitePgReservCQ>() {
            public boolean has() { return true; }
            public WhitePgReservCQ qy() { return cb.query(); }
        });
    }
