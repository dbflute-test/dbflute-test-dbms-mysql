...
public abstract class AbstractBsWhiteLineSepCommentCQ extends AbstractConditionQuery {
     ...
     */
    public void setLineSepCommentName_LikeSearch(String lineSepCommentName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setLineSepCommentName_NotLikeSearch(String lineSepCommentName, COptionCall<LikeSearchOption> opLambda) {
