...
public abstract class AbstractBsWhiteLineSepCommentCQ extends AbstractConditionQuery {
    ...
    public void setLineSepCommentName_LikeSearch(String lineSepCommentName, ConditionOptionCall<LikeSearchOption> opLambda) {
        setLineSepCommentName_LikeSearch(lineSepCommentName, xcLSOP(opLambda));
    }
    ...
    public void setLineSepCommentName_NotLikeSearch(String lineSepCommentName, ConditionOptionCall<LikeSearchOption> opLambda) {
        setLineSepCommentName_NotLikeSearch(lineSepCommentName, xcLSOP(opLambda));
    }
     ...
     */
    public HpSLCFunction<WhiteLineSepCommentCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteLineSepCommentCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteLineSepCommentCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteLineSepCommentCB.class);
    }
    ...
    public HpSLCFunction<WhiteLineSepCommentCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteLineSepCommentCB.class);
    }
    ...
    public HpSLCFunction<WhiteLineSepCommentCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteLineSepCommentCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteLineSepCommentCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteLineSepCommentCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WhiteLineSepCommentCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteLineSepCommentCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteLineSepCommentCB.class);
    }
    ...
    public void xsmyselfDerive(String fn, SubQuery<WhiteLineSepCommentCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "LINE_SEP_COMMENT_CODE";
     ...
     */
    public void myselfExists(SubQuery<WhiteLineSepCommentCB> subCBLambda) {
