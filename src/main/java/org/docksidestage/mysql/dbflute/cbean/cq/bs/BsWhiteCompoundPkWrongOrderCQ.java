...
public class BsWhiteCompoundPkWrongOrderCQ extends AbstractBsWhiteCompoundPkWrongOrderCQ {
    ...
    public ConditionValue xdfgetSecondId()
    ...
    public ConditionValue xdfgetThirdId()
    ...
    public ConditionValue xdfgetWrongName()
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, WhiteCompoundPkWrongOrderCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
