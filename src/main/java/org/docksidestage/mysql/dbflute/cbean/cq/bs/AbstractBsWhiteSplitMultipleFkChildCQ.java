...
public abstract class AbstractBsWhiteSplitMultipleFkChildCQ extends AbstractConditionQuery {
     ...
     */
    public void setChildId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setChildName_LikeSearch(String childName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setChildName_NotLikeSearch(String childName, COptionCall<LikeSearchOption> opLambda) {
