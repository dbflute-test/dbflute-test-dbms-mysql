...
/**
 * The base condition-bean of white_table_except_gen_ref.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteTableExceptGenRefCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhiteTableExceptGenRefCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteTableExceptGenRefCB() {
     ...
     * @return this. (NotNull)
     */
    public WhiteTableExceptGenRefCB acceptPK(Long genRefId) {
        assertObjectNotNull("genRefId", genRefId);
        BsWhiteTableExceptGenRefCB cb = this;
        cb.query().setGenRefId_Equal(genRefId);
        return (WhiteTableExceptGenRefCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_GenRefId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_GenRefId_Desc();
        return this;
    }
    ...
    protected WhiteTableExceptGenRefCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteTableExceptGenRefCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteTableExceptGenRefCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteTableExceptGenRefCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<WhiteTableExceptGenRefCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteTableExceptGenRefCB> unionCBLambda) {
        final WhiteTableExceptGenRefCB cb = new WhiteTableExceptGenRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteTableExceptGenRefCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhiteTableExceptGenRefCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "white_table_except_gen_ref"; }
        /**
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteTableExceptGenRefCB, WhiteTableExceptGenRefCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteTableExceptGenRefCB> sq, WhiteTableExceptGenRefCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WhiteTableExceptGenRefCB dreamCruiseCB() {
        WhiteTableExceptGenRefCB cb = new WhiteTableExceptGenRefCB();
        cb.xsetupForDreamCruise((WhiteTableExceptGenRefCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteTableExceptGenRefCB&gt;() {
     ...
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhiteTableExceptGenRefCB&gt;() {
     *     public void query(WhiteTableExceptGenRefCB cb) {
    ...
    protected WhiteTableExceptGenRefCB xcreateColumnQueryCB() {
        WhiteTableExceptGenRefCB cb = new WhiteTableExceptGenRefCB();
        cb.xsetupForColumnQuery((WhiteTableExceptGenRefCB)this);
        return cb;
    }
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteTableExceptGenRefCB&gt;() {
     *     public void query(WhiteTableExceptGenRefCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteTableExceptGenRefCB> orCBLambda) {
        xorSQ((WhiteTableExceptGenRefCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteTableExceptGenRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteTableExceptGenRefCB&gt;() {
     *             public void query(WhiteTableExceptGenRefCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteTableExceptGenRefCB> andCBLambda) {
        xorSQAP((WhiteTableExceptGenRefCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteTableExceptGenRefCB cb;
        if (mainCB != null) {
            cb = (WhiteTableExceptGenRefCB)mainCB;
        } else {
