...
public class BsWhiteUqFkWithoutPkCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteUqFkWithoutPkCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteUqFkWithoutPkCB&gt;() {
     *     public void query(WhiteUqFkWithoutPkCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteUqFkWithoutPkCQ> {
         ...
         * }, WhiteUqFkWithoutPkRef.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteUqFkWithoutPkRefCB, WhiteUqFkWithoutPkCQ> derivedWhiteUqFkWithoutPkRefList() {
            assertDerived("whiteUqFkWithoutPkRefList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteUqFkWithoutPkRefCB, WhiteUqFkWithoutPkCQ>() {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteUqFkWithoutPkCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteUqFkWithoutPkCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteUqFkWithoutPkCB> orCBLambda) {
        xorSQ((WhiteUqFkWithoutPkCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteUqFkWithoutPkCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteUqFkWithoutPkCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteUqFkWithoutPkCB> andCBLambda) {
        xorSQAP((WhiteUqFkWithoutPkCB)this, andCBLambda);
    }
