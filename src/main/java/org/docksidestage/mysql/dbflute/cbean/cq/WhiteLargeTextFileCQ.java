...
import org.docksidestage.mysql.dbflute.cbean.cq.bs.BsWhiteLargeTextFileCQ;

/**
 * The condition-query of WHITE_LARGE_TEXT_FILE.
 * <p>
 ...
 */
public class WhiteLargeTextFileCQ extends BsWhiteLargeTextFileCQ {
     ...
     */
    public WhiteLargeTextFileCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
