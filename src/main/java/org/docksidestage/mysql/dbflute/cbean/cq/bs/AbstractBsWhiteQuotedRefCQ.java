...
public abstract class AbstractBsWhiteQuotedRefCQ extends AbstractConditionQuery {
    ...
    public void setWhere_RangeOf(Integer minNumber, Integer maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setWhere_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     */
    public HpSLCFunction<WhiteQuotedRefCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteQuotedRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedRefCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteQuotedRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedRefCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteQuotedRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedRefCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteQuotedRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedRefCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteQuotedRefCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedRefCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteQuotedRefCB.class);
    }
    ...
    public void xsmyselfDerive(String fn, SubQuery<WhiteQuotedRefCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "WHERE";
     ...
     */
    public void myselfExists(SubQuery<WhiteQuotedRefCB> subCBLambda) {
