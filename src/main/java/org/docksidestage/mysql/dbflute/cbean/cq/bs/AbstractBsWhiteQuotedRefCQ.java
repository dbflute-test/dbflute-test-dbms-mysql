...
public abstract class AbstractBsWhiteQuotedRefCQ extends AbstractConditionQuery {
     ...
     */
    public void setWhere_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setOrder_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
