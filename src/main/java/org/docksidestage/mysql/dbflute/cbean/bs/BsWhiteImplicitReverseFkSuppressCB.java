...
/**
 * The base condition-bean of white_implicit_reverse_fk_suppress.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteImplicitReverseFkSuppressCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhiteImplicitReverseFkSuppressCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteImplicitReverseFkSuppressCB() {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_WhiteImplicitReverseFkSuppressId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_WhiteImplicitReverseFkSuppressId_Desc();
        return this;
    }
    ...
    protected WhiteImplicitReverseFkSuppressCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteImplicitReverseFkSuppressCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteImplicitReverseFkSuppressCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteImplicitReverseFkSuppressCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *     public void query(WhiteImplicitReverseFkSuppressCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhiteImplicitReverseFkSuppressCB> unionQuery) {
        final WhiteImplicitReverseFkSuppressCB cb = new WhiteImplicitReverseFkSuppressCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteImplicitReverseFkSuppressCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *     public void query(WhiteImplicitReverseFkSuppressCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhiteImplicitReverseFkSuppressCB> unionQuery) {
        final WhiteImplicitReverseFkSuppressCB cb = new WhiteImplicitReverseFkSuppressCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteImplicitReverseFkSuppressCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteImplicitReverseFkSuppressCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhiteImplicitReverseFkSuppressCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            columnWhiteImplicitReverseFkSuppressId(); // PK
        }
        @Override
        protected String getTableDbName() { return "white_implicit_reverse_fk_suppress"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteImplicitReverseFkSuppressCB, WhiteImplicitReverseFkSuppressCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteImplicitReverseFkSuppressCB, WhiteImplicitReverseFkSuppressCQ>() {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     ...
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *     public void query(WhiteImplicitReverseFkSuppressCB cb) {
    ...
    protected WhiteImplicitReverseFkSuppressCB xcreateColumnQueryCB() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *     public void query(WhiteImplicitReverseFkSuppressCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteImplicitReverseFkSuppressCB> orCBLambda) {
        xorSQ((WhiteImplicitReverseFkSuppressCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteImplicitReverseFkSuppressCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *             public void query(WhiteImplicitReverseFkSuppressCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteImplicitReverseFkSuppressCB> andCBLambda) {
        xorSQAP((WhiteImplicitReverseFkSuppressCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteImplicitReverseFkSuppressCB cb;
        if (mainCB != null) {
            cb = (WhiteImplicitReverseFkSuppressCB)mainCB;
        } else {
            cb = new WhiteImplicitReverseFkSuppressCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<WhiteImplicitReverseFkSuppressCQ>() {
            public boolean has() { return true; }
            public WhiteImplicitReverseFkSuppressCQ qy() { return cb.query(); }
        });
    }
