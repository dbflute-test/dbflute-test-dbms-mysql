...
public class BsWhiteImplicitReverseFkSuppressCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     *     public void query(WhiteImplicitReverseFkSuppressCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
     ...
     *     public void query(WhiteImplicitReverseFkSuppressCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteImplicitReverseFkSuppressCB&gt;() {
