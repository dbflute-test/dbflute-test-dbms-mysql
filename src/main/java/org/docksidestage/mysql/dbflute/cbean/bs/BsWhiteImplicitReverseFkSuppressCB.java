...
public class BsWhiteImplicitReverseFkSuppressCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteImplicitReverseFkSuppressCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteImplicitReverseFkSuppressCB> unionCBLambda) {
        final WhiteImplicitReverseFkSuppressCB cb = new WhiteImplicitReverseFkSuppressCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
