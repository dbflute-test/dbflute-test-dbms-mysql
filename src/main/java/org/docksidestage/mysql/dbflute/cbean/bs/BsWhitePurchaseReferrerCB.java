...
public class BsWhitePurchaseReferrerCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public WhitePurchaseReferrerCB acceptPK(Long purchaseReferrerId) {
        ...
        return (WhitePurchaseReferrerCB)this;
    }
     ...
     */
    public void union(UnionQuery<WhitePurchaseReferrerCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhitePurchaseReferrerCB> unionCBLambda) {
        final WhitePurchaseReferrerCB cb = new WhitePurchaseReferrerCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">whitePurchaseReferrer</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whitePurchaseReferrer</span>.<span style="color: #CC4747">getPurchase()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhitePurchaseReferrerCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhitePurchaseReferrerCB, WhitePurchaseReferrerCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhitePurchaseReferrerCB> sq, WhitePurchaseReferrerCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhitePurchaseReferrerCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhitePurchaseReferrerCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhitePurchaseReferrerCB> orCBLambda) {
        xorSQ((WhitePurchaseReferrerCB)this, orCBLambda);
    }
     ...
     *     public void query(WhitePurchaseReferrerCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhitePurchaseReferrerCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhitePurchaseReferrerCB> andCBLambda) {
        xorSQAP((WhitePurchaseReferrerCB)this, andCBLambda);
    }
