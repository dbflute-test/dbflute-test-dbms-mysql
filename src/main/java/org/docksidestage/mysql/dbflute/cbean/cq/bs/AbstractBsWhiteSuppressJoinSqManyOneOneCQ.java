...
public abstract class AbstractBsWhiteSuppressJoinSqManyOneOneCQ extends AbstractConditionQuery {
     ...
     * <pre>e.g. setManyOneOneName_LikeSearch("xxx", op -&gt; op.<span style="color: #CC4747">likeContain()</span>);</pre>
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;WhiteSuppressJoinSqManyOneOneCB&gt;() {
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneOneCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteSuppressJoinSqManyOneOneCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhiteSuppressJoinSqManyOneOneCB&gt;() {
     *     public void query(WhiteSuppressJoinSqManyOneOneCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneOneCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteSuppressJoinSqManyOneOneCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhiteSuppressJoinSqManyOneOneCB&gt;() {
     *     public void query(WhiteSuppressJoinSqManyOneOneCB subCB) {
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneOneCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteSuppressJoinSqManyOneOneCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhiteSuppressJoinSqManyOneOneCB&gt;() {
     *     public void query(WhiteSuppressJoinSqManyOneOneCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneOneCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteSuppressJoinSqManyOneOneCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhiteSuppressJoinSqManyOneOneCB&gt;() {
     *     public void query(WhiteSuppressJoinSqManyOneOneCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneOneCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteSuppressJoinSqManyOneOneCB.class);
    }
    ...
    public HpSSQFunction<WhiteSuppressJoinSqManyOneOneCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteSuppressJoinSqManyOneOneCB.class);
    }
