...
public abstract class AbstractBsWhiteSuppressJoinSqManyOneOneCQ extends AbstractConditionQuery {
     ...
     */
    public void setManyOneOneName_LikeSearch(String manyOneOneName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setManyOneOneName_NotLikeSearch(String manyOneOneName, COptionCall<LikeSearchOption> opLambda) {
