...
public class BsWhiteAllInOneClsNormalColRefCQ extends AbstractBsWhiteAllInOneClsNormalColRefCQ {
     ...
     * @return this. (NotNull)
     */
    public BsWhiteAllInOneClsNormalColRefCQ addSpecifiedDerivedOrderBy_Asc(String aliasName) { registerSpecifiedDerivedOrderBy_Asc(aliasName); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsWhiteAllInOneClsNormalColRefCQ addSpecifiedDerivedOrderBy_Desc(String aliasName) { registerSpecifiedDerivedOrderBy_Desc(aliasName); return this; }
    ...
    protected WhiteAllInOneClsElementCQ xcreateQueryWhiteAllInOneClsElementAsFoo() {
        String nrp = xresolveNRP("white_all_in_one_cls_normal_col_ref", "whiteAllInOneClsElementAsFoo"); String jan = xresolveJAN(nrp, xgetNNLvl());
    ...
    protected WhiteAllInOneClsElementCQ xcreateQueryWhiteAllInOneClsElementAsBar() {
        String nrp = xresolveNRP("white_all_in_one_cls_normal_col_ref", "whiteAllInOneClsElementAsBar"); String jan = xresolveJAN(nrp, xgetNNLvl());
