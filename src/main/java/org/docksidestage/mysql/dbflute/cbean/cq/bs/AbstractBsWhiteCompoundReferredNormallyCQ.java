...
public abstract class AbstractBsWhiteCompoundReferredNormallyCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<WhiteCompoundReferredNormallyCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteCompoundReferredNormallyCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteCompoundReferredNormallyCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteCompoundReferredNormallyCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteCompoundReferredNormallyCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteCompoundReferredNormallyCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteCompoundReferredNormallyCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteCompoundReferredNormallyCB.class);
    }
