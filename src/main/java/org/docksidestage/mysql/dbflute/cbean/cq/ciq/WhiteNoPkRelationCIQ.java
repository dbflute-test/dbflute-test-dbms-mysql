...
/**
 * The condition-query for in-line of white_no_pk_relation.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteNoPkRelationCIQ extends AbstractBsWhiteNoPkRelationCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteNoPkRelationCQ _myCQ;
    ...
    protected String xinCB() { return WhiteNoPkRelationCB.class.getName(); }
    protected String xinCQ() { return WhiteNoPkRelationCQ.class.getName(); }
}
