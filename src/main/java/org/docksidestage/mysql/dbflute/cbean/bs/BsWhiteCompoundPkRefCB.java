...
public class BsWhiteCompoundPkRefCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;WhiteCompoundPkRefCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;WhiteCompoundPkRefCB&gt;() {
     *     public void query(WhiteCompoundPkRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #DD4747">setupSelect_WhiteCompoundPk()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteCompoundPkRef whiteCompoundPkRef = whiteCompoundPkRefBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteCompoundPkRef.<span style="color: #DD4747">getWhiteCompoundPk()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteCompoundPkRefCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #DD4747">derivedWhiteCompoundPkRefNestByQuxMultipleIdList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;WhiteCompoundPkRefNestCB&gt;() {
         *     public void query(WhiteCompoundPkRefNestCB subCB) {
         *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, WhiteCompoundPkRefNest.<span style="color: #DD4747">ALIAS_foo...</span>);
         * </pre>
         ...
         * <pre>
         * cb.specify().<span style="color: #DD4747">derivedWhiteCompoundPkRefNestByFooMultipleIdList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;WhiteCompoundPkRefNestCB&gt;() {
         *     public void query(WhiteCompoundPkRefNestCB subCB) {
         *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteCompoundPkRefCB&gt;() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;WhiteCompoundPkRefCB&gt;() {
     ...
     *     public void query(WhiteCompoundPkRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteCompoundPkRefCB&gt;() {
