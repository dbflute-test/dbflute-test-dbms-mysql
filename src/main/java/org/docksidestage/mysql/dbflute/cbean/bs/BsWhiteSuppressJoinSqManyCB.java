...
public class BsWhiteSuppressJoinSqManyCB extends AbstractConditionBean {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ManyId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ManyId_Desc();
        return this;
    }
     ...
     */
    public void union(UnionQuery<WhiteSuppressJoinSqManyCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteSuppressJoinSqManyCB> unionCBLambda) {
        final WhiteSuppressJoinSqManyCB cb = new WhiteSuppressJoinSqManyCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteSuppressJoinSqManyCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteSuppressJoinSqManyCB, WhiteSuppressJoinSqManyCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteSuppressJoinSqManyCB> sq, WhiteSuppressJoinSqManyCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteSuppressJoinSqManyCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteSuppressJoinSqManyCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteSuppressJoinSqManyCB> orCBLambda) {
        xorSQ((WhiteSuppressJoinSqManyCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteSuppressJoinSqManyCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteSuppressJoinSqManyCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteSuppressJoinSqManyCB> andCBLambda) {
        xorSQAP((WhiteSuppressJoinSqManyCB)this, andCBLambda);
    }
