...
public class BsWhiteSuppressJoinSqManyCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteSuppressJoinSqManyCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteSuppressJoinSqManyCB&gt;() {
     *     public void query(WhiteSuppressJoinSqManyCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteSuppressJoinSqManyCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteSuppressJoinSqManyCB, WhiteSuppressJoinSqManyCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteSuppressJoinSqManyCB, WhiteSuppressJoinSqManyCQ>() {
