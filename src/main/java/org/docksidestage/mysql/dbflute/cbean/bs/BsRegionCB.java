...
public class BsRegionCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;RegionCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;RegionCB&gt;() {
     *     public void query(RegionCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<RegionCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<MemberAddressCB, RegionCQ> derivedMemberAddressList() {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<RegionCB, RegionCQ> myselfDerived() {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;RegionCB&gt;() {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<RegionCB> columnQuery(final SpecifyQuery<RegionCB> colCBLambda) {
        return xcreateColQyOperandMySql(new HpColQyHandler<RegionCB>() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;RegionCB&gt;() {
     ...
     *     public void query(RegionCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;RegionCB&gt;() {
