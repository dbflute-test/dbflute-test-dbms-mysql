...
/**
 * The condition-query for in-line of white_escaped_java_doc.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteEscapedJavaDocCIQ extends AbstractBsWhiteEscapedJavaDocCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteEscapedJavaDocCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteEscapedJavaDocCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteEscapedJavaDocCQ myCQ) {
    ...
    protected String xinCB() { return WhiteEscapedJavaDocCB.class.getName(); }
    protected String xinCQ() { return WhiteEscapedJavaDocCQ.class.getName(); }
}
