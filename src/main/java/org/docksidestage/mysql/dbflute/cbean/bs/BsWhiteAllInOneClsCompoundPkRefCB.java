...
public class BsWhiteAllInOneClsCompoundPkRefCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteAllInOneClsCompoundPkRefCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteAllInOneClsCompoundPkRefCB> unionCBLambda) {
        final WhiteAllInOneClsCompoundPkRefCB cb = new WhiteAllInOneClsCompoundPkRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">whiteAllInOneClsCompoundPkRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteAllInOneClsCompoundPkRef</span>.<span style="color: #CC4747">getWhiteAllInOneClsElementAsFoo()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">whiteAllInOneClsCompoundPkRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteAllInOneClsCompoundPkRef</span>.<span style="color: #CC4747">getWhiteAllInOneClsElementAsBar()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
