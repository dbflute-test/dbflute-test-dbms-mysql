...
public class BsWhiteAllInOneClsCompoundPkRefCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public WhiteAllInOneClsCompoundPkRefCB acceptPK(String fooCode, String barCode, String quxCode) {
        ...
        return (WhiteAllInOneClsCompoundPkRefCB)this;
    }
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteAllInOneClsCompoundPkRefCB&gt;() {
    ...
    public void union(UnionQuery<WhiteAllInOneClsCompoundPkRefCB> unionQuery) {
        final WhiteAllInOneClsCompoundPkRefCB cb = new WhiteAllInOneClsCompoundPkRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteAllInOneClsCompoundPkRefCB&gt;() {
     *     public void query(WhiteAllInOneClsCompoundPkRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = whiteAllInOneClsCompoundPkRef.<span style="color: #CC4747">getWhiteAllInOneClsElementAsFoo()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.query().setFoo...(value);
     * WhiteAllInOneClsCompoundPkRef whiteAllInOneClsCompoundPkRef = whiteAllInOneClsCompoundPkRefBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteAllInOneClsCompoundPkRef.<span style="color: #CC4747">getWhiteAllInOneClsElementAsBar()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteAllInOneClsCompoundPkRefCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteAllInOneClsCompoundPkRefCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteAllInOneClsCompoundPkRefCB> orCBLambda) {
        xorSQ((WhiteAllInOneClsCompoundPkRefCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteAllInOneClsCompoundPkRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteAllInOneClsCompoundPkRefCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteAllInOneClsCompoundPkRefCB> andCBLambda) {
        xorSQAP((WhiteAllInOneClsCompoundPkRefCB)this, andCBLambda);
    }
