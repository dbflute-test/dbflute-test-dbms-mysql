...
public abstract class AbstractBsWhitePerrottaOverMemberCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<WhitePerrottaOverMemberCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhitePerrottaOverMemberCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhitePerrottaOverMemberCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhitePerrottaOverMemberCB.class);
    }
    ...
    public HpSLCFunction<WhitePerrottaOverMemberCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhitePerrottaOverMemberCB.class);
    }
    ...
    public HpSLCFunction<WhitePerrottaOverMemberCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhitePerrottaOverMemberCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhitePerrottaOverMemberCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhitePerrottaOverMemberCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhitePerrottaOverMemberCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhitePerrottaOverMemberCB.class);
    }
