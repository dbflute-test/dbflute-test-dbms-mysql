...
public class BsWhiteMyselfCheckCB extends AbstractConditionBean {
    ...
    public WhiteMyselfCheckCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WhiteMyselfCheckCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<WhiteMyselfCheckCB> unionCBLambda) {
        final WhiteMyselfCheckCB cb = new WhiteMyselfCheckCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     */
    public void unionAll(UnionQuery<WhiteMyselfCheckCB> unionCBLambda) {
        final WhiteMyselfCheckCB cb = new WhiteMyselfCheckCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">whiteMyselfCheck</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteMyselfCheck</span>.<span style="color: #CC4747">getWhiteMyself()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteMyselfCheckCQ> {
         ...
         */
        public SpecifiedColumn columnMyselfCheckId() { return doColumn("MYSELF_CHECK_ID"); }
        /**
         * MYSELF_CHECK_NAME: {NotNull, VARCHAR(80)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMyselfCheckName() { return doColumn("MYSELF_CHECK_NAME"); }
        /**
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteMyselfCheckCB, WhiteMyselfCheckCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteMyselfCheckCB> sq, WhiteMyselfCheckCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteMyselfCheckCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteMyselfCheckCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteMyselfCheckCB> orCBLambda) {
        xorSQ((WhiteMyselfCheckCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteMyselfCheckCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteMyselfCheckCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteMyselfCheckCB> andCBLambda) {
        xorSQAP((WhiteMyselfCheckCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WhiteMyselfCheckCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WhiteMyselfCheckCQ.class.getName(); }
