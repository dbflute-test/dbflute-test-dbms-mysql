...
public class BsMemberSecurityCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;MemberSecurityCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;MemberSecurityCB&gt;() {
     *     public void query(MemberSecurityCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = memberSecurity.<span style="color: #CC4747">getMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<MemberSecurityCQ>() {
                ...
                public MemberSecurityCQ qy() { return xdfgetConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberSecurityCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<MemberSecurityCB, MemberSecurityCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<MemberSecurityCB, MemberSecurityCQ>() {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;MemberSecurityCB&gt;() {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<MemberSecurityCB> columnQuery(final SpecifyQuery<MemberSecurityCB> colCBLambda) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;MemberSecurityCB&gt;() {
     ...
     *     public void query(MemberSecurityCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;MemberSecurityCB&gt;() {
