...
public class BsWhiteSuppressJoinSqManyOneCB extends AbstractConditionBean {
    ...
    public WhiteSuppressJoinSqManyOneCQ getConditionQuery() { // public for parameter comment and internal
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;WhiteSuppressJoinSqManyOneCB&gt;() {
     *     public void query(WhiteSuppressJoinSqManyOneCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhiteSuppressJoinSqManyOneCB> unionQuery) {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;WhiteSuppressJoinSqManyOneCB&gt;() {
     *     public void query(WhiteSuppressJoinSqManyOneCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhiteSuppressJoinSqManyOneCB> unionQuery) {
        final WhiteSuppressJoinSqManyOneCB cb = new WhiteSuppressJoinSqManyOneCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<WhiteSuppressJoinSqManyOneCQ>() {
                public boolean has() { return true; }
                public WhiteSuppressJoinSqManyOneCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteSuppressJoinSqManyOneCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #DD4747">derivedWhiteSuppressJoinSqManyList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;WhiteSuppressJoinSqManyCB&gt;() {
         *     public void query(WhiteSuppressJoinSqManyCB subCB) {
         *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, WhiteSuppressJoinSqMany.<span style="color: #DD4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WhiteSuppressJoinSqManyCB, WhiteSuppressJoinSqManyOneCQ> derivedWhiteSuppressJoinSqManyList() {
            assertDerived("whiteSuppressJoinSqManyList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteSuppressJoinSqManyCB, WhiteSuppressJoinSqManyOneCQ>() {
                public void setup(String fn, SubQuery<WhiteSuppressJoinSqManyCB> sq, WhiteSuppressJoinSqManyOneCQ cq, String al, DerivedReferrerOption op) {
         ...
         */
        public HpSDRFunction<WhiteSuppressJoinSqManyOneCB, WhiteSuppressJoinSqManyOneCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteSuppressJoinSqManyOneCB, WhiteSuppressJoinSqManyOneCQ>() {
                public void setup(String fn, SubQuery<WhiteSuppressJoinSqManyOneCB> sq, WhiteSuppressJoinSqManyOneCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;WhiteSuppressJoinSqManyOneCB&gt;() {
    ...
    public HpColQyOperand.HpExtendedColQyOperandMySql<WhiteSuppressJoinSqManyOneCB> columnQuery(final SpecifyQuery<WhiteSuppressJoinSqManyOneCB> colCBLambda) {
        return xcreateColQyOperandMySql(new HpColQyHandler<WhiteSuppressJoinSqManyOneCB>() {
            public HpCalculator handle(SpecifyQuery<WhiteSuppressJoinSqManyOneCB> rightSp, String operand) {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;WhiteSuppressJoinSqManyOneCB&gt;() {
     ...
     *     public void query(WhiteSuppressJoinSqManyOneCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteSuppressJoinSqManyOneCB&gt;() {
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        ...
        specify().xsetSyncQyCall(new HpSpQyCall<WhiteSuppressJoinSqManyOneCQ>() {
            public boolean has() { return true; }
            public WhiteSuppressJoinSqManyOneCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return WhiteSuppressJoinSqManyOneCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return WhiteSuppressJoinSqManyOneCQ.class.getName(); }
