...
public class BsWhiteSuppressJoinSqManyOneCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteSuppressJoinSqManyOneCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteSuppressJoinSqManyOneCB&gt;() {
     *     public void query(WhiteSuppressJoinSqManyOneCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #CC4747">setupSelect_WhiteSuppressJoinSqManyOneOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteSuppressJoinSqManyOne whiteSuppressJoinSqManyOne = whiteSuppressJoinSqManyOneBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteSuppressJoinSqManyOne.<span style="color: #CC4747">getWhiteSuppressJoinSqManyOneOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteSuppressJoinSqManyOneCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteSuppressJoinSqManyCB, WhiteSuppressJoinSqManyOneCQ> derivedWhiteSuppressJoinSqManyList() {
