...
public class BsWhitePgReservRefCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhitePgReservRefCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhitePgReservRefCB> unionCBLambda) {
        final WhitePgReservRefCB cb = new WhitePgReservRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">whitePgReservRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whitePgReservRef</span>.<span style="color: #CC4747">getWhitePgReserv()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
