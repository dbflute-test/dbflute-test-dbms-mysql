 ...
 */
public class BsWhitePgReservRefCB extends AbstractConditionBean {
    ...
    protected WhitePgReservRefCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhitePgReservRefCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhitePgReservRefCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhitePgReservRefCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhitePgReservRefCB&gt;() {
     *     public void query(WhitePgReservRefCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhitePgReservRefCB> unionQuery) {
        final WhitePgReservRefCB cb = new WhitePgReservRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhitePgReservRefCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhitePgReservRefCB&gt;() {
     *     public void query(WhitePgReservRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhitePgReservRefCB> unionQuery) {
        final WhitePgReservRefCB cb = new WhitePgReservRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhitePgReservRefCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * cb.<span style="color: #CC4747">setupSelect_WhitePgReserv()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhitePgReservRef whitePgReservRef = whitePgReservRefBhv.selectEntityWithDeletedCheck(cb);
     * ... = whitePgReservRef.<span style="color: #CC4747">getWhitePgReserv()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhitePgReservRefCQ> {
        protected WhitePgReservCB.HpSpecification _whitePgReserv;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhitePgReservRefCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryWhitePgReserv()
                    || qyCall().qy().xgetReferrerQuery() instanceof WhitePgReservCQ) {
        ...
        public WhitePgReservCB.HpSpecification specifyWhitePgReserv() {
            assertRelation("whitePgReserv");
            if (_whitePgReserv == null) {
                _whitePgReserv = new WhitePgReservCB.HpSpecification(_baseCB, new HpSpQyCall<WhitePgReservCQ>() {
                    public boolean has() { return _qyCall.has() && _qyCall.qy().hasConditionQueryWhitePgReserv(); }
                    public WhitePgReservCQ qy() { return _qyCall.qy().queryWhitePgReserv(); } }
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _whitePgReserv.xsetSyncQyCall(new HpSpQyCall<WhitePgReservCQ>() {
                        public boolean has() { return xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryWhitePgReserv(); }
                        public WhitePgReservCQ qy() { return xsyncQyCall().qy().queryWhitePgReserv(); }
                    });
                }
            }
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhitePgReservRefCB, WhitePgReservRefCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhitePgReservRefCB, WhitePgReservRefCQ>() {
                public void setup(String fn, SubQuery<WhitePgReservRefCB> sq, WhitePgReservRefCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhitePgReservRefCB&gt;() {
     ...
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhitePgReservRefCB&gt;() {
     *     public void query(WhitePgReservRefCB cb) {
     ...
     */
    public WhitePgReservRefCB dreamCruiseCB() {
        WhitePgReservRefCB cb = new WhitePgReservRefCB();
        cb.xsetupForDreamCruise((WhitePgReservRefCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhitePgReservRefCB&gt;() {
     *     public void query(WhitePgReservRefCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhitePgReservRefCB> orCBLambda) {
        xorSQ((WhitePgReservRefCB)this, orCBLambda);
    }
     ...
     *     public void query(WhitePgReservRefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhitePgReservRefCB&gt;() {
     *             public void query(WhitePgReservRefCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhitePgReservRefCB> andCBLambda) {
        xorSQAP((WhitePgReservRefCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhitePgReservRefCB cb;
        if (mainCB != null) {
            cb = (WhitePgReservRefCB)mainCB;
        } else {
            cb = new WhitePgReservRefCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<WhitePgReservRefCQ>() {
            public boolean has() { return true; }
            public WhitePgReservRefCQ qy() { return cb.query(); }
        });
    }
