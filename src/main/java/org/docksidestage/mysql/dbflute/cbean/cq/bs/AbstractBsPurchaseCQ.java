...
public abstract class AbstractBsPurchaseCQ extends AbstractConditionQuery {
     ...
     * (購入支払)purchase_payment by PURCHASE_ID, named 'purchasePaymentAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedPurchasePaymentList()</span>.<span style="color: #DD4747">max</span>(paymentCB -&gt; {
     *     paymentCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
