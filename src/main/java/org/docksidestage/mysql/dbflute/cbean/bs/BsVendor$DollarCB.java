...
public class BsVendor$DollarCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<Vendor$DollarCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<Vendor$DollarCB> unionCBLambda) {
        final Vendor$DollarCB cb = new Vendor$DollarCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<Vendor$DollarCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<Vendor$DollarCB, Vendor$DollarCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<Vendor$DollarCB> sq, Vendor$DollarCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<Vendor$DollarCB> columnQuery(final SpecifyQuery<Vendor$DollarCB> colCBLambda) {
     ...
     */
    public void orScopeQuery(OrQuery<Vendor$DollarCB> orCBLambda) {
        xorSQ((Vendor$DollarCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<Vendor$DollarCB> andCBLambda) {
        xorSQAP((Vendor$DollarCB)this, andCBLambda);
    }
