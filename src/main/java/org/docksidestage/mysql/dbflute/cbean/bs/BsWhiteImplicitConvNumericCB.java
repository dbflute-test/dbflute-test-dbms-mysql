...
public class BsWhiteImplicitConvNumericCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public WhiteImplicitConvNumericCB acceptPK(java.math.BigDecimal implicitConvNumericId) {
        ...
        return (WhiteImplicitConvNumericCB)this;
    }
    ...
    public WhiteImplicitConvNumericCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WhiteImplicitConvNumericCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<WhiteImplicitConvNumericCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteImplicitConvNumericCB> unionCBLambda) {
        final WhiteImplicitConvNumericCB cb = new WhiteImplicitConvNumericCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * <pre>
     * <span style="color: #0000C0">whiteImplicitConvNumericBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">whiteImplicitConvNumeric</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteImplicitConvNumeric</span>.<span style="color: #CC4747">getWhiteImplicitConvInteger()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">whiteImplicitConvNumeric</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">whiteImplicitConvNumeric</span>.<span style="color: #CC4747">getWhiteImplicitConvString()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<WhiteImplicitConvNumericCQ>() {
                ...
                public WhiteImplicitConvNumericCQ qy() { return xdfgetConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteImplicitConvNumericCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteImplicitConvIntegerCB, WhiteImplicitConvNumericCQ> derivedWhiteImplicitConvIntegerList() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteImplicitConvIntegerCB, WhiteImplicitConvNumericCQ>() {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteImplicitConvStringCB, WhiteImplicitConvNumericCQ> derivedWhiteImplicitConvStringList() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteImplicitConvStringCB, WhiteImplicitConvNumericCQ>() {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteImplicitConvNumericCB, WhiteImplicitConvNumericCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<WhiteImplicitConvNumericCB, WhiteImplicitConvNumericCQ>() {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteImplicitConvNumericCB&gt;() {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<WhiteImplicitConvNumericCB> columnQuery(final SpecifyQuery<WhiteImplicitConvNumericCB> colCBLambda) {
        return xcreateColQyOperandMySql(new HpColQyHandler<WhiteImplicitConvNumericCB>() {
            public ColumnCalculator handle(SpecifyQuery<WhiteImplicitConvNumericCB> rightSp, String operand) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteImplicitConvNumericCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteImplicitConvNumericCB> orCBLambda) {
        xorSQ((WhiteImplicitConvNumericCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteImplicitConvNumericCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteImplicitConvNumericCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteImplicitConvNumericCB> andCBLambda) {
        xorSQAP((WhiteImplicitConvNumericCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WhiteImplicitConvNumericCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WhiteImplicitConvNumericCQ.class.getName(); }
