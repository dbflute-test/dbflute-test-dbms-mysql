...
public class BsMemberFollowingCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberFollowingCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<MemberFollowingCB, MemberFollowingCQ> myselfDerived() {
     ...
     */
    public HpColQyOperand.HpExtendedColQyOperandMySql<MemberFollowingCB> columnQuery(final SpecifyQuery<MemberFollowingCB> colCBLambda) {
