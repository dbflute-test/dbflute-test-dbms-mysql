...
/**
 * The condition-query for in-line of white_no_pk.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteNoPkCIQ extends AbstractBsWhiteNoPkCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteNoPkCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteNoPkCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteNoPkCQ myCQ) {
    ...
    protected String xinCB() { return WhiteNoPkCB.class.getName(); }
    protected String xinCQ() { return WhiteNoPkCQ.class.getName(); }
}
