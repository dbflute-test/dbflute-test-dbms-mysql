...
public abstract class AbstractBsWhiteCompoundPkCQ extends AbstractConditionQuery {
     ...
     */
    public void setPkFirstId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setPkSecondId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setPkName_LikeSearch(String pkName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setPkName_NotLikeSearch(String pkName, COptionCall<LikeSearchOption> opLambda) {
