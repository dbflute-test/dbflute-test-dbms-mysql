...
/**
 * The base condition-bean of white_point_type_mapping.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhitePointTypeMappingCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhitePointTypeMappingCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhitePointTypeMappingCB() {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_PointTypeMappingId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_PointTypeMappingId_Desc();
        return this;
    }
    ...
    protected WhitePointTypeMappingCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhitePointTypeMappingCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhitePointTypeMappingCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhitePointTypeMappingCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhitePointTypeMappingCB> unionQuery) {
        final WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhitePointTypeMappingCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhitePointTypeMappingCB> unionQuery) {
        final WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhitePointTypeMappingCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhitePointTypeMappingCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhitePointTypeMappingCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            columnPointTypeMappingId(); // PK
        }
        @Override
        protected String getTableDbName() { return "white_point_type_mapping"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<WhitePointTypeMappingCB, WhitePointTypeMappingCQ> myselfDerived() {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB cb) {
    ...
    protected WhitePointTypeMappingCB xcreateColumnQueryCB() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;WhitePointTypeMappingCB&gt;() {
     *     public void query(WhitePointTypeMappingCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhitePointTypeMappingCB> orCBLambda) {
        xorSQ((WhitePointTypeMappingCB)this, orCBLambda);
    }
     ...
     *     public void query(WhitePointTypeMappingCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhitePointTypeMappingCB&gt;() {
     *             public void query(WhitePointTypeMappingCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhitePointTypeMappingCB> andCBLambda) {
        xorSQAP((WhitePointTypeMappingCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhitePointTypeMappingCB cb;
        if (mainCB != null) {
            cb = (WhitePointTypeMappingCB)mainCB;
        } else {
