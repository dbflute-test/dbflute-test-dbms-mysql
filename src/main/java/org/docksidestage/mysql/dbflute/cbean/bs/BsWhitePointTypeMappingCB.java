...
public class BsWhitePointTypeMappingCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhitePointTypeMappingCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhitePointTypeMappingCB> unionCBLambda) {
        final WhitePointTypeMappingCB cb = new WhitePointTypeMappingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhitePointTypeMappingCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhitePointTypeMappingCB, WhitePointTypeMappingCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhitePointTypeMappingCB> sq, WhitePointTypeMappingCQ cq, String al, DerivedReferrerOption op)
