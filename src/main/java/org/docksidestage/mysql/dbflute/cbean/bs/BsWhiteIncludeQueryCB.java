...
public class BsWhiteIncludeQueryCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteIncludeQueryCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteIncludeQueryCB> unionCBLambda) {
        final WhiteIncludeQueryCB cb = new WhiteIncludeQueryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteIncludeQueryCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteIncludeQueryCB, WhiteIncludeQueryCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteIncludeQueryCB> sq, WhiteIncludeQueryCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteIncludeQueryCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteIncludeQueryCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteIncludeQueryCB> orCBLambda) {
        xorSQ((WhiteIncludeQueryCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteIncludeQueryCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteIncludeQueryCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteIncludeQueryCB> andCBLambda) {
        xorSQAP((WhiteIncludeQueryCB)this, andCBLambda);
    }
