...
public abstract class AbstractBsWhiteSplitMultipleFkNextCQ extends AbstractConditionQuery {
     ...
     */
    public void setNextId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * white_split_multiple_fk_base by NEXT_ID, named 'whiteSplitMultipleFkBaseAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedWhiteSplitMultipleFkBaseList()</span>.<span style="color: #DD4747">max</span>(baseCB -&gt; {
     *     baseCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     ...
     */
    public void setSecondCode_LikeSearch(String secondCode, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setSecondCode_NotLikeSearch(String secondCode, COptionCall<LikeSearchOption> opLambda) {
    ...
    public HpSSQFunction<WhiteSplitMultipleFkNextCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteSplitMultipleFkNextCB.class);
    }
    ...
    public HpSSQFunction<WhiteSplitMultipleFkNextCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteSplitMultipleFkNextCB.class);
    }
    ...
    public HpSSQFunction<WhiteSplitMultipleFkNextCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteSplitMultipleFkNextCB.class);
    }
    ...
    public HpSSQFunction<WhiteSplitMultipleFkNextCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteSplitMultipleFkNextCB.class);
    }
    ...
    public HpSSQFunction<WhiteSplitMultipleFkNextCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteSplitMultipleFkNextCB.class);
    }
    ...
    public HpSSQFunction<WhiteSplitMultipleFkNextCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteSplitMultipleFkNextCB.class);
    }
