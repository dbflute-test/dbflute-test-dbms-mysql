...
public abstract class AbstractBsWhiteSuppressJoinSqOneCQ extends AbstractConditionQuery {
     ...
     * @param oneId The value of oneId as equal. (basically NotNull: error as default, or no condition as option)
     */
     ...
     * ONE_ID: {PK, NotNull, INT(10)}
     * @param oneId The value of oneId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
     ...
     * ONE_ID: {PK, NotNull, INT(10)}
     * @param oneId The value of oneId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
     ...
     * ONE_ID: {PK, NotNull, INT(10)}
     * @param oneId The value of oneId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
     ...
     */
    public HpSLCFunction<WhiteSuppressJoinSqOneCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteSuppressJoinSqOneCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSuppressJoinSqOneCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteSuppressJoinSqOneCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSuppressJoinSqOneCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteSuppressJoinSqOneCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSuppressJoinSqOneCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteSuppressJoinSqOneCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSuppressJoinSqOneCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteSuppressJoinSqOneCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteSuppressJoinSqOneCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteSuppressJoinSqOneCB.class);
    }
