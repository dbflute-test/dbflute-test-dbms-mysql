...
public abstract class AbstractBsWhiteSuppressJoinSqOneCQ extends AbstractConditionQuery {
     ...
     */
    public void setOneId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setOneName_LikeSearch(String oneName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setOneName_NotLikeSearch(String oneName, COptionCall<LikeSearchOption> opLambda) {
