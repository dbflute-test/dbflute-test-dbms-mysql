...
public abstract class AbstractBsWhiteXlsManCQ extends AbstractConditionQuery {
     ...
     */
    public void setXlsManId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * TIMESTAMP_CONVERTED: {DATETIME(19)}
     * <pre>e.g. setTimestampConverted_FromTo(fromDate, toDate, new <span style="color: #DD4747">FromToOption</span>().compareAsDate());</pre>
     ...
     */
    public void setTimestampConverted_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
