...
/**
 * The base condition-bean of white_escaped_number_initial.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteEscapedNumberInitialCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhiteEscapedNumberInitialCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteEscapedNumberInitialCB() {
     ...
     * @return this. (NotNull)
     */
    public WhiteEscapedNumberInitialCB acceptPK(CDef.EscapedNumberInitialCls numberInitialCode) {
        assertObjectNotNull("numberInitialCode", numberInitialCode);
        BsWhiteEscapedNumberInitialCB cb = this;
        cb.query().setNumberInitialCode_Equal_AsEscapedNumberInitialCls(numberInitialCode);
        return (WhiteEscapedNumberInitialCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_NumberInitialCode_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_NumberInitialCode_Desc();
        return this;
    }
    ...
    protected WhiteEscapedNumberInitialCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteEscapedNumberInitialCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteEscapedNumberInitialCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteEscapedNumberInitialCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<WhiteEscapedNumberInitialCB> unionCBLambda) {
        final WhiteEscapedNumberInitialCB cb = new WhiteEscapedNumberInitialCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteEscapedNumberInitialCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WhiteEscapedNumberInitialCB> unionCBLambda) {
        final WhiteEscapedNumberInitialCB cb = new WhiteEscapedNumberInitialCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteEscapedNumberInitialCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteEscapedNumberInitialCQ> {
        ...
        protected void doSpecifyRequiredColumn() {
            columnNumberInitialCode(); // PK
        }
        @Override
        protected String getTableDbName() { return "white_escaped_number_initial"; }
        /**
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteEscapedNumberInitialCB, WhiteEscapedNumberInitialCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteEscapedNumberInitialCB> sq, WhiteEscapedNumberInitialCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WhiteEscapedNumberInitialCB dreamCruiseCB() {
        WhiteEscapedNumberInitialCB cb = new WhiteEscapedNumberInitialCB();
        cb.xsetupForDreamCruise((WhiteEscapedNumberInitialCB) this);
        return cb;
    }
    ...
    protected WhiteEscapedNumberInitialCB xcreateColumnQueryCB() {
        WhiteEscapedNumberInitialCB cb = new WhiteEscapedNumberInitialCB();
        cb.xsetupForColumnQuery((WhiteEscapedNumberInitialCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WhiteEscapedNumberInitialCB> orCBLambda) {
        xorSQ((WhiteEscapedNumberInitialCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteEscapedNumberInitialCB> andCBLambda) {
        xorSQAP((WhiteEscapedNumberInitialCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteEscapedNumberInitialCB cb;
        if (mainCB != null) {
            cb = (WhiteEscapedNumberInitialCB)mainCB;
        } else {
            cb = new WhiteEscapedNumberInitialCB();
        }
