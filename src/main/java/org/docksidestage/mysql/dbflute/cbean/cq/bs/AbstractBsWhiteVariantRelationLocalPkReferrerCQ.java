...
public abstract class AbstractBsWhiteVariantRelationLocalPkReferrerCQ extends AbstractConditionQuery {
     ...
     */
    public void setReversefkSuppressedId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setMasterTypeCode_LikeSearch(String masterTypeCode, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setMasterTypeCode_NotLikeSearch(String masterTypeCode, COptionCall<LikeSearchOption> opLambda) {
