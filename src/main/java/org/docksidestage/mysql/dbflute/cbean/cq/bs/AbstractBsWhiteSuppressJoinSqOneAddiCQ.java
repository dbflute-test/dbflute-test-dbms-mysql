...
public abstract class AbstractBsWhiteSuppressJoinSqOneAddiCQ extends AbstractConditionQuery {
     ...
     */
    public void setOneAddiId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setOneAddiName_LikeSearch(String oneAddiName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setOneAddiName_NotLikeSearch(String oneAddiName, COptionCall<LikeSearchOption> opLambda) {
