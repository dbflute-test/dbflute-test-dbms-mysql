...
/**
 * The base condition-bean of white_all_in_one_cls_category.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhiteAllInOneClsCategoryCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhiteAllInOneClsCategoryCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhiteAllInOneClsCategoryCB() {
     ...
     * @return this. (NotNull)
     */
    public WhiteAllInOneClsCategoryCB acceptPK(String clsCategoryCode) {
        assertObjectNotNull("clsCategoryCode", clsCategoryCode);
        BsWhiteAllInOneClsCategoryCB cb = this;
        cb.query().setClsCategoryCode_Equal(clsCategoryCode);
        return (WhiteAllInOneClsCategoryCB)this;
    }
    ...
    protected WhiteAllInOneClsCategoryCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhiteAllInOneClsCategoryCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhiteAllInOneClsCategoryCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhiteAllInOneClsCategoryCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<WhiteAllInOneClsCategoryCB> unionCBLambda) {
        final WhiteAllInOneClsCategoryCB cb = new WhiteAllInOneClsCategoryCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteAllInOneClsCategoryCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WhiteAllInOneClsCategoryCB> unionCBLambda) {
        final WhiteAllInOneClsCategoryCB cb = new WhiteAllInOneClsCategoryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhiteAllInOneClsCategoryCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteAllInOneClsCategoryCQ> {
        ...
        @Override
        protected String getTableDbName() { return "white_all_in_one_cls_category"; }
        /**
         ...
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(elementCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     elementCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     elementCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
     ...
     */
    public WhiteAllInOneClsCategoryCB dreamCruiseCB() {
        WhiteAllInOneClsCategoryCB cb = new WhiteAllInOneClsCategoryCB();
        cb.xsetupForDreamCruise((WhiteAllInOneClsCategoryCB) this);
        return cb;
    }
    ...
    protected WhiteAllInOneClsCategoryCB xcreateColumnQueryCB() {
        WhiteAllInOneClsCategoryCB cb = new WhiteAllInOneClsCategoryCB();
        cb.xsetupForColumnQuery((WhiteAllInOneClsCategoryCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WhiteAllInOneClsCategoryCB> orCBLambda) {
        xorSQ((WhiteAllInOneClsCategoryCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteAllInOneClsCategoryCB> andCBLambda) {
        xorSQAP((WhiteAllInOneClsCategoryCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhiteAllInOneClsCategoryCB cb;
        if (mainCB != null) {
            cb = (WhiteAllInOneClsCategoryCB)mainCB;
        } else {
