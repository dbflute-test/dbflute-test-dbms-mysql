...
public abstract class AbstractBsWhiteEscapedNumberInitialCQ extends AbstractConditionQuery {
     ...
     */
    public void setNumberInitialName_LikeSearch(String numberInitialName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setNumberInitialName_NotLikeSearch(String numberInitialName, COptionCall<LikeSearchOption> opLambda) {
