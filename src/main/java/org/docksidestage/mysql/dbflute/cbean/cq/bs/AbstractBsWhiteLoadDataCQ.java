...
public abstract class AbstractBsWhiteLoadDataCQ extends AbstractConditionQuery {
     ...
     */
    public void setLoadDataId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setLoadDataName_LikeSearch(String loadDataName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setLoadDataName_NotLikeSearch(String loadDataName, COptionCall<LikeSearchOption> opLambda) {
