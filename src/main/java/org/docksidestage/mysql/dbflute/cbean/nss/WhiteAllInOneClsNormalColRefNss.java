...
import org.docksidestage.mysql.dbflute.cbean.cq.WhiteAllInOneClsNormalColRefCQ;

/**
 * The nest select set-upper of white_all_in_one_cls_normal_col_ref.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteAllInOneClsNormalColRefNss {
    ...
    public WhiteAllInOneClsElementNss withWhiteAllInOneClsElementAsFoo() {
        _query.xdoNss(new WhiteAllInOneClsNormalColRefCQ.NssCall() { public ConditionQuery qf() { return _query.queryWhiteAllInOneClsElementAsFoo(); }});
    ...
    public WhiteAllInOneClsElementNss withWhiteAllInOneClsElementAsBar() {
        _query.xdoNss(new WhiteAllInOneClsNormalColRefCQ.NssCall() { public ConditionQuery qf() { return _query.queryWhiteAllInOneClsElementAsBar(); }});
