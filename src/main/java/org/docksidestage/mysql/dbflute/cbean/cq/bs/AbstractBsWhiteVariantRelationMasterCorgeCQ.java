...
public abstract class AbstractBsWhiteVariantRelationMasterCorgeCQ extends AbstractConditionQuery {
     ...
     */
    public void setMasterCorgeId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setMasterCorgeName_LikeSearch(String masterCorgeName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setMasterCorgeName_NotLikeSearch(String masterCorgeName, COptionCall<LikeSearchOption> opLambda) {
    ...
    public HpSSQFunction<WhiteVariantRelationMasterCorgeCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteVariantRelationMasterCorgeCB.class);
    }
    ...
    public HpSSQFunction<WhiteVariantRelationMasterCorgeCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteVariantRelationMasterCorgeCB.class);
    }
    ...
    public HpSSQFunction<WhiteVariantRelationMasterCorgeCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteVariantRelationMasterCorgeCB.class);
    }
    ...
    public HpSSQFunction<WhiteVariantRelationMasterCorgeCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteVariantRelationMasterCorgeCB.class);
    }
    ...
    public HpSSQFunction<WhiteVariantRelationMasterCorgeCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteVariantRelationMasterCorgeCB.class);
    }
    ...
    public HpSSQFunction<WhiteVariantRelationMasterCorgeCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteVariantRelationMasterCorgeCB.class);
    }
