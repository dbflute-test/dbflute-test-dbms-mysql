...
public class BsWhiteStilettoAliasCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteStilettoAliasCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteStilettoAliasCB> unionCBLambda) {
        final WhiteStilettoAliasCB cb = new WhiteStilettoAliasCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteStilettoAliasCQ> {
         ...
         * }, WhiteStilettoAliasRef.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteStilettoAliasRefCB, WhiteStilettoAliasCQ> derivedWhiteStilettoAliasRef() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteStilettoAliasRefCB> sq, WhiteStilettoAliasCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteStilettoAliasCB, WhiteStilettoAliasCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteStilettoAliasCB> sq, WhiteStilettoAliasCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteStilettoAliasCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteStilettoAliasCB&gt;() {
     ...
     *     public void query(WhiteStilettoAliasCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteStilettoAliasCB&gt;() {
