...
public class BsWhiteStilettoAliasCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteStilettoAliasCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteStilettoAliasCB&gt;() {
     *     public void query(WhiteStilettoAliasCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
