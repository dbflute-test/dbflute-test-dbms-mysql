...
/**
 * The condition-query for in-line of white_additional.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteAdditionalCIQ extends AbstractBsWhiteAdditionalCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteAdditionalCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteAdditionalCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteAdditionalCQ myCQ) {
    ...
    protected String xinCB() { return WhiteAdditionalCB.class.getName(); }
    protected String xinCQ() { return WhiteAdditionalCQ.class.getName(); }
}
