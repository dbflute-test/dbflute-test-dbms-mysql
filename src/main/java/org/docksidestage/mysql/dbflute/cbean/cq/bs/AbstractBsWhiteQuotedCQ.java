...
public abstract class AbstractBsWhiteQuotedCQ extends AbstractConditionQuery {
     ...
     */
    public void setSelect_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * white_quoted_ref by ORDER, named 'whiteQuotedRefAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedWhiteQuotedRefList()</span>.<span style="color: #DD4747">max</span>(refCB -&gt; {
     ...
     */
    public void setFrom_LikeSearch(String from, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setFrom_NotLikeSearch(String from, COptionCall<LikeSearchOption> opLambda) {
