...
public abstract class AbstractBsWhiteQuotedCQ extends AbstractConditionQuery {
    ...
    public void setSelect_RangeOf(Integer minNumber, Integer maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setSelect_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">existsWhiteQuotedRef</span>(refCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     refCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of WhiteQuotedRefList for 'exists'. (NotNull)
     */
    public void existsWhiteQuotedRef(SubQuery<WhiteQuotedRefCB> subCBLambda) {
     ...
     * white_quoted_ref by ORDER, named 'whiteQuotedRefAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsWhiteQuotedRef</span>(refCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     refCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of Select_NotExistsReferrer_WhiteQuotedRefList for 'not exists'. (NotNull)
     */
    public void notExistsWhiteQuotedRef(SubQuery<WhiteQuotedRefCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        WhiteQuotedRefCB cb = new WhiteQuotedRefCB(); cb.xsetupForExistsReferrer(this);
     ...
     * white_quoted_ref by ORDER, named 'whiteQuotedRefAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedWhiteQuotedRef()</span>.<span style="color: #CC4747">max</span>(refCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public HpQDRFunction<WhiteQuotedRefCB> derivedWhiteQuotedRef() {
    ...
    public void setFrom_LikeSearch(String from, ConditionOptionCall<LikeSearchOption> opLambda) {
        setFrom_LikeSearch(from, xcLSOP(opLambda));
    }
    ...
    public void setFrom_NotLikeSearch(String from, ConditionOptionCall<LikeSearchOption> opLambda) {
        setFrom_NotLikeSearch(from, xcLSOP(opLambda));
    }
     ...
     */
    public HpSLCFunction<WhiteQuotedCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteQuotedCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteQuotedCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteQuotedCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteQuotedCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteQuotedCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WhiteQuotedCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteQuotedCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteQuotedCB.class);
    }
