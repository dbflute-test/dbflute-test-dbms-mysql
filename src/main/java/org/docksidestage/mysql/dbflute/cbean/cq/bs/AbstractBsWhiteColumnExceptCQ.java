...
public abstract class AbstractBsWhiteColumnExceptCQ extends AbstractConditionQuery {
     ...
     */
    public void setExceptColumnId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setColumnExceptTest_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
