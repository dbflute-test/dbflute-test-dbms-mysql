...
public abstract class AbstractBsWhiteMyselfCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<WhiteMyselfCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteMyselfCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteMyselfCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteMyselfCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteMyselfCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteMyselfCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteMyselfCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteMyselfCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteMyselfCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteMyselfCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteMyselfCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteMyselfCB.class);
    }
