...
public class BsWhiteGearedCipherCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteGearedCipherCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteGearedCipherCB> unionCBLambda) {
        final WhiteGearedCipherCB cb = new WhiteGearedCipherCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteGearedCipherCQ> {
         ...
         */
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhiteGearedCipherCB, WhiteGearedCipherCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteGearedCipherCB> sq, WhiteGearedCipherCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhiteGearedCipherCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhiteGearedCipherCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<WhiteGearedCipherCB> orCBLambda) {
        xorSQ((WhiteGearedCipherCB)this, orCBLambda);
    }
     ...
     *     public void query(WhiteGearedCipherCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhiteGearedCipherCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteGearedCipherCB> andCBLambda) {
        xorSQAP((WhiteGearedCipherCB)this, andCBLambda);
    }
