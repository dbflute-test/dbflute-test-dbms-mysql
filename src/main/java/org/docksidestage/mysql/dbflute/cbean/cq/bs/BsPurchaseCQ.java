...
public class BsPurchaseCQ extends AbstractBsPurchaseCQ {
    ...
    public void reflectRelationOnUnionQuery(ConditionQuery bqs, ConditionQuery uqs) {
        ...
        if (bq.hasConditionQueryMemberAddressAsSkipRelation()) {
            uq.xsetParameterMapMemberAddressAsSkipRelation(bq.xdfgetParameterMapMemberAddressAsSkipRelation());
            uq.xdfgetConditionQueryMemberAddressAsSkipRelation().reflectRelationOnUnionQuery(bq.xdfgetConditionQueryMemberAddressAsSkipRelation(), uq.xdfgetConditionQueryMemberAddressAsSkipRelation());
        }
    ...
    public SummaryWithdrawalCQ querySummaryWithdrawal() {
        return xdfgetConditionQuerySummaryWithdrawal();
    }
    public SummaryWithdrawalCQ xdfgetConditionQuerySummaryWithdrawal() {
    ...
    public WhiteNoPkRelationCQ queryWhiteNoPkRelation() {
        return xdfgetConditionQueryWhiteNoPkRelation();
    }
    public WhiteNoPkRelationCQ xdfgetConditionQueryWhiteNoPkRelation() {
    ...
    public PurchaseCQ queryPurchaseSelf() {
        return xdfgetConditionQueryPurchaseSelf();
    }
    public PurchaseCQ xdfgetConditionQueryPurchaseSelf() {
    ...
    public MemberAddressCQ xdfgetConditionQueryMemberAddressAsSkipRelation() {
    ...
    public Map<String, Object> xdfgetParameterMapMemberAddressAsSkipRelation()
     ...
     * @return The instance of condition-query. (NotNull)
     */
    public WhitePurchaseReferrerCQ queryWhitePurchaseReferrerAsOne() { return xdfgetConditionQueryWhitePurchaseReferrerAsOne(); }
    public WhitePurchaseReferrerCQ xdfgetConditionQueryWhitePurchaseReferrerAsOne() {
     ...
     * @return The instance of condition-query. (NotNull)
     */
    public PurchaseCQ queryPurchaseSelfAsOne() { return xdfgetConditionQueryPurchaseSelfAsOne(); }
    public PurchaseCQ xdfgetConditionQueryPurchaseSelfAsOne() {
