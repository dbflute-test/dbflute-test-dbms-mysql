...
public abstract class AbstractBsWhiteTableExceptGenRefCQ extends AbstractConditionQuery {
     ...
     */
    public void setGenRefId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setGenRefName_LikeSearch(String genRefName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setGenRefName_NotLikeSearch(String genRefName, COptionCall<LikeSearchOption> opLambda) {
