...
public class BsWhiteAllInOneClsElementCB extends AbstractConditionBean {
    ...
    public WhiteAllInOneClsElementCQ getConditionQuery() { // public for parameter comment and internal
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;WhiteAllInOneClsElementCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;WhiteAllInOneClsElementCB&gt;() {
     *     public void query(WhiteAllInOneClsElementCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #CC4747">setupSelect_WhiteAllInOneClsCategory()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * WhiteAllInOneClsElement whiteAllInOneClsElement = whiteAllInOneClsElementBhv.selectEntityWithDeletedCheck(cb);
     * ... = whiteAllInOneClsElement.<span style="color: #CC4747">getWhiteAllInOneClsCategory()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     */
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<WhiteAllInOneClsElementCQ>() {
                ...
                public WhiteAllInOneClsElementCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteAllInOneClsElementCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnClsElementCode() { return doColumn("CLS_ELEMENT_CODE"); }
        /**
         * CLS_ELEMENT_NAME: {NotNull, VARCHAR(20)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnClsElementName() { return doColumn("CLS_ELEMENT_NAME"); }
        /**
         * ATTRIBUTE_EXP: {NotNull, TEXT(65535)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnAttributeExp() { return doColumn("ATTRIBUTE_EXP"); }
    ...
    protected String getConditionBeanClassNameInternally() { return WhiteAllInOneClsElementCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return WhiteAllInOneClsElementCQ.class.getName(); }
