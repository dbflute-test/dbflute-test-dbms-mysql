...
public abstract class AbstractBsWhiteImplicitReverseFkCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<WhiteImplicitReverseFkCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteImplicitReverseFkCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteImplicitReverseFkCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteImplicitReverseFkCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteImplicitReverseFkCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteImplicitReverseFkCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteImplicitReverseFkCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteImplicitReverseFkCB.class);
    }
