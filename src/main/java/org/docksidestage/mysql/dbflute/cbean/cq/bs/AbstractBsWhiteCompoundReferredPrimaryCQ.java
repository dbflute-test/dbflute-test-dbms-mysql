...
public abstract class AbstractBsWhiteCompoundReferredPrimaryCQ extends AbstractConditionQuery {
     ...
     */
    public void setReferredId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * white_compound_pk by PK_SECOND_ID, named 'whiteCompoundPkAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedWhiteCompoundPkList()</span>.<span style="color: #DD4747">max</span>(pkCB -&gt; {
     *     pkCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     ...
     */
    public void setReferredName_LikeSearch(String referredName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setReferredName_NotLikeSearch(String referredName, COptionCall<LikeSearchOption> opLambda) {
