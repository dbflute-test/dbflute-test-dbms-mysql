...
public abstract class AbstractBsWhiteCompoundReferredPrimaryCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
    ...
    public HpSSQFunction<WhiteCompoundReferredPrimaryCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, WhiteCompoundReferredPrimaryCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     *     public void query(WhiteCompoundReferredPrimaryCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<WhiteCompoundReferredPrimaryCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, WhiteCompoundReferredPrimaryCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     *     public void query(WhiteCompoundReferredPrimaryCB subCB) {
    ...
    public HpSSQFunction<WhiteCompoundReferredPrimaryCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, WhiteCompoundReferredPrimaryCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     *     public void query(WhiteCompoundReferredPrimaryCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteCompoundReferredPrimaryCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, WhiteCompoundReferredPrimaryCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;WhiteCompoundReferredPrimaryCB&gt;() {
     *     public void query(WhiteCompoundReferredPrimaryCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<WhiteCompoundReferredPrimaryCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, WhiteCompoundReferredPrimaryCB.class);
    }
    ...
    public HpSSQFunction<WhiteCompoundReferredPrimaryCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, WhiteCompoundReferredPrimaryCB.class);
    }
