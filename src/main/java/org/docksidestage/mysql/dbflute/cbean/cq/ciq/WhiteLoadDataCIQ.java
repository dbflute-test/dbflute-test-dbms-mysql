...
/**
 * The condition-query for in-line of white_load_data.
 * @author DBFlute(AutoGenerator)
 */
public class WhiteLoadDataCIQ extends AbstractBsWhiteLoadDataCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWhiteLoadDataCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WhiteLoadDataCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWhiteLoadDataCQ myCQ) {
    ...
    protected String xinCB() { return WhiteLoadDataCB.class.getName(); }
    protected String xinCQ() { return WhiteLoadDataCQ.class.getName(); }
}
