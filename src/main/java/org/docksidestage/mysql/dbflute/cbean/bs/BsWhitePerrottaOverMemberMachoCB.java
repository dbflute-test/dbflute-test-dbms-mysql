...
/**
 * The base condition-bean of white_perrotta_over_member_macho.
 * @author DBFlute(AutoGenerator)
 */
public class BsWhitePerrottaOverMemberMachoCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WhitePerrottaOverMemberMachoCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWhitePerrottaOverMemberMachoCB() {
     ...
     * @return this. (NotNull)
     */
    public WhitePerrottaOverMemberMachoCB acceptPK(String machoCode) {
        assertObjectNotNull("machoCode", machoCode);
        BsWhitePerrottaOverMemberMachoCB cb = this;
        cb.query().setMachoCode_Equal(machoCode);
        return (WhitePerrottaOverMemberMachoCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_MachoCode_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_MachoCode_Desc();
        return this;
    }
    ...
    protected WhitePerrottaOverMemberMachoCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WhitePerrottaOverMemberMachoCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WhitePerrottaOverMemberMachoCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WhitePerrottaOverMemberMachoCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;WhitePerrottaOverMemberMachoCB&gt;() {
     *     public void query(WhitePerrottaOverMemberMachoCB unionCB) {
     ...
     */
    public void union(UnionQuery<WhitePerrottaOverMemberMachoCB> unionQuery) {
        final WhitePerrottaOverMemberMachoCB cb = new WhitePerrottaOverMemberMachoCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhitePerrottaOverMemberMachoCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;WhitePerrottaOverMemberMachoCB&gt;() {
     *     public void query(WhitePerrottaOverMemberMachoCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<WhitePerrottaOverMemberMachoCB> unionQuery) {
        final WhitePerrottaOverMemberMachoCB cb = new WhitePerrottaOverMemberMachoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WhitePerrottaOverMemberMachoCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhitePerrottaOverMemberMachoCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WhitePerrottaOverMemberMachoCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "white_perrotta_over_member_macho"; }
        /**
         ...
         */
        public HpSDRFunction<WhitePerrottaOverMemberCB, WhitePerrottaOverMemberMachoCQ> derivedWhitePerrottaOverMemberList() {
         ...
         */
        public HpSDRFunction<WhitePerrottaOverMemberMachoCB, WhitePerrottaOverMemberMachoCQ> myselfDerived() {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;WhitePerrottaOverMemberMachoCB&gt;() {
     *     public void query(WhitePerrottaOverMemberMachoCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;WhitePerrottaOverMemberMachoCB&gt;() {
     *     public void query(WhitePerrottaOverMemberMachoCB cb) {
    ...
    protected WhitePerrottaOverMemberMachoCB xcreateColumnQueryCB() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;WhitePerrottaOverMemberMachoCB&gt;() {
     *     public void query(WhitePerrottaOverMemberMachoCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<WhitePerrottaOverMemberMachoCB> orCBLambda) {
        xorSQ((WhitePerrottaOverMemberMachoCB)this, orCBLambda);
    }
     ...
     *     public void query(WhitePerrottaOverMemberMachoCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhitePerrottaOverMemberMachoCB&gt;() {
     *             public void query(WhitePerrottaOverMemberMachoCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhitePerrottaOverMemberMachoCB> andCBLambda) {
        xorSQAP((WhitePerrottaOverMemberMachoCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WhitePerrottaOverMemberMachoCB cb;
        if (mainCB != null) {
            cb = (WhitePerrottaOverMemberMachoCB)mainCB;
        } else {
