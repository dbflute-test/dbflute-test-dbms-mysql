...
public class BsWhitePerrottaOverMemberMachoCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhitePerrottaOverMemberMachoCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhitePerrottaOverMemberMachoCB> unionCBLambda) {
        final WhitePerrottaOverMemberMachoCB cb = new WhitePerrottaOverMemberMachoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhitePerrottaOverMemberMachoCQ> {
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhitePerrottaOverMemberCB, WhitePerrottaOverMemberMachoCQ> derivedWhitePerrottaOverMember() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhitePerrottaOverMemberCB> sq, WhitePerrottaOverMemberMachoCQ cq, String al, DerivedReferrerOption op)
        ...
        public org.dbflute.cbean.chelper.dbms.HpSDRFunctionMySql<WhitePerrottaOverMemberMachoCB, WhitePerrottaOverMemberMachoCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhitePerrottaOverMemberMachoCB> sq, WhitePerrottaOverMemberMachoCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;WhitePerrottaOverMemberMachoCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;WhitePerrottaOverMemberMachoCB&gt;() {
     ...
     *     public void query(WhitePerrottaOverMemberMachoCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;WhitePerrottaOverMemberMachoCB&gt;() {
