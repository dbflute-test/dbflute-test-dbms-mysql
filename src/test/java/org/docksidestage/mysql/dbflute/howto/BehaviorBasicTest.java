...
public class BehaviorBasicTest extends UnitContainerTestCase {
    ...
    public void test_update() {
        ...
        // ## Assert ##
        Member afterMember = memberBhv.selectEntityWithDeletedCheck(cb -> cb.acceptPK(3));
        ...
        log("xxx: " + purchaseBhv.selectList(purchaseCB).get(0).getMember());
    ...
    public void test_outsideSql_execute_updateMemberChangedToWithdrawalForcedly() {
        ...
        //    --> 第二引数にベタっと値を指定して良い。
        //    --> パラメータコメントは/*pmb.xxx*/ではなく/*xxx*/とする。
        // 
