...
import org.docksidestage.mysql.dbflute.exbhv.WhitePgReservBhv;
import org.docksidestage.mysql.dbflute.exbhv.WhitePgReservRefBhv;
import org.docksidestage.mysql.dbflute.exentity.WhitePgReserv;
import org.docksidestage.mysql.dbflute.exentity.WhitePgReservRef;
...
public class WxPgReservColumnTest extends UnitContainerTestCase {
    ...
    public void test_PgReserv_insert_update() {
        ...
        WhitePgReserv actual = whitePgReservBhv.selectByPK(reserv.getClassSynonym()).get();
