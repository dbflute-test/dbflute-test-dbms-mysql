...
import org.docksidestage.mysql.dbflute.exbhv.WhiteVariantRelationMasterQuxBhv;
import org.docksidestage.mysql.dbflute.exbhv.WhiteVariantRelationReferrerBhv;
import org.docksidestage.mysql.dbflute.exentity.WhiteVariantRelationMasterBar;
import org.docksidestage.mysql.dbflute.exentity.WhiteVariantRelationMasterFoo;
import org.docksidestage.mysql.dbflute.exentity.WhiteVariantRelationMasterQux;
import org.docksidestage.mysql.dbflute.exentity.WhiteVariantRelationReferrer;
    ...
    public void test_VariantRelation_SetupSelect_basic() throws Exception {
        ...
        for (WhiteVariantRelationReferrer referrer : referrerList) {
            ...
            if (foo != null) {
                ...
                whiteVariantRelationMasterBarBhv.selectByPK(bar.getMasterBarId()).get();
                assertTrue(referrer.isMasterTypeCodeBarCls());
                assertNull(foo);
                assertNull(qux);
            } else if (qux != null) {
                whiteVariantRelationMasterQuxBhv.selectByPK(qux.getMasterQuxId()).get();
