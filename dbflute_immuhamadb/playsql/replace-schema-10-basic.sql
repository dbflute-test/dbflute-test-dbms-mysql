...
(
	EVENT_MEMBER_ID BIGINT NOT NULL AUTO_INCREMENT COMMENT 'イベント会員ID',
...
) COMMENT = '[イベント]会員 : 会員のプロフィールやアカウントなどの基本情報を保持する。基本的に物理削除はなく、退会したらステータスが退会会員になる。ライフサイクルやカテゴリの違う会員情報は、one-to-oneなどの関連テーブルにて。';
...
) COMMENT = '[イベント]会員ステータス : 会員のプロフィールやアカウントなどの基本情報を保持する。基本的に物理削除はなく、退会したらステータスが退会会員になる。ライフサイクルやカテゴリの違う会員情報は、one-to-oneなどの関連テーブルにて。';


CREATE TABLE EVENT_PRODUCT
(
	EVENT_PRODUCT_ID BIGINT NOT NULL AUTO_INCREMENT COMMENT 'イベント商品ID',
...
CREATE INDEX IX_PRODUCT_PRODUCT_NAME USING BTREE ON EVENT_PRODUCT (PRODUCT_NAME ASC);
